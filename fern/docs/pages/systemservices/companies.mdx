...
The [companies](/systemservices/companies/get-companies) endpoint responds to `GET` requests with a list of companies. Here's what the request looks like:
