...
| Endpoints||
| :-| :---------------|
| <GetVerb/>| [/ticketing/catalog/:storeCode](/ticketing/api-reference/catalog/get-catalog) |
</Aside>
...
These endpoints allow applications, such as mobile apps or web front-ends, to retrieve ticket details in a structured, 
API-first manner without relying on a traditional website interface. 
By providing data directly, the headless setup enables greater flexibility in how the ticket information 
is presented and consumed by various user interfaces.
