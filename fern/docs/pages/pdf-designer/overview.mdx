---
title: "Introduction to the PDF Designer API"
---

## General
This set of endpoints is used by PDF Designer to build content intended to be shipped to the customer. A manifest contains all assets bundled and is made accessible to the rendering tool as a batch.
