codeunit 6151432 "NPR Retail Feature" implements "NPR Feature Management"
{
    Access = Internal;
    ...
    begin
        ...
        Feature.Validate(Feature, Enum::"NPR Feature"::Retail);
        Feature.Insert();
    end;
    ...
    var
        FeatureIdTok: Label 'Retail', Locked = true, MaxLength = 50;
    begin
        exit(FeatureIdTok);
    end;
    ...
    var
        FeatureDescriptionLbl: Label 'Retail', MaxLength = 2024;
    begin
