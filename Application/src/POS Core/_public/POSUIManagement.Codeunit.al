codeunit 6150702 "NPR POS UI Management"
{
    ...
    var
        ...
        VariablesEditorPopupItemsPerRowLbl: Label 'Items per row';
        ...
        PosEditorInvalidDeviceSizeLbl: Label 'Invalid device size';
        PosEditorChooseDeviceForEditingLayoutsLbl: Label 'Choose device wider than 736px for editing layouts or using desktop layout';
        ...
        GlobalSettingsStatisticsWorkingTimeLbl: Label 'Working Hours Configuration';
        GlobalSettingsStatisticsWorkingTimeInfoLbl: Label 'Please define the working hours';
        GlobalSettingsStatisticsWorkingTimeInfoAllowedRangeLbl: Label 'Allowed range: 0 - 24';
        GlobalSettingsStatisticsOpeningHoursFromLbl: Label 'From:';
        GlobalSettingsStatisticsOpeningHoursToLbl: Label 'To:';
        GlobalSettingsStatisticsErrorOpeningHoursCannotEqualLbl: Label 'Working hours cannot be equal';
        GlobalSettingsStatisticsErrorOpeningHoursFromLaterThanToLbl: Label 'From cannot start later than To';
        ...
        ColorSettingsSelectSecondaryTextColorLbl: Label 'Select color to be used as a secondary text color : ';
    ...
    begin
        ...
        Captions.Add('Variables_Editor_PopupItemsPerRow', VariablesEditorPopupItemsPerRowLbl);
        ...
        Captions.Add('POS_Editor_InvalidDeviceSize', PosEditorInvalidDeviceSizeLbl);
        Captions.Add('POS_Editor_ChooseDeviceForEditingLayouts', PosEditorChooseDeviceForEditingLayoutsLbl);
        ...
        Captions.Add('Global_Settings_StatisticsWorkingTime', GlobalSettingsStatisticsWorkingTimeLbl);
        Captions.Add('Global_Settings_StatisticsWorkingTimeInfo', GlobalSettingsStatisticsWorkingTimeInfoLbl);
        Captions.Add('Global_Settings_StatisticsWorkingTimeInfoAllowedRange', GlobalSettingsStatisticsWorkingTimeInfoAllowedRangeLbl);
        Captions.Add('Global_Settings_StatisticsOpeningHoursFrom', GlobalSettingsStatisticsOpeningHoursFromLbl);
        Captions.Add('Global_Settings_StatisticsOpeningHoursTo', GlobalSettingsStatisticsOpeningHoursToLbl);
        Captions.Add('Global_Settings_StatisticsErrorOpeningHoursCannotEqual', GlobalSettingsStatisticsErrorOpeningHoursCannotEqualLbl);
        Captions.Add('Global_Settings_StatisticsErrorOpeningHoursFromLaterThanTo', GlobalSettingsStatisticsErrorOpeningHoursFromLaterThanToLbl);
        ...
        Captions.Add('Color_Settings_SelectSecondaryTextColor', ColorSettingsSelectSecondaryTextColorLbl);
