codeunit 6060137 "NPR Scenario Obsoleted Feature" implements "NPR Feature Management"
{
    Access = Internal;
    ...
    begin
        ...
        Feature.Validate(Feature, Enum::"NPR Feature"::"POS Scenarios Obsoleted");
        Feature.Insert();
    end;
    ...
    var
        FeatureIdTok: Label 'ScenariosObsoleted', Locked = true, MaxLength = 50;
    begin
        exit(FeatureIdTok);
    end;
    ...
    var
        FeatureDescriptionLbl: Label 'Scenarios Obsoleted', MaxLength = 2024;
    begin
