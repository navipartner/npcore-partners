codeunit 6184996 "NPR New POS Editor Feature" implements "NPR Feature Management"
{
    Access = Internal;
    ...
    begin
        ...
        Feature.Validate(Feature, Enum::"NPR Feature"::"New POS Editor");
        Feature.Insert();
    end;
    ...
    var
        FeatureIdTok: Label 'NewPOSEditor', Locked = true, MaxLength = 50;
    begin
        exit(FeatureIdTok);
    end;
    ...
    var
        FeatureDescriptionLbl: Label 'New POS Editor', MaxLength = 2024;
    begin
