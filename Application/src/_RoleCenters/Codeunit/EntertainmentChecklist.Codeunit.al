...
codeunit 6060003 "NPR Entertainment Checklist"
{
    ...
    begin
        ...
        exit('NPR-Checklist-Entertainment-v1.2');
    end;
    ...
    begin
        //Global Language
        GuidedExperience.InsertAssistedSetup(WelcomeVideoENTxt, WelcomeVideoENTxt, WelcomeVideoENTxt, 2, ObjectType::Codeunit, Codeunit::"NPR Entertainment Welcome Vid.", "Assisted Setup Group"::GettingStarted, '', "Video Category"::GettingStarted, '');
