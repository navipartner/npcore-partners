codeunit 6060035 "NPR SMS Implementation"
{
    Access = Internal;
    ...
    procedure SendSMS(PhoneNo: Text; SenderNo: Text; Message: Text; var UserNotified: Boolean)
    begin
    ...
    procedure FindTemplate(RecordVariant: Variant; var Template: Record "NPR SMS Template Header"; IsHandled: Boolean): Boolean
    var
        TempBlob: Codeunit "Temp Blob";
        RecRef: RecordRef;
    ...
    var
        ...
        DataTypeManagement: Codeunit "Data Type Management";
    begin
        OnBeforeSelectTemplate(IsHandled, RecordVariant, Template);
        if IsHandled then
            exit(true);
        ...
        OnAfterSelectTemplate(RecordVariant, Template, TemplateFound);
        exit(TemplateFound);
    end;
    ...
    local procedure OnBeforeSelectTemplate(var IsHandled: Boolean; RecordVariant: Variant; var Template: Record "NPR SMS Template Header")
    begin
    end;

    [IntegrationEvent(false, FALSE)]
    local procedure OnAfterSelectTemplate(RecordVariant: Variant; var Template: Record "NPR SMS Template Header"; var TemplateFound: Boolean)
    begin
    end;
