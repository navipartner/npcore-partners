table 6014588 "NPR Replication Service Setup"
{
            ...
            begin
                if Enabled then begin
                    ...
                    case Rec.AuthType of
                        Rec.AuthType::Basic:
                            WebServiceAuthHelper.GetBasicAuthorizationParamsBuff(Rec.UserName, Rec."API Password Key", TempAuthParamsBuff);
                        Rec.AuthType::OAuth2:
    ...
    internal procedure RegisterService(pAPIVersion: Code[20]; pServiceUrl: Text[250]; pName: Text[100]; pEnabled: Boolean; pAuthType: Enum "NPR API Auth. Type"; pTenant: Text[50])
    begin
