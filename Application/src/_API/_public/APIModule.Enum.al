...
enum 6059812 "NPR API Module" implements "NPR API Module Resolver"
{
    ...
    {
        Implementation = "NPR API Module Resolver" = "NPR ChannelMgrModuleResolver";
    }
    ...
    value(6248330; coupon)
    {
        Implementation = "NPR API Module Resolver" = "NPR CouponModuleResolver";
    }
    ...
    value(6248650; retailprint)
    {
        Implementation = "NPR API Module Resolver" = "NPR API Retail Print Resolver";
    }
    value(6248660; sale)
    {
        Implementation = "NPR API Module Resolver" = "NPR SaleResolver";
    }
