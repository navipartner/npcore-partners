codeunit 6014567 "NPR Report - Debet Receipt"
{
    ...
    var
        ...
        AuditRollPayment2: Record "NPR Audit Roll";
        SalesCrMemoHeader: Record "Sales Cr.Memo Header";
        AuditRollSale: Record "NPR Audit Roll";
        AuditRollDetails: Record "NPR Audit Roll";
        NoTxt: Label 'No.';
    ...
    begin
        ...
        SalesInvoiceHeader.SetRange("NPR Sales Ticket No.", AuditRollPayment."Sales Ticket No.");
    ...
    begin
        ...
        SalesShipmentHeader.SetRange("NPR Sales Ticket No.", AuditRollPayment."Sales Ticket No.");
    ...
    begin
        ...
        ReturnReceiptHeader.SetRange("NPR Sales Ticket No.", AuditRollPayment."Sales Ticket No.");
    ...
    begin
        ...
        if AuditRollPayment2.FindSet then
            repeat
    ...
    begin
        ...
        SalesCrMemoHeader.SetRange("NPR Sales Ticket No.", AuditRollPayment2."Sales Ticket No.");
    ...
    begin
        ...
        if AuditRollDetails.FindSet then
            repeat
