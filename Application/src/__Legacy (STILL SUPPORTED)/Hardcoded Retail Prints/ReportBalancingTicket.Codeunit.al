codeunit 6014564 "NPR Report: Balancing Ticket"
{
    ...
    var
        ...
        LastRegister: Record "NPR Register";
        ...
        GiftVoucherPaymentTypePOS: Record "NPR Payment Type POS";
        ForeignGiftVoucherPaymentTypePOS: Record "NPR Payment Type POS";
        CreditVoucherPaymentTypePOS: Record "NPR Payment Type POS";
        ForeignCreditVoucherPaymentTypePOS: Record "NPR Payment Type POS";
        TerminalCard: Record "NPR Payment Type POS";
        OtherCreditCards: Record "NPR Payment Type POS";
        ManualCards: Record "NPR Payment Type POS";
        Terminal: Record "NPR Payment Type POS";
        ForeignCurrency: Record "NPR Payment Type POS";
        GiftVoucherDiscountAccount: Record "G/L Account";
        GLAccount: Record "G/L Account";
        PaymentTypeCounting: Record "NPR Payment Type POS";
    ...
    begin
        ...
        if GiftVoucherDiscountAccount.FindSet then
            repeat
                ...
                GiftVoucherDiscountAccount.SetRange("NPR Register Filter", GlobalPeriod."Register No.");
                GiftVoucherDiscountAccount.SetFilter("NPR Sales Ticket No. Filter", '%1..%2',
                                             GlobalPeriod."Opening Sales Ticket No.",
                                             GlobalPeriod."Sales Ticket No.");
                GiftVoucherDiscountAccount.CalcFields("NPR G/L Entry in Audit Roll");

                //Gavekortrabatkonto, Body (1) - OnPreSection()
                if GiftVoucherDiscountAccount."NPR G/L Entry in Audit Roll" <> 0 then begin
                    RPLinePrintMgt.AddTextField(1, 0, PayOutGVDiscountTxt);
                    RPLinePrintMgt.AddDecimalField(2, 2, GiftVoucherDiscountAccount."NPR G/L Entry in Audit Roll");
                end;
    ...
    begin
        ...
        GLAccount.SetRange("NPR Retail Payment", true);
        ...
        if GLAccount.FindSet then
            repeat
                ...
                GLAccount.SetRange("NPR Register Filter", GlobalPeriod."Register No.");
                GLAccount.SetFilter("NPR Sales Ticket No. Filter", '%1..%2', GlobalPeriod."Opening Sales Ticket No.", GlobalPeriod."Sales Ticket No.");
                GLAccount.CalcFields("NPR G/L Entry in Audit Roll");
                ...
                if GLAccount."NPR G/L Entry in Audit Roll" <> 0 then begin
                    RPLinePrintMgt.AddTextField(1, 0, GLAccount.Name + '  ' + Format(GLAccount."No."));
                    RPLinePrintMgt.AddDecimalField(2, 2, GLAccount."NPR G/L Entry in Audit Roll");
                end;
