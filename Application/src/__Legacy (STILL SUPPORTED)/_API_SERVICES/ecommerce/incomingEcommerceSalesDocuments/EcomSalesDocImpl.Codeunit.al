...
codeunit 6248616 "NPR Ecom Sales Doc Impl"
{
    Access = Internal;
    ObsoleteState = Pending;
    ObsoleteTag = '2025-10-19';
    ObsoleteReason = 'Replaced with V2 of the API implementation: NPR Ecom Sales Doc Impl V2';
    ...
    begin
        ...
        //this event is here just for backwards compatability.
    ...
    begin
        ...
        ConfigTemplateCode := EcomSalesDocUtils.GetCustConfigTemplate(EcomSalesHeader."Sell-to Customer Type");
    ...
    local procedure InsertSalesLineShipmentFee(EcomSalesHeader: Record "NPR Ecom Sales Header"; SalesHeader: Record "Sales Header"; EcomSalesLine: Record "NPR Ecom Sales Line"; var SalesLine: Record "Sales Line")
    var
        ...
        EcomSalesDocUtils: Codeunit "NPR Ecom Sales Doc Utils";
    begin
        if EcomSalesLine.Type <> EcomSalesLine.Type::"Shipment Fee" then
            exit;

        if (EcomSalesLine.Quantity = 0) and (EcomSalesLine."Line Amount" = 0) then begin
            InsertSalesLineShipmentFeeAsComment(EcomSalesHeader, SalesHeader, EcomSalesLine, SalesCommentLine);
            exit;
        end;
        ...
        ShipmentMapping.SetRange("External Shipment Method Code", EcomSalesLine."No.");
        ...
        case ShipmentMapping."Shipment Fee Type" of
            ...
            ShipmentMapping."Shipment Fee Type"::"Charge (Item)":
                ...
                EcomSalesDocImplEvents.OnInsertSalesLineShipmentFeeSelectShippingFee(EcomSalesHeader, SalesHeader, EcomSalesLine, SalesLine, ShipmentMapping);
        end;
        ...
        SalesLine."NPR Inc Ecom Sales Line Id" := EcomSalesLine.SystemId;
        EcomSalesDocImplEvents.OnInsertSalesLineShipmentFeeBeforeFinalizeLine(EcomSalesHeader, SalesHeader, EcomSalesLine, SalesLine);
        SalesLine.Modify(true);
    end;
    ...
    begin
        ...
        //this event here is just for backwards compatability
