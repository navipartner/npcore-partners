...
codeunit 6248617 "NPR EcomSalesDocApiAgent"
{
    Access = Internal;
    ObsoleteState = Pending;
    ObsoleteTag = '2025-10-19';
    ObsoleteReason = 'Replaced with V2 of the API agent: NPR EcomSalesDocApiAgentV2';
    ...
    begin
        IncSalesDocumentJsonObject.StartObject('salesDocument')
                                 ...
                                 .StartObject('sellToCustomer')
                                    ...
                                    .AddProperty('type', EcomSalesHeader."Sell-to Customer Type")
        ...
        EcomSalesDocApiEvents.OnGetSalesDocumentJsonObjectAfterSalesHeaderInformation(EcomSalesHeader, IncSalesDocumentJsonObject);
        ...
        EcomSalesDocApiEvents.OnGetSalesDocumentJsonObjectAfterSalesHeaderInformationBeforeEndObject(EcomSalesHeader, IncSalesDocumentJsonObject);
        IncSalesDocumentJsonObject.EndObject();
    end;
