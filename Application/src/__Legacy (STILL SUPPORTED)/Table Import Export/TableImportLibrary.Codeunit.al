codeunit 6014449 "NPR Table Import Library"
{
    ...
    var
        ...
        DotNetStream: DotNet NPRNetStreamReader;
        DotNetEncoding: DotNet NPRNetEncoding;
        DotNetFilePath: Text;
        DotNetReadArray: DotNet NPRNetArray;
        AutoSave: Boolean;
        AutoUpdate: Boolean;
        AutoReplace: Boolean;
        FileName: Text[250];
    ...
    [TryFunction]
    local procedure TryFieldObsoleteCheck(FieldNo: Integer; var XmlDoc: DotNet "NPRNetXmlDocument"; var IsObsolete: Boolean)
    begin
        //-NPR5.48 [340086]
    ...
    [TryFunction]
    local procedure TryFieldAutoIncrementCheck(FieldNo: Integer; var XmlDoc: DotNet "NPRNetXmlDocument"; var IsAutoIncrement: Boolean)
    begin
        //-NPR5.42 [313693]
    ...
    [TryFunction]
    local procedure LoadXmlInStream(var InStream: InStream; var XmlDoc: DotNet "NPRNetXmlDocument")
    begin
        //-NPR5.42 [313693]
    ...
    local procedure LoadMetadataXml(TableNo: Integer; var XmlDoc: DotNet "NPRNetXmlDocument")
    var
        InStream: InStream;
        ObjectMetadata: Record "Object Metadata";
        RecRef: RecordRef;
    ...
    var
        ...
        ReadChars: Integer;
        DotNetSubArray: DotNet NPRNetArray;
    begin
        //-NPR5.48 [340086]
    ...
    local procedure SplitString(Text: Text; SplitChar: Text[1]; var SplitArray: DotNet NPRNetArray)
    var
        String: DotNet NPRNetString;
        CharArray: DotNet NPRNetArray;
        DotNetChar: DotNet NPRNetChar;
    begin
        //-NPR5.48 [340086]
