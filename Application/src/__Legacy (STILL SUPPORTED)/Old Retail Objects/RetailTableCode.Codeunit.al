codeunit 6014400 "NPR Retail Table Code"
{
    ...
    procedure CreateItemGroupNoSeries(var ItemGroup: Record "NPR Item Group")
    var
    ...
    procedure GiftVoucherCommonCreate(var GiftVoucher: Record "NPR Gift Voucher")
    var
        GlobalGiftVoucher: Record "NPR Gift Voucher";
    ...
    procedure GiftVoucherCommonValidate(var SaleHeader: Record "NPR Sale POS"; GiftVoNo: Code[20]; Status: Integer)
    var
        GlobalGiftVoucher: Record "NPR Gift Voucher";
    ...
    procedure GiftVoucherCommonOfflineModify(var GiftVoucher: Record "NPR Gift Voucher")
    var
        GlobalGiftVoucher: Record "NPR Gift Voucher";
    ...
    procedure GiftVoucherCommonClearOrig(var GiftVoucher: Record "NPR Gift Voucher"): Boolean
    var
        CompanyDetailed: Record "NPR Company All";
        GlobalGiftVoucher: Record "NPR Gift Voucher";
    begin
        //GVCommonClearOrig
    ...
    procedure CreditVoucherCommonCreate(var CreditVoucher: Record "NPR Credit Voucher")
    var
        GlobalCreditVoucher: Record "NPR Credit Voucher";
    ...
    procedure CreditVoucherCommonValidate(var SaleHeader: Record "NPR Sale POS"; CreditVoNo: Code[20]; Status: Integer)
    var
    ...
    procedure CreditVoucherCommonClearOrig(var CreditVoucher: Record "NPR Credit Voucher"): Boolean
    var
        CompanyDetailed: Record "NPR Company All";
        GlobalCreditVoucher: Record "NPR Credit Voucher";
    begin
    ...
    procedure CreditVoucherCommonModify(CreditVoucher: Record "NPR Credit Voucher")
    var
        GlobalCreditVoucher: Record "NPR Credit Voucher";
    begin
        //CVCommonModify
    ...
    procedure ExchLabelCommonCreate(var ExchangeLabel: Record "NPR Exchange Label")
    var
        ErrorRecordExist: Label 'Exchange label %1 is already created in the common company!';
        GlobalExchangeLabel: Record "NPR Exchange Label";
    begin
        //-NPR5.27
        RetailSetup.Get;
