codeunit 6014469 "NPR Dynamic Module Helper"
{
    ...
    procedure CreateOrFindModule(ModuleName: Text[50]; var DynamicModule: Record "NPR Dynamic Module")
    begin
    ...
    procedure CreateModuleSetting(DynamicModule: Record "NPR Dynamic Module"; SettingID: Integer; Name: Text; DataType: Integer; AdditionalPropertyType: Option; AdditionalPropertyValue: Text; SetupValue: Variant)
    var
    ...
    local procedure InsertModule(var DynamicModule: Record "NPR Dynamic Module")
    begin
    ...
    local procedure ValidateModuleSetting(var DynamicModuleSetting: Record "NPR Dynamic Module Setting"; DefaultValue: Variant)
    begin
        CheckSetupValue(DynamicModuleSetting, DefaultValue);
        SetSetupValue(DynamicModuleSetting, DefaultValue);
    end;

    local procedure PresetValuesAction(var DynamicModuleSetting: Record "NPR Dynamic Module Setting"; ActionToTake: Option Get,Set)
    begin
    ...
    procedure CheckSetupValue(DynamicModuleSetting: Record "NPR Dynamic Module Setting"; VariantValue: Variant)
    begin
        DataTypeAction(DynamicModuleSetting, VariantValue, 0);
    end;

    procedure GetSetupValue(DynamicModuleSetting: Record "NPR Dynamic Module Setting"; var VariantValue: Variant)
    begin
        DataTypeAction(DynamicModuleSetting, VariantValue, 1);
    end;

    procedure SetSetupValue(var DynamicModuleSetting: Record "NPR Dynamic Module Setting"; VariantValue: Variant)
    begin
        DataTypeAction(DynamicModuleSetting, VariantValue, 2);
    end;

    local procedure DataTypeAction(var DynamicModuleSetting: Record "NPR Dynamic Module Setting"; var VariantValue: Variant; ActionToTake: Option Check,Get,Set)
    var
    ...
    local procedure FormatValue(var DynamicModuleSetting: Record "NPR Dynamic Module Setting"; VariantValue: Variant)
    begin
    ...
    local procedure ShowError(IsError: Boolean; DynamicModuleSetting: Record "NPR Dynamic Module Setting"; ErrorType2: Option)
    var
    ...
    procedure ShowModuleSettings(DynamicModule: Record "NPR Dynamic Module")
    var
        DynamicModuleSetting: Record "NPR Dynamic Module Setting";
    begin
    ...
    local procedure PrepareScopeSettings(var DynamicModuleSetting: Record "NPR Dynamic Module Setting"; ShowAll: Boolean)
    var
        DynamicModuleSettingTemp: Record "NPR Dynamic Module Setting" temporary;
        NewGuid: Guid;
        DynamicModule: Record "NPR Dynamic Module";
        DynamicModuleSettings: Page "NPR Dynamic Module Settings";
    begin
    ...
    local procedure GetDynamicModuleFromName(ModuleName: Text[50]; var DynamicModule: Record "NPR Dynamic Module"): Boolean
    var
        DynamicModule2: Record "NPR Dynamic Module";
    begin
    ...
    procedure UpdateAdditionalProperty(DynamicModule: Record "NPR Dynamic Module"; SettingID: Integer; AdditionalPropertyType: Option; AdditionalPropertyValue: Text)
    var
        DynamicModuleSetting: Record "NPR Dynamic Module Setting";
    begin
        DynamicModuleSetting.Get(DynamicModule."Module Guid", SettingID);
    ...
    local procedure AssignAdditionalProperty(var DynamicModuleSetting: Record "NPR Dynamic Module Setting"; AdditionalPropertyType: Option " ",Length,OptionString,DecimalPrecision; AdditionalPropertyValue: Text): Boolean
    var
    ...
    procedure DeleteSettings(var DynamicModule: Record "NPR Dynamic Module"; var DynamicModuleSetting: Record "NPR Dynamic Module Setting")
    var
        DynamicModule2: Record "NPR Dynamic Module";
    begin
        //-NPR5.43 [316419]
    ...
    local procedure BackupData(var DynamicModule: Record "NPR Dynamic Module"; var DynamicModuleSetting: Record "NPR Dynamic Module Setting")
    var
        DynamicModule2: Record "NPR Dynamic Module";
        DynamicModuleSetting2: Record "NPR Dynamic Module Setting";
    begin
        //-NPR5.43 [316419]
    ...
    procedure RestoreData(var SavedDynamicModule: Record "NPR Dynamic Module"; var SavedDynamicModuleSetting: Record "NPR Dynamic Module Setting")
    var
        DynamicModule: Record "NPR Dynamic Module";
        DynamicModuleSetting2: Record "NPR Dynamic Module Setting";
    begin
    ...
    procedure RestoreSetting(var DynamicModuleSetting: Record "NPR Dynamic Module Setting")
    begin
