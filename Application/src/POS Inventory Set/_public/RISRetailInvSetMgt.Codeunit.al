...
{
    internal procedure IsRetailInventoryEnabled(): Boolean
    var
    ...
    [TryFunction]
    internal procedure TryRequestInventory(RetailInventorySetEntry: Record "NPR RIS Retail Inv. Set Entry"; var RetailInventoryBuffer: Record "NPR RIS Retail Inv. Buffer")
    var
        RetailInventorySet: Record "NPR RIS Retail Inv. Set";
    begin
    ...
    internal procedure ResetInventorySetEntriesAPIValues(RetailInvSet: Record "NPR RIS Retail Inv. Set")
    var
        RetailInventorySetEntry: Record "NPR RIS Retail Inv. Set Entry";
    begin
    ...
    internal procedure ResetInventorySetEntryAPIValues(var RetailInventorySetEntry: Record "NPR RIS Retail Inv. Set Entry")
    begin
