...
codeunit 6248684 "NPR Ret.Pol.: Log Entry RetPol" implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR Retention Policy Log Entry", RetentionPolicyImpl);
