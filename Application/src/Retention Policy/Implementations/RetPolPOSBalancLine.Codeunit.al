...
codeunit 6248710 "NPR Ret.Pol.: POS Balanc. Line" implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR POS Balancing Line", RetentionPolicyImpl);
