...
codeunit 6248711 "NPR Ret.Pol.: POSEntryOutptLog" implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR POS Entry Output Log", RetentionPolicyImpl);
