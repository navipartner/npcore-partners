...
codeunit 6248717 "NPR Ret.Pol.: POS Posting Log" implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR POS Posting Log", RetentionPolicyImpl);
