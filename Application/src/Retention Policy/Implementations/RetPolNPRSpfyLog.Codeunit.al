...
codeunit 6248722 "NPR Ret.Pol.: NPR Spfy Log" implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR Spfy Log", RetentionPolicyImpl);
