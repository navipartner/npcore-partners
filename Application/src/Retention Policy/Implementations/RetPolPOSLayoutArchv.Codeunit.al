...
codeunit 6248715 "NPR Ret.Pol.: POS Layout Archv" implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR POS Layout Archive", RetentionPolicyImpl);
