...
codeunit 6248695 "NPR Ret.Pol.: EFT Transc. Log" implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR EFT Transaction Log", RetentionPolicyImpl);
