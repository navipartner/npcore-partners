...
codeunit 6248714 "NPR Ret.Pol.: POSEntryTaxLine" implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR POS Entry Tax Line", RetentionPolicyImpl);
