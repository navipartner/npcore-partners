...
codeunit 6248696 "NPR Ret.Pol.: EFT Transc. Req." implements "NPR IRetention Policy V2"
{
    Access = Internal;
    ...
    begin
        ...
        RetentionPolicy.OnBeforeAddTableOnDiscoverRetentionPolicyTablesV2(Database::"NPR EFT Transaction Request", RetentionPolicyImpl);
