codeunit 6151417 "NPR Magento Pmt. Quickpay Mgt."
{
    ...
    local procedure SendWebRequest(Dictionary: DotNet NPRNetDictionary_Of_T_U; DotNetArray: DotNet NPRNetArray; HttpWebRequest: DotNet NPRNetHttpWebRequest)
    begin
    ...
    local procedure SerializeObject(Dictionary: DotNet NPRNetDictionary_Of_T_U; var DotNetArray: DotNet NPRNetArray)
    var
        Encoding: DotNet NPRNetEncoding;
        JavaScriptSerializer: DotNet NPRNetJavaScriptSerializer;
    ...
    local procedure SetupHttpWebRequest(var HttpWebRequest: DotNet NPRNetHttpWebRequest; RequestMethod: Code[10]; PaymentLine: Record "NPR Magento Payment Line"; RequestService: Text)
    var
        PaymentGateway: Record "NPR Magento Payment Gateway";
    begin
    ...
    var
        DictionaryErrors: DotNet NPRNetDictionary_Of_T_U;
        DictionaryKeys: DotNet NPRNetDictionary_Of_T_U;
        IEnumerator: DotNet NPRNetIEnumerator;
        IEnumerator2: DotNet NPRNetIEnumerator;
        JavaScriptSerializer: DotNet NPRNetJavaScriptSerializer;
        ListOfKeys: DotNet NPRNetList_Of_T;
        ListOfValues: DotNet NPRNetList_Of_T;
        Type: DotNet NPRNetType;
        Value: Text;
