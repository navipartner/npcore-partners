codeunit 6150907 "NPR HC Customer Management"
{
    ...
    local procedure CustomerAction(XmlDoc: DotNet "NPRNetXmlDocument")
    var
    ...
    local procedure UpdateCustomer(ItemXmlElement: DotNet NPRNetXmlElement) Imported: Boolean
    var
    ...
    local procedure InsertCustomer(XmlElement: DotNet NPRNetXmlElement; var Customer: Record Customer)
    var
