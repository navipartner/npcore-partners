codeunit 6150906 "NPR HC Sales Doc. Mgt."
{
    ...
    begin
        ...
        TempSalesHeader."No." := NpXmlDomMgt.GetXmlAttributeText(Element, 'documentno', false);
    ...
    begin
        ...
        TempSalesLine."Document No." := NpXmlDomMgt.GetXmlAttributeText(Element, 'documentno', false);
        ...
        TempSalesLine."No." := NpXmlDomMgt.GetXmlText(Element, 'no', 0, false);
        TempSalesLine."Location Code" := NpXmlDomMgt.GetXmlText(Element, 'locationcode', 0, false);
        TempSalesLine."Posting Group" := NpXmlDomMgt.GetXmlText(Element, 'postinggroup', 0, false);
        Evaluate(TempSalesLine."Shipment Date", NpXmlDomMgt.GetXmlText(Element, 'shipmentdate', 0, false), 9);
        TempSalesLine.Description := NpXmlDomMgt.GetXmlText(Element, 'description', 0, false);
        TempSalesLine."Description 2" := NpXmlDomMgt.GetXmlText(Element, 'description2', 0, false);
        TempSalesLine."Unit of Measure" := NpXmlDomMgt.GetXmlText(Element, 'unitofmeasure', 0, false);
        ...
        TempSalesLine."Shortcut Dimension 1 Code" := NpXmlDomMgt.GetXmlText(Element, 'shortcutdimension1code', 0, false);
        TempSalesLine."Shortcut Dimension 2 Code" := NpXmlDomMgt.GetXmlText(Element, 'shortcutdimension2code', 0, false);
        TempSalesLine."Customer Price Group" := NpXmlDomMgt.GetXmlText(Element, 'customerpricegroup', 0, false);
        TempSalesLine."Job No." := NpXmlDomMgt.GetXmlText(Element, 'jobno', 0, false);
        TempSalesLine."Work Type Code" := NpXmlDomMgt.GetXmlText(Element, 'worktypecode', 0, false);
        ...
        TempSalesLine."Bill-to Customer No." := NpXmlDomMgt.GetXmlText(Element, 'billtocustomerno', 0, false);
        ...
        TempSalesLine."Gen. Bus. Posting Group" := NpXmlDomMgt.GetXmlText(Element, 'genbuspostinggroup', 0, false);
        TempSalesLine."Gen. Prod. Posting Group" := NpXmlDomMgt.GetXmlText(Element, 'genprodpostinggroup', 0, false);
        Evaluate(TempSalesLine."VAT Calculation Type", NpXmlDomMgt.GetXmlText(Element, 'vatcalculationtype', 0, false), 9);
        TempSalesLine."Transaction Type" := NpXmlDomMgt.GetXmlText(Element, 'transactiontype', 0, false);
        TempSalesLine."Transport Method" := NpXmlDomMgt.GetXmlText(Element, 'transportmethod', 0, false);
        Evaluate(TempSalesLine."Attached to Line No.", NpXmlDomMgt.GetXmlText(Element, 'attachedtolineno', 0, false), 9);
        TempSalesLine."Exit Point" := NpXmlDomMgt.GetXmlText(Element, 'exitpoint', 0, false);
        TempSalesLine.Area := NpXmlDomMgt.GetXmlText(Element, 'area', 0, false);
        TempSalesLine."Transaction Specification" := NpXmlDomMgt.GetXmlText(Element, 'transactionspecification', 0, false);
        TempSalesLine."Tax Category" := NpXmlDomMgt.GetXmlText(Element, 'taxcategory', 0, false);
        TempSalesLine."Tax Area Code" := NpXmlDomMgt.GetXmlText(Element, 'taxareacode', 0, false);
        Evaluate(TempSalesLine."Tax Liable", NpXmlDomMgt.GetXmlText(Element, 'taxliable', 0, false), 9);
        TempSalesLine."Tax Group Code" := NpXmlDomMgt.GetXmlText(Element, 'taxgroupcode', 0, false);
        TempSalesLine."VAT Clause Code" := NpXmlDomMgt.GetXmlText(Element, 'vatclausecode', 0, false);
        TempSalesLine."VAT Bus. Posting Group" := NpXmlDomMgt.GetXmlText(Element, 'vatbuspostinggroup', 0, false);
        TempSalesLine."VAT Prod. Posting Group" := NpXmlDomMgt.GetXmlText(Element, 'vatprodpostinggroup', 0, false);
        TempSalesLine."Currency Code" := NpXmlDomMgt.GetXmlText(Element, 'currencycode', 0, false);
        ...
        TempSalesLine."Prepayment VAT Identifier" := NpXmlDomMgt.GetXmlText(Element, 'prepaymentvatidentifier', 0, false);
        TempSalesLine."Prepayment Tax Area Code" := NpXmlDomMgt.GetXmlText(Element, 'prepaymenttaxareacode', 0, false);
        Evaluate(TempSalesLine."Prepayment Tax Liable", NpXmlDomMgt.GetXmlText(Element, 'prepaymenttaxliable', 0, false), 9);
        TempSalesLine."Prepayment Tax Group Code" := NpXmlDomMgt.GetXmlText(Element, 'prepaymenttaxgroupcode', 0, false);
        ...
        TempSalesLine."IC Partner Code" := NpXmlDomMgt.GetXmlText(Element, 'icpartnercode', 0, false);
        ...
        TempSalesLine."Job Task No." := NpXmlDomMgt.GetXmlText(Element, 'jobtaskno', 0, false);
        Evaluate(TempSalesLine."Job Contract Entry No.", NpXmlDomMgt.GetXmlText(Element, 'jobcontractentryno', 0, false), 9);
        TempSalesLine."Deferral Code" := NpXmlDomMgt.GetXmlText(Element, 'deferralcode', 0, false);
        Evaluate(TempSalesLine."Returns Deferral Start Date", NpXmlDomMgt.GetXmlText(Element, 'returnsdeferralstartdate', 0, false), 9);
        TempSalesLine."Variant Code" := NpXmlDomMgt.GetXmlText(Element, 'variantcode', 0, false);
        TempSalesLine."Bin Code" := NpXmlDomMgt.GetXmlText(Element, 'bincode', 0, false);
        ...
        TempSalesLine."Unit of Measure Code" := NpXmlDomMgt.GetXmlText(Element, 'unitofmeasurecode', 0, false);
        ...
        TempSalesLine."Depreciation Book Code" := NpXmlDomMgt.GetXmlText(Element, 'depreciationbookcode', 0, false);
        Evaluate(TempSalesLine."Depr. until FA Posting Date", NpXmlDomMgt.GetXmlText(Element, 'depruntilfapostingdate', 0, false), 9);
        TempSalesLine."Duplicate in Depreciation Book" := NpXmlDomMgt.GetXmlText(Element, 'duplicateindepreciationbook', 0, false);
        Evaluate(TempSalesLine."Use Duplication List", NpXmlDomMgt.GetXmlText(Element, 'useduplicationlist', 0, false), 9);
        TempSalesLine."Responsibility Center" := NpXmlDomMgt.GetXmlText(Element, 'responsibilitycenter', 0, false);
        ...
        TempSalesLine."Shipping Agent Code" := NpXmlDomMgt.GetXmlText(Element, 'shippingagentcode', 0, false);
        TempSalesLine."Shipping Agent Service Code" := NpXmlDomMgt.GetXmlText(Element, 'shippingagentservicecode', 0, false);
        ...
        TempSalesLine."BOM Item No." := NpXmlDomMgt.GetXmlText(Element, 'bomitemno', 0, false);
        TempSalesLine."Return Reason Code" := NpXmlDomMgt.GetXmlText(Element, 'returnreasoncode', 0, false);
        Evaluate(TempSalesLine."Allow Line Disc.", NpXmlDomMgt.GetXmlText(Element, 'allowlinedisc', 0, false), 9);
        TempSalesLine."Customer Disc. Group" := NpXmlDomMgt.GetXmlText(Element, 'customerdiscgroup', 0, false);
    ...
    begin
        ...
        TempReservationEntry."Source Batch Name" := NpXmlDomMgt.GetXmlAttributeText(Element, 'sourcebatchname', false);
        ...
        TempReservationEntry."Item No." := NpXmlDomMgt.GetXmlText(Element, 'itemno', 0, false);
        ...
        TempReservationEntry.Description := NpXmlDomMgt.GetXmlText(Element, 'description', 0, false);
        ...
        TempReservationEntry."Serial No." := NpXmlDomMgt.GetXmlText(Element, 'serialno', 0, false);
        TempReservationEntry."Created By" := NpXmlDomMgt.GetXmlText(Element, 'createdby', 0, false);
        TempReservationEntry."Changed By" := NpXmlDomMgt.GetXmlText(Element, 'changedby', 0, false);
        ...
        TempReservationEntry."New Serial No." := NpXmlDomMgt.GetXmlText(Element, 'newserialno', 0, false);
        TempReservationEntry."New Lot No." := NpXmlDomMgt.GetXmlText(Element, 'newlotno', 0, false);
        Evaluate(TempReservationEntry."Disallow Cancellation", NpXmlDomMgt.GetXmlText(Element, 'disallowcancellation', 0, false), 9);
        TempReservationEntry."Lot No." := NpXmlDomMgt.GetXmlText(Element, 'lotno', 0, false);
