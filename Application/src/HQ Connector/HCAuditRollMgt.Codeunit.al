codeunit 6150904 "NPR HC Audit Roll Mgt."
{
    ...
    local procedure UpdateAuditRolls(XmlDoc: DotNet "NPRNetXmlDocument")
    var
    ...
    local procedure UpdateAuditRoll(XmlElement: DotNet NPRNetXmlElement) DocumentNoFilter: Text
    var
    ...
    local procedure UpdateAuditRollLine(ItemXmlElement: DotNet NPRNetXmlElement) DocumentNo: Text
    var
    ...
    local procedure InsertAuditRollLine(XmlElement: DotNet NPRNetXmlElement; var HCAuditRoll: Record "NPR HC Audit Roll")
    var
    ...
    local procedure UpdateComments(var BCAuditRoll: Record "NPR HC Audit Roll"; VariantXmlElement: DotNet NPRNetXmlElement)
    var
