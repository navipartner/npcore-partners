xmlport 6059937 "NPR Rss Reader Activity Import"
{
    ...
    schema
    {
        textelement(rss)
        {
            textelement(channel)
            {
                tableelement("RSS Reader Activity"; "NPR RSS Reader Activity")
                {
                    XmlName = 'item';
                    UseTemporary = true;
    ...
    var
        RssReaderActivityTemp: Record "NPR RSS Reader Activity" temporary;
    ...
    procedure GetRssActivityRec(var RssReaderActivityTempHere: Record "NPR RSS Reader Activity" temporary)
    begin
