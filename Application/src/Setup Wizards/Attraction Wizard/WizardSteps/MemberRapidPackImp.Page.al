page 6151386 "NPR Member. RapidPack Imp."
{
    Extensible = False;
    PageType = ListPart;
    ...
    begin
        ...
        rapidstartBaseDataMgt.GetAllPackagesInBlobStorage(BaseUri + '/membermanagement/?restype=container&comp=list'
    ...
    begin
        ...
        foreach RapidPackage in RapidPackageList do begin
            ...
            rapidstartBaseDataMgt.ImportPackage(
                BaseUri + '/membermanagement/' + RapidPackage
