page 6184773 "NPR Setup HU MS POS Paym Meth"
{
    Caption = 'Setup HU MS POS Payment Method Mapping';
    Extensible = false;
        ...
        area(Content)
        {
            ...
            group(SetupPaymMethodsStep)
            {
                ...
                group(PaymentMethods)
                {
                    ...
                    ShowCaption = false;
                    Editable = true;
                    part(HUMSPaymentMethodsSetupStep; "NPR HU MS POS Paym. Meth. Step")
                    {
    ...
    var
        ...
        HUMSPOSPaymMethDataToCreate: Boolean;
    ...
    begin
        CurrPage.HUMSPaymentMethodsSetupStep.Page.CopyRealToTemp();
    ...
    begin
        ...
        FinishActionEnabled := HUMSPOSPaymMethDataToCreate;
    end;

    local procedure CheckIfDataFilledIn()
    begin
        HUMSPOSPaymMethDataToCreate := CurrPage.HUMSPaymentMethodsSetupStep.Page.HUMSPOSPaymentMethodMappingDataToCreate();
    end;

    local procedure FinishAction();
    begin
        CurrPage.HUMSPaymentMethodsSetupStep.Page.CreatePOSPaymMethodMappingData();
        OnAfterFinishStep(HUMSPOSPaymMethDataToCreate);
        CurrPage.Close();
    end;
