page 6184788 "NPR NO POS Audit Profile Step"
{
    Caption = 'NO POS Audit Profile Setup';
    Extensible = false;
    PageType = ListPart;
    ...
    internal procedure NOPOSAuditProfileDataToCreate(): Boolean
    begin
        exit(CheckIsDataSet());
    end;
    ...
    begin
        Rec.SetRange("Audit Handler", NOAuditMgt.HandlerCode());
