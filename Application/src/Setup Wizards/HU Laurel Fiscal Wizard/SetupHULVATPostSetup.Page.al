page 6185024 "NPR Setup HU L VAT PostSetup"
{
    Caption = 'Setup HU Laurel VAT Posting Setup Mapping';
    Extensible = false;
        ...
        area(Content)
        {
            ...
            group(SetupVATPostingStep)
            {
                ...
                group(VATPostingStep)
                {
                    ShowCaption = false;
                    Editable = true;
                    part(HULVATPostingSetupStep; "NPR HUL VAT Posting Setup Step")
                    {
                        ApplicationArea = NPRRetail;
    ...
    begin
        CurrPage.HULVATPostingSetupStep.Page.CopyRealToTemp();
    ...
    begin
        DataPopulated := CurrPage.HULVATPostingSetupStep.Page.IsDataPopulated();
    end;

    local procedure FinishAction();
    begin
        CurrPage.HULVATPostingSetupStep.Page.CreateVATPostingSetupMappingData();
