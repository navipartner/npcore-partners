page 6184768 "NPR Setup ES Return Reason Map"
{
    Caption = 'Setup ES Return Reason Mapping';
    Extensible = false;
    ...
    layout
    {
        area(Content)
        {
            ...
            group(SetReturnReasonStep)
            {
                ...
                group(SetESReturnReasons)
                {
                    Caption = 'Set ES Return Reasons';
                    ShowCaption = false;
                    Editable = true;
                    part(ESReturnReasonMapStep; "NPR ES Return Reason Map Step")
                    {
    ...
    begin
        CurrPage.ESReturnReasonMapStep.Page.CopyToTemp();
    ...
    begin
        DataPopulated := CurrPage.ESReturnReasonMapStep.Page.IsDataPopulated();
    end;

    local procedure FinishAction();
    begin
        CurrPage.ESReturnReasonMapStep.Page.CreateReturnReasonMappingData();
