page 6151512 "NPR BG SIS POS Audit Prof Step"
{
    Caption = 'BG SIS POS Audit Profile Setup';
    Extensible = false;
    PageType = ListPart;
    ...
    begin
        ...
        repeat
            if (Rec."Audit Handler" = BGSISAuditMgt.HandlerCode()) and Rec."Audit Log Enabled" and Rec."Require Item Return Reason" then
                exit(true);
        until Rec.Next() = 0;
