page 6151516 "NPR Setup BG SIS VAT PostSetup"
{
    Caption = 'Setup BG SIS VAT Posting Setup Mapping';
    Extensible = false;
    ...
    layout
    {
        area(Content)
        {
            ...
            group(SetVATPostingSetupStep)
            {
                ...
                group(SetBGSISVATPostingSetups)
                {
                    Caption = 'Set BG SIS VAT Posting Setups';
                    ShowCaption = false;
                    Editable = true;
                    part(BGSISVATPostSetupStep; "NPR BG SIS VAT Post Setup Step")
                    {
    ...
    begin
        CurrPage.BGSISVATPostSetupStep.Page.CopyToTemp();
    ...
    begin
        DataPopulated := CurrPage.BGSISVATPostSetupStep.Page.IsDataPopulated();
    end;

    local procedure FinishAction();
    begin
        CurrPage.BGSISVATPostSetupStep.Page.CreateVATPostingSetupMappingData();
