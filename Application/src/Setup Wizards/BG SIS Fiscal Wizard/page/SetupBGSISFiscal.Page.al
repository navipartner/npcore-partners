        ...
        area(Content)
        {
            ...
            group(IntroStep)
            {
                ...
                group(Welcome)
                {
                    ...
                    {
                        Caption = '';
                        InstructionalText = ' This essential step ensures your business adheres to Bulgerian fiscal regulations. Enable BG SIS fiscalization and set up related settings for a comprehensive and compliant financial foundation.';
                    }
                }
                group("Let's go!")
                {
