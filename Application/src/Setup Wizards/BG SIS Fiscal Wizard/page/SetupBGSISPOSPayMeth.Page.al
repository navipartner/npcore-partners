page 6151514 "NPR Setup BG SIS POS Pay Meth"
{
    Caption = 'Setup BG SIS POS Payment Method Mapping';
    Extensible = false;
    ...
    layout
    {
        area(Content)
        {
            ...
            group(SetPOSPaymentMethodStep)
            {
                ...
                group(SetBGSISPOSPaymentMethods)
                {
                    Caption = 'Set BG SIS POS Payment Methods';
                    ShowCaption = false;
                    Editable = true;
                    part(BGSISPOSPayMethStep; "NPR BG SIS POS Pay. Meth. Step")
                    {
    ...
    begin
        CurrPage.BGSISPOSPayMethStep.Page.CopyToTemp();
    ...
    begin
        DataPopulated := CurrPage.BGSISPOSPayMethStep.Page.IsDataPopulated();
    end;

    local procedure FinishAction();
    begin
        CurrPage.BGSISPOSPayMethStep.Page.CreatePOSPaymentMethodMappingData();
