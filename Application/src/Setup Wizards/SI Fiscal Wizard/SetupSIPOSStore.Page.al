page 6184471 "NPR Setup SI POS Store"
{
    ...
    var
        ...
        SIPOSPaymMethDataToCreate: Boolean;
    ...
    begin
        ...
        FinishActionEnabled := SIPOSPaymMethDataToCreate;
    end;

    local procedure CheckIfDataFilledIn()
    begin
        SIPOSPaymMethDataToCreate := CurrPage.SIPOSStoreSetupStep.Page.SIPOSPaymentMethodMappingDataToCreate();
    end;

    local procedure FinishAction();
    begin
        CurrPage.SIPOSStoreSetupStep.Page.CreatePOSPaymMethodMappingData();
        OnAfterFinishStep(SIPOSPaymMethDataToCreate);
        CurrPage.Close();
    end;
