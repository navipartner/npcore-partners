page 6184675 "NPR AT POS Audit Profile Step"
{
    Caption = 'AT POS Audit Profile Setup';
    Extensible = false;
    PageType = ListPart;
    ...
    begin
        ...
        repeat
            if (Rec."Audit Handler" = ATAuditMgt.HandlerCode()) and Rec."Audit Log Enabled" then
                exit(true);
        until Rec.Next() = 0;
