page 6150873 "NPR Seating Flow Stat. Step"
{
    Extensible = False;
    ...
    begin
        Rec."Status Object" := Rec."Status Object"::Seating;
    end;
    ...
    internal procedure SeatingFlowStatusesToCreate(): Boolean
    begin
        exit(Rec.FindSet());
    end;

    internal procedure CreateSeatingFlowStatuses()
    var
        FlowStatus: Record "NPR NPRE Flow status";
    begin
        if Rec.FindSet() then
