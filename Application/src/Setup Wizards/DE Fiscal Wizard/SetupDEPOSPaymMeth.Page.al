page 6184781 "NPR Setup DE POS Paym. Meth."
{
    Caption = 'Setup DE POS Payment Method Mapping';
    Extensible = false;
    ...
    layout
    {
        area(Content)
        {
            ...
            // DE POS Payment Methods
            group(SetPOSPaymentMethodStep)
            {
                Visible = SetPOSPaymentMethodStepVisible;
                group(SetDEPOSPaymentMethods)
                {
                    Caption = 'Set DE POS Payment Methods';
                    ShowCaption = false;
                    Editable = true;
                    part(DEPOSPaymMethStep; "NPR DE POS Paym. Meth. Step")
                    {
    ...
    begin
        CurrPage.DEPOSPaymMethStep.Page.CopyToTemp();
    ...
    begin
        DataPopulated := CurrPage.DEPOSPaymMethStep.Page.IsDataPopulated();
    end;

    local procedure FinishAction();
    begin
        CurrPage.DEPOSPaymMethStep.Page.CreatePOSPaymentMethodMappingData();
