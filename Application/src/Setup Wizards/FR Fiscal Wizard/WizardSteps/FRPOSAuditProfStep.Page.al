page 6184836 "NPR FR POS Audit Prof Step"
{
    ...
    begin
        Rec.SetRange("Audit Handler", FRAuditMgt.HandlerCode());
        Rec.SetRange("Audit Log Enabled", true);
        Rec.SetRange("Print Receipt On Sale Cancel", false);
        Rec.SetRange("Do Not Print Receipt on Sale", false);
        Rec.SetRange("Allow Zero Amount Sales", false);
