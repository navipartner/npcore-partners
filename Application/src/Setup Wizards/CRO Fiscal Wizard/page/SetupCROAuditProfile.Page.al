page 6151345 "NPR Setup CRO Audit Profile"
{
    Caption = 'Setup CRO POS Audit Profile';
    Extensible = false;
    ...
    begin
        CurrPage.CROChooseAuditProfileStep.Page.CopyRealToTemp();
    ...
    begin
        CROPOSAuditDataToCreate := CurrPage.CROChooseAuditProfileStep.Page.CROPOSAuditProfileDataToCreate();
    end;

    local procedure FinishAction();
    begin
        CurrPage.CROChooseAuditProfileStep.Page.CreatePOSAuditProfileData();
