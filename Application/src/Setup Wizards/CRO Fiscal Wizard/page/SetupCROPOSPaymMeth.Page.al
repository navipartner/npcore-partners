page 6151353 "NPR Setup CRO POS Paym. Meth."
{
    Caption = 'Setup CRO POS Payment Method Mapping';
    Extensible = false;
        ...
        area(Content)
        {
            ...
            group(SetupPaymMethodsStep)
            {
                ...
                group(PaymentMethods)
                {
                    ...
                    ShowCaption = false;
                    Editable = true;
                    part(CROPaymentMethodsSetupStep; "NPR CRO POS Paym. Method Step")
                    {
    ...
    var
        ...
        CROPOSPaymMethDataToCreate: Boolean;
    ...
    begin
        ...
        FinishActionEnabled := CROPOSPaymMethDataToCreate;
    end;

    local procedure CheckIfDataFilledIn()
    begin
        CROPOSPaymMethDataToCreate := CurrPage.CROPaymentMethodsSetupStep.Page.CROPOSPaymentMethodMappingDataToCreate();
    end;

    local procedure FinishAction();
    begin
        CurrPage.CROPaymentMethodsSetupStep.Page.CreatePOSPaymMethodMappingData();
        OnAfterFinishStep(CROPOSPaymMethDataToCreate);
        CurrPage.Close();
    end;
