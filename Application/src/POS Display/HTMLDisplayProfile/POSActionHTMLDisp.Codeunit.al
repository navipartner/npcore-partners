...
'let main=async e=>{try{const{context:t,popup:r,captions:a,parameters:n}=e;let o="";switch(t.JSAction!==void 0?o=t.JSAction:o=n.CustomerDisplayOp.toString(),o){case"OPEN":OpenCloseDisplay(!0);break;case"CLOSE":OpenCloseDisplay(!1);break;case"GET_INPUT":await CollectInput(e);break;case"QRPaymentScan":await workflow.respond("QRPaymentScan")&&QRPaymentScan(t);break;default:r.error(a.ErrUnknownOperation+": ''"+n.CustomerDisplayOp.toString()+"''");break}}catch(t){popup.error(t)}};async function CollectInput(e){const{hwc:t,workflow:r,popup:a,captions:n}=e;switch(objParam={JSAction:"GetInput",InputType:"Phone & Signature"},await r.respond("POSEntryNo")){case"GET_INPUT":break;case"NOT_SELECTED":a.error(n.ErrPOSEntryNotSelected);return;case"INPUT_EXISTS":a.error(n.ErrPOSEntryInputExists);return;default:a.error(n.ErrPOSEntryUndefined);return}let i=!1;for(;!i;){let s=await t.invoke("HTMLDisplay",{DisplayAction:"SendJS",JSParameter:JSON.stringify(objParam)});i=await r.respond("InputCollected",s.JSON.Input)}}async function OpenCloseDisplay(e){await hwc.invoke("HTMLDisplay",{DisplayAction:e?"Open":"Close"})}async function QRPaymentScan(e){console.log(e),e.Command==="Open"?await hwc.invoke("HTMLDisplay",{DisplayAction:"SendJS",JSParameter:JSON.stringify({JSAction:"QRPaymentScan",Provider:e.Provider,Command:"Open",QrContent:e.QrContent,PaymentAmount:e.Amount})}):await hwc.invoke("HTMLDisplay",{DisplayAction:"SendJS",JSParameter:JSON.stringify({JSAction:"QRPaymentScan",Command:"Close"})})}'
        );
    end;
}
