codeunit 6014528 "NPR Barcode Library"
{
    ...
    begin
        ...
        with Rec do begin
            ...
            "NPR Cross-Reference No." := ReturnedCrossRef."Cross-Reference No.";
    ...
    begin
        ...
        if Found then begin
            TransferLine."NPR Cross-Reference No." := ItemCrossReference."Cross-Reference No.";
    ...
    begin
        ...
        with ItemCrossReference do begin
            ...
            TempCrossRefItem := TransferLine2."NPR Cross-Reference No.";
            Reset;
            SetCurrentKey("Cross-Reference No.", "Cross-Reference Type", "Cross-Reference Type No.", "Discontinue Bar Code");
            SetRange("Cross-Reference No.", TransferLine."NPR Cross-Reference No.");
            SetRange("Discontinue Bar Code", false);
    ...
    local procedure CrossReferenceNoLookUp(var Sender: Codeunit "NPR Barcode Library"; var TransferLine3: Record "Transfer Line")
    var
    ...
    begin
        ...
        with TransferLine3 do begin
            ...
            if PAGE.RunModal(PAGE::"Cross Reference List", ItemCrossReference3) = ACTION::LookupOK then
                Validate("NPR Cross-Reference No.", ItemCrossReference3."Cross-Reference No.");
        end;
        //+NPR5.23 [242315]
    end;
    ...
    [IntegrationEvent(TRUE, false)]
    procedure CallCrossRefNoLookupMixDiscount(var MixedDiscountLine: Record "NPR Mixed Discount Line")
    begin
        //-NPR5.26 [246594]
    end;

    [EventSubscriber(ObjectType::Codeunit, 6014528, 'CallCrossRefNoLookupMixDiscount', '', false, false)]
    local procedure CrossRefNoLookupMixDiscount(var Sender: Codeunit "NPR Barcode Library"; var MixedDiscountLine: Record "NPR Mixed Discount Line")
    var
    ...
    local procedure OnAfterValidateCrossRefMixDiscount(var Rec: Record "NPR Mixed Discount Line"; var xRec: Record "NPR Mixed Discount Line"; CurrFieldNo: Integer)
    var
        ReturnedCrossRef: Record "Item Cross Reference";
    begin
        //-NPR5.26 [246594]
    ...
    procedure ICRLookupMixedDiscount(var MixedDiscountLine2: Record "NPR Mixed Discount Line"; var ReturnedCrossRef: Record "Item Cross Reference")
    var
        AlternativeNo: Record "NPR Alternative No.";
    ...
    [IntegrationEvent(TRUE, false)]
    procedure CallCrossRefNoLookupPeriodicDiscount(var PeriodDiscountLine: Record "NPR Period Discount Line")
    begin
        //-NPR5.26 [246594]
    end;

    [EventSubscriber(ObjectType::Codeunit, 6014528, 'CallCrossRefNoLookupPeriodicDiscount', '', false, false)]
    local procedure CrossRefNoLookupPeriodicDiscount(var Sender: Codeunit "NPR Barcode Library"; var PeriodDiscountLine: Record "NPR Period Discount Line")
    var
        ItemCrossReference2: Record "Item Cross Reference";
    begin
        //-NPR5.26 [246594]
    ...
    local procedure OnAfterValidateCrossRefPeriodicDiscount(var Rec: Record "NPR Period Discount Line"; var xRec: Record "NPR Period Discount Line"; CurrFieldNo: Integer)
    var
        ReturnedCrossRef: Record "Item Cross Reference";
    begin
        //-NPR5.26 [246594]
    ...
    procedure ICRLookupPeriodicDiscount(var PeriodDiscountLine2: Record "NPR Period Discount Line"; var ReturnedCrossRef: Record "Item Cross Reference")
    var
        AlternativeNo: Record "NPR Alternative No.";
