codeunit 6184681 "NPR Label Management"
{
    Access = Internal;
        ...
        if _TmpSelectionBuffer.FindSet() then begin
            case _TmpSelectionBuffer.Number of
                ...
                DATABASE::"Warehouse Activity Line":
                    ...
                    LabelLibrary.OnPrintSelection(_TmpSelectionBuffer, ReportType);
            end;
        end;
    end;
    ...
    begin
        ...
        case RecRef.Number of
            ...
            DATABASE::"Warehouse Activity Line":
                ...
                LabelLibrary.OnRunPrintPage(RecRef, RetailJournalMgt, _TmpRetailJnlCode, IsHandled);
    ...
    begin
        ...
        LabelLibrary.OnBeforePrintRetailJournal(JournalLine, ReportType, Skip);
        if Skip then
            exit;
        ...
        LabelLibrary.OnAfterPrintRetailJournal(JournalLine, ReportType);
    end;
    ...
    internal procedure ApplyFilter(VarRec: Variant; var FilteredLineRecRef: RecordRef)
    var
        RecRef2: RecordRef;
    ...
    begin
        ...
        case RecRef2.Number of
            ...
            DATABASE::"Warehouse Activity Header":
                ...
                LabelLibrary.OnApplyFilter(FilteredLineRecRef, VarRec, IsHandled);
    ...
    internal procedure ResolveVariantAndPrintItem(var Item: Record Item; ReportType: Integer) PrintedQty: Decimal
    var
    ...
    internal procedure FlushJournalToPrinter(RetailJournalCode: Code[40]; ReportType: Integer)
    var
        RetailJnlLine: Record "NPR Retail Journal Line";
    begin
