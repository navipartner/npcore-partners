        ...
        area(processing)
        {
            group(Show)
            {
                ...
                action(TypeOfSales)
                {
                    ...
                    Enabled = TypeOfSales;
                    ApplicationArea = All;
                    ToolTip = 'Executes the Membership Sales Type action';
            ...
            group(Options)
            {
                ...
                group(ValueToCalculate)
                {
                    ...
                    action(Amount)
                    {
                        ...
                        ApplicationArea = All;
                        ToolTip = 'Executes the Amount action';
                    ...
                    action(NoofMemberships)
                    {
                        ...
                        ApplicationArea = All;
                        ToolTip = 'Executes the Membership Count action';
                ...
                group(PeriodTotal)
                {
                    action(Accumulated)
                    {
                        ...
                        ApplicationArea = All;
                        ToolTip = 'Executes the Accumulate action';
                    ...
                    action(NetChange)
                    {
                        ...
                        ApplicationArea = All;
                        ToolTip = 'Executes the Net Change action';
                ...
                group("Chart Type")
                {
                    ...
                    action(StackedArea)
                    {
                        ...
                        ApplicationArea = All;
                        ToolTip = 'Executes the Stacked Area action';
                    ...
                    action(StackedColumn)
                    {
                        ...
                        ApplicationArea = All;
                        ToolTip = 'Executes the Stacked Column action';
