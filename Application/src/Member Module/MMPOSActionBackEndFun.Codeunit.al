codeunit 6060108 "NPR MM POS Action: BackEnd Fun" implements "NPR IPOS Workflow"
{
    Access = Internal;
    ...
    var
        ItemNumber: Code[20];
        POSActionBackEndB: Codeunit "NPR MM POS Action: BackEnd B";
    begin
    ...
    begin
        exit(
        //###NPR_INJECT_FROM_FILE:MMPOSActionBackEndFun.js###
