codeunit 6060126 "NPR MM Membership Kiosk"
{
    ...
    begin
        ...
        case PageId of
            0:
                Css := WelcomePageCss();
            1:
                Css := ScanTicketBarcodeCss();
            2:
                Css := MemberInfoCaptureCss();
            3:
                Css := TakePhotoCss();
            4:
                Css := PreviewCardCss();
    ...
    begin
        case PageId of
            ...
            1:
                Script := ScanTicketBarcodeScript();
            2:
                Script := MemberInfoCaptureScript();
            3:
                Script := TakePhotoScript();
            4:
                Script := PreviewCardScript();
            5:
                Script := PrintScript();
            6:
                Script := ShowErrorScript();
            else
                Script := WelcomePageScript();
        end;
    end;
