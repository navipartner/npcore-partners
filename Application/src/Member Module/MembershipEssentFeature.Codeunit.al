codeunit 6151439 "NPR Membership Essent. Feature" implements "NPR Feature Management"
{
    Access = Internal;
    ...
    begin
        ...
        Feature.Validate(Feature, Enum::"NPR Feature"::"Membership Essential");
        Feature.Insert();
    end;
    ...
    var
        FeatureIdTok: Label 'MembershipEssential', Locked = true, MaxLength = 50;
    begin
        exit(FeatureIdTok);
    end;
    ...
    var
        FeatureDescriptionLbl: Label 'Membership Essential', MaxLength = 2024;
    begin
