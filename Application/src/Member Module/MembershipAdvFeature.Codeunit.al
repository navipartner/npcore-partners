codeunit 6151440 "NPR Membership Adv. Feature" implements "NPR Feature Management"
{
    Access = Internal;
    ...
    begin
        ...
        Feature.Validate(Feature, Enum::"NPR Feature"::"Membership Advanced");
        Feature.Insert();
    end;
    ...
    var
        FeatureIdTok: Label 'MembershipAdvanced', Locked = true, MaxLength = 50;
    begin
        exit(FeatureIdTok);
    end;
    ...
    var
        FeatureDescriptionLbl: Label 'Membership Advanced', MaxLength = 2024;
    begin
