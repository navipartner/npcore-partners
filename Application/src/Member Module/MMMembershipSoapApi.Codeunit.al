codeunit 6248507 "NPR MMMembershipSoapApi"
{
    Access = Internal;
    ...
    var
        ...
        XmlDocRequest: XmlDocument;
        XmlDocResponse: XmlDocument;
        MemberCardValidationLbl: Label 'Service %1 at %2 could not validate membercard %3.';
    ...
    begin
        ...
        if (not IsValid) then
            if (NotValidReason = '') then
                NotValidReason := StrSubstNo(MemberCardValidationLbl, SoapAction, NPRRemoteEndpointSetup."Endpoint URI", ForeignMemberCardNumber);
...
#pragma warning restore AA0139
    ...
    internal procedure UpdateLocalMembershipPoints(NPRRemoteEndpointSetup: Record "NPR MM NPR Remote Endp. Setup"; MembershipEntryNo: Integer; Prefix: Code[10]; ForeignMemberCardNumber: Text[100]; var NotValidReason: Text) IsValid: Boolean
    var
        SoapAction: Text[50];
        XmlDocRequest: XmlDocument;
        XmlDocResponse: XmlDocument;
    ...
    internal procedure WebServiceApi(NPRRemoteEndpointSetup: Record "NPR MM NPR Remote Endp. Setup"; SoapAction: Text; var ReasonText: Text; var XmlDocIn: XmlDocument; var XmlDocOut: XmlDocument): Boolean
    begin
        ReasonText := '';
    ...
    local procedure MemberCardNumberValidationRequest(ExternalMemberCardNumber: Text[100]; ScannerStationId: Text; var SoapAction: Text[50]; var XmlDoc: XmlDocument)
    var
        XmlRequest: Text;
    begin
