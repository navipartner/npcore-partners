codeunit 6151289 "NPR SS Action: Insert Item" implements "NPR IPOS Workflow"
{
    Access = Internal;
...
# pragma warning restore
    ...
    var
        ...
        SSActionInsertItemB: Codeunit "NPR SS Action: Insert Item B.";
        Item: Record Item;
    begin
    ...
    begin
        exit(
//###NPR_INJECT_FROM_FILE:SSActionInsertItem.js###
