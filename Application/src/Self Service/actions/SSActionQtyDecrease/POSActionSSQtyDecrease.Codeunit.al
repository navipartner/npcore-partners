codeunit 6151281 "NPR POSAction: SS Qty Decrease" implements "NPR IPOS Workflow"
{
    Access = Internal;
    ...
    var
        Qty: Decimal;
        SSActionQtyDecreaseB: Codeunit "NPR POSAct. SS Qty Decrease B";
    begin
    ...
    begin
        exit(
//###NPR_INJECT_FROM_FILE:POSActionSSQtyDecrease.js###
