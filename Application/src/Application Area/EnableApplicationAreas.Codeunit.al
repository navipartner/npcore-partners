codeunit 6151349 "NPR Enable Application Areas"
{
    ...
    begin
        ...
        TempApplicationAreaSetup."NPR BG Fiscal" := IsBGFiscalizationEnabled();
    end;
    ...
    local procedure IsBGFiscalizationEnabled(): Boolean
    var
    ...
    begin
        ...
        exit(BGFiscalizationSetup."Enable BG Fiscal");
    end;
