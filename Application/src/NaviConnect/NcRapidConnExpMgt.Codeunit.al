codeunit 6151091 "NPR Nc RapidConn. Exp. Mgt."
{
    ...
    local procedure ExportToXml(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup"; NcTask: Record "NPR Nc Task"; var XmlDoc: DotNet "NPRNetXmlDocument")
    var
    ...
    local procedure CommitXmlToOutput(NcTask: Record "NPR Nc Task"; XmlDoc: DotNet "NPRNetXmlDocument"; OutputName: Text; var NcTaskOutput: Record "NPR Nc Task Output")
    var
        OutStr: OutStream;
    begin
        //-NC2.17 [335927]
    ...
    local procedure OnAfterApplyPackageFilter(ConfigPackageTable: Record "Config. Package Table"; var RecRef: RecordRef; var Handled: Boolean; NcTask: Record "NPR Nc Task")
    begin
