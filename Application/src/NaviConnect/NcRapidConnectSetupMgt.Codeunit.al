codeunit 6151090 "NPR Nc RapidConnect Setup Mgt."
{
    ...
    local procedure RunInitNcSetup(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup"; NcRapidConnectTrigger: Record "NPR Nc RapidConnect Trig.Table")
    begin
        if not ExportEnabled(NcRapidConnectSetup) then
            exit;
        //-NC2.14 [322308]
    ...
    local procedure InitDataLogSetup(NcRapidConnectTrigger: Record "NPR Nc RapidConnect Trig.Table")
    var
    ...
    local procedure InitDataLogSubscriber(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup"; NcRapidConnectTrigger: Record "NPR Nc RapidConnect Trig.Table")
    var
    ...
    local procedure InitNcTaskSetup(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup"; NcRapidConnectTrigger: Record "NPR Nc RapidConnect Trig.Table")
    var
    ...
    procedure InitExportTriggers(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup")
    var
    ...
    local procedure OnInsertExportTrigger(var Rec: Record "NPR Nc RapidConnect Trig.Table")
    var
    ...
    local procedure OnModifyExportTrigger(var Rec: Record "NPR Nc RapidConnect Trig.Table")
    var
        NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup";
    begin
        if Rec.IsTemporary then
    ...
    local procedure OnValidateExportEnabled(var Rec: Record "NPR Nc RapidConnect Setup")
    begin
        if Rec.IsTemporary then
            exit;
    ...
    local procedure OnValidateImportEnabled(var Rec: Record "NPR Nc RapidConnect Setup")
    begin
        if Rec.IsTemporary then
            exit;
    ...
    local procedure OnValidateImportType(var Rec: Record "NPR Nc RapidConnect Setup"; CurrFieldNo: Integer)
    var
        NcImportType: Record "NPR Nc Import Type";
    begin
    ...
    local procedure OnValidateTaskProcessorCode(var Rec: Record "NPR Nc RapidConnect Setup")
    begin
        if Rec.IsTemporary then
            exit;
    ...
    local procedure OnModifyRapidConnectSetup(var Rec: Record "NPR Nc RapidConnect Setup"; RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
            exit;
    ...
    local procedure SetupTempTableObjects(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup"; var TempAllObjWithCaption: Record AllObjWithCaption temporary)
    var
    ...
    local procedure ImportEnabled(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup"): Boolean
    begin
        exit(NcRapidConnectSetup."Import Enabled");
    end;

    local procedure FindImportTypeCode(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup") ImportTypeCode: Code[20]
    var
        NcImportType: Record "NPR Nc Import Type";
        PostFix: Code[20];
    begin
    ...
    procedure SetConfigPackageTableFilter(NcRapidConnectSetup: Record "NPR Nc RapidConnect Setup"; var ConfigPackageTable: Record "Config. Package Table")
    var
    ...
    begin
        exit(CODEUNIT::"NPR Nc RapidConnect Imp. Mgt.");
    end;

    local procedure LookupCodeunitId(): Integer
    begin
        exit(CODEUNIT::"NPR Nc RapidConnect Imp. Look.");
    end;
