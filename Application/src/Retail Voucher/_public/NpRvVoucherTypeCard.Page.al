            ...
            group("Send Voucher")
            {
                ...
                group(Control6014426)
                {
                    ...
                    group(Control6014407)
                    {
                        ...
                        {
                            ToolTip = '[S] ~ Voucher No. || [N] ~ Random Number || [N*3] ~ 3 Random Numbers || [AN] ~ Random Char || [AN*3] ~ 3 Random Chars. For EAN13, the reference number pattern should consist of 12 characters. The 13th character is a check digit generated by the system.';
                            ApplicationArea = NPRRetail;
                        }
                    }
                    group(Control6014405)
                    {
                        ...
                        {
                            ToolTip = '[S] ~ Voucher No. || [N] ~ Random Number || [N*3] ~ 3 Random Numbers. For EAN13, the reference number pattern should consist of 12 characters. The 13th character is a check digit generated by the system.';
                            ApplicationArea = NPRRetail;
                        }
                    }
                }
