codeunit 6151080 "NPR ExRv Mgt."
{
    ...
    var
        ExRvVoucherType: Record "NPR ExRv Voucher Type";
    ...
    local procedure IssueGiftVoucher(ExRvVoucherType: Record "NPR ExRv Voucher Type"; var TempExRvVoucher: Record "NPR ExRv Voucher")
    var
    ...
    procedure UpdateIsOpenVouchers(ExRvVoucherType: Record "NPR ExRv Voucher Type")
    var
        ExRvVoucher: Record "NPR ExRv Voucher";
        PrevVoucher: Text;
    begin
    ...
    var
        ExRvVoucher2: Record "NPR ExRv Voucher";
    begin
    ...
    procedure PostVoucher(var ExRvVoucher: Record "NPR ExRv Voucher")
    var
    ...
    local procedure SetupGenJnlLine(ExRvVoucher: Record "NPR ExRv Voucher"; var GenJnlLine: Record "Gen. Journal Line")
    var
