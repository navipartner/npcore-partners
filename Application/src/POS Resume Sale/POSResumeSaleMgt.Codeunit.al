codeunit 6150739 "NPR POS Resume Sale Mgt."
{
    ...
    procedure SelectUnfinishedSaleToResume(var SalePOS: Record "NPR Sale POS"; POSSession: Codeunit "NPR POS Session"; var POSQuoteEntryNo: Integer): Boolean
    var
    ...
    local procedure SaleToResumeIsSelected(var SalePOS: Record "NPR Sale POS"; POSUnit: Record "NPR POS Unit"; POSSession: Codeunit "NPR POS Session"; var POSQuoteEntryNo: Integer): Boolean
    var
    ...
    procedure DoSaveAsPOSQuote(POSSession: Codeunit "NPR POS Session"; SalePOS: Record "NPR Sale POS"; SkipDialog: Boolean; CancelFailed: Boolean): Integer
    var
    ...
    procedure LoadFromPOSQuote(var SalePOS: Record "NPR Sale POS"; POSQuoteEntryNo: Integer) Success: Boolean
    var
        POSQuoteEntry: Record "NPR POS Quote Entry";
    ...
    local procedure DoLoadFromPOSQuote(var SalePOS: Record "NPR Sale POS"; POSQuoteEntryNo: Integer): Boolean
    var
        POSQuoteEntry: Record "NPR POS Quote Entry";
        POSActionLoadPOSQuote: Codeunit "NPR POS Action: Load POS Quote";
    begin
    ...
    procedure LogSaleResume(SalePOS: Record "NPR Sale POS"; FromTicketNo: Code[20])
    var
    ...
    procedure OnBeforePromptResumeSale(var SalePOS: Record "NPR Sale POS"; POSSession: Codeunit "NPR POS Session"; var SkipDialog: Boolean; var ActionOption: Option " ",Resume,CancelAndNew,SaveAsQuote; var ActionOnCancelError: Option " ",Resume,SaveAsQuote,ShowError; var Handled: Boolean)
    begin
    end;
}