...
Release notes 5.40.2337.58 - released on May 27, 2021
- An update to previous fix: Fixes issue showing notification bar in BC17+ (#450630)


Release notes 5.40.2303.57 - released on April 23, 2021
- Fixes issue showing notification bar in BC17+ (#450630)


Release notes 5.40.2265.56 - released on March 16, 2021
- Fixes issue with refresh on orientation/size change on mobile devices.
- Fixes issue with workflow calls not logging information about AL trace timings.


Release notes 5.40.2224.55 - released on February 3, 2021
- Fixes issue with refresh on orientation/size change on mobile devices.
...
n$.addModule("Window",
    function () {
        ...
        function hideNavNavigation() {
            ...
            // #450630 (notification panel)
            const doc = window.frameElement.ownerDocument;
