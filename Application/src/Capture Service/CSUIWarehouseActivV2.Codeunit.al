codeunit 6151399 "NPR CS UI Warehouse Activ. V2"
{
    ...
    local procedure CreateDataLine(var CSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling"; WarehouseActivityHeader: Record "Warehouse Activity Header")
    var
    ...
    local procedure ClearDataLine(var CSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling")
    var
        LineNo: Integer;
        CSUIHeader: Record "NPR CS UI Header";
    begin
