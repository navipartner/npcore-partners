table 6151391 "NPR CS Stock-Takes"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Count ("NPR CS Stock-Takes Data" WHERE("Stock-Take Id" = FIELD("Stock-Take Id"),
        ...
        {
            CalcFormula = Count ("NPR CS Refill Data" WHERE("Stock-Take Id" = FIELD("Stock-Take Id")));
