codeunit 6059913 "NPR Delete CS Posting Buffer"
{
    ...
    procedure DeleteCSPostingBuffer(TaskLine: Record "NPR Task Line"; CompanyToDelete: Text[50]; LastDateToDelete: Date)
    var
    ...
    procedure DeleteCSCommunicationLog(TaskLine: Record "NPR Task Line"; CompanyToDelete: Text[50]; LastDateToDelete: Date)
    var
