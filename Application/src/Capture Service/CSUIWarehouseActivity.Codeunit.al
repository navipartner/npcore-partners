codeunit 6151387 "NPR CS UI Warehouse Activity"
{
    ...
    var
        ...
        UpdatedCSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling";
    begin
    ...
    local procedure CheckQty(var CSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling"; InputValue: Text)
    var
        Qty: Decimal;
    begin
        if InputValue = '' then begin
    ...
    local procedure CreateDataLine(var CSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling"; RecordVariant: Variant)
    var
        NewCSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling";
        LineNo: Integer;
        RecRefByVariant: RecordRef;
        CSWarehouseActivityHandlingByVar: Record "NPR CS Wareh. Activ. Handling";
    ...
    local procedure UpdateDataLine(var CSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling")
    begin
    ...
    begin
        ...
        if BinIsMandatory then begin
            ...
            case CSWarehouseActivityHandling."Activity Type" of
                CSWarehouseActivityHandling."Activity Type"::"Invt. Put-away":
                    WhseActivityLine.SetRange("Activity Type", WhseActivityLine."Activity Type"::"Invt. Put-away");
                CSWarehouseActivityHandling."Activity Type"::"Invt. Pick":
                    ...
                    if MiniformHeader."Expand Summary Items" then begin
                        ...
                        Line := XmlElement.Create('Line', '',
                            StrSubstNo(Text015, WhseActivityLine."Qty. to Handle", WhseActivityLine."Qty. Outstanding",
                                ItemIdentifier, WhseActivityLine.Description));
                        AddAttribute(Line, 'Descrip', WhseActivityLine.FieldCaption(Description));
                        AddAttribute(Line, 'Indicator', Indicator);
                        AddAttribute(Line, 'Type', Format(LineType::TEXT));
    ...
    begin
        ...
        foreach XMLFunctionNode in ReturnedNode.AsXmlElement().GetChildElements() do begin
            if (XMLFunctionNode.AsXmlElement().InnerText = 'REGISTER') then
                AddAttribute(XMLFunctionNode, 'Actions', StrMenuTxt);
        end;
    end;

    local procedure Reset(CSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling")
    var
        WhseActivityLine: Record "Warehouse Activity Line";
        Location: Record Location;
        BinIsMandatory: Boolean;
    ...
    local procedure Register(CSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling"; Index: Integer)
    var
        WhseActivityLine: Record "Warehouse Activity Line";
    ...
    begin
        ...
        if CSSetup."Post with Job Queue" then begin
            ...
            case CSWarehouseActivityHandling."Activity Type" of
                CSWarehouseActivityHandling."Activity Type"::"Invt. Movement":
                    CSPostingBuffer."Job Type" := CSPostingBuffer."Job Type"::"Invt. Movement";
                CSWarehouseActivityHandling."Activity Type"::"Invt. Pick":
                    CSPostingBuffer."Job Type" := CSPostingBuffer."Job Type"::"Invt. Pick";
                CSWarehouseActivityHandling."Activity Type"::"Invt. Put-away":
                    CSPostingBuffer."Job Type" := CSPostingBuffer."Job Type"::"Invt. Put-away";
                CSWarehouseActivityHandling."Activity Type"::Movement:
                    CSPostingBuffer."Job Type" := CSPostingBuffer."Job Type"::Movement;
                CSWarehouseActivityHandling."Activity Type"::Pick:
                    CSPostingBuffer."Job Type" := CSPostingBuffer."Job Type"::Pick;
                CSWarehouseActivityHandling."Activity Type"::"Put-away":
                    CSPostingBuffer."Job Type" := CSPostingBuffer."Job Type"::"Put-away";
            end;
        ...
        if WhseActivityLine.FindSet then begin
            ...
            repeat
                case CSWarehouseActivityHandling."Activity Type" of
                    CSWarehouseActivityHandling."Activity Type"::Pick, CSWarehouseActivityHandling."Activity Type"::"Put-away":
                        begin
                    ...
                    CSWarehouseActivityHandling."Activity Type"::"Invt. Pick", CSWarehouseActivityHandling."Activity Type"::"Invt. Put-away":
                        begin
    ...
    local procedure TransferDataLine(CSWarehouseActivityHandling: Record "NPR CS Wareh. Activ. Handling"): Boolean
    var
        WhseActivityLine: Record "Warehouse Activity Line";
