codeunit 6151573 "NPR AF API - Spire Barcode"
{
    ...
    procedure GenerateBarcode(var AFArgumentTableSpire: Record "NPR AF Args: Spire Barcode" temporary): Boolean
    var
        AFAPISpire: Codeunit "NPR AF API - Spire Barcode";
    ...
    local procedure BuildRequest(var AFArgumentTableSpire: Record "NPR AF Args: Spire Barcode"): Boolean
    var
        ...
        ImageStream: DotNet NPRNetMemoryStream;
        OutStr: OutStream;
