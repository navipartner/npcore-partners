codeunit 6014490 "NPR Pakkelabels.dk Mgnt"
{
    ...
    var
        ...
        RequestURL: Text;
        ResponseString: Text;
        ConvertBase64: DotNet NPRNetConvert;
    ...
    begin
        ...
        if CurrentClientType <> CLIENTTYPE::Windows then
            Download(TempFilePath, 'Download label', '', 'PDF file(*.pdf)|*.pdf', TempFileName) else begin
    ...
    var
        ...
        [RunOnClient]
        ProcessWindowsStyle: DotNet NPRNetProcessWindowStyle;
    begin
