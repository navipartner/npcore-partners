...
codeunit 6151469 "NPR Spfy Task Send Voucher"
{
    ...
    var
        ...
        _SpfyTaskSendCustomers: Codeunit "NPR Spfy Task Send Customers";
    ...
    begin
        ...
        _SpfyTaskSendCustomers.SetGraphQLClient(GraphQLClient);  //customer resolution calls Shopify from inside the gift card request build
    end;
    ...
    begin
        ...
        BuyerName := _SpfyTaskSendCustomers.GetFullName(Voucher.Name, Voucher."Name 2");  //GetFullName trims
        ...
        if NominationExists then
            NomineeIsTheBuyer :=
                UpperCase(RecipientEmail) = UpperCase(_SpfyTaskSendCustomers.GetCustomerEmail(Voucher."Customer No.", ShopifyStoreCode, BuyerEmail));
        ...
        ShopifyBillToCustGID :=
            _SpfyTaskSendCustomers.GetShopifyCustomerGID(
        ...
        if NomineeIsTheBuyer and (ShopifyBillToCustGID <> '') then begin
            ...
            ShopifyShipToCustGID := _SpfyTaskSendCustomers.GetShopifyCustomerGID('', ShopifyStoreCode, RecipientEmail, RecipientName, true);
