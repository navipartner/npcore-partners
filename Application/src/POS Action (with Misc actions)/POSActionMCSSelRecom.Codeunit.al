codeunit 6060083 "NPR POS Action: MCS Sel.Recom"
{
    ...
    begin
        ...
        case WorkflowStep of
            ...
            'recommendeditem':
                SelectRecommendedItem(JSON, POSSession, FrontEnd);
            'handle':
                begin
                    JSON.SetScope('/', true);
    ...
    local procedure SelectRecommendedItem(Context: Codeunit "NPR POS JSON Management"; POSSession: Codeunit "NPR POS Session"; FrontEnd: Codeunit "NPR POS Front End Management") AccountNo: Code[20]
    var
    ...
    local procedure SendSaleData(Context: Codeunit "NPR POS JSON Management"; POSSession: Codeunit "NPR POS Session"; FrontEnd: Codeunit "NPR POS Front End Management") AccountNo: Code[20]
    var
        MCSRecommendationsModel: Record "NPR MCS Recomm. Model";
        MCSRecommendationsSetup: Record "NPR MCS Recommendations Setup";
        SalePOS: Record "NPR Sale POS";
    ...
    local procedure RegisterRecommendedItemSales(POSSession: Codeunit "NPR POS Session"; RecommendedItemNo: Code[20])
    var
