codeunit 6150995 "NPR MPOS Action Scan Item Info" implements "NPR IPOS Workflow"
{
    Access = Internal;
    ...
    begin
        ...
        RequestJsonObject := MPOSHelperFunctions.BuildJSONParams('SCANDITITEMINFO',
                                                                 '-1',
                                                                 '10',
                                                                 '',
                                                                 '10',
    ...
    begin
        exit(
//###NPR_INJECT_FROM_FILE:MPOSActionScanItemInfo.js###
