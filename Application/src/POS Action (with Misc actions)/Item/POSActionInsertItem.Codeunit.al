...
#pragma warning restore 
        ...
        WorkflowConfig.AddBooleanParameter('SkipItemAvailabilityCheck', true, ParamSkipItemAvailabilityCheck_CaptionLbl, ParamSkipItemAvailabilityCheck_DescLbl);
...
#pragma warning restore AA0139
    ...
    local procedure GetCurrentItemPriceCaption(Context: Codeunit "NPR POS JSON Helper"; Sale: Codeunit "NPR POS Sale"): JsonObject
    var
        ItemIdentifier: Text;
