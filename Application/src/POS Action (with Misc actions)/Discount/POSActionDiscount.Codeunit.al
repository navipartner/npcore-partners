...
'const main=async({workflow:t,captions:i,parameters:s,popup:n})=>{let a,e,d,u={discountReason:s.FixedReasonCode};u.discountReason==""&&(s.LookupReasonCode||s.ReasonCodeMandatory)&&(u=await t.respond("LookupReasonCode")),d=s.DimensionCode;let o={dimensionValue:s.DimensionValue};switch(d!=""&&o.dimensionValue==""&&(o=await t.respond("AddDimensionValue")),a=s.FixedDiscountNumber,s._parameters.DiscountType){case 0:e=i.DiscountLabel0,a==0&&(a=await n.numpad(e));break;case 1:e=i.DiscountLabel1,a==0&&(a=await n.numpad(e));break;case 2:e=i.DiscountLabel2,a==0&&(a=await n.numpad(e));break;case 3:e=i.DiscountLabel3,a==0&&(a=await n.numpad(e));break;case 4:e=i.DiscountLabel4,a==0&&(a=await n.numpad(e));break;case 5:e=i.DiscountLabel5,a==0&&(a=await n.numpad(e));break;case 6:e=i.DiscountLabel6,a==0&&(a=await n.numpad(e));break;case 7:e=i.DiscountLabel7,a==0&&(a=await n.numpad(e));break;case 8:e=i.DiscountLabel8,a==0&&(a=await n.numpad(e));break;case 9:break;case 10:break;case 11:e=i.DiscountLabel11,a==0&&(a=await n.numpad(e));break;case 12:e=i.DiscountLabel12,a==0&&(a=await n.numpad(e));break}if(a===null)return;const{postWorkflows:c}=await t.respond("ProcessRequest",{discountNumber:a,discountReason:u,dimensionValue:o});await processWorkflows(t,c)};async function processWorkflows(t,i){if(i)for(const[s,{mainParameters:n,customParameters:a}]of Object.entries(i))await t.run(s,{context:{customParameters:a},parameters:n})}'
        )
    end;
