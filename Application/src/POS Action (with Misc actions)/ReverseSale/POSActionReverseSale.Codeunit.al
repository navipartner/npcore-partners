codeunit 6059876 "NPR POS Action: Reverse Sale" implements "NPR IPOS Workflow"
{
    ...
    var
        ...
        ParamSetPrint_DescLbl: Label 'Print standard BC report after export & posting is done';
        ...
        ParamSendPDF2NAV_CptLbl: Label 'Send PDF2BC';
        ParamSendPDF2NAV_DescLbl: Label 'Handle document output via PDF2BC';
        ...
        ParamSetSend_DescLbl: Label 'Output BC report after export & posting, via document sending profiles';
        ParamSendPrepayDoc_CptLbl: Label 'Send Prepayment Document';
        ParamSendPrepayDoc_DescLbl: Label 'Output prepayment BC report via document sending profiles, after payment in new sale';
        ParamPdf2NavPrepayDoc_CptLbl: Label 'Prepayment PDF2BC';
        ParamPdf2NavPrepayDoc_DescLbl: Label 'Output prepayment BC report via PDF2BC, after payment in new sale';
        ParamSendPayAndPost_CptLbl: Label 'Pay&Post Send Document';
        ParamSendPayAndPost_DescLbl: Label 'Output BC report via document sending profiles, after payment in new sale';
        ParamPdf2NavPayAndPost_CptLbl: Label 'Pay&Post PDF2BC';
        ParamPdf2NavPayAndPost_DescLbl: Label 'Output BC report via PDF2BC, after payment in new sale';
