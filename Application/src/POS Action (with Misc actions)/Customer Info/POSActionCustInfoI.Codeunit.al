codeunit 6150801 "NPR POS Action: Cust.Info-I" implements "NPR IPOS Workflow"
{
    ...
    var
        ...
        ParameterShow_OptionsLbl: Label 'CustLedgerEntries,ItemLedgerEntries', Locked = true;
        ParameterShow_OptionCaptionsLbl: Label 'Customer Ledger Entries,Customer Item Ledger Entries';
    begin
...
'let main=async({})=>await workflow.respond();'
    ...
    var
        ParameterShow: Option CustLedgerEntries,ItemLedgerEntries;
        CustomerNo: Code[20];
    begin
