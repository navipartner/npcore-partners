codeunit 6014635 "NPR Item Block Mgt."
{
    var
    ...
    begin
        exit(CODEUNIT::"NPR Item Block Mgt.");
    end;

    [EventSubscriber(ObjectType::Codeunit, Codeunit::"NPR POS Sale Line", 'OnBeforeInsertSaleLine', '', true, true)]
    local procedure TestBlockedOnPOSSaleLineInsert(POSSalesWorkflowStep: Record "NPR POS Sales Workflow Step"; SaleLinePOS: Record "NPR Sale Line POS")
    begin
    ...
    begin
        ...
        Item.TestField("NPR Sale Blocked", false);
    end;
    ...
    begin
        ...
        Item.TestField("NPR Purchase Blocked", false);
    end;

    [EventSubscriber(ObjectType::Table, Database::"NPR Dynamic Module", 'OnDiscoverModule', '', true, true)]
