codeunit 6059908 "NPR Chilkat FTP/SFTP"
{
    ...
    var
        ...
        ChilkatFtp2: DotNet NPRNetFtp2;
        ChilkatSFTP: DotNet NPRNetSFtp;

    local procedure FTP_UploadTQ(TaskLine: Record "NPR Task Line")
    var
    ...
    local procedure FTP_DownloadTQ(TaskLine: Record "NPR Task Line")
    var
    ...
    local procedure SFTP_UploadTQ(TaskLine: Record "NPR Task Line")
    begin
        //-TQ1.20
        with TaskLine do begin
