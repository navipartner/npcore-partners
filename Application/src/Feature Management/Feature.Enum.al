enum 6014577 "NPR Feature" implements "NPR Feature Management"
{
...
#endif
    value(92; "Shopify RowVersion Change Detection")
    {
    ...
    value(230; "New Z-Report Experience")
    {
        ...
        Implementation = "NPR Feature Management" = "NPR New Z-Report Exp";
    }
    value(240; "New NpRv Print Experience")
    {
        Caption = 'New NpRv Print Experience';
        Implementation = "NPR Feature Management" = "NPR New NpRv Print Exp.";
    }
    value(250; "New Sales Doc Confirmation Experience")
    {
        Caption = 'New Sales Doc Confirmation Experience';
        Implementation = "NPR Feature Management" = "NPR New Sales Doc Conf. Exp";
    }
    value(260; "New Begin Workshift Experience")
    {
