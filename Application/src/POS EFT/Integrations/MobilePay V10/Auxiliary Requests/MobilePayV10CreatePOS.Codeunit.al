codeunit 6014478 "NPR MobilePayV10 CreatePOS"
{
    ...
    var
        ...
        QR_BEACON_NOT_EMPTY: Label '%1 must be empty as it will be generated by mobilepay for QR-only usage.';
        QR_BEACON_EMPTY: Label '%1 must not be empty unless used in QR-only mode. Scan the box ID into the field.';
    ...
    begin
        ...
        if mobilePayUnitSetup."Only QR" then begin
            if mobilePayUnitSetup."Beacon ID" <> '' then begin
                error(QR_BEACON_NOT_EMPTY, mobilePayUnitSetup.FieldCaption("Beacon ID"));
            end;
            ...
            if mobilePayUnitSetup."Beacon ID" = '' then begin
                error(QR_BEACON_EMPTY, mobilePayUnitSetup.FieldCaption("Beacon ID"))
            end;
            jsonRequest.Add('beaconId', mobilePayUnitSetup."Beacon ID");
            beaconTypes.Add('QR');
