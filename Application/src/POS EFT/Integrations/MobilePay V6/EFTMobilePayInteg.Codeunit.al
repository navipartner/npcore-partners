codeunit 6184513 "NPR EFT MobilePay Integ."
{
    ...
    procedure UnRegisterPoS(EFTSetupIn: Record "NPR EFT Setup")
    var
        EFTTypePOSUnitGenParam: Record "NPR EFTType POSUnit Gen.Param.";
    begin
        ClearAll;
    ...
    procedure ReadPoSAssignPoSUnitId(EFTSetupIn: Record "NPR EFT Setup")
    var
    ...
    procedure PaymentCancel(var EFTTransReq: Record "NPR EFT Transaction Request"): Boolean
    begin
        ClearLastError();
    ...
    [TryFunction]
    local procedure InvokePaymentStart(var EFTTransReq: Record "NPR EFT Transaction Request")
    var
        RequestBody: Text[1024];
        ResponseText: Text[1024];
        CustToken: Integer;
    ...
    [TryFunction]
    local procedure InvokeGetPaymentStatus(EFTTransReq: Record "NPR EFT Transaction Request"; var PaymentStatus: Integer; var CustomerID: Text; var TransactionID: Text)
    var
        RequestBody: Text[1024];
        ResponseText: Text[1024];
    ...
    local procedure GetLocationID(EFTSetupIn: Record "NPR EFT Setup"): Text
    var
        EFTTypePOSUnitGenParam: Record "NPR EFTType POSUnit Gen.Param.";
    begin
    ...
    local procedure GetPoSID(EFTSetupIn: Record "NPR EFT Setup"): Text
    var
        EFTTypePOSUnitGenParam: Record "NPR EFTType POSUnit Gen.Param.";
    begin
    ...
    local procedure GetPosUnitID(EFTSetupIn: Record "NPR EFT Setup"): Text
    var
        EFTTypePOSUnitGenParam: Record "NPR EFTType POSUnit Gen.Param.";
    begin
    ...
    local procedure GetPoSUnitAssigned(EFTSetupIn: Record "NPR EFT Setup"): Boolean
    var
        EFTTypePOSUnitGenParam: Record "NPR EFTType POSUnit Gen.Param.";
    begin
        //-NPR5.51 [352248]
    ...
    local procedure GetPoSRegistered(EFTSetupIn: Record "NPR EFT Setup"): Boolean
    var
        EFTTypePOSUnitGenParam: Record "NPR EFTType POSUnit Gen.Param.";
    begin
        //-NPR5.51 [352248]
    ...
    local procedure GetAPIKey(EFTSetupIn: Record "NPR EFT Setup"): Text
    var
        EFTTypePaymentGenParam: Record "NPR EFT Type Pay. Gen. Param.";
    begin
