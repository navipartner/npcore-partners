codeunit 6184493 "NPR Pepper End Workshift TSD"
{
    ...
    procedure InvokeEndWorkshiftRequest(var FrontEnd: Codeunit "NPR POS Front End Management"; var POSSession: Codeunit "NPR POS Session")
    begin
