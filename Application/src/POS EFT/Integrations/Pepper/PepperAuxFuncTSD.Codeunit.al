codeunit 6184494 "NPR Pepper Aux Func. TSD"
{
    ...
    var
        ...
        AuxRequest: DotNet NPRNetAuxRequest0;
        AuxResponse: DotNet NPRNetAuxResponse0;
    ...
    procedure InvokeAuxRequest(var FrontEnd: Codeunit "NPR POS Front End Management"; var POSSession: Codeunit "NPR POS Session")
    begin
