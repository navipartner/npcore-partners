codeunit 6184491 "NPR Pepper Begin Workshift TSD"
{
    ...
    var
        ...
        StartWorkShiftRequest: DotNet NPRNetStartWorkshiftRequest0;
        StartWorkShiftResponse: DotNet NPRNetStartWorkshiftResponse0;
        ConfigDriver: DotNet NPRNetConfigDriverParam0;
        PepperOpen: DotNet NPRNetOpenParam0;
    ...
    procedure InvokeBeginWorkshift(var FrontEnd: Codeunit "NPR POS Front End Management"; var POSSession: Codeunit "NPR POS Session")
    begin
