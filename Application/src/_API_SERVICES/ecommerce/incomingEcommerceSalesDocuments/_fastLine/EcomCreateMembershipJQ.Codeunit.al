codeunit 6151049 "NPR EcomCreateMembershipJQ"
{
    Access = Internal;
    ...
    begin
        ...
        EcomSalesHeader.SetRange("Memberships Exist", true);
        ...
        EcomSalesHeader.SetFilter("Membership Processing Status", '%1|%2', EcomSalesHeader."Membership Processing Status"::Pending, EcomSalesHeader."Membership Processing Status"::"Partially Processed");
    ...
    var
        JobDescriptionLbl: Label 'Process Membership From Ecommerce Document';
    begin
    ...
    begin
        exit(codeunit::"NPR EcomCreateMembershipJQ");
    end;
    ...
    var
        ...
        ScheduleJobQueueConfirmLbl: Label 'Are you sure you want to configure the job queue for ecommerce document membership processing?';
    begin
