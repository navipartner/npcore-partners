...
codeunit 6185080 "NPR TicketingTicketAgent"
{
    ...
    begin
        ...
        HaveTicket := true;
        Ticket.Init();
        Ticket.SetLoadFields("External Ticket No.", "Item No.", "Valid From Date", "Valid From Time", "Valid To Date", "Valid To Time", "No.", AmountExclVat, AmountInclVat, Blocked, PrintedDateTime, PrintCount, SystemCreatedAt, "Ticket Type Code", "Ticket Reservation Entry No.", "Variant Code", SystemId);
    ...
    begin
        ...
        if (not BadFilter) then begin
            if (ReservationRequest.FindSet()) then begin
                ...
                repeat
                    TicketingCatalog.GetCatalogItemDescription(StoreCode, ReservationRequest."Item No.", TempTicketDescriptionBuffer, ReservationRequest.TicketHolderPreferredLanguage);
    ...
    internal procedure TicketHistoryDTO(var ResponseJson: Codeunit "NPR JSON Builder"; ArrayName: Text; Ticket: Record "NPR TM Ticket"; TicketType: Record "NPR TM Ticket Type"; WithEvents: Boolean): Codeunit "NPR JSON Builder";
    var
    ...
    begin
        ...
        ReservationRequest.SetLoadFields("Session Token ID", "Authorization Code", "TicketHolderName", "TicketHolderPreferredLanguage", "Notification Address", Quantity);
    ...
    begin
        ...
        TicketBom.SetLoadFields("Admission Code", Quantity);
    ...
    begin
        ...
        if (TicketAccessEntry.FindSet()) then begin
            ...
            TicketingCatalog.GetCatalogItemDescription('', Ticket."Item No.", TempTicketDescriptionBuffer, ReservationRequest.TicketHolderPreferredLanguage);

            repeat
                ResponseJson.StartObject()
                    .AddObject(AdmissionDTO(ResponseJson, 'admissionDetails', Ticket."Item No.", Ticket."Variant Code", TicketAccessEntry."Admission Code", TicketAccessEntry.Status = TicketAccessEntry.Status::BLOCKED, 255, TempTicketDescriptionBuffer))
