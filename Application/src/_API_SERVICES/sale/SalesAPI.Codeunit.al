...
codeunit 6248369 "NPR SalesAPI" implements "NPR API Request Handler"
{
    Access = Internal;
    ...
    local procedure Handle(ApiFunction: Enum "NPR SalesApiFunctions"; var Request: Codeunit "NPR API Request") Response: Codeunit "NPR API Response"
    var
        SalesApiHandler: Codeunit "NPR SalesApiHandler";
    ...
    begin
        ...
        SalesApiHandler.SetRequest(ApiFunction, Request);
        if (SalesApiHandler.Run()) then begin
            Response := SalesApiHandler.GetResponse();
    ...
    local procedure LogMessage(Function: Enum "NPR SalesApiFunctions";
        DurationMs: Decimal;
    ...
    begin
        ...
        if (HttpStatusCode in [200 .. 299]) then begin
            ...
            Session.LogMessage('NPR_API_Sales', ResponseMessage, Verbosity::Normal, DataClassification::SystemMetadata, TelemetryScope::All, CustomDimensions);
        end else begin
            ...
            Session.LogMessage('NPR_API_Sales', ResponseMessage, Verbosity::Error, DataClassification::SystemMetadata, TelemetryScope::All, CustomDimensions);
        end;
    end;
}
#endif