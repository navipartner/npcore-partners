report 6014425 "NPR List of Status Phase"
{
    // NPR5.41/JLK /20180419  CASE 301928 Object created
    DefaultLayout = RDLC;
    RDLCLayout = './src/_Reports/layouts/List of Status Phase.rdlc';
    ...
    dataset
    {
        dataitem("Stock-Take Worksheet"; "NPR Stock-Take Worksheet")
        {
            ...
            dataitem("Stock-Take Worksheet Line"; "NPR Stock-Take Worksheet Line")
            {
