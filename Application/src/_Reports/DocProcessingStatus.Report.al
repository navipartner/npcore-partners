report 6014463 "NPR Doc. Processing Status"
{
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "No.", "Posting Date", "NPR Document Processing";
            ...
            column(InvoiceDocumentProcessing; SalesInvoiceHeader."NPR Document Processing")
            {
                IncludeCaption = true;
            }
            ...
            begin
                ...
                case SalesInvoiceHeader."NPR Document Processing" of
                    0:
                        begin //Print
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(CrMemoDocumentProcessing; "Sales Cr.Memo Header"."NPR Document Processing")
            {
            }
            ...
            begin
                ...
                case "Sales Cr.Memo Header"."NPR Document Processing" of
                    0:
                        begin //Print
