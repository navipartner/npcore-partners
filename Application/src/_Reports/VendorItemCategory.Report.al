...
#ENDIF
    ...
    dataset
    {
        ...
        //         {
        //         }
        //         column(SaleLCY_ItemCategory; ItemCategorySalesLCY)
        //         {
        //         }
        //         column(PurchaseLCY_ItemCategory; PurchasesLCY)
        //         {
        //         }
        ...
        //         {
        //         }
        //         column(CR_ItemCategory; ItemCategorySalesLCY - ConsumptionAmount)
        //         {
        //         }
        ...
        //         {
        //         }
        //         column(SaleLCYLY_ItemCategory; VaregrupperecSalesLCY)
        //         {
        //         }
        ...
        //             NPRGetVESalesLCYAndConsumptionAmount(ItemCategorySalesLCY, ConsumptionAmount);
        //             NPRGetVEPurchasesLCY(PurchasesLCY);
        //             if ItemCategorySalesLCY <> 0 then
        //                 DG := ((ItemCategorySalesLCY - ConsumptionAmount) / ItemCategorySalesLCY) * 100;
        ...
        //             Varegrupperec.NPRGetVESalesLCYAndConsumptionAmount(VaregrupperecSalesLCY, VaregrupperecConsumptionAmount);
        //             Varegrupperec.CalcFields("NPR Sales (Qty.)");

        //             Omsaetningsidsteaar := VaregrupperecSalesLCY;
        //             Antalsidsteaar := Varegrupperec."NPR Sales (Qty.)";

        //             if Sortervaregruppe then begin
        //                 if Vendor."NPR Sales (LCY)" <> 0 then
        //                     Pctoms := ItemCategorySalesLCY / Vendor."NPR Sales (LCY)" * 100
        //                 else
        //                     Clear(Pctoms);
        ...
        //                     SortType::omsaetning:
        //                         TempNPRBuffer."Decimal 1" := ItemCategorySalesLCY;
        //                     SortType::db:
        //                         TempNPRBuffer."Decimal 1" := (ItemCategorySalesLCY - ConsumptionAmount);
        //                 end;
        ...
        //             SaleLCYSum += ItemCategorySalesLCY;
        //             PurchaseLCYSum += PurchasesLCY;
        //             Pctoms_Sum += Pctoms;
        //             SalesQtySum += "Item Category"."NPR Sales (Qty.)";
        //             CRSum += (ItemCategorySalesLCY - ConsumptionAmount);
        //             if ItemCategorySalesLCY <> 0 then
        //                 DgSum += ((ItemCategorySalesLCY - ConsumptionAmount) / ItemCategorySalesLCY) * 100;

        //             AmtLYSum += Antalsidsteaar;
        //             TurnoverLYSum += Omsaetningsidsteaar;
        //             SaleLCYLYSum += VaregrupperecSalesLCY;
        //             SumCost += ConsumptionAmount;

        //             if VaregrupperecSalesLCY <> 0 then
        //                 PctaendringItemCategory := ((ItemCategorySalesLCY - VaregrupperecSalesLCY) / (VaregrupperecSalesLCY)) * 100
        //             else
        ...
        //         {
        //         }
        //         column(SaleLCY_ItemCategory2; ItemCategorySalesLCY)
        //         {
        //         }
        //         column(PurchaseLCY_ItemCategory2; PurchasesLCY)
        //         {
        //         }
        //         column(SalesQty_ItemCategory2; "Item Category"."NPR Sales (Qty.)")
        //         {
        //         }
        //         column(CR_ItemCategory2; ItemCategorySalesLCY - ConsumptionAmount)
        //         {
        //         }
        ...
        //             "Item Category".NPRGetVESalesLCYAndConsumptionAmount(ItemCategorySalesLCY, ConsumptionAmount);
        //             "Item Category".CalcFields("NPR Sales (Qty.)");
        ...
        //                 PctaendringItemCategory := ((ItemCategorySalesLCY - TempNPRBuffer."Decimal 2") / (TempNPRBuffer."Decimal 2")) * 100
        //             else
        //                 Clear(PctaendringItemCategory);
        //         end;
