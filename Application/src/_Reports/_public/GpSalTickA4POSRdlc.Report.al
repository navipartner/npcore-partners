report 6014574 "NPR Gp Sal Tick A4 - POS Rdlc"
{
#if not BC17
    Extensible = true;
#ENDIF
    RDLCLayout = './src/_Reports/layouts/Gp Sales Ticket A4 - POS.rdlc';
    WordLayout = './src/_Reports/layouts/Gp Sales Ticket A4 - POS Word.docx';
    Caption = 'Sales Ticket A4 - Global POS';
    ...
    dataset
    {
        dataitem("NPR Gp POS Entry"; "NPR NpGp POS Sales Entry")
        {
            ...
            column(Entry_Date_POS_Entry; Format(EntryDate, 0, 0))
            {
            }
            ...
            column(DocumentDate_No_POS_Entry; "Posting Date")
            {
            }
            ...
            dataitem("NPR Gp POS Sales Line"; "NPR NpGp POS Sales Line")
            {
            ...
            dataitem("NPR DE POS Audit Log Aux. Info"; "NPR DE POS Audit Log Aux. Info")
            {
                ...
                begin
                    "NPR DE POS Audit Log Aux. Info".SetRange("POS Entry No.", "NPR Gp POS Entry"."Entry No.");
                end;
            }
            ...
            dataitem("NPR POS Entry Payment Line"; "NPR POS Entry Payment Line")
            {
                ...
                trigger OnPreDataItem()
                begin
                    "NPR POS Entry Payment Line".SetRange("POS Entry No.", "NPR Gp POS Entry"."Entry No.");
            ...
            dataitem("NPR POS Entry Tax Line"; "NPR POS Entry Tax Line")
            {
                ...
                trigger OnPreDataItem()
                begin
                    "NPR POS Entry Tax Line".SetRange("POS Entry No.", "NPR Gp POS Entry"."Entry No.");
            ...
            begin
                if POSStore.Get("NPR Gp POS Entry"."POS Store Code") then begin
                ...
                Clear(AddrArray);
                if "NPR Gp POS Entry"."Customer No." <> '' then begin
                    Customer.Get("NPR Gp POS Entry"."Customer No.");
                    FormatAddress.Customer(AddrArray, Customer);
                end else
                    CustomerAddress := TextFunctions.AddressArrayToMultilineString(AddrArray);
                EntryDate := DT2Date("NPR Gp POS Entry"."Entry Time");
            end;
        }
