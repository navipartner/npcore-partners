report 6014438 "NPR Gift Voucher A5 Right"
{
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            dataitem("Gift Voucher"; "NPR Gift Voucher")
            {
                ...
                column(IssueDate_GiftVoucher; StrSubstNo('%1', "Gift Voucher"."Issue Date") + RegisterLbl + StrSubstNo('%1', "Register No.") + SalesTicketLbl + "Gift Voucher"."Sales Ticket No." + ' - ' + "Gift Voucher"."No." + ' - ' + Format(Time))
                {
                }
                ...
                begin
                    ...
                    if (StrLen(Format(POSStore."Fax No.")) > 0) then
                        FaxText := FaxLbl + Format(POSStore."Fax No.");
                    ...
                    if RetailSetup."Salesperson on Sales Ticket" then
                        SalepersonText := SalespersonLbl + ' ' + Format(SalespersonPurchaser.Name)
                    else
                        SalepersonText := '';
                end;
            }
    ...
    var
        ...
        SalesTicketLbl: Label ' - Sales Ticket';
        CopyText: Text[30];
        FaxText: Text[50];
