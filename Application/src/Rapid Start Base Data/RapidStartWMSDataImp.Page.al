page 6059893 "NPR RapidStart WMS Data Imp."
{
    PageType = NavigatePage;

    UsageCategory = Administration;
    ApplicationArea = NPRRetail;
    Caption = 'RapidStart WMS Data Imp.';
        ...
        area(Content)
        {
            ...
            field("Package Name"; package)
            {
                ...
                begin
                    ...
                    rapidstartBaseDataMgt.GetAllPackagesInBlobStorage(BaseUri + '/wms-test-data/?restype=container&comp=list'
