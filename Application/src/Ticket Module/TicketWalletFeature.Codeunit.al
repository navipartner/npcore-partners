codeunit 6151436 "NPR Ticket Wallet Feature" implements "NPR Feature Management"
{
    Access = Internal;
    ...
    begin
        ...
        Feature.Validate(Feature, Enum::"NPR Feature"::"Ticket Wallet");
        Feature.Insert();
    end;
    ...
    var
        FeatureIdTok: Label 'TicketWallet', Locked = true, MaxLength = 50;
    begin
        exit(FeatureIdTok);
    end;
    ...
    var
        FeatureDescriptionLbl: Label 'Ticket Wallet', MaxLength = 2024;
    begin
