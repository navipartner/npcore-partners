codeunit 6151433 "NPR Ticket Advanced Feature" implements "NPR Feature Management"
{
    Access = Internal;
    ...
    begin
        ...
        Feature.Validate(Feature, Enum::"NPR Feature"::"Ticket Advanced");
        Feature.Insert();
    end;
    ...
    var
        FeatureIdTok: Label 'TicketAdvanced', Locked = true, MaxLength = 50;
    begin
        exit(FeatureIdTok);
    end;
    ...
    var
        FeatureDescriptionLbl: Label 'Ticket Advanced', MaxLength = 2024;
    begin
