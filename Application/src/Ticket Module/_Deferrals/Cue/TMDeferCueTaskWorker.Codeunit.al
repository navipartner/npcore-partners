codeunit 6184755 "NPR TM DeferCueTaskWorker"
{
    ...
    var
        TempDeferCue: Record "NPR TM DeferralCue" temporary;
    ...
    begin
        ...
        Result.Add(Format(TempDeferCue.FieldNo(UnresolvedCount)), Format(DeferRevenueRequest.Count(), 0, 9));
        ...
        Result.Add(Format(TempDeferCue.FieldNo(PendingDeferralCount)), Format(DeferRevenueRequest.Count(), 0, 9));
