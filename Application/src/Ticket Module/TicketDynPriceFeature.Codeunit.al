codeunit 6151437 "NPR Ticket Dyn. Price Feature" implements "NPR Feature Management"
{
    Access = Internal;
    ...
    begin
        ...
        Feature.Validate(Feature, Enum::"NPR Feature"::"Ticket Dynamic Price");
        Feature.Insert();
    end;
    ...
    var
        FeatureIdTok: Label 'TicketDynamicPrice', Locked = true, MaxLength = 50;
    begin
        exit(FeatureIdTok);
    end;
    ...
    var
        FeatureDescriptionLbl: Label 'Ticket Dynamic Price', MaxLength = 2024;
    begin
