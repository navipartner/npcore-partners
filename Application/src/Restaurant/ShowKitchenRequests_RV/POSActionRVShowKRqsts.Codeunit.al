codeunit 6151070 "NPR POSAction: RV Show K.Rqsts" implements "NPR IPOS Workflow"
{
    Access = Internal;
    ...
    var
        BusinessLogic: Codeunit "NPR POSAct. RV Show K.RequestB";
    ...
    begin
        exit(
        //###NPR_INJECT_FROM_FILE:POSActionRVShowKRequests.js###
