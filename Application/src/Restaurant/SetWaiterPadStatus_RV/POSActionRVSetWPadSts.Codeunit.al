codeunit 6150684 "NPR POSAction: RV Set WPad Sts" implements "NPR IPOS Workflow"
{
    Access = Internal;
    ...
    var
        ...
        BusinessLogic: Codeunit "NPR POSAct: RV Set WP Status-B";
    ...
    begin
        exit(
        //###NPR_INJECT_FROM_FILE:POSActionRVSetWPadStatus.js###
