codeunit 6150683 "NPR POSAction: RV Save Layout" implements "NPR IPOS Workflow"
{
    Access = Internal;
    ...
    var
        BusinessLogic: Codeunit "NPR POSAct. RV Save LayoutB";
    ...
    begin
        exit(
        //###NPR_INJECT_FROM_FILE:POSActionRVSaveLayout.js###
