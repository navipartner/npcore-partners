codeunit 6150661 "NPR POSAction: Print Wa. Pad" implements "NPR IPOS Workflow"
{
    Access = Internal;
    ...
    var
        BusinessLogic: Codeunit "NPR POSAction: Print WP-B";
    ...
    begin
        exit(
        //###NPR_INJECT_FROM_FILE:POSActionPrintWaPad.js###
