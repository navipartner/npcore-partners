codeunit 6060105 "NPR POS Input Box Setup Mgt."
{
    ...
    internal procedure InitDefaultEanBoxSetup()
    var
    ...
    internal procedure InitEanBoxEventParameters(EanBoxEvent: Record "NPR Ean Box Event")
    var
        EanBoxSetupEvent: Record "NPR Ean Box Setup Event";
    ...
    internal procedure InitEanBoxSetupEventParameters(EanBoxSetupEvent: Record "NPR Ean Box Setup Event")
    var
        EanBoxEvent: Record "NPR Ean Box Event";
        EanBoxParameter: Record "NPR Ean Box Parameter";
        POSActionParameter: Record "NPR POS Action Parameter";
    ...
    internal procedure DefaultSalesSetupCode(): Code[10]
    begin
        exit('SALE');
    end;
}
