codeunit 6014417 "NPR POS Doc. Export Try Pay"
{
    ...
    procedure HandlePrepaymentTransactional(POSSessionIn: Codeunit "NPR POS Session"; SalesHeaderIn: Record "Sales Header"; PrepaymentValueIn: Decimal; PrepaymentIsAmountIn: Boolean; PrintIn: Boolean; SendIn: Boolean; Pdf2NavIn: Boolean; Self: Codeunit "NPR POS Doc. Export Try Pay") Success: Boolean
    begin
    ...
    procedure HandlePayAndPostTransactional(POSSessionIn: Codeunit "NPR POS Session"; SalesHeaderIn: Record "Sales Header"; PrintIn: Boolean; Pdf2NavIn: Boolean; SendIn: Boolean; FullPostingIn: Boolean; Self: Codeunit "NPR POS Doc. Export Try Pay") Success: Boolean;
    begin
        POSSession := POSSessionIn;
        SalesHeader := SalesHeaderIn;
        Print := PrintIn;
