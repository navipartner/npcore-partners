codeunit 6060082 "NPR MCS Recomm. Handler"
{
    ...
    procedure RefreshRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; ShowDialog: Boolean)
    var
        Item: Record Item;
        TaskDialog: Dialog;
    begin
    ...
    local procedure InsertItemRecommendations(Item: Record Item; MCSRecommendationsModel: Record "NPR MCS Recomm. Model")
    var
    ...
    local procedure DeleteItemRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; Item: Record Item)
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
    begin
    ...
    procedure InsertPOSSaleRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; SalePOS: Record "NPR Sale POS")
    var
    ...
    procedure InsertPOSSaleLineRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; SalePOS: Record "NPR Sale POS"; SaleLinePOS: Record "NPR Sale Line POS")
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
        MCSRecommendationsLog: Record "NPR MCS Recommendations Log";
        TempMCSRecommendationsLine: Record "NPR MCS Recommendations Line" temporary;
    ...
    begin
        ...
        TempMCSRecommendationsLine."Model No." := MCSRecommendationsModel.Code;
        TempMCSRecommendationsLine."Log Entry No." := MCSRecommendationsLog."Entry No.";
        TempMCSRecommendationsLine."Table No." := DATABASE::"NPR Sale Line POS";
    ...
    procedure InsertSalesRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; SalesHeader: Record "Sales Header")
    var
    ...
    procedure InsertSalesLineRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; SalesHeader: Record "Sales Header"; SalesLine: Record "Sales Line")
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
        MCSRecommendationsLog: Record "NPR MCS Recommendations Log";
        TempMCSRecommendationsLine: Record "NPR MCS Recommendations Line" temporary;
    ...
    local procedure DeletePOSSaleRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; SalePOS: Record "NPR Sale POS")
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
    begin
        MCSRecommendationsLine.Reset;
        MCSRecommendationsLine.SetRange("Table No.", DATABASE::"NPR Sale Line POS");
        MCSRecommendationsLine.SetRange("Model No.", MCSRecommendationsModel.Code);
    ...
    procedure DeletePOSSaleLineRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; SaleLinePOS: Record "NPR Sale Line POS")
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
    begin
        MCSRecommendationsLine.Reset;
    ...
    local procedure DeleteSalesRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; SalesHeader: Record "Sales Header")
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
    begin
        MCSRecommendationsLine.Reset;
    ...
    procedure DeleteSalesLineRecommendations(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; SalesLine: Record "Sales Line")
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
    begin
        MCSRecommendationsLine.Reset;
    ...
    local procedure InsertRecommendationsLog(var MCSRecommendationsLog: Record "NPR MCS Recommendations Log")
    begin
    ...
    procedure GetRecommendationsLinesFromSalePOS(SalePOS: Record "NPR Sale POS"; var TempMCSRecommendationsLine: Record "NPR MCS Recommendations Line")
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
        Item: Record Item;
        SaleLinePOS: Record "NPR Sale Line POS";
    ...
    procedure GetRecommendationsLinesFromSales(SalesHeader: Record "Sales Header"; var TempMCSRecommendationsLine: Record "NPR MCS Recommendations Line")
    var
        MCSRecommendationsLine: Record "NPR MCS Recommendations Line";
        Item: Record Item;
        SalesLine: Record "Sales Line";
    ...
    procedure GetItemListFromRecommendations(var TempItem: Record Item temporary; var TempMCSRecommendationsLine: Record "NPR MCS Recommendations Line" temporary; NumberOfItemsToReturn: Integer)
    var
        Item: Record Item;
        TempMCSRecommendationsLine2: Record "NPR MCS Recommendations Line" temporary;
    begin
    ...
    local procedure SaleLinePOSIsInModelFilter(SaleLinePOS: Record "NPR Sale Line POS"; MCSRecommendationsModel: Record "NPR MCS Recomm. Model"): Boolean
    var
    ...
    local procedure SalesLineIsInModelFilter(SalesLine: Record "Sales Line"; MCSRecommendationsModel: Record "NPR MCS Recomm. Model"): Boolean
    var
        TempItem: Record Item temporary;
        Item: Record Item;
    begin
