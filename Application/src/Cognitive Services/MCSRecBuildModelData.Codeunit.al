codeunit 6060080 "NPR MCS Rec. Build Model Data"
{
    ...
    procedure PreviewDataToSend(SendType: Option Catalog,History,BusinessRules; MCSRecommendationsModel: Record "NPR MCS Recomm. Model")
    var
        OStr: OutStream;
        IStr: InStream;
        DisplayText: Text;
    ...
    procedure GetCatalogStream(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; ModifiedItemsOnly: Boolean; MarkAsModified: Boolean; var Outstr: OutStream)
    var
        MCSRecommendationsCatalog: XMLport "NPR MCS Recomm. Catalog";
    begin
    ...
    procedure GetHistoryStream(var MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; MarkAsModified: Boolean; var Outstr: OutStream; var HasMoreLines: Boolean)
    var
        MCSRecommendationsHistory: XMLport "NPR MCS Recomm. History";
    ...
    procedure GetCatalogCSV(MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; ModifiedItemsOnly: Boolean; MarkAsModified: Boolean) Filename: Text
    var
        MCSRecommendationsCatalog: XMLport "NPR MCS Recomm. Catalog";
        TempFile: File;
        Outstr: OutStream;
    ...
    procedure GetHistoryCSV(var MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; MarkAsModified: Boolean; var HasMoreLines: Boolean) Filename: Text
    var
        MCSRecommendationsHistory: XMLport "NPR MCS Recomm. History";
        ItemLedgerEntry: Record "Item Ledger Entry";
        Tempfile: File;
    ...
    local procedure GetSetup(var MCSRecommendationsSetup: Record "NPR MCS Recommendations Setup")
    begin
    ...
    procedure UploadData(var MCSRecommendationsModel: Record "NPR MCS Recomm. Model")
    var
        MCSRecServiceAPI: Codeunit "NPR MCS Rec. Service API";
        CatalogFile: Text;
        UsageFile: Text;
    ...
    procedure CreateRecommendationsBuild(var MCSRecommendationsModel: Record "NPR MCS Recomm. Model")
    var
        MCSRecServiceAPI: Codeunit "NPR MCS Rec. Service API";
    begin
    ...
    procedure TestGetRecommendations(var MCSRecommendationsModel: Record "NPR MCS Recomm. Model"; ItemNo: Code[20])
    var
        MCSRecServiceAPI: Codeunit "NPR MCS Rec. Service API";
    begin
    ...
    procedure CreateRecommendationsModel(var MCSRecommendationsModel: Record "NPR MCS Recomm. Model")
    var
        MCSRecServiceAPI: Codeunit "NPR MCS Rec. Service API";
        DataFilePath: Text;
    begin
    ...
    procedure UploadUsageData(var MCSRecommendationsModel: Record "NPR MCS Recomm. Model")
    var
        MCSRecServiceAPI: Codeunit "NPR MCS Rec. Service API";
        CatalogFile: Text;
        UsageFile: Text;
