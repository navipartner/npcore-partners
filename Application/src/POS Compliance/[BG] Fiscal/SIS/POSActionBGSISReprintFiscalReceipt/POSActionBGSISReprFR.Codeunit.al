codeunit 6184734 "NPR POS Action: BG SIS Repr FR" implements "NPR IPOS Workflow"
{
    Access = Internal;

    procedure Register(WorkflowConfig: Codeunit "NPR POS Workflow Config");
    var
        ActionDescriptionLbl: Label 'This is a built-in action to manage reprinting of fiscal receipts from electronic journal.';
        ParamTypeCaptionLbl: Label 'Type';
        ParamTypeDescrLbl: Label 'Specifies the Type used.';
        ParamTypeOptionsCaptionLbl: Label 'Enter Grand Receipt No.,Reprint Selected Fiscalized';
        ParamTypeOptionsLbl: Label 'enterGrandReceiptNo,reprintSelectedFiscalized', Locked = true;
    begin
    ...
    begin
        ...
        Response := POSActionBGSISReprFRB.PrepareHTTPRequest(Type, POSSale."Register No.");
    end;
    ...
    begin
        ...
        POSActionBGSISReprFRB.HandleResponse(ResponseText);
    end;

    local procedure GetActionScript(): Text
    begin
        exit(
//###NPR_INJECT_FROM_FILE:POSActionBGSISReprFR.js###
