codeunit 6248349 "NPR BE Fiscal Sales Receipt"
{
    Access = Internal;
    ...
    begin
        ...
        Printer.ProcessBuffer(Codeunit::"NPR BE Fiscal Sales Receipt", Enum::"NPR Line Printer Device"::Epson, TempPrinterDeviceSettings);
    end;
    ...
    begin
        ...
        if POSStore.Get(POSEntry."POS Store Code") then begin
            ...
            if POSStore."VAT Registration No." <> '' then
                ...
                if CompanyInformation.Get() and (CompanyInformation."VAT Registration No." <> '') then
                    Printer.AddLine(VATRegistrationNoLbl + CompanyInformation."VAT Registration No.", 1);
