codeunit 6014454 "NPR CleanCash Identity Msg." implements "NPR CleanCash XCCSP Interface"
{
    ...
    begin
        ...
        CleanCashTransactionRequest."Request Type" := CleanCashTransactionRequest."Request Type"::IdentityRequest;
    ...
    begin
        ...
        StatusRequest := XmlElement.Create('IdentityRequest', XmlNs);
        ...
        Envelope.Add(CleanCashXCCSPProtocol.AddElement('type', 'RequestIdentity', XmlNs));
        Envelope.Add(Data);
...
#pragma warning restore
    ...
    begin
        ...
        if (Element.SelectSingleNode('cc:type[text()="IdentityResponse"]', NamespaceManager, Node)) then begin
