table 6059834 "NPR SAF-T Cash Export Header"
{
    Access = Internal;
    Caption = 'SAF-T Cash Register Export Header';
    DataClassification = CustomerContent;
    DrillDownPageId = "NPR SAF-T Cash Export Card";
    LookupPageId = "NPR SAF-T Cash Export Card";
    ...
    fields
    {
        ...
        field(10; Status; Enum "NPR SAF-T Cash Export Status")
        {
            Caption = 'Status';
            DataClassification = CustomerContent;
            Editable = false;
