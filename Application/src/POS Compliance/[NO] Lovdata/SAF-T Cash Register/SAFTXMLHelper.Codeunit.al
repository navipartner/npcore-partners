codeunit 6184524 "NPR SAF-T XML Helper"
{
    Access = Internal;
    ...
    var
        ...
        SAFTNameSpaceTxt: Label 'urn:StandardAuditFile-Taxation-CashRegister:NO', Locked = true;
    ...
    internal procedure ExportXMLDocument(var SAFTExportLine: Record "NPR SAF-T Cash Export Line"; SAFTExportHeader: Record "NPR SAF-T Cash Export Header")
    var
    ...
    internal procedure ExportSAFTExportLineBlobToFile(SAFTExportLine: Record "NPR SAF-T Cash Export Line"; FilePath: Text[512])
    var
        EntryTempBlob: Codeunit "Temp Blob";
        SAFTCashExportFile: Record "NPR SAF-T Cash Export File";
        SAFTCashExportMgt: Codeunit "NPR SAF-T Cash Export Mgt.";
        OutStr: OutStream;
        InStr: InStream;
    begin
