table 6060065 "NPR NO POS Audit Log Aux. Info"
{
    Access = Internal;
    Caption = 'NO POS Audit Log Aux. Info';
    DataClassification = CustomerContent;
    DrillDownPageId = "NPR NO POS Audit Log Aux. Info";
    LookupPageId = "NPR NO POS Audit Log Aux. Info";

    fields
    {
        field(1; "Audit Entry Type"; Enum "NPR NO Audit Entry Type")
        {
