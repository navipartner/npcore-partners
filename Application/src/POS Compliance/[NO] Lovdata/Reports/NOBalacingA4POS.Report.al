...
#ENDIF
    ...
    begin
        ...
        NOReportStatisticsMgt.CalcCancelledReceiptsAmount(SalespersonPurchaser.Code, POSWorkshiftCheckpoint.SystemCreatedAt, PreviousZReportDateTime, CancelledReceiptsAmount);
    end;
