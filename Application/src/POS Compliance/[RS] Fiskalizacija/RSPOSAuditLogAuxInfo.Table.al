table 6059830 "NPR RS POS Audit Log Aux. Info"
{
    Access = Internal;
    Caption = 'RS POS Audit Log Aux. Info';
    DataClassification = CustomerContent;
    DrillDownPageId = "NPR RS POS Audit Log Aux. Info";
    LookupPageId = "NPR RS POS Audit Log Aux. Info";
    ...
    fields
    {
        ...
        field(28; District; Text[25])
        {
            Caption = 'District';
            DataClassification = CustomerContent;
        }
        field(29; Mrc; Text[20])
        {
            Caption = 'Mrc';
            DataClassification = CustomerContent;
        }
        ...
        field(60; "POS Entry Type"; Option)
        {
            Caption = 'Entry Type';
            DataClassification = CustomerContent;
            Editable = false;
        ...
        {
            CalcFormula = exist("NPR RS POS Audit Log Aux. Copy" where("Audit Entry Type" = field("Audit Entry Type"), "Audit Entry No." = field("Audit Entry No.")));
            Caption = 'Fiscal Bill Copies';
            Editable = false;
            FieldClass = FlowField;
        }
        field(110; "Fiscal Bill E-Mails"; Boolean)
        {
            CalcFormula = exist("NPR RS Fiscal E-Mail Log" where("Audit Entry Type" = field("Audit Entry Type"), "Audit Entry No." = field("Audit Entry No."), Successful = const(true)));
