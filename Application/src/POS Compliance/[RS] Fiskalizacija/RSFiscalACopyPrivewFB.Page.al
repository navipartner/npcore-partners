page 6059909 "NPR RS Fiscal A.Copy Privew FB"
{
    ...
    begin
        FiscalBillContent := RSFiscalPreviewMgt.SetContentOfFiscalBillPrivew(Rec."Audit Entry No.", Rec."Audit Entry Type", Rec."Payment Method Code", true);
