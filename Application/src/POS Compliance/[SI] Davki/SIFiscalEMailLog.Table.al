table 6059869 "NPR SI Fiscal E-Mail Log"
{
    Access = Internal;
    Caption = 'SI Fiscal E-Mail Log';
    DataClassification = CustomerContent;
    DrillDownPageId = "NPR SI Fiscal E-Mail Logs";
    LookupPageId = "NPR SI Fiscal E-Mail Logs";
    ...
    fields
    {
        ...
        field(3; "Audit Entry Type"; Enum "NPR SI Audit Entry Type")
        {
