codeunit 6014645 "NPR BTF GetInvoices" implements "NPR BTF IEndPoint"
{
    var
    ...
    begin
        ...
        if not CheckServiceEndPoint(ServiceSetup, ServiceEndPoint, Response) then
            exit;
        GetInvoices(ServiceSetup, ServiceEndPoint, ServiceEndPointForAuth, Response);
    end;
    ...
    local procedure GetInvoices(ServiceSetup: Record "NPR BTF Service Setup"; ServiceEndPoint: Record "NPR BTF Service EndPoint"; ServiceEndPointForAuth: Record "NPR BTF Service EndPoint"; var Response: Codeunit "Temp Blob")
    var
