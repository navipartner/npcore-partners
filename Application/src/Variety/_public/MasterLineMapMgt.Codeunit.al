...
{
    internal procedure FilterRecRefOnMasterId(var RR: RecordRef; var SrcRR: RecordRef; WithoutMaster: Boolean)
    var
    ...
    internal procedure IsMaster(TableId: Integer; TableRecordId: Guid): Boolean
    var
        MasterLineMap: Record "NPR Master Line Map";
    begin
    ...
    internal procedure TransferOwnershipToNextInLine(TableId: Integer; TableRecordId: Guid)
    var
    ...
    internal procedure GetLastInLineSystemId(TableId: Integer; MasterId: Guid): Guid
    var
        MasterLineMap: Record "NPR Master Line Map";
        LastInLine: Guid;
    begin
