...
#pragma warning restore AA0139
        ...
        Response.Add('mmUnprocessedRefundMessage', Payments.GetUnprocessedPartialRegretConfirmation(SalePOS, POSPaymentMethod));
