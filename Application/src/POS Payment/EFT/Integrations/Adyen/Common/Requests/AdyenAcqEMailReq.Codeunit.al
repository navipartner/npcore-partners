codeunit 6248335 "NPR EFT Adyen Acq EMail Req."
{
    Access = Internal;
    ...
    begin
        ...
        Json.WriteStartObject('');
        Json.WriteStringProperty('Text', 'Enter your email address:');
        Json.WriteEndObject();
        ...
        Json.WriteStringProperty('DefaultInputString', 'name@domain.com');
