codeunit 6184499 "NPR EFT Framework Mgt."
{
    ...
    var
        ...
        Handled: Boolean;
    begin
        EFTInterface.OnCreateHwcEftDeviceRequest(EFTTransactionRequest, EftRequest, Handled);
        if not Handled then
            Error('EFT Integration %1 is not subscribing to CreateHwcRequest correctly.', EFTTransactionRequest."Integration Type");
    end;
