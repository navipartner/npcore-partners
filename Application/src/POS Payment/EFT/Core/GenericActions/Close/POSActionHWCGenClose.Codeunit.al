...
'let main=async({workflow:o,hwc:t,popup:l,context:s,captions:a})=>{let e,r,c={Success:!1},u={Success:!1};debugger;s.request.Unattended||(e=await l.simplePayment({showStatus:!0,title:a.workflowTitle,amount:" ",onAbort:async()=>{await l.confirm(a.confirmAbort)&&(e.updateStatus(a.statusAborting),await t.invoke(s.request.HwcName,{Type:"RequestCancel",EntryNo:s.request.EntryNo},r))},abortValue:{completed:"Aborted"}}));try{return r=t.registerResponseHandler(async i=>{switch(i.Type){case s.request.Type:try{console.log("[Generic HWC] Operation "+s.request.Type+" for "+s.request.HwcName+" completed with status "+i.Success),e&&e.updateStatus(a.statusFinalizing),u=await o.respond("ProcessResult",{hwcResponse:i}),(s.showSuccessMessage&&u.Success||!u.Success)&&e&&l.message({caption:u.Message,title:a.workflowTitle}),c=i,t.unregisterResponseHandler(r)}catch(n){console.error("[Generic HWC] Operation failed: "+n),t.unregisterResponseHandler(r,n)}break;case"UpdateDisplay":e&&e.updateStatus(i.DisplayLine),console.log("[Generic HWC] Operation "+i.DisplayLine);break}}),e&&e.updateStatus(a.statusExecuting),e&&e.enableAbort(!0),await t.invoke(s.request.HwcName,s.request,r),await t.waitForContextCloseAsync(r),{success:u.Success}}finally{e&&e.close()}};'
        );
    end;
