...
codeunit 6248362 "NPR IncEcomSalesDocApiAgent"
{
    ...
    ObsoleteReason = 'Replaced with V2 of the API agent: NPR EcomSalesDocApiAgent';
...
#pragma warning disable AA0139
        ...
        IncEcomSalesHeader."Sell-to Customer Type" := JsonHelper.GetJText(RequestBody, 'sellToCustomer.type', MaxStrLen(IncEcomSalesHeader."Sell-to Customer Type"), true, true);
    ...
    begin
        IncSalesDocumentJsonObject.StartObject('salesDocument')
                                 ...
                                 .StartObject('sellToCustomer')
                                    ...
                                    .AddProperty('type', IncSalesHeader."Sell-to Customer Type")
