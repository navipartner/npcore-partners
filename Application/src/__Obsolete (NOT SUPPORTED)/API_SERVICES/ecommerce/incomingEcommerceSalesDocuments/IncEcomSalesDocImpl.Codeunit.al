...
codeunit 6248364 "NPR Inc Ecom Sales Doc Impl"
{
    ...
    begin
        ...
        if NewCustomer then begin
            ...
            CustomerTemplateCode := IncEcomSalesDocUtils.GetCustTemplate(Customer);
        ...
        ConfigTemplateCode := IncEcomSalesDocUtils.GetCustConfigTemplate(IncEcomSalesHeader."Sell-to Customer Type");
...
#pragma warning restore AA0139
    ...
    internal procedure UpdateSaleDocumentPostingStatusFromSalesHeader(SalesHeader: Record "Sales Header")
    var
    ...
    begin
        ...
        if (IncEcomSalesHeader."API Version Date" <> 0D) and (IncEcomSalesHeader."API Version Date" <> GetApiVersion()) then
            exit;
    ...
    internal procedure UpdateSalesDocumentLinePostingInformationSalesInvoice(SalesInvLine: Record "Sales Invoice Line")
    var
        IncEcomSalesHeader: Record "NPR Inc Ecom Sales Header";
        IncEcomSalesLine: Record "NPR Inc Ecom Sales Line";
        IncEcomSalesDocImplEvents: Codeunit "NPR IncEcomSalesDocImplEvents";
    ...
    internal procedure UpdateSalesDocumentLinePostingInformationSalesCreditMemo(SalesCrMemoLine: Record "Sales Cr.Memo Line")
    var
        IncEcomSalesHeader: Record "NPR Inc Ecom Sales Header";
        IncEcomSalesLine: Record "NPR Inc Ecom Sales Line";
        IncEcomSalesDocImplEvents: Codeunit "NPR IncEcomSalesDocImplEvents";
