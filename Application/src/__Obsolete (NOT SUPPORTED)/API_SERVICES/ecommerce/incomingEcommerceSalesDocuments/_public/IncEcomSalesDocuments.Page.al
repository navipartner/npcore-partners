...
page 6185000 "NPR Inc Ecom Sales Documents"
{
    PageType = list;
    UsageCategory = None;
    SourceTable = "NPR Inc Ecom Sales Header";
    Editable = false;
    Caption = 'Incoming Ecommerce Sales Documents (Legacy)';
    SourceTableView = sorting(systemCreatedAt) order(descending);
    InsertAllowed = false;
    ModifyAllowed = false;
    CardPageId = "NPR Inc Ecom Sales Document";
    ObsoleteState = Pending;
    ObsoleteTag = '2025-10-26';
    ObsoleteReason = 'Replaced with NPR Ecom Sales Documents';
    layout
    {
        area(content)
        {
