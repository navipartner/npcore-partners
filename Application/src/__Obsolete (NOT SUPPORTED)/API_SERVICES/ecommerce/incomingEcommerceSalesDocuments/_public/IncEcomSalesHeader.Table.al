table 6151112 "NPR Inc Ecom Sales Header"
{
    DataClassification = CustomerContent;
    Caption = 'Incoming Ecommerce Sales Header';
#if not BC17 and not BC18 and not BC19 and not BC20 and not BC21 and not BC22
    DrillDownPageId = "NPR Inc Ecom Sales Documents";
    LookupPageId = "NPR Inc Ecom Sales Documents";
#endif
    ObsoleteState = Pending;
    ObsoleteTag = '2025-10-26';
    ObsoleteReason = 'Replaced with NPR Ecom Sales Header';

    fields
    {
        field(2; "External No."; Text[20])
        {
            DataClassification = CustomerContent;
            Caption = 'External No.';
        }
        field(30; "Document Type"; Enum "NPR Inc Ecom Sales Doc Type")
        {
            DataClassification = CustomerContent;
            Caption = 'Document Type';
        }
        field(60; "Creation Status"; Enum "NPR IncEcomSalesDocCrtStatus")
        {
            DataClassification = CustomerContent;
        ...
        field(160; Amount; Decimal)
        {
            ...
            Editable = false;
            CalcFormula = sum("NPR Inc Ecom Sales Line"."Line Amount" where("Document Type" = field("Document Type"),
                                                         "External Document No." = field("External No.")));
        }
        field(170; "Invoiced Amount"; Decimal)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = sum("NPR Inc Ecom Sales Line"."Invoiced Amount" where("Document Type" = field("Document Type"),
                                                         "External Document No." = field("External No.")));
        }
        ...
        field(1200; "Captured Payment Amount"; Decimal)
        {
            ...
            CalcFormula = Sum("NPR Inc Ecom Sales Pmt. Line"."Captured Amount" WHERE("Document Type" = FIELD("Document Type"),
                                                                                     "External Document No." = FIELD("External No.")));
        }
        field(1210; "Payment Amount"; Decimal)
        {
            CalcFormula = Sum("NPR Inc Ecom Sales Pmt. Line".Amount WHERE("Document Type" = FIELD("Document Type"),
                                                                          "External Document No." = FIELD("External No.")));
        ...
        {
            CalcFormula = Sum("NPR Inc Ecom Sales Pmt. Line"."Invoiced Amount" WHERE("Document Type" = FIELD("Document Type"),
                                                                          "External Document No." = FIELD("External No.")));
        ...
        field(1220; "Posting Status"; Enum "NPR IncEcomSalesDocPostStatus")
        {
            DataClassification = CustomerContent;
    ...
    keys
    {
        key(Key1; "Document Type", "External No.")
        {
            Clustered = true;
        }
    ...
    begin
        IncEcomSalesDocUtils.DeleteSalesDocSalesLines(Rec);
        IncEcomSalesDocUtils.DeleteSalesDocPaymentLines(Rec);
    end;
#endif
}