codeunit 6059918 "NPR Add Person Face"
{
    ...
    procedure AddPersonFace(var Contact: Record Contact; var ImageInStream: InStream; var EntryNo: Integer) Imported: Boolean
    var
        JsonResponse: Text;
    begin
        FacialRecognitionSetup.FindFirst();

        CreateRequest(Contact, ImageInStream);
        SendRequest();
    ...
    local procedure CreateRequest(var Contact: Record Contact; var ImageInStream: InStream)
    var
