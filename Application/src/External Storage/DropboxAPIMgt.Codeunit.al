codeunit 6184860 "NPR Dropbox API Mgt."
{
    ...
    begin
        ...
        TempStorageTypes.Codeunit := CODEUNIT::"NPR Dropbox API Mgt.";
    ...
    var
        DropBoxOverview: Page "NPR DropBox Overview";
    begin
    ...
    begin
        ...
        if PAGE.RunModal(PAGE::"NPR DropBox Setup", DropBoxAPISetup) <> ACTION::LookupOK then
            exit;
