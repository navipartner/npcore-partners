...
#ENDIF
        ...
        PerCompanyUpgradeTags.Add(GetUpgradeTag(Codeunit::"NPR NPRE Upgrade", 'UpdateMarkRequestsAsServedParameter'));
...
#ENDIF
        ...
        PerCompanyUpgradeTags.Add(GetUpgradeTag(Codeunit::"NPR POS License Billing Upgrd.", 'MigrateValidDates'));
        PerCompanyUpgradeTags.Add(GetUpgradeTag(Codeunit::"NPR Module Licensing Upgrd.", 'RegisterModuleLicensingFeature'));
        PerCompanyUpgradeTags.Add(GetUpgradeTag(Codeunit::"NPR Module Licensing Upgrd.", 'DisableLegacyPosBilling'));
#endif
            ...
            Codeunit::"NPR NPRE Upgrade":
                case UpgradeStep of
                    ...
                    'UpdateMarkRequestsAsServedParameter':
                        exit('NPRE_UpdateMarkRequestsAsServedParameter_20260403');
                end;
...
#ENDIF
            ...
            Codeunit::"NPR New Feature Handler":
                case UpgradeStep of
                    ...
                    'NewNpRvPrintExperienceHandle':
                        exit('NPR-NewNpRvPrintExperienceHandle-20260628');
            ...
            Codeunit::"NPR UPG JQ Notif NP Email":
                case UpgradeStep of
                    'JQNotifNPEmailHandle':
                        exit('NPR-JQNotifNPEmailHandle-20260804');
                end;
...
#ENDIF
            ...
            Codeunit::"NPR POS License Billing Upgrd.":
                case UpgradeStep of
                    ...
                    'MigrateValidDates':
                        exit('NPR-MigrateValidDates-20260601');
                end;
            Codeunit::"NPR Module Licensing Upgrd.":
                case UpgradeStep of
                    'RegisterModuleLicensingFeature':
                        exit('NPR-RegisterModuleLicensingFeature-20260605');
                    'DisableLegacyPosBilling':
                        exit('NPR-DisableLegacyPosBilling-20260605');
                end;
#endif
            ...
            Codeunit::"NPR UPG TM Notif Address":
                case UpgradeStep of
