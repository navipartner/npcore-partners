...
#ENDIF
        ...
        PerCompanyUpgradeTags.Add(GetUpgradeTag(Codeunit::"NPR New Feature Handler", 'NewPOSSwitchRegisterHandle'));
        ...
        PerCompanyUpgradeTags.Add(GetUpgradeTag(Codeunit::"NPR UPG New Feature Handler", 'NewPOSSwitchRegisterHandle'));
            ...
            Codeunit::"NPR New Feature Handler":
                case UpgradeStep of
                    ...
                    'NewPOSSwitchRegisterHandle':
                        exit('NPR-NewPOSSwitchRegisterHandle-20260119');
                end;
