codeunit 6014681 "NPR Mix Discount Calc. Mgt."
{
    ...
    [Obsolete('Use CalculateMixedDiscountLine(ItemNo: Code[20]; VariantCode: Code[20]; var POSSaleLineTemp: Record "NPR POS Sale Line" temporary) MixedDiscountExists: Boolean')]
