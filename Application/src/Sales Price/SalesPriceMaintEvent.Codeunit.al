codeunit 6014481 "NPR Sales Price Maint. Event"
{
    ...
    begin
        ...
        if (Rec."Unit Cost" = xRec."Unit Cost") and
           ...
           (Rec."NPR Item Group" = xRec."NPR Item Group") then
            exit;
    ...
    var
        ...
        RecRef: RecordRef;
        BreakLoop: Boolean;
        SalesPriceMaintenanceGroups: Record "NPR Sales Price Maint. Groups";
        TmpItem: Record Item;
                            ...
                            if SalesPriceMaintenanceGroups.FindSet then begin
                                repeat
                                    if not BreakLoop then
                                        BreakLoop := ExcludeItemGroup(Item."NPR Item Group", SalesPriceMaintenanceGroups."Item Group");
