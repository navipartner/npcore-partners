page 6014596 "NPR Item Cat. Code Stats"
{
    ...
    internal procedure SetFilter(GlobalDim1: Code[20]; GlobalDim2: Code[20]; DatoStart: Date; DatoEnd: Date; LastYearCalc: Text[50]; ItemCategoryFilter: Code[20]; ItemNoFilter: Code[20])
    begin
        //SetFilter()
