codeunit 85064 "NPR POS Act. Ins. Cus.Id Tests"
{
    ...
    begin
        ...
        // [When] Add Additional Customer Identification
        AddAdditionalCustomerIdentification(SalePOS, POSSale, NewDesc);

        // [Then] Additional Customer Identification is added to POS Sale
    ...
    begin
        ...
        RSPOSSale."RS Customer Identification" := NewDesc;
