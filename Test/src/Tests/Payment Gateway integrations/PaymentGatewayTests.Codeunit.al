codeunit 85123 "NPR Payment Gateway Tests"
{
    ...
    #region Event based integration
    [Test]
    [TestPermissions(TestPermissions::Disabled)]
    procedure PaymentLineIsCapturedUponPostingWithEventsTest()
    var
        GatewayCode: Code[10];
        SalesHeader: Record "Sales Header";
        SalesPost: Codeunit "Sales-Post";
    ...
    begin
        ...
        // [GIVEN] Given a payment gateway
        CodeunitId := Codeunit::"NPR PG CI Test Integration";
        GatewayCode := _LibPaymentGateway.CreatePaymentGateway(CodeunitId, CodeunitId, CodeunitId);
    ...
    [Test]
    [TestPermissions(TestPermissions::Disabled)]
    procedure PaymentLineIsRefundedUponPostingReverseSalesWithEventsTest()
    var
        GatewayCode: Code[10];
        SalesHeader: Record "Sales Header";
        SalesPost: Codeunit "Sales-Post";
    ...
    [Test]
    [TestPermissions(TestPermissions::Disabled)]
    procedure PaymentLineIsCancelledWhenDeletedWithEventsTest()
    var
        GatewayCode: Code[10];
        SalesHeader: Record "Sales Header";
        PaymentLine: Record "NPR Magento Payment Line";
