codeunit 85035 "NPR POS Normal Tax Calc. Tests"
{
    ...
    [Test]
    procedure SkipTaxCalcForwardForZeroAmountDirectSaleNormalVATToDo()
    var
    ...
    [Test]
    procedure SkipTaxCalcForwardForZeroAmountInclTaxDirectSaleNormalVATToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleNormalVATLineDiscountManualToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been created forward for direct sale with tax calculation type set as normal vat including line discount
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleNormalVATLineAndInvDiscountManualToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been created forward for direct sale with tax calculation type set as normal vat including line and invoice discount
        ...
        SetRandomValuesForward(TempPOSSaleTaxLine[1], Item[1], Qty[1], VATPostingSetup."VAT %", LineDisc[1], LineDiscPct[1], InvDiscAmt[1]);
        SetRandomValuesForward(TempPOSSaleTaxLine[2], Item[2], Qty[2], VATPostingSetup."VAT %", LineDisc[2], LineDiscPct[2], InvDiscAmt[2]);
        ...
        VerifyTaxLineCalcForward(TempPOSSaleTaxLine[1], POSSaleTaxLine);
        VerifyTaxLineCalcWithLineDiscount(POSSaleTaxLine, SaleLinePOS);
        VerifyTaxCalcLineCopied2Header(POSSaleTaxLine, POSSaleTax);
        VerifyTaxCalcHeaderCopied2Source(POSSaleTax, SaleLinePOS);
        VerifyTaxCalcHeaderCopied2SourceForward(POSSaleTax, SaleLinePOS);
        ...
        VerifyTaxLineCalcForward(TempPOSSaleTaxLine[2], POSSaleTaxLine);
        VerifyTaxLineCalcWithInvDiscount(POSSaleTaxLine, SaleLinePOS);
        VerifyTaxCalcLineCopied2Header(POSSaleTaxLine, POSSaleTax);
        VerifyTaxCalcHeaderCopied2Source(POSSaleTax, SaleLinePOS);
        VerifyTaxCalcHeaderCopied2SourceForward(POSSaleTax, SaleLinePOS);
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleNormalVATPostedToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been posted forward for direct sale with tax calculation type set as normal vat
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleNormalVATLineDiscountManualPostedToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been posted forward for direct sale with tax calculation type set as normal vat including line discount
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleNormalVATLineAndInvDiscountManualPostedToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: array[2] of Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been posted forward for direct sale with tax calculation type set as normal vat including line and invoice discount
    ...
    [Test]
    procedure SkipTaxCalcForwardForZeroAmountDirectSaleReverseVATToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    begin
        //Forward direct sale for reverse vat is not possbile due to Tax Type setup on POS View Profile
        exit;
    ...
    [Test]
    procedure SkipTaxCalcForwardForZeroAmountInclTaxDirectSaleReverseVATToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleReverseVATToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been created forward for direct sale with tax calculation type set as reverse charge vat
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleReverseVATLineDiscountManualToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been created forward for direct sale with tax calculation type set as reverse charge vat including line discount
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleReverseVATLineAndInvDiscountManualToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: array[2] of Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been created forward for direct sale with tax calculation type set as reverse charge vat including line and invoice discount
        ...
        //Store random decimal values in temporary records
        SetRandomValuesForward(TempPOSSaleTaxLine[1], Item[1], Qty[1], 0, LineDisc[1], LineDiscPct[1], InvDiscAmt[1]);
        SetRandomValuesForward(TempPOSSaleTaxLine[2], Item[2], Qty[2], 0, LineDisc[2], LineDiscPct[2], InvDiscAmt[2]);
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleReverseVATPostedToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been posted forward for direct sale with tax calculation type set as reverse charge vat
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleReverseVATLineDiscountManualPostedToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been posted forward for direct sale with tax calculation type set as reverse charge vat including line discount
    ...
    [Test]
    procedure VerifyTaxCalcForwardForDirectSaleReverseVATLineAndInvDiscountManualPostedToDo()
    var
        POSViewProfile: Record "NPR POS View Profile";
        VATPostingSetup: Record "VAT Posting Setup";
        Item: array[2] of Record Item;
    ...
    begin
        ...
        // [SCENARIO] Verify Tax Calculation has been posted forward for direct sale with tax calculation type set as reverse charge vat including line and invoice discount
