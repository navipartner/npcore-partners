codeunit 85162 "NPR Library CRO Fiscal"
{
    ...
    begin
        ...
        CROPOSPaymentMethodMapping."CRO Payment Method" := CROPOSPaymentMethodMapping."CRO Payment Method"::Cash;
    ...
    begin
        ...
        if not sender.TestGetSignatureFromResponse(CROPOSAuditLogAuxInfo, ResponseText) then
            Error(XMLSignatureErr);
        IsHandled := true;
    end;
}