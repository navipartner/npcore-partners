...
#ENDIF
        ...
        CROPOSStoreMapping.Init();
        CROPOSStoreMapping."POS Store Code" := POSUnit."POS Store Code";
        CROPOSStoreMapping."Bill No. Series" := CreateNumberSeries();
        CROPOSStoreMapping.Insert();
        NoSeriesLine.SetRange("Series Code", CROPOSStoreMapping."Bill No. Series");
        NoSeriesLine.SetRange(Open, true);
        NoSeriesLine.FindLast();
#IF NOT (BC17 OR BC18 OR BC19 OR BC20 OR BC21 OR BC22 OR BC23)
