# Brands reference guide

Find out what each of the fields on the **Brands** is used for by referring to the following tables. Each table corresponds to a different section in the **Brands** page.
...
| **Short Description**   | Enter a short description for your brand page using Page Builder editor.         |
| **Description**  | Enter a long description for your brand page using Page Builder editor.  |
