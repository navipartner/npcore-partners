...
For the process to work, [data log subscribers](../explanation/autogeneratedsetups.md#data-log-subscribers) need to be registered. Data log subscribers create **Task List** entries which are processed by a [job queue entry](../explanation/autogeneratedsetups.md#job-queue-entries).
...
- If the items in questions are [variants](../explanation/varieties.md), the following is sent:

   - Variant names and values
   - [SKU](../explanation/shopifysku.md)
...
### Next steps
- [Get orders from Shopify](../explanation/getting_orders.md)
- [Send data back to Shopify](../explanation/senddataback.md)
