codeunit 6059966 "NPR MPOS Payment API"
{
    ...
    local procedure OnAction(WorkflowStep: Text; PaymentType: Record "NPR Payment Type POS"; Context: JsonObject; POSSession: Codeunit "NPR POS Session"; FrontEnd: Codeunit "NPR POS Front End Management"; var Handled: Boolean)
    var
    ...
    procedure CallPaymentStart(var SaleLinePOS: Record "NPR Sale Line POS")
    var
        mPOSAdyenTransactions: Record "NPR MPOS Adyen Transactions";
        mPOSProxy: Page "NPR MPOS Proxy";
        JSON: Text;
        CallBackUrl: Text;
        DateTimeTick: DotNet NPRNetDateTime;
        CurrSessionId: Code[20];
        mPOSAdyenTransactionsResponse: Record "NPR MPOS Adyen Transactions";
        BigTextVar: BigText;
        Ostream: OutStream;
        ...
        mPOSNetsTransactionsResponse: Record "NPR MPOS Nets Transactions";
        Cancelled: Boolean;
        TempBlob: Codeunit "Temp Blob";
        CreditCardProtocolHelper: Codeunit "NPR Credit Card Prot. Helper";
    ...
    local procedure ParseAdyenJson(var mPOSAdyenTransactions: Record "NPR MPOS Adyen Transactions")
    var
        JObject: JsonObject;
        ResponsData: Text;
        IStream: InStream;
    ...
    local procedure ParseNetsJson(var mPOSNetsTransactions: Record "NPR MPOS Nets Transactions")
    var
        JObject: JsonObject;
        ResponsData: Text;
        IStream: InStream;
    ...
    procedure CallCancelStart(var SaleLinePOS: Record "NPR Sale Line POS"): Boolean
    var
        mPOSAdyenTransactions: Record "NPR MPOS Adyen Transactions";
        mPOSProxy: Page "NPR MPOS Proxy";
        JSON: Text;
    ...
    local procedure HandlePrint(var mPOSNetsTransactionsResponse: Record "NPR MPOS Nets Transactions")
    var
