codeunit 6150915 "NPR HC POS Entry Management"
{
    ...
    local procedure ProcessPOSTransaction(XmlDoc: DotNet "NPRNetXmlDocument")
    var
    ...
    local procedure ProcessPOSEntry(POSEntryXmlElement: DotNet NPRNetXmlElement) Imported: Boolean
    var
    ...
    local procedure InsertPOSEntry(XmlElement: DotNet NPRNetXmlElement; var POSEntry: Record "NPR POS Entry")
    var
        TempDimensionBuffer: Record "Dimension Buffer" temporary;
        TempPOSEntry: Record "NPR POS Entry" temporary;
        DimensionManagement: Codeunit DimensionManagement;
        OStream: OutStream;
        DimXmlElement: DotNet NPRNetXmlElement;
        XmlNodeList: DotNet NPRNetXmlNodeList;
        i: Integer;
    begin
        Clear(TempPOSEntry);
    ...
    local procedure UpdatePOSLedgerRegister(XmlElement: DotNet NPRNetXmlElement; var POSEntry: Record "NPR POS Entry")
    var
    ...
    local procedure InsertPOSSalesLine(XmlElement: DotNet NPRNetXmlElement; var POSEntry: Record "NPR POS Entry")
    var
    ...
    local procedure InsertPOSPaymentLine(XmlElement: DotNet NPRNetXmlElement; var POSEntry: Record "NPR POS Entry")
    var
    ...
    local procedure InsertPOSTaxAmountLine(XmlElement: DotNet NPRNetXmlElement; var POSEntry: Record "NPR POS Entry")
    var
    ...
    local procedure InsertPOSBalancingLine(XmlElement: DotNet NPRNetXmlElement; var POSEntry: Record "NPR POS Entry")
    var
    ...
    local procedure BuildDimensionBuffer(XmlElement: DotNet NPRNetXmlElement; var DimensionBuffer: Record "Dimension Buffer")
    var
        POSPeriodRegister: Record "NPR POS Period Register";
        TempPOSPeriodRegister: Record "NPR POS Period Register" temporary;
        OStream: OutStream;
