codeunit 6059998 "NPR Client Diag. Data Mgt."
{
    ...
    local procedure CollectClientData(var ClientDiagnostics: Record "NPR Client Diagnostics"; NewSession: Boolean)
    var
    ...
    procedure ScheduleDataCollection(ClientDiagnostics: Record "NPR Client Diagnostics")
    var
        NewSessionID: Integer;
    begin
        StartSession(NewSessionID, CODEUNIT::"NPR Client Diag. Data Mgt.", CompanyName, ClientDiagnostics);
    end;

    local procedure CommitClientDiagnostics(ClientDiagnosticsFrom: Record "NPR Client Diagnostics") HasNewInfo: Boolean
    var
        ClientDiagnosticsTo: Record "NPR Client Diagnostics";
        PrevRec: Text;
    begin
        HasNewInfo := false;
    ...
    procedure InitCurrentUser(var ClientDiagnostics: Record "NPR Client Diagnostics"): Boolean
    begin
        if not FindMySession() then
            exit(false);
    ...
    local procedure SetComputerInfo(var ClientDiagnostics: Record "NPR Client Diagnostics") HasNewInfo: Boolean
    var
    ...
    begin
        ...
        ClientDiagnostics."OS Version" := ''; //Unknown in webclient
    ...
    local procedure SetLicenseInfo(var ClientDiagnostics: Record "NPR Client Diagnostics") HasNewInfo: Boolean
    var
        User: Record User;
        PrevRec: Text;
    begin
    ...
    local procedure SetLoginInfo(var ClientDiagnostics: Record "NPR Client Diagnostics") HasNewInfo: Boolean
    var
    ...
    local procedure SetLogoutInfo(var ClientDiagnostics: Record "NPR Client Diagnostics") HasNewInfo: Boolean
    var
        PrevRec: Text;
    begin
        PrevRec := Format(ClientDiagnostics);
    ...
    local procedure SetPosClientType(POSClientType: Integer; var ClientDiagnostics: Record "NPR Client Diagnostics") HasNewInfo: Boolean
    var
        PrevRec: Text;
    begin
        PrevRec := Format(ClientDiagnostics);
    ...
    local procedure SetIPAddress(IPAddress: Text; var ClientDiagnostics: Record "NPR Client Diagnostics") HasNewInfo: Boolean
    var
        Latitude: Decimal;
        Longitude: Decimal;
    ...
    local procedure SetGeoPosition(var ClientDiagnostics: Record "NPR Client Diagnostics") HasNewInfo: Boolean
    var
    ...
    local procedure TransferComputerInfo(ClientDiagnosticsFrom: Record "NPR Client Diagnostics"; var ClientDiagnosticsTo: Record "NPR Client Diagnostics")
    begin
    ...
    local procedure TransferLicenseInfo(ClientDiagnosticsFrom: Record "NPR Client Diagnostics"; var ClientDiagnosticsTo: Record "NPR Client Diagnostics")
    begin
    ...
    local procedure TransferLoginInfo(ClientDiagnosticsFrom: Record "NPR Client Diagnostics"; var ClientDiagnosticsTo: Record "NPR Client Diagnostics")
    begin
    ...
    local procedure TransferLogoutInfo(ClientDiagnosticsFrom: Record "NPR Client Diagnostics"; var ClientDiagnosticsTo: Record "NPR Client Diagnostics")
    begin
    ...
    local procedure TransferPosInfo(ClientDiagnosticsFrom: Record "NPR Client Diagnostics"; var ClientDiagnosticsTo: Record "NPR Client Diagnostics")
    begin
    ...
    var
        [RunOnClient]
        NetworkInterface: DotNet NPRNetNetworkInterface;
        [RunOnClient]
        NetworkInterfaces: DotNet NPRNetArray;
        i: Integer;
    begin
