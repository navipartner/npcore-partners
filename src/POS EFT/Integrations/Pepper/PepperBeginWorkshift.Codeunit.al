...
codeunit 6184481 "NPR Pepper Begin Workshift"
{
    ...
    var
        ...
        StartWorkShiftRequest: DotNet NPRNetStartWorkshiftRequest;
        StartWorkShiftResponse: DotNet NPRNetStartWorkshiftResponse;
        ConfigDriver: DotNet NPRNetConfigDriverParam;
        PepperOpen: DotNet NPRNetOpenParam;
