...
codeunit 6184484 "NPR Pepper Aux Functions"
{
    ...
    var
        ...
        AuxRequest: DotNet NPRNetAuxRequest;
        AuxResponse: DotNet NPRNetAuxResponse;
        AuxResult: DotNet NPRNetAuxResult;
        AuxParam: DotNet NPRNetAuxParam;
        PepperOpCodes: DotNet NPRNetPepperOpCodes;
