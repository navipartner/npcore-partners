codeunit 6184524 "NPR EFT ISMP Baxi Prot."
{
    ...
    var
        ...
        ActiveModelID: Guid;
        EntryNo: Integer;
        EFTISMPBaxiIntegration: Codeunit "NPR EFT ISMP Baxi Integ.";
    ...
    local procedure InitState(EFTTransactionRequest: Record "NPR EFT Transaction Request")
    begin
        Clear(Model);
        Clear(ActiveModelID);
        Clear(EntryNo);
    ...
    var
        ...
        EFTISMPBaxiIntegration: Codeunit "NPR EFT ISMP Baxi Integ.";
        EFTISMPBaxiTrxDialog: Codeunit "NPR EFT ISMP Baxi Trx Dia.";
    begin
    ...
    local procedure Javascript(EFTTransactionRequest: Record "NPR EFT Transaction Request"): Text
    var
        JSScript: Text;
        Json: Text;
    begin
    ...
    local procedure PaymentRequest(EFTTransactionRequest: Record "NPR EFT Transaction Request") JSON: Text
    var
