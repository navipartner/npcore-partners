codeunit 6014504 "NPR Retail Contract Mgt."
{
    ...
    procedure CheckInsurance(var SalePos: Record "NPR Sale POS"): Boolean
    var
        PhotoSetup: Record "NPR Retail Contr. Setup";
        SaleLinePos: Record "NPR Sale Line POS";
    begin
    ...
    procedure InsertInsurance(var SalePos: Record "NPR Sale POS")
    var
        PhotoSetup: Record "NPR Retail Contr. Setup";
        SaleLinePos: Record "NPR Sale Line POS";
        LineNo: Integer;
    ...
    var
        ...
        PhotoSetup: Record "NPR Retail Contr. Setup";
        ReportSelectionPhoto: Record "NPR Report Selection: Contract";
    ...
    procedure PosSaleToWarranty(var SalePos: Record "NPR Sale POS"): Code[20]
    var
        Item: Record Item;
    ...
    begin
        ...
        repeat
            if Item.Get(SaleLinePos."No.") then
                if (Item."NPR Guarantee Index" = Item."NPR Guarantee Index"::"Flyt til garanti kar.") then begin
                    LineNo += 10000;
                    WarrantyLine.Init;
