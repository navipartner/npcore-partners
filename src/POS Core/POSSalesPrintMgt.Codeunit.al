codeunit 6150729 "NPR POS Sales Print Mgt."
{
    ...
    [EventSubscriber(ObjectType::Codeunit, 6150705, 'OnFinishSale', '', true, true)]
    local procedure PrintCreditVoucherOnSale(POSSalesWorkflowStep: Record "NPR POS Sales Workflow Step"; SalePOS: Record "NPR Sale POS")
    var
        AuditRoll: Record "NPR Audit Roll";
    ...
    procedure PrintSalesReceipt(var AuditRoll: Record "NPR Audit Roll"; SilentError: Boolean; ViewDemand: Boolean): Boolean
    var
        StdCodeunitCode: Codeunit "NPR Std. Codeunit Code";
    begin
    ...
    procedure PrintPOSEntrySalesReceipt(SalePOS: Record "NPR Sale POS")
    var
