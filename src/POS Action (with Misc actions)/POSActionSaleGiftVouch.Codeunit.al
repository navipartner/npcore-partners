codeunit 6150800 "NPR POS Action: SaleGiftVouch."
{
    ...
    begin
        ...
        for VoucherCount := 1 to SalesQuantity do begin
            ...
            if (PaymentTypePOS."Via Terminal") then begin
                Error('This action does not support electronic gift vouchers. Use "EFT_GIFT_CARD" instead.');
            end else begin
    ...
    local procedure GetQuantity(Context: JsonObject; FrontEnd: Codeunit "NPR POS Front End Management"): Decimal
    var
        JSON: Codeunit "NPR POS JSON Management";
    begin
    ...
    local procedure GetDiscount(Context: JsonObject; FrontEnd: Codeunit "NPR POS Front End Management"): Decimal
    var
        JSON: Codeunit "NPR POS JSON Management";
    begin
        JSON.InitializeJObjectParser(Context, FrontEnd);
    ...
    local procedure GetDiscountType(Context: JsonObject; FrontEnd: Codeunit "NPR POS Front End Management"): Integer
    var
        JSON: Codeunit "NPR POS JSON Management";
    begin
    ...
    var
        ...
        TempNo: Code[20];
        NewTempNo: Code[20];
        TouchScreen: Codeunit "NPR Touch Screen - Func.";
    ...
    procedure SetGiftVoucherInfo(var POSSession: Codeunit "NPR POS Session"; VoucherNo: Code[20]): Boolean
    var
        RetailSetup: Record "NPR Retail Setup";
        GiftVoucher: Record "NPR Gift Voucher";
        SalePOS: Record "NPR Sale POS";
    ...
    begin
        ...
        if not Handled then
            PAGE.RunModal(PAGE::"NPR Create Gift Voucher", GiftVoucher);
