codeunit 6150671 "NPR POSAction: Edit Web Depen."
{
    ...
    var
        ...
        CurrWebClientDependency: Record "NPR Web Client Dependency";
        [WithEvents]
    ...
    local procedure OnLookupDependencyCode(var POSParameterValue: Record "NPR POS Parameter Value"; Handled: Boolean)
    var
    ...
    local procedure OnActionEditWebDependency(JSON: Codeunit "NPR POS JSON Management"; FrontEnd: Codeunit "NPR POS Front End Management")
    var
        Type: Integer;
        "Code": Code[10];
    begin
    ...
    local procedure SaveNavContent(NavContentJson: Text; FrontEnd: Codeunit "NPR POS Front End Management")
    var
        NavContent: DotNet NPRNetString;
        OutStr: OutStream;
    begin
