codeunit 6184502 "NPR CleanCash AuditRoll Mgt."
{
    ...
    local procedure CreateCleanCashAuditRollRow(var AuditRoll: Record "NPR Audit Roll")
    var
    ...
    local procedure SetVatInformation(var CleanCashAuditRoll: Record "NPR CleanCash Audit Roll"; VatRates: array[4] of Decimal; VatAmounts: array[4] of Decimal)
    begin
