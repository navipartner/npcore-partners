codeunit 6151507 "NPR Nc Man. Nav Modules Mgt."
{
    ...
    var
        ...
        XmlNsManager: DotNet NPRNetXmlNamespaceManager;
        ResponseText: Text;
    begin
        if Url = '' then
            exit(false);
    ...
    local procedure AppendNavObjects(VersionListId: Text; var XmlElement: DotNet NPRNetXmlElement)
    var
        "Object": Record "Object";
        NpXmlDomMgt: Codeunit "NPR NpXml Dom Mgt.";
        XmlElementObject: DotNet NPRNetXmlElement;
        XmlElementObjectField: DotNet NPRNetXmlElement;
    begin
