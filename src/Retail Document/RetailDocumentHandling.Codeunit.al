...
codeunit 6014480 "NPR Retail Document Handling"
{
    ...
    var
        RetailDocLinesRec: Record "NPR Retail Document Lines";

    procedure Sale2RetailDocument(var SalePOS: Record "NPR Sale POS"): Boolean
    var
        ...
        RetailComments2: Record "NPR Retail Comment";
        Txt000: Label 'Error';
    ...
    begin
        ...
        if RetailComment.Find('-') then
            repeat
                ...
                RetailComments2."Table ID" := DATABASE::"NPR Retail Document Header";
        ...
        /* CONTRACT */
        begin
            if PAGE.RunModal(PAGE::"NPR Retail Document Header", RetailDocumentHeader) <> ACTION::LookupOK then begin
    ...
    procedure RetailDocument2Sale(var SalePOS: Record "NPR Sale POS"; var SalesCode: Code[20])
    var
        ...
        RetailDocumentHeader: Record "NPR Retail Document Header";
        RetailDocumentLines: Record "NPR Retail Document Lines";
        RetailDocumentList: Page "NPR Retail Document List";
        RetailSetup: Record "NPR Retail Setup";
        LineNo: Integer;
    begin
        //RetailContract2Sale
        ...
        with SalePOS do begin
            ...
            if RetailDocumentHeader.Deposit <> 0 then begin
                ...
                if Customer.Get(RetailDocumentHeader."Customer No.") then
                    SaleLinePOS.Internal := Customer."NPR Internal y/n";
    ...
    procedure UnfoldBOM(RetailDocumentLines: Record "NPR Retail Document Lines"; ItemNo: Code[20])
    var
        LineNo: Integer;
    ...
    procedure UnfoldAccessories(RetailDocumentLines: Record "NPR Retail Document Lines")
    var
    ...
    procedure UnfoldItemsUpdate(RetailDocumentLines: Record "NPR Retail Document Lines")
    var
        BOMComponent: Record "BOM Component";
        AccessorySparePart: Record "NPR Accessory/Spare Part";
    begin
    ...
    procedure UnfoldItemsDelete(RetailDocumentLines: Record "NPR Retail Document Lines")
    begin
        RetailDocLinesRec.Reset;
        RetailDocLinesRec.SetRange("Document Type", RetailDocumentLines."Document Type");
        RetailDocLinesRec.SetRange("Document No.", RetailDocumentLines."Document No.");
