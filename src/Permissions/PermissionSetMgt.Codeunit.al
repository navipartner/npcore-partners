codeunit 6014454 "NPR Permission Set Mgt."
{
...
until AllObj.Next = 0;
    ...
    begin
        ...
        if PageNumber in [
          ...
          PAGE::Users,
          PAGE::Devices,
          PAGE::"NPR POS Web Fonts",
          PAGE::"NPR Dependency Mgt. Setup",
          PAGE::"NPR POS Stargate Packages"
          ] then
            exit(true)
        else
            exit(false);
    ...
    begin
        ...
        if AllObj.FindSet then
            ...
            until AllObj.Next = 0;
        GivePermission(RoleID, AllObj."Object Type"::TableData, DATABASE::"NPR Audit Roll", 1, 2, 2, 2, 1);
        //+NPR5.41 [312644]
    end;
