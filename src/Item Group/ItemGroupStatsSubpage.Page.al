page 6014587 "NPR Item Group Stats Subpage"
{
    // 
    ...
    var
        ...
        moreField: Boolean;
        pos: Integer;
        TempItemGroup: Record "NPR Item Group" temporary;
        [InDataSet]
        LSQty: Boolean;
        [InDataSet]
        LSAmount: Boolean;
        ...
        if HideEmpty then begin
            ...
            if ItemGroup.Find('-') then
                repeat
                    ...
                    SetItemLedgerEntryFilter(ItemLedgerEntry);
                    ItemLedgerEntry.SetRange("NPR Item Group No.", ItemGroup."No.");
                    if ItemLedgerEntry.Count > 0 then
                        ItemLedgerEntry.CalcSums(Quantity);
                    //-NPR5.51 [358271]
                    Clear(ValueEntry);
                    SetValueEntryFilter(ValueEntry);
                    ValueEntry.SetRange("NPR Item Group No.", ItemGroup."No.");
    ...
    var
        "Item Group 1": Record "NPR Item Group";
    begin
        //ToggleExpandCollapse
        //-NPR3.1
    ...
    local procedure IsExpanded(ActualItemGroup: Record "NPR Item Group"): Boolean
    begin
        //IsExpanded
        //-NPR3.1
    ...
    local procedure HasChildren(ActualItemGroup: Record "NPR Item Group"): Boolean
    var
        IG2: Record "NPR Item Group";
    begin
        //HasChildren
        //-NPR3.1
