codeunit 6184865 "NPR External Storage Job Queue"
{
    ...
    var
        TempStorageOperationType: Record "NPR Storage Operation Type" temporary;
    ...
    local procedure GetOperationParameters(JobQueueEntry: Record "Job Queue Entry"; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        ExternalStorageInterface: Codeunit "NPR External Storage Interface";
        i: Integer;
    begin
    ...
    procedure GenerateJobQueueParameter(StorageID: Text; var StorageOperationType: Record "NPR Storage Operation Type"; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary) JobQParam: Text
    var
        ExternalStorageInterface: Codeunit "NPR External Storage Interface";
        [RunOnClient]
        Clipboard: DotNet NPRNetClipboard;
    begin
