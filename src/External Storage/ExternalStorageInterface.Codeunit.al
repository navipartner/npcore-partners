codeunit 6184866 "NPR External Storage Interface"
{
    ...
    [IntegrationEvent(false, false)]
    procedure OnConfigureSetup(var StorageSetup: Record "NPR Storage Setup")
    begin
    end;

    procedure HandleOperation(StorageID: Text[24]; var TempStorageOperationType: Record "NPR Storage Operation Type" temporary; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        StorageType: Record "NPR Storage Type";
        AzureStorageAPIMgt: Codeunit "NPR Azure Storage API Mgt.";
        DropboxAPIMgt: Codeunit "NPR Dropbox API Mgt.";
        FTPManagement: Codeunit "NPR FTP Management";
    begin
    ...
    local procedure HandleDropBoxOperation(StorageID: Text[24]; var TempStorageOperationType: Record "NPR Storage Operation Type" temporary; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        DropBoxOverview: Record "NPR DropBox Overview";
    begin
    ...
    local procedure HandleAzureStorageOperation(StorageID: Text[24]; var TempStorageOperationType: Record "NPR Storage Operation Type" temporary; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
    ...
    local procedure HandleFTPOperation(StorageID: Text[24]; var TempStorageOperationType: Record "NPR Storage Operation Type" temporary; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
    ...
    procedure DropBoxUpdateRefresh(AccountCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        DropboxAPIMgt: Codeunit "NPR Dropbox API Mgt.";
        Dialog: Dialog;
        Refresh: Boolean;
    ...
    procedure DropBoxUpload(AccountCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        DropBoxOverview: Record "NPR DropBox Overview";
        TempDropBoxOverview: Record "NPR DropBox Overview" temporary;
        DropBoxAPISetup: Record "NPR DropBox API Setup";
        TempBlob: Codeunit "Temp Blob";
        File: Record File;
        ServerOverview: Page "NPR Server Overview";
    ...
    begin
        ...
        if DirectoryName = '' then begin
            ...
            if not (PAGE.RunModal(PAGE::"NPR DropBox Dir. Select", TempDropBoxOverview) = ACTION::LookupOK) then
                exit;
    ...
    procedure DropBoxDownload(AccountCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        DropBoxOverview: Record "NPR DropBox Overview";
        TempBlob: Codeunit "Temp Blob";
        DropBoxAPISetup: Record "NPR DropBox API Setup";
    ...
    procedure DropBoxDelete(AccountCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        DropBoxOverview: Record "NPR DropBox Overview";
        DropboxAPIMgt: Codeunit "NPR Dropbox API Mgt.";
        FileManagement: Codeunit "File Management";
    ...
    procedure DropBoxOverviewRun(AccountCode: Text; var DropBoxOverview: Record "NPR DropBox Overview"): Boolean
    begin
        DropBoxOverview.SetRange("Account Code", AccountCode);

        exit(PAGE.RunModal(PAGE::"NPR DropBox Overview", DropBoxOverview) = ACTION::LookupOK);
    end;

    procedure AzureStorageUpdateRefresh(AccountName: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        AzureStoageAPIMgt: Codeunit "NPR Azure Storage API Mgt.";
        Refresh: Boolean;
    ...
    procedure AzureStorageUpload(AccountCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        AzureStorageAPISetup: Record "NPR Azure Storage API Setup";
        AzureStorageOverview: Record "NPR Azure Storage Overview";
        TempAzureStorageOverview: Record "NPR Azure Storage Overview" temporary;
        TempBlob: Codeunit "Temp Blob";
        File: Record File;
        ServerOverview: Page "NPR Server Overview";
        FileManagement: Codeunit "File Management";
    ...
    begin
        ...
        if (DirectoryName = '') or (ContainerName = '') then begin
            ...
            if not (PAGE.RunModal(PAGE::"NPR Azure Storage Dir. Select", TempAzureStorageOverview) = ACTION::LookupOK) then
                exit;
    ...
    procedure AzureStorageDownload(AccountCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        AzureStorageOverview: Record "NPR Azure Storage Overview";
        TempBlob: Codeunit "Temp Blob";
        AzureStorageAPISetup: Record "NPR Azure Storage API Setup";
    ...
    procedure AzureStorageDelete(AccountCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        AzureStorageOverview: Record "NPR Azure Storage Overview";
        AzureStoageAPIMgt: Codeunit "NPR Azure Storage API Mgt.";
        FileManagement: Codeunit "File Management";
    ...
    procedure AzureStorageOverviewRun(AccountName: Text; var AzureStorageOverview: Record "NPR Azure Storage Overview"): Boolean
    begin
        AzureStorageOverview.SetRange("Account name", AccountName);

        exit(PAGE.RunModal(PAGE::"NPR Azure Storage Overview", AzureStorageOverview) = ACTION::LookupOK);
    end;

    procedure FTPUpdateRefresh(AccountCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        FTPManagement: Codeunit "NPR FTP Management";
        Dialog: Dialog;
        Refresh: Boolean;
        ...
        Directories: DotNet "NPRNetXmlDocument";
    begin
    ...
    procedure FTPUpload(HostCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        TempBlob: Codeunit "Temp Blob";
        FTPSetup: Record "NPR FTP Setup";
        FTPOverview: Record "NPR FTP Overview";
        TempFTPOverview: Record "NPR FTP Overview" temporary;
        File: Record File;
        ServerOverview: Page "NPR Server Overview";
        FTPManagement: Codeunit "NPR FTP Management";
        FileManagement: Codeunit "File Management";
    ...
    begin
        ...
        if DirectoryName = '' then begin
            ...
            if not (PAGE.RunModal(PAGE::"NPR FTP Dir. Select", TempFTPOverview) = ACTION::LookupOK) then
                exit;
    ...
    procedure FTPDownload(HostCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        TempBlob: Codeunit "Temp Blob";
        FTPSetup: Record "NPR FTP Setup";
        FTPOverview: Record "NPR FTP Overview";
    ...
    procedure FTPDelete(HostCode: Text; var TempStorageOperationParameter: Record "NPR Storage Operation Param." temporary)
    var
        FTPOverview: Record "NPR FTP Overview";
        FTPManagement: Codeunit "NPR FTP Management";
        FileManagement: Codeunit "File Management";
    ...
    procedure FTPOverviewRun(HostCode: Text; var FTPOverview: Record "NPR FTP Overview"): Boolean
    begin
        FTPOverview.SetRange("Host Code", HostCode);

        exit(PAGE.RunModal(PAGE::"NPR FTP Overview", FTPOverview) = ACTION::LookupOK);
    end;
    ...
    var
        ...
        IncDocImportAttach: Codeunit "Import Attachment - Inc. Doc.";
        FileManagement: Codeunit "File Management";
        RecRef: RecordRef;
    begin
        ...
        IncDocImportAttach.ImportAttachment(IncomingDocumentAttachment, FileName);
    end;
}