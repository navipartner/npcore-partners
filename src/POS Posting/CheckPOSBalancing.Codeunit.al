codeunit 6014663 "NPR Check POS Balancing"
{
    ...
    local procedure CheckBalancing(SalePOS: Record "NPR Sale POS"; IncludeTicketNo: Boolean)
    var
    ...
    local procedure CheckRegisterStatus(SalePOS: Record "NPR Sale POS")
    var
        Register: Record "NPR Register";
        AuditRoll: Record "NPR Audit Roll";
    begin
    ...
    // TODO: CTRLUPGRADE - References a removed event publisher - INVESTIGATE
    /*
    ...
    */
    ...
    local procedure OnAfterValidateSalesPersonOnSalePOSCheckBalancing(var Rec: Record "NPR Sale POS"; var xRec: Record "NPR Sale POS"; CurrFieldNo: Integer)
    begin
