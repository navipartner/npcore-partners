codeunit 6014422 "NPR Environment Mgt."
{
    ...
    local procedure OnAfterEnvironmentTypeChange(var xRecTmp: Record "NPR NP Retail Setup" temporary; var Rec: Record "NPR NP Retail Setup")
    begin
    end;
    ...
    var
        ...
        NPRetailSetupPage: Page "NPR NP Retail Setup";
        Iterations: Integer;
    begin
    ...
    local procedure CheckIfEmpty(var NPRetailSetup: Record "NPR NP Retail Setup"; var ActiveSession: Record "Active Session"): Boolean
    var
        RecFound: Boolean;
        FirstTime: Boolean;
    begin
    ...
    local procedure HandleEnvironmentChange(var NPRetailSetup: Record "NPR NP Retail Setup"; var ActiveSession: Record "Active Session")
    var
        Type: Integer;
        NPRetailSetupPage: Page "NPR NP Retail Setup";
