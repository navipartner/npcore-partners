codeunit 6060133 "NPR Record Field Mgt."
{
        ...
        if StrPos(Ref, ',') > 0 then begin
            ...
            if RecordFieldSetup.Get(TableNo) then begin
                case GlobalFieldNo of
                    ...
                    20:
                        exit(RecordFieldSetup."Text Field 1 Caption");
                    21:
                        exit(RecordFieldSetup."Text Field 2 Caption");
                    30:
                        exit(RecordFieldSetup."Decimal Field 1 Caption");
                    31:
                        exit(RecordFieldSetup."Decimal Field 2 Caption");
                    40:
                        exit(RecordFieldSetup."Code Field 1 Caption");
                    41:
                        exit(RecordFieldSetup."Code Field 2 Caption");
                end;
            end;
        end;
    end;
    ...
    begin
        ...
        case FieldNo of
            ...
            40:
                LookupTableNo := RecordFieldSetup."Code Field 1 Table No.";
            41:
                LookupTableNo := RecordFieldSetup."Code Field 2 Table No.";
        end;
