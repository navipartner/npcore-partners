codeunit 6151574 "NPR AF API - Notification Hub"
{
    ...
    procedure SendPushNotification(var AFArgumentsNotificationHub: Record "NPR AF Arguments - Notific.Hub" temporary): Boolean
    var
    ...
    local procedure BuildRequest(var AFArgumentsNotificationHub: Record "NPR AF Arguments - Notific.Hub"): Boolean
    var
    ...
    var
        AFArgumentsNotificationHub: Record "NPR AF Arguments - Notific.Hub";
        AFAPINotificationHub: Codeunit "NPR AF API - Notification Hub";
        AFSetup: Record "NPR AF Setup";
    begin
        if Message = '' then
