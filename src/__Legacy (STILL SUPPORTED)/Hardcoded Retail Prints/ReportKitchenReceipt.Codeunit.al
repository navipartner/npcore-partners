codeunit 6014575 "NPR Report: Kitchen Receipt"
{
    ...
    var
        ...
        AuditRollComments: Record "NPR Audit Roll";
        tmpAuditRollSaleInclComments: Record "NPR Audit Roll" temporary;
        Item: Record Item;
...
until AuditRoll.Next = 0;
    ...
    local procedure BuildAuditRollTmpBuffer(var AuditRollSale: Record "NPR Audit Roll"; var AuditRollComments: Record "NPR Audit Roll"; var tmpAuditRollBufferOut: Record "NPR Audit Roll" temporary)
    begin
        //-NPR5.23 [238800]
        ...
        if AuditRollComments.FindSet then
            repeat
                tmpAuditRollBufferOut.Init;
