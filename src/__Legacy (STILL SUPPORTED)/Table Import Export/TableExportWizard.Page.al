page 6014456 "NPR Table Export Wizard"
{
    ...
    // NPR5.54/LS  /20200331  CASE 376993 Excluded some Transaction Tables for Master setup
    ...
    layout
    {
        area(content)
        {
            ...
            {
                ShowCaption = false;
                part("Fields"; "NPR Table Exp. Wizard Fields")
                {
                    Caption = 'Fields';
                    SubPageLink = TableNo = FIELD("Object ID");
                }
                part(TableFilters; "NPR Exp. Wizard Filters")
                {
...
until AllObj.Next = 0;
    ...
    begin
        ...
        AddTable(DATABASE::"NPR Retail Setup");
        AddTable(DATABASE::"NPR Register");
        AddTable(DATABASE::"NPR Payment Type POS");
        AddTable(DATABASE::"NPR Report Selection Retail");
        AddTable(DATABASE::"NPR Item Group");
        AddTable(DATABASE::"NPR Audit Roll Posting");
        AddTable(DATABASE::"NPR Retail Document Header");
        AddTable(DATABASE::"NPR Retail Document Lines");
        AddTable(DATABASE::"NPR Payment Type - Prefix");
        AddTable(DATABASE::"NPR E-mail Log");
        AddTable(DATABASE::"NPR E-mail Template Header");
        AddTable(DATABASE::"NPR E-mail Templ. Line");
        AddTable(DATABASE::"NPR I-Comm");
        AddTable(DATABASE::"NPR Retail Contr. Setup");
        //-NPR5.23
        ...
        //-NPR5.25
        AddTable(DATABASE::"NPR Object Output Selection");
        AddTable(DATABASE::"NPR RP Template Header");
        AddTable(DATABASE::"NPR RP Template Line");
        AddTable(DATABASE::"NPR RP Data Items");
        AddTable(DATABASE::"NPR RP Data Item Links");
        //+NPR5.25
        //-NPR5.25
        AddTable(DATABASE::"NPR Pepper EFT Trx Type");
        AddTable(DATABASE::"NPR Pepper EFT Result Code");
        AddTable(DATABASE::"NPR Pepper Config.");
        AddTable(DATABASE::"NPR Pepper Instance");
        AddTable(DATABASE::"NPR Pepper Terminal");
        AddTable(DATABASE::"NPR Pepper Terminal Type");
        AddTable(DATABASE::"NPR Pepper Version");
        AddTable(DATABASE::"NPR EFT Transaction Request");
        AddTable(DATABASE::"NPR EFT Transact. Req. Comment");
        AddTable(DATABASE::"NPR Pepper Card Type");
        AddTable(DATABASE::"NPR Pepper Card Type Fee");
        AddTable(DATABASE::"NPR Pepper Card Type Group");
        //+NPR5.25
    end;
        ...
        case AllTransferCategory of
            ...
            AllTransferCategory::"StdRetail Master":
                AllObj.SetRange("Object ID", 1, 6189999);        // Std and Retail Master and Setup tables
                                                                 //-NPR5.51 [319037]
            AllTransferCategory::TicketingSetupMaster:
                AllObj.SetFilter("Object ID", '%1|%2|%3|%4|%5', 6060118, 6060119, 6060120, 6060121, 6059784);        // Ticketing Master and Setup Tables
            AllTransferCategory::TicketingTransactional:
                AllObj.SetFilter("Object ID", '%1|%2|%3|%4|%5|%6|%7', 6060111, 6060113, 6060110, 6059785, 6059786, 6059787, 6059788);  // Ticketing Transaction Tables
            AllTransferCategory::MembershipMaster:
                AllObj.SetFilter("Object ID", '%1|%2|%3|%4|%5|%6|%7', 6060124, 6060125, 6060140, 6060141, 6060142, 6060132, 6060136);  // Membership Master and Setup Tables
                                                                                                                                       //+NPR5.51 [319037]
        end;
        //+NPR5.40 [309303]
                    ...
                    case AllTransferCategory of
                        ...
                        AllTransferCategory::"All Master":         // All Master and Setup Tables except Transactions
                            ...
                            if AllObj."Object ID" in [17, 21, 25, 32 .. 62, 81, 83 .. 91, 95 .. 97, 99 .. 203, 205 .. 224, 240 .. 241, 244 .. 249, 253 .. 269
                              ...
                              , 5802 .. 5811, 5815 .. 6084, 6506 .. 6550, 6650 .. 6670, 7030 .. 6009999
                                ...
                                , 6014449 .. 6014460, 6014473 .. 6014509, 6014552 .. 6014559, 6014561 .. 6014564, 6014628 .. 6014642
                                , 6016806, 6016818 .. 6016819, 6016821 .. 6016822, 6016828, 6016830, 6016868 .. 6016869
                                 , 6059768, 6059767
                                  //+NPR5.54 [376993]
                                  //-NPR5.48 [340086]
                                  ...
                                  , 6059970 .. 6060166
                                  , 6085591 .. 6085594, 6085780, 6086001 .. 6086002, 6086005
                                  , 6150620 .. 6150699, 6150723 .. 6150725, 6150901 .. 6184489, 6184495 .. 6184496, 6184501 .. 6184502, 6184510 .. 6189999] = false then
                                //+NPR5.54 [376993]
                                //+NPR5.48 [340086]
                                //+NPR5.41 [311855]
                                AddTable(AllObj."Object ID");
                        ...
                        AllTransferCategory::"Retail Master":
                            begin      // All Retail Master and Setup Tables except Transactions
                                ...
                                if AllObj."Object ID" in [6014403, 6014405 .. 6014409, 6014411 .. 6014416, 6014418 .. 6014426, 6014429 .. 6014432, 6014434 .. 6014436, 6014439 .. 6014444, 6014445 .. 6014446
                                    , 6014449 .. 6014460, 6014473 .. 6014477, 6014481 .. 6014509, 6014552 .. 6014559, 6014561 .. 6014564, 6014628 .. 6014642
                                    , 6016806, 6016818 .. 6016819, 6016821 .. 6016822, 6016828, 6016830, 6016868 .. 6016869, 6085591 .. 6085594, 6085780, 6086001 .. 6086002, 6086005
                                    , 6059768
                                    , 6059770 .. 6059772, 6059781 .. 6059782, 6059785 .. 6059893, 6059898 .. 6059899, 6059903 .. 6059934, 6059940 .. 6059941, 6059946, 6059951 .. 6059968
                                    , 6059970 .. 6060039, 6060042 .. 6060051, 6060054, 6060056 .. 6060166, 6150620 .. 6150639, 6150643 .. 6150699, 6150723 .. 6150725, 6150901 .. 6151010
                                    , 6151013 .. 6151099, 6151103, 6151108 .. 6151124, 6151131 .. 6151589, 6151591 .. 6151598, 6151604 .. 6184489, 6184495 .. 6184496, 6184501 .. 6184502, 6184510 .. 6189999] = false then
    ...
    var
        SavedExportWizard: Record "NPR Saved Export Wizard";
        TempField: Record "Field" temporary;
        TempTableFilter: Record "Table Filter" temporary;
    begin
        //-NPR5.23
