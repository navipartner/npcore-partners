codeunit 6014589 "NPR GCP Mgt."
{
    ...
    procedure PrintFile(PrinterID: Text; var Content: DotNet NPRNetMemoryStream; ContentType: Text; TicketCJT: Text; Title: Text; Tag: Text) Success: Boolean
    var
        AccessTokenValue: Text;
        RefreshTokenValue: Text;
        API: Codeunit "NPR GCP API";
        Token: Record "NPR OAuth Token";
    begin
        Commit;
    ...
    procedure SetTicketOptions(var GCPSetup: Record "NPR GCP Setup")
    var
        JObject: DotNet JObject;
        GCPTicketOptions: Page "NPR GCP Ticket Options";
        OutStream: OutStream;
        TicketJson: Text;
        InStream: InStream;
    begin
