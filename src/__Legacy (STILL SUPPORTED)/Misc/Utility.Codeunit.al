codeunit 6014424 "NPR Utility"
{
    ...
    procedure GetTicketText(var RetailComment: Record "NPR Retail Comment" temporary; Register: Record "NPR Register")
    var
    ...
    begin
        ...
        if (Date2DMY(Date, 3) mod 4 = 0) then begin
            if not (Date2DMY(Date, 3) mod 100 = 0) then
                ...
                if (Date2DMY(Date, 3) mod 400 = 0) then
                    Months[2] := 29;
        end;
        Months[3] := 31;
        Months[4] := 30;
