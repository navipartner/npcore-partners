codeunit 6014525 "NPR DotNet File Library"
{
    SingleInstance = true;

    trigger OnRun()
    var
        This: Codeunit "NPR DotNet File Library";
        Temp: Text;
    begin
        This.WRITEMODE(true);
        This.TEXTMODE(true);
    ...
    var
        [RunOnClient]
        FileWrap: DotNet NPRNetFileWrapper;
    ...
    var
        [RunOnClient]
        SeekOriginDotNet: DotNet NPRNetSeekOrigin;
    begin
        TestInit;
