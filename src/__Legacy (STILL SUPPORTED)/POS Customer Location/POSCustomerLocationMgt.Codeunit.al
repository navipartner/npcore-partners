codeunit 6014440 "NPR POS Customer Location Mgt."
{
    ...
    var
        ...
        POSCustLoc: Record "NPR POS Customer Location";

    procedure GetSaleFromLoc(LocNumber: Code[20]; var SalePOS: Record "NPR Sale POS"; var SalePOSLoc: Record "NPR Sale POS"): Boolean
    var
    ...
    procedure SaveSaleToLoc(LocNumber: Code[20]; var SalePOS: Record "NPR Sale POS"): Boolean
    var
        ErrorMsg: Text;
        NewReceipt: Boolean;
        POSCustLoc: Record "NPR POS Customer Location";
    ...
    procedure Print(PrintEventIn: Integer; var SalePOSIn: Record "NPR Sale POS"; LocNumber: Code[20])
    var
    ...
    var
        TSCustLocations: Page "NPR Touch Screen - Cust Loc.";
        POSCustLocation: Record "NPR POS Customer Location";
    begin
    ...
    procedure StampSaleAndGetFromLoc(LocNumber: Code[20]; var SalePOS: Record "NPR Sale POS"; var SalePOSLoc: Record "NPR Sale POS"): Boolean
    begin
        //-NPR5.31 [264112]
        if LocNumber = '' then
            LocNumber := List(true, true);
    ...
    local procedure EmptySale(var SalePOS: Record "NPR Sale POS"): Boolean
    var
        SaleLinePOS: Record "NPR Sale Line POS";
    begin
    ...
    local procedure SaveSale(LocNumber: Code[20]; var SalePOS: Record "NPR Sale POS"; NewReceipt: Boolean; DeleteCurrentSaleHeader: Boolean)
    var
        SalePOSLoc: Record "NPR Sale POS";
        SaleLinePOSLoc: Record "NPR Sale Line POS";
        SaleLinePOS: Record "NPR Sale Line POS";
        LineNo: Integer;
        RetailFormCode: Codeunit "NPR Retail Form Code";
    begin
