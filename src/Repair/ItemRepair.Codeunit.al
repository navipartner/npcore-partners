codeunit 6059981 "NPR Item Repair"
{
    ...
    var
        ItemRepair: Record "NPR Item Repair";
    ...
    begin
        with ItemRepair do begin
            ...
            "Variety 1 (Item)" := Item."NPR Variety 1";
            "Variety 1 Table (Item)" := Item."NPR Variety 1 Table";
            "Variety 2 (Item)" := Item."NPR Variety 2";
            "Variety 2 Table (Item)" := Item."NPR Variety 2 Table";
            "Variety 3 (Item)" := Item."NPR Variety 3";
            "Variety 3 Table (Item)" := Item."NPR Variety 3 Table";
            "Variety 4 (Item)" := Item."NPR Variety 4";
            "Variety 4 Table (Item)" := Item."NPR Variety 4 Table";
            "Cross Variety No." := Item."NPR Cross Variety No.";
            "Variety Group" := Item."NPR Variety Group";
            "Variety 1 (Var)" := ItemVar."NPR Variety 1";
            "Variety 1 Table (Var)" := ItemVar."NPR Variety 1 Table";
            "Variety 1 Value (Var)" := ItemVar."NPR Variety 1 Value";
            "Variety 2 (Var)" := ItemVar."NPR Variety 2";
            "Variety 2 Table (Var)" := ItemVar."NPR Variety 2 Table";
            "Variety 2 Value (Var)" := ItemVar."NPR Variety 2 Value";
            "Variety 3 (Var)" := ItemVar."NPR Variety 3";
            "Variety 3 Table (Var)" := ItemVar."NPR Variety 3 Table";
            "Variety 3 Value (Var)" := ItemVar."NPR Variety 3 Value";
            "Variety 4 (Var)" := ItemVar."NPR Variety 4";
            "Variety 4 Table (Var)" := ItemVar."NPR Variety 4 Table";
            "Variety 4 Value (Var)" := ItemVar."NPR Variety 4 Value";
            ...
            "Blocked (Var)" := ItemVar."NPR Blocked";
    ...
    procedure TestSelectedRepairEntries(var ItemRepair: Record "NPR Item Repair")
    begin
        LineCount := 0;
        Dia.Open('Analysing Entries @1@@@@@@@@@');
        NoOfRecords := ItemRepair.Count;
    ...
    local procedure TestRepairEntry(ItemRepair: Record "NPR Item Repair")
    var
        Item: Record Item;
        ItemVar: Record "Item Variant";
        ItemExists: Boolean;
    ...
    begin
        ...
        if ItemRepair."Variety 1 Used" then begin
            InsertTestEntry(ItemRepair, 10, Item."NPR Variety 1" = ItemVar."NPR Variety 1", 'Variety 1 match');
            InsertTestEntry(ItemRepair, 11, Item."NPR Variety 1 Table" = ItemVar."NPR Variety 1 Table", 'Variety 1 table match');
            InsertTestEntry(ItemRepair, 15, VarietyTable.Get(Item."NPR Variety 1", Item."NPR Variety 1 Table"), 'Variety 1 table exists (Item)');
            InsertTestEntry(ItemRepair, 16, VarietyTable.Get(ItemVar."NPR Variety 1", ItemVar."NPR Variety 1 Table"), 'Variety 1 table exists (Variant)');
            InsertTestEntry(ItemRepair, 17, VarietyValue.Get(ItemVar."NPR Variety 1", ItemVar."NPR Variety 1 Table", ItemVar."NPR Variety 1 Value"), 'Variety 1 Value exists (Variant)');
        end;

        if ItemRepair."Variety 2 Used" then begin
            InsertTestEntry(ItemRepair, 20, Item."NPR Variety 2" = ItemVar."NPR Variety 2", 'Variety 2 match');
            InsertTestEntry(ItemRepair, 21, Item."NPR Variety 2 Table" = ItemVar."NPR Variety 2 Table", 'Variety 2 table match');
            InsertTestEntry(ItemRepair, 25, VarietyTable.Get(Item."NPR Variety 2", Item."NPR Variety 2 Table"), 'Variety 2 table exists (Item)');
            InsertTestEntry(ItemRepair, 26, VarietyTable.Get(ItemVar."NPR Variety 2", ItemVar."NPR Variety 2 Table"), 'Variety 2 table exists (Variant)');
            InsertTestEntry(ItemRepair, 27, VarietyValue.Get(ItemVar."NPR Variety 2", ItemVar."NPR Variety 2 Table", ItemVar."NPR Variety 2 Value"), 'Variety 2 Value exists (Variant)');
        end;

        if ItemRepair."Variety 3 Used" then begin
            InsertTestEntry(ItemRepair, 30, Item."NPR Variety 3" = ItemVar."NPR Variety 3", 'Variety 3 match');
            InsertTestEntry(ItemRepair, 31, Item."NPR Variety 3 Table" = ItemVar."NPR Variety 3 Table", 'Variety 3 table match');
            InsertTestEntry(ItemRepair, 35, VarietyTable.Get(Item."NPR Variety 3", Item."NPR Variety 3 Table"), 'Variety 3 table exists (Item)');
            InsertTestEntry(ItemRepair, 36, VarietyTable.Get(ItemVar."NPR Variety 3", ItemVar."NPR Variety 3 Table"), 'Variety 3 table exists (Variant)');
            InsertTestEntry(ItemRepair, 37, VarietyValue.Get(ItemVar."NPR Variety 3", ItemVar."NPR Variety 3 Table", ItemVar."NPR Variety 3 Value"), 'Variety 3 Value exists (Variant)');
        end;

        if ItemRepair."Variety 4 Used" then begin
            InsertTestEntry(ItemRepair, 40, Item."NPR Variety 4" = ItemVar."NPR Variety 4", 'Variety 4 match');
            InsertTestEntry(ItemRepair, 41, Item."NPR Variety 4 Table" = ItemVar."NPR Variety 4 Table", 'Variety 4 table match');
            InsertTestEntry(ItemRepair, 45, VarietyTable.Get(Item."NPR Variety 4", Item."NPR Variety 4 Table"), 'Variety 4 table exists (Item)');
            InsertTestEntry(ItemRepair, 46, VarietyTable.Get(ItemVar."NPR Variety 4", ItemVar."NPR Variety 4 Table"), 'Variety 4 table exists (Variant)');
            InsertTestEntry(ItemRepair, 47, VarietyValue.Get(ItemVar."NPR Variety 4", ItemVar."NPR Variety 4 Table", ItemVar."NPR Variety 4 Value"), 'Variety 4 Value exists (Variant)');
        end;
    end;

    local procedure InsertTestEntry(var ItemRepair: Record "NPR Item Repair"; TestNo: Integer; IsSuccess: Boolean; Desc: Text[50])
    var
        ItemRepairTest: Record "NPR Item Repair Tests";
    begin
    ...
    var
        ItemRepairTest: Record "NPR Item Repair Tests";
        ItemRepair: Record "NPR Item Repair";
        ItemRepairAction: Record "NPR Item Repair Action";
    begin
    ...
    procedure SuggestSelectedActions(var ItemRepair: Record "NPR Item Repair")
    begin
        LineCount := 0;
        Dia.Open('Analysing Entries @1@@@@@@@@@');
        NoOfRecords := ItemRepair.Count;
    ...
    local procedure SuggestAction(ItemRepair: Record "NPR Item Repair")
    var
        ItemRepairTest: Record "NPR Item Repair Tests";
        ...
        VarietyTable: Record "NPR Variety Table";
        VarietyValue: Record "NPR Variety Value";
        ItemRepairActionItem: Record "NPR Item Repair Action";
        ItemRepairActionVariant: Record "NPR Item Repair Action";
        BreakLoop: Boolean;
    begin
        ...
        if ItemRepairTest.FindSet then
            repeat
                BreakLoop := false;
                case ItemRepairTest."Test No." of
                    ...
                    10 .. 19: //variety 1 is not ok
                        begin
                            ...
                            if (ItemVar."NPR Variety 1" <> '') and (ItemVar."NPR Variety 1 Table" <> '') then begin
                                if not VarietyTable.Get(ItemVar."NPR Variety 1", ItemVar."NPR Variety 1 Table") then
                                    Clear(VarietyTable);
                                if not VarietyValue.Get(ItemVar."NPR Variety 1", ItemVar."NPR Variety 1 Table", ItemVar."NPR Variety 1 Value") then
                                    Clear(VarietyValue);
                    ...
                    20 .. 29: //variety 2 is not ok
                        begin
                            ...
                            ItemVar.Get(ItemRepair."Item No.", ItemRepair."Variant Code");
                            //order is: push from variant to item, if this is a valid combination. else push it the other way
                            if (ItemVar."NPR Variety 2" <> '') and (ItemVar."NPR Variety 2 Table" <> '') then begin
                                if not VarietyTable.Get(ItemVar."NPR Variety 2", ItemVar."NPR Variety 2 Table") then
                                    Clear(VarietyTable);
                                if not VarietyValue.Get(ItemVar."NPR Variety 2", ItemVar."NPR Variety 2 Table", ItemVar."NPR Variety 2 Value") then
                                    Clear(VarietyValue);
                                if (VarietyTable.Code <> '') and (VarietyValue.Value <> '') then begin //its a valid combination
    ...
    procedure SetAction(var ItemRepairAction: Record "NPR Item Repair Action"; ItemNo: Code[20]; VarietyNo: Integer; "Action": Integer; NewVariety: Code[20]; NewVarietyTable: Code[20])
    begin
    ...
    procedure ManualSetActionSelected(var ItemRepair: Record "NPR Item Repair"; ActionType: Option Item,Variant; ActionVariant: Integer)
    begin
        LineCount := 0;
    ...
    procedure ManualSetAction(ItemRepair: Record "NPR Item Repair"; ActionType: Option Item,Variant; ActionVariant: Integer)
    var
        ItemRepairAction: Record "NPR Item Repair Action";
    begin
    ...
    procedure SetNewVarietyValues(var ItemRepair: Record "NPR Item Repair")
    begin
        LineCount := 0;
    ...
    procedure SetNewVarietyValue(ItemRepair: Record "NPR Item Repair")
    var
        ItemRepairAction: Record "NPR Item Repair Action";
        DoAction: Boolean;
    begin
    ...
    procedure DoAction(ItemRepairAction: Record "NPR Item Repair Action")
    var
        ItemVar: Record "Item Variant";
    ...
    begin
        ...
        if ItemVar.FindSet then
            repeat
                ...
                if ItemRepairAction."Variety 1 Action" = ItemRepairAction."Variety 1 Action"::UseItemSetup then begin
                    if ItemVar."NPR Variety 1" <> ItemRepairAction."New Variety 1" then begin
                        InsertLogEntry(ItemVar."Item No.", ItemVar.Code, 'Item Variant Updated (Variety 1)', ItemVar."NPR Variety 1", ItemRepairAction."New Variety 1");
                        ItemRepairAction.TestField("New Variety 1");
                        ItemVar."NPR Variety 1" := ItemRepairAction."New Variety 1";
                        DoModify := true;
                    end;

                    if ItemVar."NPR Variety 1 Table" <> ItemRepairAction."New Variety 1 Table" then begin
                        InsertLogEntry(ItemVar."Item No.", ItemVar.Code, 'Item Variant Updated (Variety 1 Table)', ItemVar."NPR Variety 1 Table", ItemRepairAction."New Variety 1 Table");
                        ItemRepairAction.TestField("New Variety 1 Table");
                        ItemVar."NPR Variety 1 Table" := ItemRepairAction."New Variety 1 Table";
                        DoModify := true;
                    end;

                    if (ItemVar."NPR Variety 1 Value" <> ItemRepairAction."New Variety 1 Value") then begin
                        InsertLogEntry(ItemVar."Item No.", ItemVar.Code, 'Item Variant Updated (Variety 1 Value)', ItemVar."NPR Variety 1 Value", ItemRepairAction."New Variety 1 Value");
                        ItemRepairAction.TestField("New Variety 1 Value");
                        ItemVar."NPR Variety 1 Value" := ItemRepairAction."New Variety 1 Value";
                        DoModify := true;
                    end;
                ...
                if ItemRepairAction."Variety 2 Action" = ItemRepairAction."Variety 2 Action"::UseItemSetup then begin
                    if ItemVar."NPR Variety 2" <> ItemRepairAction."New Variety 2" then begin
                        InsertLogEntry(ItemVar."Item No.", ItemVar.Code, 'Item Variant Updated (Variety 2)', ItemVar."NPR Variety 2", ItemRepairAction."New Variety 2");
                        ItemRepairAction.TestField("New Variety 2");
                        ItemVar."NPR Variety 2" := ItemRepairAction."New Variety 2";
                        DoModify := true;
                    end;

                    if ItemVar."NPR Variety 2 Table" <> ItemRepairAction."New Variety 2 Table" then begin
                        InsertLogEntry(ItemVar."Item No.", ItemVar.Code, 'Item Variant Updated (Variety 2 Table)', ItemVar."NPR Variety 2 Table", ItemRepairAction."New Variety 2 Table");
                        ItemRepairAction.TestField("New Variety 2 Table");
                        ItemVar."NPR Variety 2 Table" := ItemRepairAction."New Variety 2 Table";
                        DoModify := true;
                    end;

                    if (ItemVar."NPR Variety 2 Value" <> ItemRepairAction."New Variety 2 Value") then begin
                        InsertLogEntry(ItemVar."Item No.", ItemVar.Code, 'Item Variant Updated (Variety 2 Value)', ItemVar."NPR Variety 2 Value", ItemRepairAction."New Variety 2 Value");
                        ItemRepairAction.TestField("New Variety 2 Value");
                        ItemVar."NPR Variety 2 Value" := ItemRepairAction."New Variety 2 Value";
                        DoModify := true;
                    end;
                ...
                if DoModify then begin
                    ...
                    if VarietyCloneData.GetFromVariety(ItemVarTest, ItemVar."Item No.", ItemVar."NPR Variety 1 Value", ItemVar."NPR Variety 2 Value", ItemVar."NPR Variety 3 Value", ItemVar."NPR Variety 4 Value") then
                        //+NPR5.29 [263917]
        ...
        if ItemRepairAction."Variety 1 Action" = ItemRepairAction."Variety 1 Action"::UseVariantSetup then begin
            if ItemRepairAction."New Variety 1" <> Item."NPR Variety 1" then begin
                InsertLogEntry(Item."No.", '', 'Item Updated (Variety 1)', Item."NPR Variety 1", ItemRepairAction."New Variety 1");
                ItemRepairAction.TestField("New Variety 1");
                Item."NPR Variety 1" := ItemRepairAction."New Variety 1";
                DoModify := true;
            end;

            if ItemRepairAction."New Variety 1 Table" <> Item."NPR Variety 1 Table" then begin
                InsertLogEntry(Item."No.", '', 'Item Variant Updated (Variety 1 Table)', Item."NPR Variety 1 Table", ItemRepairAction."New Variety 1 Table");
                ItemRepairAction.TestField("New Variety 1 Table");
                Item."NPR Variety 1 Table" := ItemRepairAction."New Variety 1 Table";
                DoModify := true;
            end;
        end;

        if ItemRepairAction."Variety 2 Action" = ItemRepairAction."Variety 2 Action"::UseVariantSetup then begin
            if ItemRepairAction."New Variety 2" <> Item."NPR Variety 2" then begin
                InsertLogEntry(Item."No.", '', 'Item Updated (Variety 2)', Item."NPR Variety 2", ItemRepairAction."New Variety 2");
                ItemRepairAction.TestField("New Variety 2");
                Item."NPR Variety 2" := ItemRepairAction."New Variety 2";
                DoModify := true;
            end;

            if ItemRepairAction."New Variety 2 Table" <> Item."NPR Variety 2 Table" then begin
                InsertLogEntry(Item."No.", '', 'Item Variant Updated (Variety 2 Table)', Item."NPR Variety 2 Table", ItemRepairAction."New Variety 2 Table");
                ItemRepairAction.TestField("New Variety 2 Table");
                Item."NPR Variety 2 Table" := ItemRepairAction."New Variety 2 Table";
                DoModify := true;
            end;
        end;
    ...
    procedure DoSelectedActions(var ItemRepairAction: Record "NPR Item Repair Action")
    begin
        LineCount := 0;
        Dia.Open('Executing Actions @1@@@@@@@@@');
        NoOfRecords := ItemRepairAction.Count;
        if ItemRepairAction.FindFirst then
            repeat
                LineCount += 1;
                Dia.Update(1, Round(LineCount / NoOfRecords * 10000, 1));
    ...
    var
        ItemRepairLog: Record "NPR Item Repair Log";
    begin
        ItemRepairLog.Init;
