table 6151368 "NPR CS Rfid Header"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Count ("NPR CS Rfid Lines" WHERE(Id = FIELD(Id),
        ...
        case "Doc. Type" of
            "Doc. Type"::Ship:
                begin
                    ...
                    PAGE.Run(PAGE::"NPR CS RFID Header Card", CSRfidHeader);
                end;
            "Doc. Type"::Receive:
                begin
                    Clear(CSRfidHeader);
    ...
    var
        CSRfidLines: Record "NPR CS Rfid Lines";
        CSShippingHandlingRfid: Record "NPR CS Transf. Handl. Rfid";
    begin
