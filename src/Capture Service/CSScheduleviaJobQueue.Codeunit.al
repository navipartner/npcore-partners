codeunit 6151347 "NPR CS Schedule via Job Queue"
{
    ...
    trigger OnRun()
    var
        CSCountingschedule: Record "NPR CS Counting schedule";
    begin
        TestData(Rec);
    ...
    local procedure GetData(var JobQueueEntry: Record "Job Queue Entry"; var CSCountingschedule: Record "NPR CS Counting schedule")
    var
        RecRef: RecordRef;
    begin
        with JobQueueEntry do
    ...
    local procedure Process(var CSCountingschedule: Record "NPR CS Counting schedule")
    var
        CSCountingscheduleExecute: Codeunit "NPR CS Count. schedule Execute";
    begin
    ...
    local procedure CleanUp(var CSCountingschedule: Record "NPR CS Counting schedule")
    var
    ...
    local procedure SetJobQueueStatus(var CSCountingschedule: Record "NPR CS Counting schedule"; NewStatus: Option)
    begin
