codeunit 6151355 "NPR CS Post via Job Queue"
{
    ...
    local procedure GetData(var JobQueueEntry: Record "Job Queue Entry"; var CSPostingBuffer: Record "NPR CS Posting Buffer")
    var
        RecRef: RecordRef;
    begin
        with JobQueueEntry do
    ...
    local procedure Process(var CSPostingBuffer: Record "NPR CS Posting Buffer")
    var
    ...
    local procedure CleanUp(var CSPostingBuffer: Record "NPR CS Posting Buffer")
    begin
        SetJobQueueStatus(CSPostingBuffer, CSPostingBuffer."Job Queue Status"::" ");
    end;

    local procedure SetJobQueueStatus(var CSPostingBuffer: Record "NPR CS Posting Buffer"; NewStatus: Option)
    begin
