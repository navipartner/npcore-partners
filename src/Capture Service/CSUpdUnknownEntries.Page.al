page 6151365 "NPR CS Upd. Unknown Entries"
{
        ...
        area(creation)
        {
            action(AssociateLines)
            {
                ...
                var
                    ...
                    CSStockTakesData2: Record "NPR CS Stock-Takes Data";
                    TempCSStockTakesData: Record "NPR CS Stock-Takes Data" temporary;
                    CSRfidData: Record "NPR CS Rfid Data";
                    Item: Record Item;
                    CSHelperFunctions: Codeunit "NPR CS Helper Functions";
                    CSSelectEntries: Page "NPR CS Select Entries";
                begin
                    ...
                    if Item."NPR Has Variants" and (TempCSStockTakesData."Variant Code" = '') then
                    ...
                    if CSStockTakesData.FindSet then
                        repeat
                            ...
                            ItemCrossReference."NPR Is Retail Serial No." := true;
