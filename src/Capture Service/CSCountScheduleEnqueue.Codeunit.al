codeunit 6151349 "NPR CS Count.Schedule: Enqueue"
{
    ...
    local procedure EnqueueDoc(var CSCountingschedule: Record "NPR CS Counting schedule")
    var
    ...
    begin
        ...
        with CSCountingschedule do begin
            ...
            JobQueueEntry."Object ID to Run" := CODEUNIT::"NPR CS Schedule via Job Queue";
