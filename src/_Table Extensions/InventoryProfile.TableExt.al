tableextension 6014455 "NPR Inventory Profile" extends "Inventory Profile"
{
    ...
    procedure NPRTransferFromRetailReplnmDemand(var ReplenishmentDemandLine: Record "NPR Retail Repl. Demand Line")
    begin
        //-NPR5.40 [289017]
