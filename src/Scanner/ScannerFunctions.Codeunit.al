codeunit 6014438 "NPR Scanner - Functions"
{
    ...
    var
        ...
        FindesVare: Boolean;
        Dialog1: Dialog;
        AltVare: Record "NPR Alternative No.";
        Placering: Code[10];
    ...
    procedure initRetailJournal(var initRJH: Record "NPR Retail Journal Header")
    begin
        //initLabel
    ...
    procedure initSale(var Eksp: Record "NPR Sale POS")
    begin
        //initEksp
    ...
    procedure initCampaignDiscount(var PeriodeRabat: Record "NPR Period Discount")
    begin
        //initPerioderabat
    ...
    procedure initMixedDiscount(var Miksrabat: Record "NPR Mixed Discount")
    begin
        //initMixRabat
    ...
    var
        ...
        Files: Record File;
        ScannerSetupFields: Record "NPR Scanner: Field Setup";
        ...
        Fname: Text;
        SavePath: Text;
        Fil: Codeunit "NPR DotNet File Library";
    begin
        //TODO: Refactor for webclient
        Error('Not supported in webclient');
                ...
                begin
                    ...
                    case ScannerSetup."File - Name Type" of
                        ScannerSetup."File - Name Type"::GUID:
                            Filename := filenameCreate(0, 0) + '.dat';
                        ScannerSetup."File - Name Type"::DateTime:
                            Filename := filenameCreate(1, 0) + '.dat';
                    ...
                    case ScannerSetup.Port of
                        ScannerSetup.Port::COM1:
                            PortStr := '1';
                        ScannerSetup.Port::COM2:
                            PortStr := '2';
                        else
                            PortStr := '';
                    end;
                                ...
                                if TempBlob.HasValue then begin
                                    ...
                                    while not Data.EOS do begin
                                        case ScannerSetup."File - In Record Sep. Type" of
                                            ...
                                            ScannerSetup."File - In Record Sep. Type"::Char:
                                                Error(t015, Format(ScannerSetup."File - In Record Sep. Type"));
                                        end;
                                    end;
                                end;
                            end else begin
    ...
    procedure GoSend(var RetailJournalLine: Record "NPR Retail Journal Line")
    var
        ScannerSetupFields: Record "NPR Scanner: Field Setup";
        BackupFilename: Text;
        Filename: Text;
                                ...
                                repeat
                                    case ScannerSetupFields.Type of
                                        ...
                                        ScannerSetupFields.Type::ScannerNo:
                                            ;
                                        ScannerSetupFields.Type::SerialNo:
                                            Str := "Retail Journal Line"."Serial No.";
