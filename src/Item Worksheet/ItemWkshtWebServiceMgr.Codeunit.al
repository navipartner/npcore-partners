codeunit 6060049 "NPR Item Wksht. WebService Mgr"
{
        ...
        if LoadXmlDoc(XmlDoc) then begin
            ...
            case FunctionName of
                'CreateItemWorksheetLine':
                    CreateItemWorksheetLines(XmlDoc, "Entry No.", "Document ID");
                else
    ...
    local procedure CreateItemWorksheetLines(XmlDoc: DotNet "NPRNetXmlDocument"; RequestEntryNo: Integer; DocumentID: Text[100])
    var
    ...
    local procedure CreateItemWorksheetLine(XmlElement: DotNet NPRNetXmlElement; Token: Text[100]; DocumentID: Text[100]) Imported: Boolean
    var
    ...
    local procedure ReadItemWorksheetLine(XmlElement: DotNet NPRNetXmlElement; Token: Text[100]; var ItemWorksheetLine: Record "NPR Item Worksheet Line")
    var
    ...
    local procedure ReadWkshLineAttributes(ItemWorksheetLine: Record "NPR Item Worksheet Line"; XmlElement: DotNet NPRNetXmlElement)
    var
        XmlElement2: DotNet NPRNetXmlElement;
        XmlNodeList: DotNet NPRNetXmlNodeList;
        i: Integer;
    ...
    local procedure ReadWkshLineAttribute(ItemWorksheetLine: Record "NPR Item Worksheet Line"; XmlElement: DotNet NPRNetXmlElement)
    var
    ...
    begin
        ...
        NPRAttrManagement.GetAttributeKey(DATABASE::"NPR Item Worksheet Line", ItemWorksheetLine."Worksheet Template Name", ItemWorksheetLine."Line No.", 0, ItemWorksheetLine."Worksheet Name", 0, AttributeKey, false);
        ...
        NPRAttrManagement.GetAttributeKey(DATABASE::"NPR Item Worksheet Line", ItemWorksheetLine."Worksheet Template Name", ItemWorksheetLine."Line No.", 0, ItemWorksheetLine."Worksheet Name", 0, AttributeKey, true);
