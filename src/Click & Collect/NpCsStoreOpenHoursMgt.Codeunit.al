codeunit 6151208 "NPR NpCs Store Open.Hours Mgt."
{
    ...
    local procedure ApplyOpeningHourEntryEveryDay(NpCsOpenHourEntry: Record "NPR NpCs Open. Hour Entry")
    var
        Date: Record Date;
    begin
    ...
    local procedure ApplyOpeningHourEntryDate(NpCsOpenHourEntry: Record "NPR NpCs Open. Hour Entry")
    begin
        if NpCsOpenHourEntry."Entry Date" = 0D then
            exit;
    ...
    local procedure GetPeriodNoFilter(NpCsOpenHourEntry: Record "NPR NpCs Open. Hour Entry") PeriodNoFilter: Text
    begin
