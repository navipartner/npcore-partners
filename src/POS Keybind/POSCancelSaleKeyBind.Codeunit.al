codeunit 6150742 "NPR POS Cancel Sale Key Bind"
{
    ...
    var
        POSView: DotNet NPRNetView0;
        POSViewType: DotNet NPRNetViewType0;
    ...
    local procedure OnKeyPressEsc(POSSession: Codeunit "NPR POS Session"; FrontEnd: Codeunit "NPR POS Front End Management")
    var
        POSView: DotNet NPRNetView0;
        POSViewType: DotNet NPRNetViewType0;
    begin
