...
n$.addModule("UI",
    function () {
        ...
        n$.UI = {
            ...
            images: {
                logo: Microsoft.Dynamics.NAV.GetImageResource("Controls/Transcendence/Images/npretaillogo_med.png"),
                watermark: ""
            }
        };
            ...
            function processViewActivation(view) {
                ...
                if (userGuides.length) {
                    indicator.append($("<img src=\"" +
                        m$.GetImageResource("Controls/Transcendence/Images/lightbulb_" + (available.length ? "on" : "off")) +
                        "\">")
                        .on("click",
                            function () {
                                n$.UserGuide.capability.showWalkthroughs();
...
Release notes 5.40.2054.53 - not yet released
                                ...
                                case "options":
                                    ...
                                    var option = [
                                        ...
                                        $("<div class=\"\lookup\"><img src=\"" +
                                            m$.GetImageResource("Controls/Transcendence/Images/gear") +
                                            "\"></div>").click(function() {
                                            doOptions();
                                        })
                                    ];
                                ...
                                case "lookup":
                                    ...
                                    if (typeof lookup === "function") {
                                        ...
                                        var output = [
                                            lookupInput,
                                            $("<div class=\"\lookup\"><img src=\"" +
                                                m$.GetImageResource("Controls/Transcendence/Images/search") +
                                                "\"></div>").click(function() {
                                                doLookup();
                                            })
                                        ];
    ...
    if (par.action &&
        ...
        setTimeout(function () {
            ...
            var clickable = $("<div class=\"warning\"><img src=\"" +
                Microsoft.Dynamics.NAV.GetImageResource("Controls/Transcendence/Images/icon-" + icon + ".png") +
                "\"></div>");
