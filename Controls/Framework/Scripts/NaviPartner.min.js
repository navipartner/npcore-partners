...
(function() {
    ...
    function finalize(finalizer) {
        try {
            var signal = {
                    ...
                    console.log(
                        "Finalization completed on a finalizer (" + finalizer.finalizerName + ").");
                    finalizer.done = true;
                }
            };
            if (finalizer(signal))
    ...
    function awaitAll() {
        var doneAll = true;
        finalizers.forEach(function(finalizer) {
            doneAll = doneAll && finalizer.done;
        });
        return doneAll;
    };
    ...
    function performFinalization(callback) {
        ...
        finalizers.forEach(function(finalizer) {
            finalize(finalizer);
            skipAwait = skipAwait && finalizer.done;
        });

        if (skipAwait || awaitAll()) {
...
n$.addModule("Capabilities",
        ...
        */
        function() {
            ...
            n$.Capability = function(name, id, description, descriptor) {
                ...
                Object.defineProperty(this, "supported", { value: !!this.external.getCapability(this.id) });
                        ...
                        name,
                        {
                            value: function() {
                                return this.supported
                                    ...
                                    : (reportNotSupported(),
                                        (descriptor.noSupport &&
                                                descriptor.noSupport[name] &&
                                                typeof descriptor.noSupport[name] === "function")
            ...
            n$.Capabilities = {
                register: function(capability) {
                    ...
                    n$.ready.addFinalizer(function(signal) {
                            n$.ExternalObject
                                .getActual()
                                .announceCapability(capability.name, capability.id, capability.description);
                            signal.done(); // TODO: this should all be async, and signal.done() should be done when announceCapability has been processed through a promise
                        },
    ...
    .depend("Debug", "External", "External.Loader", "Localization");﻿;
                ...
                "Enables sharing relevant transactional state from the POS transaction with the host application, and events from host application back to NAV.",
                {
                    methods: {
                        activeSale: function(active) {
                            return this.external.activeSale(active);
                        },
                        documentReady: function(name) {
                            return this.external.documentReady(name);
                        },
                        getFrontEndId: function() {
                            return this.external.getFrontEndId();
                        },
                        reload: function() {
                            return this.external.reload();
                        },
                    ...
                    events: {
                        majorTomEvent: function (reason) {
                            n$.Events.MajorTomEvent.raise(reason);
                        },
                ...
                "Enables sharing of Microsoft Dynamics NAV back-end busy state with the host application.",
                {
                    methods: {
                        setBusy: function(busy) {
                            return this.external.setBusy(busy);
                        }
                    }
                }));
        })
...
n$.addModule("Enums",
    ...
    .depend("Css");﻿;
// TODO: refactor:
// - correct method case (e.g. "Raise" to "raise")
n$.addModule("Events",
    function() {
        ...
        n$.Events = {
            ...
            TextEnter: new n$.Event.Method({ name: "TextEnter" }),
        ...
        function () {
            var cookieBasedWalkthrough = {
                isWalkthroughCompleted: function(w) {
                    return n$.Cookies.getCookie("walkthrough_" + w) === "true";
                },
    ...
    n$.addModule("External.Chromium",
            function() {
                n$.ExternalObject.Chromium = function() {
                    n$.ExternalObject.call(this, "Chromium-based Major Tom");
                    ...
                    Object.defineProperties(this,
                        {
                                    ...
                                    function(id) {
                                        try {
                                            ...
                                            n$.Debug.External.warning(
                                                "Major Tom does not seem to support the capabilities feature. Please upgrade Major Tom to a new version.");
                                        }
                                    }
                            },
                            announceCapability:
                            ...
                            registerKeyPress: {
                                value: function (keypress) {
                                    return csharpHost.registerKeyPress(keypress);
                                }
                            },
                            popupActive: {
                                value: function (active) {
        ...
        function () {
                ...
                Object.defineProperties(this,
                    {
                        getCapability: {
                            value:
                                function (guid) {
                                    try {
                                        return window.webkit.messageHandlers.getCapability.postMessage(guid);
                                    } catch (e) {
                                        n$.Debug.External
                                            .warning(
                                                "The iOS app does not seem to support the capabilities feature. Please upgrade the iOS app to a new version.");
                                        return false;
                                    }
                                }
                        },
                        announceCapability:
                        {
                            value:
                                function (name, id, description) {
                                    try {
                                        window.webkit.messageHandlers.announceCapability.postMessage(name, id, description);
                                    } catch (e) {
                                        n$.Debug.External
                                            .warning(
                                                "The iOS app does not seem to support the capabilities feature. Please upgrade the iOS app to a new version.");
                        ...
                        // TODO: define other supported functions in here.

                        // Events
                        activeSale: {
                            value: function(active) {
                                window.webkit.messageHandlers.activeSale.postMessage(active);
                            }
                        },
                        documentReady: {
                            value: function(name) {
                                window.webkit.messageHandlers.documentReady.postMessage(name);
                            }
                        },
                        getFrontEndId: {
                            value: function() {
                                return window.webkit.messageHandlers.getFrontEndId.postMessage();
                            }
                        }
                    });
            };
            ...
            (function () {
                n$.ExternalObject.iOS.prototype.priority = function () {
                    // TODO: return a specific priority (lower is higher)
                    return 20;
                };
                n$.ExternalObject.iOS.prototype.isApplicable = function () {
                    // TODO: define unmistakeable conditions to determine this is really running in the iOS app.
        ...
        function () {
            ...
            (function() {
                ...
                function getUnsupportedFunction(name) {
                    return function() {
                        n$.Debug.Framework.warning("Unsupported external method called: [" + name + "].");
                    };
                };
...
n$.addModule("External.MajorTom",
                ...
                Object.defineProperties(this,
                    {
                        ...
                        getCapability: {
                            value:
                                function(id) {
                                    try {
                                        return window.external.GetCapability(id);
                                    } catch (e) {
                                        n$.Debug.External.warning(
                                            "Major Tom does not seem to support the capabilities feature. Please upgrade Major Tom to a new version.");
                                        return false;
                        ...
                        invokeProxy: {
                            value: function(envelope, handle) {
                                return window.external.InvokeProxyWithHandle(envelope, handle);
                            }
                        },
                        invokeProxyAsync: {
                            value: function(envelope) {
                        ...
                        advertiseStargatePackages: {
                            value: function(content) {
                                try {
                                    return window.external.AdvertiseStargatePackages(JSON.stringify(content));
                                } catch (e) {
                                    n$.Debug.External.warning(
                                        "Major Tom does not seem to support the AdvertiseStargatePackages method. Please upgrade Major Tom to a new version.");
                                    return null;
                        ...
                        isWalkthroughCompleted: {
                            value: function(id) {
                                return window.external.IsWalkthroughCompleted(id);
                            }
                        },
                        indicateWalkthroughAvailable: {
                            value: function(id) {
                        ...
                        getFrontEndId: {
                            value: function() {
                                return window.external.GetFrontEndId();
                            }
                        },
                        reload: {
                            value: function() {
                        ...
                        registerKeyPress: {
                            value: function (keypress) {
                                return window.external.RegisterKeyPress(keypress);
                            }
                        },
                        popupActive: {
                            value: function (active) {
                        ...
                        isKiosk: {
                            value: function() {
                                return window.external.IsKiosk();
                            }
                        },
                        disableKiosk: {
                            value: function() {
    ...
    .depend("External", "External.Browser");﻿n$.addModule("Focus",
    function () {
...
n$.addModule("InputFilters",
    ...
    }).depend("InputFilter");﻿n$.addModule("jQuery",
    function() {
    ...
    function() {
        n$.ready(function() {
                try {
                    ...
                    if (n$.Framework.Environment.Mobile()) {
                        var phone = /phone\.aspx/gi.test(window.top.location);

                        if (phone && landscape)
                            suggestBetterResolution(
                                "This application is optimized for portrait orientation on your phone. Please, turn your phone to portrait mode.");

                        if (!phone && portrait)
                            suggestBetterResolution(
                                "This application is optimized for landscape orientation on your tablet. Please, turn your tablet to landscape mode.");
...
n$.addModule("UserGuide",
    function () {
        ...
        n$.UserGuide.prototype.validate = function (json) {
            ...
            // TODO: validate JSON for user guide, if there are any errors, set valid to false, throw warning
            ...
            me.completed ||
                setTimeout(function() {
                    json.trigger || (me.auto && me.run(null, !me.completed));
                });
        ...
        (function () {
            ...
            n$.UserGuide.capability = {
                registerWalkthrough: function(guide) {
                    if (!n$.Capabilities.Walkthrough.supported)
                        return;
                ...
                showWalkthroughs: function () {
                    ...
                    if (oneGuide.length === 1 && !oneGuide[0].isRunning && !oneGuide[0].completed) {
            ...
            function processViewActivation(view) {
                ...
                userGuides.forEach(function(g) {
                    var evaluation = g.evaluateOnView(view), runThis = !executed && evaluation.auto && !g.completed;
                    evaluation.ok &&
...
n$.addModule("Version",
    function () {
        ...
        n$.Version = {
            version: "5.40.1529.40",
            product: "NP Retail 2017",
...
Release notes 5.40.1529.40 - released on March 11 2019:
...
- Pressing Enter does not close dialogs anymore, and pressing Esc to close a dialog causes transaction to end. Case #346148. 
                    ...
                    steps: [
                        {
                            ...
                            text: [
                                "<h1>Welcome!</h1>",
                                "Welcome to NP Retail 2017! It seems to be your first time here, so let us help you get the most ouf of it.",
    ...
    function() {
        ...
        n$.ready(function() {
            ...
            function unload() {
                ...
                (
                    unloaded = true,
                    n$.Events.CloseRequested.raise()
                );
            };

            window.top.onbeforeunload = unload;
    ...
    function () {
        ...
        (function () {
            ...
            n$.Workflow.Workflow.prototype._stepCompleted = function(step) {
                ...
                step._abort
                    ? me._abortWorkflow()
                    : (me.thisStep = me.continueAtStep || me.thisStep.nextStep, me.continueAtStep && delete me.continueAtStep, me.thisStep &&
                        setTimeout(function() {
                                me._paused ||
                                    me.thisStep.execute();
                            }));
...
﻿;
n$.addModule("FrontEndAsync.Keyboard",
    function() {
            ...
            "Enables Major Tom to send registered keyboard presses over to JavaScript to pass them onto C/AL.",
            {
                methods: {
                    registerKeyPress: function(keypress) {
                        return this.external.registerKeyPress(keypress);
                    },
                    popupActive: function (active) {
                        return this.external.popupActive(!!active);
                    }
                },
                events: {
    ...
    }).depend("Debug", "FrontEndAsync", "Capabilities", "External");﻿n$.addModule("Kiosk",
    function() {
            ...
            document.addEventListener(
                ...
                function () {
                    ...
                    down = setTimeout(function() {
                            ...
                            if (!n$.Capabilities.Kiosk.isKiosk())
                                return;
...
n$.addModule("FrontEndAsync.SecureMethod",
    function() {
        ...
        /*
        // TODO: Uncomment this block when front-end validation in MT becomes available (this GUID is alright already, it's unique)
        n$.Capabilities.register(new n$.Capability("SecureMethods",
        "c050c100-f900-40d6-8690-f6c1c2f57069",
        "Enables integration with Major Tom to perform security checks on the client before allowing invocation of back-end methods/events.",
        {
            methods: {
            },
            events: {
    ...
    }).depend("Debug", "FrontEndAsync", "Capabilities", "External");﻿;
n$.addModule("Stargate",
        function() {
            ...
            n$.AsyncRequestHandlers.InvokeDevice = function (req) {
                ...
                try {
                    ...
                    var resp = n$.Capabilities.Stargate.invokeProxy(
                        req.Envelope,
                        storeContext(
                            {
                                id: req.Id,
                    ...
                    debug.device.warning("Device invocation failed: " + e.message, true);
                };
                logEnd();
            ...
            n$.AsyncRequestHandlers.StargatePackages = function(req) {
                ...
                try {
                    var shouldRestart = n$.Capabilities.Stargate.advertise(req.Content);
                    if (shouldRestart) {
                        n$.Popup.dialog({
                            title: "Important Information",
                            caption:
    ...
    .depend("Capabilities", "Debug", "Events", "External", "Focus", "FrontEndAsync");
﻿n$.addModule("Kiosk",
    function () {
    ...
    function executeClick() {
        ...
        if (!me.action) {
            ...
            if (typeof constructor === "function") {
                ...
                action.cache ? (me.action = action) : action.execute(dataSourceParam, workflowCompletionCallback);
            } else {
        ...
        me.action instanceof n$.Workflow.ActionHandler &&
    ...
    sections &&
        sections.forEach(function(section) {
            ...
            if (section.component) {
                ...
                section.caption && (ctrl.caption = section.caption);
...
n$.Controls.TextBox = function(par) {
    ...
    par.html = $("<input type='" + (par.type || "text") + "'>")
        .on({
            input: triggerInput,
            mouseup: function() {
                if (!me.value)
            ...
            n$.ready.finalize(function() {
                setTimeout(function() {
                    n$.Events.FrameworkReady.raise(function() {
                        ...
                        var id = n$.Capabilities.Events.getFrontEndId() || "WebBrowser;;";
                        (id = id.split(";"),
