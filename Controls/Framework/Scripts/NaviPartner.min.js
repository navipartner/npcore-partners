    ...
    function () {
        ...
        n$.Capability = function (name, id, description, descriptor) {
            ...
            function implementFunc(name, f) {
                ...
                this[name] = function () {
                    return new Promise((fulfill, reject) => invokers.push({ this: me, arguments, fulfill, reject }));
                }
...
n$.addModule("External.iOS",
    function () {
        n$.ExternalObject.iOS = function () {
            ...
            // TODO: Remove this block of code when Capabilities are supported on iOS ---
            Object.defineProperties(this,
                {
                    announceCapability: {
...
n$.addModule("Workflow20", function () {
    ...
    function executeCode(workflow, code) {
        return new Promise(function (fulfill, reject) {
            var funcPromise = new Promise(function (funcFulfill, funcReject) {
                ...
                codePromise
                    .then(function (code) {
                        code = "var $$ = workflow.scope, $param = workflow.scope.param, $labels = workflow.scope.labels, " +
    ...
    (function () {
         ...
         */
        WorkflowCallResponseAwaiter.prototype.process = function (content) {
        ...
        function WorkflowInterface(interface) {
             ...
             * A completed worklfow does not allow:
             * - completing
             * - failing
             * - showing popups
             * - responding to NAV
            ...
            function getNestedWorkflowPromise(action, context) {
                return new Promise(function (fulfill, reject) {
                    ...
                    function runWorkflow() {
                        var workflow = { action: $.extend(true, {}, workflowCache[action]) };
                        if (context.context)
        ...
        n$.Workflow20 = {
            ...
            Workflow: function (button, parent) {
                var workflowDefinition = button.action.Workflow;
                var parameters = button.action.Parameters;
                var metadata = button.metadata;
                ...
                this.execute = function (dataSource, completionCallback) {
                    ...
                    var promise = new Promise(function (fulfill, reject) {
                        // Instance of the interface object that allows controling the promise (resolving, rejecting)
                        var workflow = new WorkflowInterface(
                            {
