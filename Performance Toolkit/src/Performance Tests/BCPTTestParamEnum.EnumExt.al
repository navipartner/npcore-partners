enumextension 88000 "NPR BCPT Test Param. Enum" extends "BCPT Test Param. Enum"
{
    ...
    value(88007; "NPR BCPT Initialize Data")
    {
        Implementation = "BCPT Test Param. Provider" = "NPR BCPT Initialize Data";
    }
    value(88008; "NPR BCPT POS DS Total Disc Amt")
    {
    ...
    value(88010; "NPR BCPT POS Post GL Entries")
    {
        Implementation = "BCPT Test Param. Provider" = "NPR BCPT POS Post GL Entries";
    }
    value(88011; "NPR BCPT POS Post Item Entries")
    {
    ...
    value(88014; "NPR BCPT Membership Renew")
    {
        Implementation = "BCPT Test Param. Provider" = "NPR BCPT Membership Renew";
    }
}