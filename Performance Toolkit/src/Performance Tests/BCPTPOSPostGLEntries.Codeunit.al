codeunit 88010 "NPR BCPT POS Post GL Entries" implements "BCPT Test Param. Provider"
{
    SingleInstance = true;
    ...
    local procedure POSPostGLEntries()
    begin
        BCPTTestContext.StartScenario('POS Post GL Entries');
        Codeunit.Run(Codeunit::"NPR POS Post GL Entries JQ");
        BCPTTestContext.EndScenario('POS Post GL Entries');
    end;
