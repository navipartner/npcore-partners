page 6059830 "Event Grouped Plan. Lines Sub"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                IndentationColumn = "Group Source Line No.";
                ...
                field("Job Task No.";"Job Task No.")
                {
                    ...
                    var
                        EventTaskLines: Page "Event Task Lines";
    ...
    begin
        //-NPR5.55 [397741]
        ShowAsBold := Rec."Group Line" and (Rec."Group Source Line No." = 0);
        //+NPR5.55 [397741]
    end;
