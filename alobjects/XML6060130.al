xmlport 6060130 "MM Get Membership Members"
{
        ...
        textelement(members)
        {
            textelement(getmembers)
            {
                ...
                textelement(response)
                {
                    ...
                    tableelement(tmpmemberinforesponse;"MM Member Info Capture")
                    {
                        MaxOccurs = Unbounded;
                        MinOccurs = Zero;
                        XmlName = 'member';
        ...
        if (MembershipRole.FindSet ()) then begin
          repeat
            ...
            case MembershipRole."GDPR Approval" of
              MembershipRole."GDPR Approval"::ACCEPTED : tmpMemberInfoResponse."GDPR Approval" := tmpMemberInfoResponse."GDPR Approval"::ACCEPTED;
              MembershipRole."GDPR Approval"::REJECTED : tmpMemberInfoResponse."GDPR Approval" := tmpMemberInfoResponse."GDPR Approval"::REJECTED;
              MembershipRole."GDPR Approval"::PENDING  : tmpMemberInfoResponse."GDPR Approval" := tmpMemberInfoResponse."GDPR Approval"::PENDING;
              else
