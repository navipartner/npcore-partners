page 6059769 "NaviDocs Document List"
{
    ...
    var
        NewHandlingProfile: Record "NaviDocs Handling Profile";
        TempChangedNaviDocsEntry: Record "NaviDocs Entry" temporary;
    begin
        //-NPR5.40 [306875]
        NaviDocsEntry2.SetCurrentKey("Entry No.");
