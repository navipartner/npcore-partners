codeunit 6014559 "RP Ripac Device Library"
{
    ...
    begin
        case Char of
          'G' : PrintNVGraphicsData(1,0);
          'P' : SelectCutModeAndCutPaper(66,3);
          ...
          'h' : PrintNVGraphicsDataNew(6,0,48,69,48,48,1,1);
        end;
    end;
    ...
    begin
        case UpperCase(Command) of
          ...
          'STOREDLOGO_1' : PrintNVGraphicsData(1,0);
          'STOREDLOGO_2' : PrintNVGraphicsData(2,0);
        end;
    end;
