codeunit 6150790 "POS Action - Customer Location"
{
    ...
    begin
        ...
        case Setting of
          ...
          Setting::Export : LocationExport(LocationNo,POSSession, FrontEnd);
          Setting::StampAndImport : LocationStampAndImport(LocationNo, POSSession);
          //+NPR5.31 [264112]
          Setting::Import : LocationImport(LocationNo,POSSession);
          Setting::List   : LocationList();
          Setting::Print  : LocationPrint(LocationNo,POSSession);
        end;

        Handled := true;
    end;

    local procedure LocationExport(LocationNo: Code[20];POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    local procedure LocationImport(LocationNo: Code[20];POSSession: Codeunit "POS Session")
    var
        POSSale: Codeunit "POS Sale";
        SalePOS: Record "Sale POS";
        POSCustLocMgt: Codeunit "POS Customer Location Mgt.";
        LocSalePOS: Record "Sale POS";
    begin
        POSSession.GetSale(POSSale);
        POSSale.GetCurrentSale(SalePOS);
    ...
    local procedure LocationPrint(LocationNo: Code[20];POSSession: Codeunit "POS Session")
    var
        POSSale: Codeunit "POS Sale";
        SalePOS: Record "Sale POS";
        POSCustLocMgt: Codeunit "POS Customer Location Mgt.";
    ...
    local procedure LocationStampAndImport(LocationNo: Code[20];POSSession: Codeunit "POS Session")
    var
        POSSale: Codeunit "POS Sale";
        SalePOS: Record "Sale POS";
        POSCustLocMgt: Codeunit "POS Customer Location Mgt.";
    ...
    local procedure WriteAuditRollTrace(var NewSalePOS: Record "Sale POS";var OldSalePOS: Record "Sale POS")
    var
    ...
    local procedure WritePOSEntryTrace(var NewSalePOS: Record "Sale POS";var OldSalePOS: Record "Sale POS")
    var
