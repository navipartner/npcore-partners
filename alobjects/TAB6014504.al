table 6014504 "Customer Repair"
{
    ...
    fields
    {
        ...
        field(2;"Customer No.";Code[20])
        {
            ...
            TableRelation = IF ("Customer Type"=CONST(Cash)) Contact
                            ELSE IF ("Customer Type"=CONST(Ordinary)) Customer;
        ...
        {
            CalcFormula = Exist("Retail Comment" WHERE ("Table ID"=CONST(6014504),
                                                        "No."=FIELD("No.")));
            Caption = 'Comment';
    ...
    procedure AssistEdit(xCustomerRepair: Record "Customer Repair"): Boolean
    var
    ...
    procedure TransferFromAuditRoll(var AuditRoll: Record "Audit Roll")
    begin
    ...
    procedure PostItemPart(var CustRepair: Record "Customer Repair")
    var
        ItemJnlLine: Record "Item Journal Line" temporary;
        CustRepairItemParts: Record "Customer Repair Journal";
    ...
    procedure PostItemPartWithoutFinalize(var CustRepair: Record "Customer Repair")
    var
        ItemJnlLine: Record "Item Journal Line" temporary;
        CustRepairItemParts: Record "Customer Repair Journal";
        ItemJnlPostLine: Codeunit "Item Jnl.-Post Line";
    ...
    procedure CreateSalesLine(SalesHeader: Record "Sales Header";CustomerRepair: Record "Customer Repair")
    var
        SalesLine: Record "Sales Line";
        CustomerRepairJournal: Record "Customer Repair Journal";
