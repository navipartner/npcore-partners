codeunit 6151501 "Nc Task Mgt."
{
    ...
    var
        TaskProcesLine: Record "Nc Task Proces. Line";
        TempDataLogRecord: Record "Data Log Record" temporary;
        TempTask: Record "Nc Task" temporary;
        RecordID: RecordID;
    begin
    ...
    var
        ...
        TaskOutput: Record "Nc Task Output";
    begin
        Initialize();
    ...
    local procedure InsertTasks(var TempTask: Record "Nc Task" temporary)
    var
    ...
    local procedure InsertTempTasks(TaskProcessor: Record "Nc Task Processor";DataLogCompanyName: Text[30];var TempDataLogRecord: Record "Data Log Record" temporary;var TempTask: Record "Nc Task" temporary)
    var
        DataLogField: Record "Data Log Field";
        TaskSetup: Record "Nc Task Setup";
        TempTaskSetup: Record "Nc Task Setup" temporary;
        RecRef: RecordRef;
        RecordID: RecordID;
        i: Integer;
        Counter: Integer;
              ...
              repeat
                ...
                //+NC2.08 [298597]
                  ...
                  case TempDataLogRecord."Type of Change" of
                    TempDataLogRecord."Type of Change"::Insert : TempTask.Type := TempTask.Type::Insert;
                    TempDataLogRecord."Type of Change"::Modify : TempTask.Type := TempTask.Type::Modify;
                    TempDataLogRecord."Type of Change"::Delete : TempTask.Type := TempTask.Type::Delete;
                    TempDataLogRecord."Type of Change"::Rename : TempTask.Type := TempTask.Type::Rename;
                  end;
    ...
    local procedure DeleteDuplicates(TaskProcessor: Record "Nc Task Processor";var TempTask: Record "Nc Task" temporary)
    var
    ...
    procedure ReqisterUniqueTask(NewUniqueTaskBuffer: Record "Nc Unique Task Buffer" temporary;var UniqueTaskBuffer: Record "Nc Unique Task Buffer" temporary) IsDuplicate: Boolean
    begin
    ...
    procedure GetRecRef(NcTask: Record "Nc Task";var RecRef: RecordRef): Boolean
    var
    ...
    procedure RunSourceCard(NaviConnectTask: Record "Nc Task")
    var
    ...
    procedure GetRecordPosition(NcTask: Record "Nc Task") RecordPosition: Text
    var
        RecordID: RecordID;
        RecRef: RecordRef;
    begin
