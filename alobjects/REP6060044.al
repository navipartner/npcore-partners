report 6060044 "Map Excel Item Worksheet"
{
    ...
    requestpage
    {
        ...
        trigger OnOpenPage()
        var
            LocItemWorksheet: Record "Item Worksheet";
        begin
            BoolTryMatch := true;
        ...
        if ExcelBuf.FindFirst then begin
          repeat
            ...
            if BoolTryMatch and (ItemWorksheetExcelColumn."Map to Field Number" = 0) then begin
              RecField.Reset;
              RecField.SetRange(TableNo,DATABASE::"Item Worksheet Line");
              ...
              if ItemWorksheetExcelColumn."Map to Field Number" = 0 then begin
                RecField.SetRange(TableNo,DATABASE::"Item Worksheet Variant Line");
                RecField.SetFilter(FieldName,'%1',ItemWorksheetExcelColumn."Excel Header Text");
