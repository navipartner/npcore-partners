codeunit 6014675 "Endpoint Management"
{
    ...
    procedure PopulatePKFields(var EndpointRequest: Record "Endpoint Request";RecRef: RecordRef)
    var
          ...
          127 :
            ...
            for I := 1 to PKKeyRef.FieldCount do begin
              ...
              if FieldRefPKField.Type = ToFieldRef.Type then begin
                ...
                else if EndpointRequest."PK Code 2" = '' then
    ...
    procedure CreateModifyRequests(Endpoint: Record Endpoint)
    var
        RecRef: RecordRef;
    ...
    procedure MarkPreviousRequestsAsObsolete(EndpointRequest: Record "Endpoint Request")
    var
        OldEndpointRequests: Record "Endpoint Request";
        EndPoint: Record Endpoint;
    begin
    ...
    procedure SetBatchStatus(EndpointRequestBatch: Record "Endpoint Request Batch";NewStatus: Option Collecting,"Ready to Send",Sent)
    var
    ...
    procedure InsertFilterRecords(EndpointQuery: Record "Endpoint Query";RecRef: RecordRef)
    var
        EndpointQueryFilter: Record "Endpoint Query Filter";
        FieldRec: Record "Field";
        FldRef: FieldRef;
