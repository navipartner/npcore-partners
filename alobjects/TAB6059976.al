table 6059976 "Variety Group"
{
    ...
    DrillDownPageID = "Variety Group";
    LookupPageID = "Variety Group";
    ...
    begin
        if "Create Copy of Variety 1 Table" then
          CopyTable2NewTable("Variety 1", "Variety 1 Table", Item."Variety 1 Table");
        if "Create Copy of Variety 2 Table" then
          CopyTable2NewTable("Variety 2", "Variety 2 Table", Item."Variety 2 Table");
        if "Create Copy of Variety 3 Table" then
          CopyTable2NewTable("Variety 3", "Variety 3 Table", Item."Variety 3 Table");
        if "Create Copy of Variety 4 Table" then
          CopyTable2NewTable("Variety 4", "Variety 4 Table", Item."Variety 4 Table");
    end;

    procedure CopyTable2NewTable(Type: Code[10];FromTable: Code[40];ToTable: Code[40])
    var
        FromVRTTable: Record "Variety Table";
        ToVRTTable: Record "Variety Table";
        FromVRTValue: Record "Variety Value";
        ToVRTValue: Record "Variety Value";
    begin
        ...
        if FromVRTValue.FindSet then repeat
    ...
    begin
        ...
        case true of
          ((NewVar1Code = '') and (NewVar2Code = '') and (NewVar3Code = '')) : exit('');
          ((NewVar1Code = '') and (NewVar2Code = '')) : exit(NewVar3Code);
          ((NewVar1Code = '') and (NewVar3Code = '')) : exit(NewVar2Code);
          ((NewVar2Code = '') and (NewVar3Code = '')) : exit(NewVar1Code);
          (NewVar1Code = '') : exit(NewVar2Code + Sep2 + NewVar3Code);
          (NewVar2Code = '') : exit(NewVar1Code + Sep1 + NewVar3Code);
          (NewVar3Code = '') : exit(NewVar1Code + Sep1 + NewVar2Code);
        end;
        //+NPR5.43 [317108]
    end;
}
