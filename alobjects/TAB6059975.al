table 6059975 "Variety Field Setup"
{
    ...
    DrillDownPageID = "Variety Fields Lookup";
    LookupPageID = "Variety Fields Lookup";
    ...
    fields
    {
        ...
        field(15;"Variety Matrix Subscriber 1";Text[60])
        {
            ...
            begin
                ...
                EventSubscription.SetRange("Publisher Object ID",CODEUNIT::"Variety Matrix Management");
            ...
            begin
                ...
                if "Secondary Type" = "Secondary Type"::Internal then begin
                  case "Secondary Field No." of
                    1: "Secondary Description" := Text001;
                  end;
                end;
                //+VRT1.10
    ...
    var
        VRTFieldsSetup: Record "Variety Field Setup";
        VRTFieldsSetupCopy: Record "Variety Field Setup";
    begin
        //Sales Line
