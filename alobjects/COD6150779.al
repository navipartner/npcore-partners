codeunit 6150779 "POS Action - Pepper Terminal"
{
    ...
    begin
        ...
        //+NPR5.46 [290734]
              ...
              if (EFTTransactionRequest.Successful) then
                case CommandType of
                  CommandType::INSTALL : Message (InstallOK);
                  CommandType::OPEN : Message (OpenOK);
                  CommandType::ENDOFDAY : Message (CLoseOK);
                end
            end;
        end;
        ...
        case NextWorkflowStep of
          NextWorkflowStep::Pause : FrontEnd.PauseWorkflow ();
          NextWorkflowStep::WaitForDevice : FrontEnd.ContinueAtStep ('EFT_wait');
          NextWorkflowStep::CheckResult : FrontEnd.ContinueAtStep ('EFT_checkresult');
          NextWorkflowStep::Done : FrontEnd.ContinueAtStep ('done');
          else
    ...
    local procedure DoWork(POSSession: Codeunit "POS Session";EftCommand: Option;AuxCommand: Integer;OtherCommand: Integer;SalePOS: Record "Sale POS";Register: Record Register)
    var
        SaleLine: Record "Sale Line POS";
        EFTTransactionRequest: Record "EFT Transaction Request";
        Handled: Boolean;
        TouchScreenFunctions: Codeunit "Touch Screen - Functions";
        PepperLibraryTranscendence: Codeunit "Pepper Library Transcendence";
          ...
          CommandType::OTHER :
            begin
              ...
              case OtherCommand of
                1 : PepperLibraryTranscendence.SetTerminalToOfflineMode(Register,0); //Activate
                2 : PepperLibraryTranscendence.SetTerminalToOfflineMode(Register,1); //Deactivate
              end;
    ...
    local procedure SetTransactionRequest(POSSession: Codeunit "POS Session";EFTTransactionRequest: Record "EFT Transaction Request")
    begin
    ...
    local procedure GetTransactionRequest(POSSession: Codeunit "POS Session";var EFTTransactionRequest: Record "EFT Transaction Request")
    var
        EntryNo: Integer;
        Token: Guid;
        TmpVariant: Variant;
    ...
    local procedure GetEFTSetup(Register: Record Register;var EFTSetup: Record "EFT Setup")
    var
        PepperLibraryTranscendence: Codeunit "Pepper Library Transcendence";
    begin
        //-NPR5.46 [290734]
