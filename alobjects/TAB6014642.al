table 6014642 "Tax Free Handler Parameters"
{
    ...
    procedure SerializeParameterBLOB(var TaxFreeUnit: Record "Tax Free POS Unit")
    var
        OutStream: OutStream;
        JSON: Text;
    ...
    procedure DeserializeParameterBLOB(var TaxFreeUnit: Record "Tax Free POS Unit")
    var
        Buffer: Text;
        JSON: Text;
        JObject: DotNet JObject;
    ...
    begin
        ...
        case "Data Type" of
          ...
          "Data Type"::Option : Error('Not implemented');
        end;
    end;
