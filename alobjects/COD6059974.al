codeunit 6059974 "Variety Check"
{
    ...
    begin
        ...
        if (Item."Variety 1" = XRecItem."Variety 1") and
           (Item."Variety 2" = XRecItem."Variety 2") and
           (Item."Variety 3" = XRecItem."Variety 3") and
           (Item."Variety 4" = XRecItem."Variety 4") and
           (Item."Variety 1 Table" = XRecItem."Variety 1 Table") and
           (Item."Variety 2 Table" = XRecItem."Variety 2 Table") and
           (Item."Variety 3 Table" = XRecItem."Variety 3 Table") and
           (Item."Variety 4 Table" = XRecItem."Variety 4 Table") then
          exit;
    ...
    procedure CheckDeleteVarietyValue(VRTValue: Record "Variety Value")
    var
        ItemVariant: Record "Item Variant";
    begin
        ItemVariant.SetRange("Variety 1", VRTValue.Type);
        ItemVariant.SetRange("Variety 1 Table", VRTValue.Table);
        ItemVariant.SetRange("Variety 1 Value", VRTValue.Value);
        if ItemVariant.FindSet then repeat
          CheckItemVariantDeleteAllowed(ItemVariant);
        until ItemVariant.Next = 0;

        ItemVariant.SetRange("Variety 2", VRTValue.Type);
        ItemVariant.SetRange("Variety 2 Table", VRTValue.Table);
        ItemVariant.SetRange("Variety 2 Value", VRTValue.Value);
        if ItemVariant.FindSet then repeat
          CheckItemVariantDeleteAllowed(ItemVariant);
        until ItemVariant.Next = 0;

        ItemVariant.SetRange("Variety 3", VRTValue.Type);
        ItemVariant.SetRange("Variety 3 Table", VRTValue.Table);
        ItemVariant.SetRange("Variety 3 Value", VRTValue.Value);
        if ItemVariant.FindSet then repeat
          CheckItemVariantDeleteAllowed(ItemVariant);
        until ItemVariant.Next = 0;

        ItemVariant.SetRange("Variety 4", VRTValue.Type);
        ItemVariant.SetRange("Variety 4 Table", VRTValue.Table);
        ItemVariant.SetRange("Variety 4 Value", VRTValue.Value);
        if ItemVariant.FindSet then repeat
          CheckItemVariantDeleteAllowed(ItemVariant);
        until ItemVariant.Next = 0;
    end;
    ...
    begin
        ...
        if (Item."Variety 1" <> '') and (XRecItem."Variety 1" = '') then
          exit(false);
        if (Item."Variety 2" <> '') and (XRecItem."Variety 2" = '') then
          exit(false);
        if (Item."Variety 3" <> '') and (XRecItem."Variety 3" = '') then
          exit(false);
        if (Item."Variety 4" <> '') and (XRecItem."Variety 4" = '') then
          exit(false);
        ...
        ItemVar.SetRange("Item No.", Item."No.");
        if ItemVar.FindSet then repeat
          if (Item."Variety 1" <> XRecItem."Variety 1") or (Item."Variety 1 Table" <> XRecItem."Variety 1 Table") then begin
            if not Variety.Get(Item."Variety 1") then
              exit(false);
          ...
          if (Item."Variety 2" <> XRecItem."Variety 2") or (Item."Variety 2 Table" <> XRecItem."Variety 2 Table") then begin
            if not Variety.Get(Item."Variety 2") then
              exit(false);
          ...
          if (Item."Variety 3" <> XRecItem."Variety 3") or (Item."Variety 3 Table" <> XRecItem."Variety 3 Table") then begin
            if not Variety.Get(Item."Variety 3") then
              exit(false);
            if not VarietyTable.Get(Item."Variety 3", Item."Variety 3 Table") then
              exit(false);
            if not VarietyValue.Get(Item."Variety 3", Item."Variety 3 Table", ItemVar."Variety 3 Value") then
              exit(false);
          end;

          if (Item."Variety 4" <> XRecItem."Variety 4") or (Item."Variety 4 Table" <> XRecItem."Variety 4 Table") then begin
            if not Variety.Get(Item."Variety 4") then
              exit(false);
            if not VarietyTable.Get(Item."Variety 4", Item."Variety 4 Table") then
              exit(false);
            if not VarietyValue.Get(Item."Variety 4", Item."Variety 4 Table", ItemVar."Variety 4 Value") then
              exit(false);
          end;
        until ItemVar.Next = 0;
        exit(true);
    ...
    var
        ItemVar: Record "Item Variant";
        VarValue: Record "Variety Value";
    begin
        //-NPR5.33 [282177]
        ItemVar.SetRange("Item No.", Item."No.");
        if ItemVar.FindSet then repeat
          if ItemVar."Variety 1" <> Item."Variety 1" then
            ItemVar."Variety 1" := Item."Variety 1";
          if ItemVar."Variety 1 Table" <> Item."Variety 1 Table" then
            ItemVar."Variety 1 Table" := Item."Variety 1 Table";
          if ItemVar."Variety 1" <> '' then
            VarValue.Get(ItemVar."Variety 1", ItemVar."Variety 1 Table",ItemVar."Variety 1 Value");

          if ItemVar."Variety 2" <> Item."Variety 2" then
            ItemVar."Variety 2" := Item."Variety 2";
          if ItemVar."Variety 2 Table" <> Item."Variety 2 Table" then
            ItemVar."Variety 2 Table" := Item."Variety 2 Table";
          if ItemVar."Variety 2" <> '' then
            VarValue.Get(ItemVar."Variety 2", ItemVar."Variety 2 Table",ItemVar."Variety 2 Value");

          if ItemVar."Variety 3" <> Item."Variety 3" then
            ItemVar."Variety 3" := Item."Variety 3";
          if ItemVar."Variety 3 Table" <> Item."Variety 3 Table" then
            ItemVar."Variety 3 Table" := Item."Variety 3 Table";
          if ItemVar."Variety 3" <> '' then
            VarValue.Get(ItemVar."Variety 3", ItemVar."Variety 3 Table",ItemVar."Variety 3 Value");

          if ItemVar."Variety 4" <> Item."Variety 4" then
            ItemVar."Variety 4" := Item."Variety 4";
          if ItemVar."Variety 4 Table" <> Item."Variety 4 Table" then
            ItemVar."Variety 4 Table" := Item."Variety 4 Table";
          if ItemVar."Variety 4" <> '' then
            VarValue.Get(ItemVar."Variety 4", ItemVar."Variety 4 Table",ItemVar."Variety 4 Value");
          ItemVar.Modify(true);
        until ItemVar.Next = 0;
        //+NPR5.33 [282177]
    end;
    ...
    local procedure SetNewMasterLineT6014422(OldMasterLine: Record "Retail Journal Line")
    var
    ...
    local procedure OnAfterDeleteMasterVarietyLineT6014422(var Rec: Record "Retail Journal Line";RunTrigger: Boolean)
    var
        SalesLine: Record "Sales Line";
    begin
        //-NPR5.44 [323081]
    ...
    local procedure OnAfterValidateItemNoT6014422(var Rec: Record "Retail Journal Line";var xRec: Record "Retail Journal Line";CurrFieldNo: Integer)
    begin
        //-NPR5.44 [323081]
        if Rec.IsTemporary then
          exit;
