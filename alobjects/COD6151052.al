codeunit 6151052 "Retail Replenishment Mgmt"
{
    ...
    var
        RetailReplenishmentSetup: Record "Retail Replenishment Setup";
        Item: Record Item;
    ...
    local procedure DefaultDemandCalc(var RetaiReplDemandLine: Record "Retai Repl. Demand Line"; GracePeriod: DateFormula)
    var
        DistributionSetup: Record "Distribution Setup";
        Item: Record Item;
    ...
    procedure CreateRetailCampaignDemands(RetailCampaignHeader: Record "Retail Campaign Header")
    begin
        //Create demands
    end;

    procedure CreateCampaignPurchOrdersDirectFromDemand(var RetaiReplDemandLine: Record "Retai Repl. Demand Line")
    var
