codeunit 6151050 "Item Hierarchy Mgmt."
{
    ...
    procedure CreateItemHierarchyLines(ItemHierarchy: Record "Item Hierarchy")
    var
        ItemHierarchyLevel: Record "Item Hierarchy Level";
        ItemHierarchyLine: Record "Item Hierarchy Line";
        Item: Record Item;
        PreviousLevelLine: Record "Item Hierarchy Level";
    ...
    procedure CreateItemHierachyFromRetailCampaign(RetailCampaignHeader: Record "Retail Campaign Header")
    var
    ...
    local procedure UpdateItemHierachyLinesFromRetailCampaign(RetailCampaignHeader: Record "Retail Campaign Header")
    var
        ItemHierarchy: Record "Item Hierarchy";
        ItemHierarchyLine: Record "Item Hierarchy Line";
    ...
    local procedure CreateItemHierachyLinesFromRetailCampaign(RetailCampaignHeader: Record "Retail Campaign Header";ItemHierarchy: Record "Item Hierarchy")
    var
        RetailCampaignLine: Record "Retail Campaign Line";
        ItemHierarchyLine: Record "Item Hierarchy Line";
        ItemHierarchyLevel: Record "Item Hierarchy Level";
