codeunit 6060074 "Incoming Document Splitter"
{
    ...
    var
        ...
        SplitOnValue: Text;
        CSVSplitter: Codeunit "CSV Splitter";
    begin
    ...
    begin
        ...
        if IncomingDocument.FindSet then repeat
    ...
    begin
        ...
        DataExchColumnDef.SetFilter("Split File",'>0');
        if DataExchColumnDef.FindFirst then begin
          SplitMethod := DataExchColumnDef."Split File";
          SplitOnColumn := DataExchColumnDef."Column No.";
          SplitOnValue := DataExchColumnDef."Split Value";
        end else
          SplitMethod := 0;
    end;
    ...
    [EventSubscriber(ObjectType::Table, 1223, 'OnAfterValidateEvent', 'Split File', false, false)]
    ...
    begin
        if Rec."Split File" <> Rec."Split File"::NewFileOnSplitValue then
          Rec."Split Value" := '';
        if Rec."Split File" > 0 then begin
          DataExchColumnDef.Reset;
