        ...
        case WorkflowStep of
          'do_work' :
            begin
              ...
              case FunctionId of
                0 : SetCustomer (POSSession, MemberCardNumber);
                1 : ViewPoints (POSSession, MemberCardNumber);
                2 : RedeemPoints (Context, POSSession, FrontEnd, MemberCardNumber);
                3 : SelectAvailableCoupon (Context, POSSession, FrontEnd, MemberCardNumber);
                //-MM1.37 [350364]
                4 : SetCustomer (POSSession, MemberCardNumber);
                //+MM1.37 [350364]
