codeunit 6150806 "POS Action - Receivables"
{
    ...
    local procedure OnValidateCustomerView(var POSParameterValue: Record "POS Parameter Value")
    var
        RecRef: RecordRef;
    begin
        //-NPR5.43 [318038]
    ...
    [EventSubscriber(ObjectType::Table, 6150705, 'OnValidateValue', '', true, true)]
    local procedure OnValidateCustLedgerEntryView(var POSParameterValue: Record "POS Parameter Value")
    var
        RecRef: RecordRef;
    ...
    procedure SelectCustomerWorkFlow(Context: DotNet npNetJObject;POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    begin
        //-NPR5.45 [319706]
        exit(CODEUNIT::"POS Action - Receivables");
        //+NPR5.45 [319706]
    end;
