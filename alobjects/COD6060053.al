codeunit 6060053 "Item Wksht. Workflow Events"
{
    ...
    begin
        WorkflowEventHandling.AddEventToLibrary(NewItemWorksheetLineInserted,DATABASE::"Item Worksheet Line",TextDescrNewItemWorksheetLineInserted,0,false);
    ...
    local procedure RunWorkflowOnAfterInsertWorksheeLine(var Rec: Record "Item Worksheet Line";RunTrigger: Boolean)
    var
    ...
    var
        WorkflowManagement: Codeunit "Workflow Management";
    begin
        if Rec."Item Status" = xRec."Item Status" then
          exit;
