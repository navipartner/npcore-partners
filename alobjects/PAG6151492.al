page 6151492 "Raptor Data Buffer Entries"
{
    ...
    LinksAllowed = false;
    PageType = List;
    SourceTable = "Raptor Data Buffer";
    ...
    procedure SetRaptorAction(_Action: Record "Raptor Action")
    begin
    ...
    procedure GetRaptorAction(var _Action: Record "Raptor Action")
    begin
