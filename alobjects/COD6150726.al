codeunit 6150726 "POS Action - Insert Customer"
{
    ...
    local procedure OnActionCreateContact(CardPageId: Integer;var SalePOS: Record "Sale POS")
    var
    ...
    local procedure OnActionCreateCustomer(CardPageId: Integer;var SalePOS: Record "Sale POS")
    var
    ...
    local procedure SelectCustomerRequired(POSSalesWorkflowStep: Record "POS Sales Workflow Step";var POSSession: Codeunit "POS Session")
    var
        Customer: Record Customer;
        SalePOS: Record "Sale POS";
        POSSale: Codeunit "POS Sale";
    ...
    local procedure OnBeforeInsertPOSSalesWorkflowStep(var Rec: Record "POS Sales Workflow Step";RunTrigger: Boolean)
    begin
        //-NPR5.49 [343617]
    ...
    begin
        //-NPR5.49 [343617]
        exit(CODEUNIT::"POS Action - Insert Customer");
        //+NPR5.49 [343617]
    end;
}
