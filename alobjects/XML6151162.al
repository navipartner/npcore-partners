xmlport 6151162 "MM Register Sale"
{
    ...
    schema
    {
        textelement(RegisterSale)
        {
            ...
            textelement(Request)
            {
                ...
                {
                    MaxOccurs = Once;
                    tableelement(tmpregistersalesrequest;"MM Register Sales Buffer")
                    {
                        XmlName = 'Line';
                        UseTemporary = true;
    ...
    procedure GetRequest(var TmpAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;var TmpSalesLine: Record "MM Register Sales Buffer" temporary;var TmpPaymentLine: Record "MM Register Sales Buffer" temporary)
    begin
    ...
    procedure GetResponse(var ResponseCodeOut: Code[10];var ResponseMessageOut: Text;var DocumentIdOut: Text;var TmpPoints: Record "MM Loyalty Ledger Entry (Srvr)" temporary)
    begin
