report 6014418 "Item Group Stat M/Y"
{
    ...
    dataset
    {
        dataitem("Integer";"Integer")
        {
            ...
            dataitem(MainItemGroup;"Item Group")
            {
                ...
                dataitem(SubItemGroup;"Item Group")
                {
                    ...
                    dataitem(LastYearAuditRoll_sub;"Audit Roll")
                    {
                    ...
                    dataitem(CurrentYearAuditRoll_sub;"Audit Roll")
                    {
                        DataItemTableView = SORTING("Register No.","Sales Ticket No.","Sale Type","Line No.","No.","Sale Date");
                        ...
                        begin
                            if Quantity > 0 then begin
                              ...
                              TMPItem2."Item Group" :=  "Item Group";
