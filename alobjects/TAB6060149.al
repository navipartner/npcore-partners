table 6060149 "RC Membership Burndown Setup"
{
    ...
    begin
        case "Chart Type" of
          "Chart Type"::"Stacked Area":        exit(BusinessChart."Chart Type"::StackedArea);
          "Chart Type"::"Stacked Area (%)":    exit(BusinessChart."Chart Type"::StackedArea100);
          "Chart Type"::"Stacked Column":      exit(BusinessChart."Chart Type"::StackedColumn);
          "Chart Type"::"Stacked Column (%)":  exit(BusinessChart."Chart Type"::StackedColumn100);
        end;
    end;
