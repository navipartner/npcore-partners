report 6014602 "Alt. No. to ICR barcodes"
{
    ...
    dataset
    {
        dataitem("Alternative No.";"Alternative No.")
        {
            ...
            begin
                ...
                if "Variant Code" = '' then
                  case VRTSetup."Item Cross Ref. Description(I)" of
                    VRTSetup."Item Cross Ref. Description(I)"::ItemDescription1: ICR.Description := Item.Description;
                    VRTSetup."Item Cross Ref. Description(I)"::ItemDescription2: ICR.Description := Item."Description 2";
                  end
                else begin
                  if not ItemVariant.Get(Code, "Variant Code") then
                    Clear(ItemVariant);
                  case VRTSetup."Item Cross Ref. Description(V)" of
                    VRTSetup."Item Cross Ref. Description(V)"::ItemDescription1: ICR.Description := Item.Description;
                    VRTSetup."Item Cross Ref. Description(V)"::ItemDescription2: ICR.Description := Item."Description 2";
                    VRTSetup."Item Cross Ref. Description(V)"::VariantDescription1: ICR.Description := ItemVariant.Description;
                    VRTSetup."Item Cross Ref. Description(V)"::VariantDescription2: ICR.Description := ItemVariant."Description 2";
                  end;
                end;
            ...
            begin
                OpenDialog();
                UpdateDialog(1, DATABASE::"Alternative No.");
