codeunit 6151511 "Nc Import Processor"
{
    ...
    procedure ProcessImportEntry(var NcImportEntry: Record "Nc Import Entry") Success: Boolean
    var
        DataLogMgt: Codeunit "Data Log Management";
    begin
        MarkAsStarted(NcImportEntry);

        Success := CODEUNIT.Run(CODEUNIT::"Nc Import Mgt.",NcImportEntry);
    ...
    local procedure MarkAsStarted(var NcImportEntry: Record "Nc Import Entry")
    begin
        ClearLastError;
    ...
    local procedure MarkAsCompleted(Success: Boolean;var NcImportEntry: Record "Nc Import Entry")
    var
    ...
    procedure ScheduleRetry(var NcImportEntry: Record "Nc Import Entry")
    var
        NcImportType: Record "Nc Import Type";
    begin
        if not NcImportType.Get(NcImportEntry."Import Type") then
    ...
    procedure ScheduleImport(var NcImportEntry: Record "Nc Import Entry")
    var
        SessionId: Integer;
    begin
    ...
    begin
        exit(CODEUNIT::"Nc Import Processor");
    end;
}
