codeunit 6150911 "HC Generic Web Req. Management"
{
    ...
    [TryFunction]
    procedure TryProcessRequest(var TmpHCGenericWebRequest: Record "HC Generic Web Request")
    var
        IsProcessed: Boolean;
    begin
    ...
    local procedure ProcessRequest(var HCGenericWebRequest: Record "HC Generic Web Request";var IsProcessed: Boolean)
    var
    ...
    local procedure OnBeforeProcessRequest(var HCGenericWebRequest: Record "HC Generic Web Request";var IsProcessed: Boolean)
    begin
    end;
