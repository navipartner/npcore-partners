codeunit 6014467 "Retail Journal Code"
{
    ...
    var
        ...
        RetailJournalList: Page "Retail Journal List";
        Dialog: Dialog;
        Counter: Integer;
        LineNo: Integer;
        LineCounter: Integer;
    ...
    begin
        ...
        if RetailJournalHeader.FindFirst then repeat
          ...
          LineCounter := 0;
          if RetailJournalLine.Find('-') then repeat
            Counter += 1;
            LineCounter += 1;
    ...
    procedure ExportToPeriodDiscount(var RetailJournalLine: Record "Retail Journal Line")
    var
    ...
    procedure ExportToItemJournal(var RetailJournalLine: Record "Retail Journal Line")
    var
        RetailJournalHeader: Record "Retail Journal Header";
    ...
    procedure ExportToPurchaseJournal(var RetailJournalLine: Record "Retail Journal Line")
    var
        Item: Record Item;
        RetailJournalHeader: Record "Retail Journal Header";
    ...
    procedure ExportToFile(var RetailJournalLine: Record "Retail Journal Line")
    begin
        XMLPORT.Run(XMLPORT::"Retail Journal Import/Export",true,false,RetailJournalLine);
    end;
    ...
    procedure CopyCampaign2RetailJnlLines(var PeriodDiscountLine: Record "Period Discount Line";RetailJnlCode: Code[40])
    var
    ...
    procedure CopyMix2RetailJnlLines(var MixedDiscountLine: Record "Mixed Discount Line";RetailJnlCode: Code[40])
    var
        RetailJnlLine: Record "Retail Journal Line";
    begin
        //-NPR5.46 [294354]
    ...
    procedure CopyQuantity2RetailJnlLines(var QuantityDiscountLine: Record "Quantity Discount Line";RetailJnlCode: Code[40])
    var
        RetailJnlLine: Record "Retail Journal Line";
    begin
        //-NPR5.46 [294354]
    ...
    begin
        ...
        if RetailJnlCode <> '' then begin
          ...
          if PAGE.RunModal(PAGE::"Retail Journal List", RetailJnlHeader) <> ACTION::LookupOK then
            exit(false);
    ...
    procedure CopySalesReturn2RetailJnlLines(var AuditRoll: Record "Audit Roll";RetailJnlCode: Code[40])
    var
        RetailJnlLine: Record "Retail Journal Line";
        Register: Record Register;
    begin
