codeunit 6014417 "Call Terminal Integration"
{
    ...
    begin
        ...
        //-NPR4.10
        //DotNetGlobals.DimSalesScreen(TRUE);
        Marshaller.DimScreen(true);
        //+NPR4.10
        ...
        //-NPR5.00
          ...
          RegisterGlobal."Credit Card Solution"::"SAGEM Flexiterm JavaScript": begin
            ...
            then begin
              Marshaller.DimScreen(false);
              Marshaller.DisplayError('',DankortProtocol.GetInitErrorText(),true);
            end;
        ...
        //-NPR5.00
          RegisterGlobal."Credit Card Solution"::Pepper: begin
            PaymentTypePOS.Get("No.");
            Register.Get("Register No.");
            ...
            then begin
              Marshaller.DimScreen(false);
              //-NPR5.22
              //Marshaller.Error('',PepperProtocol.GetInitErrorText(),TRUE);
               Marshaller.DisplayError('',PepperProtocol.GetInitErrorText(),false);
              exit;
              //+NPR5.22
            end;
            ...
            if PepperProtocol.IsOffline then begin
              ...
              //REPEAT
              //  Marshaller.DimScreen(FALSE);
              //  Marshaller.NumPadText(TextOfflineCaption,AuthorisationNo,FALSE,FALSE);
              //  IF STRLEN(AuthorisationNo) > 12 THEN
              //    Marshaller.Error('',TextAuthNoTooLong,FALSE);
              //  IF PepperProtocol.AuthNoRequired AND (STRLEN(AuthorisationNo) < 5) THEN BEGIN
              //    Marshaller.DimScreen(FALSE);
              //    Marshaller.Error('',TextAuthNoTooShort,FALSE);
              //    EXIT;
              //  END;
              //UNTIL STRLEN(AuthorisationNo) < 13;
              ...
              repeat
                ...
                if StrLen(AuthorisationNo) > MaxLengthAuthNo then
                  Marshaller.DisplayError('',StrSubstNo(PepperText003,MaxLengthAuthNo),false);
                if PepperProtocol.AuthNoRequired and (StrLen(AuthorisationNo) < MinLengthAuthNo) then begin
                  Marshaller.DimScreen(false);
                  if Marshaller.Confirm('',StrSubstNo(PepperText004,MinLengthAuthNo)) then begin
                    Marshaller.DisplayError('',PepperText005,false);
                    exit;
                  end;
                end;
        ...
        //+NPR5.46 [290734]
          ...
          RegisterGlobal."Credit Card Solution"::"MSP Navision" : begin
            //-NPR4.10
            //ERROR('No longer supported.');
            Marshaller.DisplayError('','No longer supported.',true);
            //+NPR4.10
          end;
        
          RegisterGlobal."Credit Card Solution"::"SAGEM Flexiterminal" : begin
            //-NPR5.28
          ...
          */
          ...
          RegisterGlobal."Credit Card Solution"::"SAGEM Flexitermina from server" : begin
            //-NPR5.28
            //    "Flexi-DK-dialog".Init("Amount Including VAT", Rec,
            //                           Betalingsvalg."Cardholder Verification Method", Betalingsvalg."Type of Transaction",FALSE);
            //    COMMIT;
          ...
          RegisterGlobal."Credit Card Solution"::POINT : begin
            //-NPR5.28
            //    "Flexi-DK-dialog".Init("Amount Including VAT", Rec,
            //                           Betalingsvalg."Cardholder Verification Method", Betalingsvalg."Type of Transaction",FALSE);
            //    COMMIT;
        ...
        //+NPR5.26 [248043]
          ...
          //-1.1e
          RegisterGlobal."Credit Card Solution"::"SAGEM Flexiterm .NET" : begin
            //-NPR5.28
            //    PaymentTypePOS.GET("No.");
            //    Register.GET("Register No.");
            //    "Flexi-DK-dialog".Init("Amount Including VAT", Rec,
          ...
          //+1.1e
            ...
            //-NPR4.10
            //DotNetGlobals.DimSalesScreen(FALSE);
            Marshaller.DimScreen(false);
            //+NPR4.10
