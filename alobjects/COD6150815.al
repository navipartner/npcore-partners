    ...
    begin
        ...
        case SetDocumentType of
            ...
            SetDocumentType::BlanketOrder:
                ...
                Error(ERRDOCTYPE, Format(SetDocumentType), Format(SetDocumentType::Order), Format(SetDocumentType::Invoice), Format(SetDocumentType::CreditMemo), Format(SetDocumentType::ReturnOrder));
        end;
