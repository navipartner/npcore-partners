table 6014500 "Used Goods Registration"
{
    ...
    fields
    {
        ...
        field(44;"Item Group No.";Code[10])
        {
            ...
            TableRelation = "Item Group" WHERE ("Used Goods Group"=CONST(true),
    ...
    procedure Assistedit(UsedGoodsRegistration: Record "Used Goods Registration"): Boolean
    var
        NoSeriesManagement: Codeunit NoSeriesManagement;
        RetailSetup: Record "Retail Setup";
    begin
