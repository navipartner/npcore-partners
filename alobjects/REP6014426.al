report 6014426 "Vendor Top/Sale"
{
    ...
    dataset
    {
        ...
        {
            CalcFields = "Sales (LCY)","Balance (LCY)","COGS (LCY)";
            ...
            dataitem("<Kreditorsidsteaar>";Vendor)
            {
                ...
                begin
                    if ("Sales (LCY)" = 0) and ("Balance (LCY)" = 0) and ("Sales (LCY)"-"COGS (LCY)" = 0) then
                      CurrReport.Skip;
                    ...
                    case ShowType of
                      ShowType::Varesalg :
                       begin
                        VendorAmountLastYear."Amount (LCY)" := Multipl * "Sales (LCY)";
                       end;
                      ShowType::Avance :
                        begin
                         VendorAmountLastYear."Amount (LCY)" := Multipl * ("Sales (LCY)" - "COGS (LCY)");
                        end;
                    end;

                    VendorAmountLastYear.Insert;
                    SalesLastYear += "Sales (LCY)";
                    DbLastYear += "Sales (LCY)"-"COGS (LCY)";
                end;
            ...
            begin
                ...
                case ShowType of
                  ShowType::Varesalg :
                   begin
                    VendorAmount."Amount (LCY)" := Multipl * "Sales (LCY)";
                   end;
                  ShowType::Avance :
                   begin
                    VendorAmount."Amount (LCY)" := Multipl * ("Sales (LCY)" - "COGS (LCY)");
                   end;
                end;
            ...
            begin
                ...
                q := 1;
                if VendorAmountLastYear.FindFirst then repeat
        ...
        dataitem("Integer";"Integer")
        {
            ...
            column(SalesLCY_Vendor;Vendor."Sales (LCY)")
            {
            }
            column(COGSLCY_Vendor;Vendor."COGS (LCY)")
            {
            }
            ...
            column(Stock_Vendor;Vendor3.Stock)
            {
            }
            ...
            column(Sales_LCY_Vendor2;Vendor2."Sales (LCY)")
            {
            }
            column(Profit_Vendor2;Vendor2."Sales (LCY)"-Vendor2."COGS (LCY)")
            {
            }
            ...
            begin
                ...
                if (MaxAmt <> 0) then
                  Share := Round(Vendor."Sales (LCY)" * 100 / MaxAmt,1)
                else
                  Share := 0;
                ...
                Vendor2.CalcFields("Sales (LCY)","COGS (LCY)", "Balance (LCY)");
                ...
                case ShowType of
                  ShowType::Varesalg :
                    begin
                      AmountLastYear := Vendor2."Sales (LCY)";
                      PctOfTotal := "Pct."(Vendor."Sales (LCY)", VendorSales);
                      Index       := "Pct."(Vendor."Sales (LCY)", AmountLastYear);
                    end;
                  ShowType::Avance :
                    begin
                      AmountLastYear := Vendor2."Sales (LCY)" - Vendor2."COGS (LCY)";
                      PctOfTotal := "Pct."(Vendor."Sales (LCY)"-Vendor."COGS (LCY)", VendorProfit);
                      Index       := "Pct."(Vendor."Sales (LCY)"-Vendor."COGS (LCY)", AmountLastYear);
                    end;
                end;
                ...
                DgLastYear := "Pct."(Vendor2."Sales (LCY)"-Vendor2."COGS (LCY)", Vendor2."Sales (LCY)");

                //-NPR70.00.00.00
                SalesPct := "Pct."(Vendor."Sales (LCY)", VendorSales);
                BalancePct := "Pct."(Vendor."Balance (LCY)", VendorBalance);
                //-NPR5.43 [317517]
                //ProfitPct := "Pct."(Vendor."Sales (LCY)"-Vendor."COGS (LCY)",VendorProfit);
                //+NPR5.43 [317517]
                ProfitPct2 := "Pct."(Vendor2."Sales (LCY)"-Vendor2."COGS (LCY)", DbLastYear);
                SalesPct2 := "Pct."(Vendor2."Sales (LCY)", SalesLastYear);
                IndexSales[1] := "Pct."(Vendor."Sales (LCY)", Vendor2."Sales (LCY)");
