codeunit 6151024 "NpRv Sales Doc. Mgt."
{
    ...
    procedure SelectVoucherType(var NpRvVoucherType: Record "NpRv Voucher Type"): Boolean
    var
        TempNpRvVoucherType: Record "NpRv Voucher Type" temporary;
    begin
    ...
    procedure IssueVoucher(SalesHeader: Record "Sales Header";NpRvVoucherType: Record "NpRv Voucher Type") VoucherNo: Text
    var
    ...
    procedure InsertPayment(XmlElement: DotNet npNetXmlElement;var SalesHeader: Record "Sales Header";var NpRvVoucher: Record "NpRv Voucher";Amount: Decimal): Boolean
    var
        NpRvSalesLine: Record "NpRv Sales Line";
    ...
    begin
        ...
        MagentoPaymentLine."Source Table No." := DATABASE::"NpRv Voucher";
        MagentoPaymentLine."Source No." := NpRvVoucher."No.";
        MagentoPaymentLine."External Reference No." := SalesHeader."External Order No.";
    ...
    procedure ApplyPayment(SalesHeader: Record "Sales Header";var NpRvSalesLine: Record "NpRv Sales Line")
    var
    ...
    local procedure OnBeforeDeleteMagentoPaymentLine(var Rec: Record "Magento Payment Line";RunTrigger: Boolean)
    var
        NpRvSalesLine: Record "NpRv Sales Line";
    begin
        if Rec.IsTemporary then
    ...
    begin
        ...
        if TotalAmtInclVat < SalesHeader."Magento Payment Amount" then
          Error(Text003,TotalAmtInclVat,SalesHeader."Magento Payment Amount");
    end;
    ...
    begin
        ...
        MagentoPaymentLine.SetRange("Source Table No.",DATABASE::"NpRv Voucher");
    ...
    local procedure FindVoucherTypes(var TempNpRvVoucherType: Record "NpRv Voucher Type" temporary)
    var
        NpRvVoucherType: Record "NpRv Voucher Type";
    ...
    local procedure SendVoucher(NpRvVoucher: Record "NpRv Voucher")
    var
        NpRvVoucherMgt: Codeunit "NpRv Voucher Mgt.";
        LastErrorText: Text;
    begin
