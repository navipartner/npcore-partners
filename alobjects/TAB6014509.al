table 6014509 "Warranty Directory"
{
    ...
    LookupPageID = "Warranty Catalog List";
    ...
    fields
    {
        ...
        field(8;"Customer No.";Code[20])
        {
            ...
            TableRelation = IF (Debitortype=CONST(Kontant)) Contact
                            ELSE IF (Debitortype=CONST(Alm)) Customer;
        ...
        field(101;"No. from Audit Roll";Code[20])
        {
            ...
            TableRelation = IF ("Type from Audit Roll"=CONST("G/L")) "G/L Account"."No."
                            ELSE IF ("Type from Audit Roll"=CONST(Payment)) "Payment Type POS"."No."
                            ELSE IF ("Type from Audit Roll"=CONST(Customer)) Customer."No."
                            ELSE IF ("Type from Audit Roll"=CONST(Item)) Item."No." WHERE (Blocked=CONST(false));
        ...
        {
            CalcFormula = Exist("Retail Comment" WHERE ("Table ID"=CONST(6014514),
                                                        "No."=FIELD("No.")));
            Caption = 'Comment';
    ...
    procedure TransferFromAuditRoll(var AuditRoll: Record "Audit Roll"): Boolean
    var
    ...
    begin
        ...
        if AuditRoll2.Find('-') then repeat
          LineNo += 10000;
    ...
    begin
        ...
        if ReportSelectionContract.Find('-') then repeat
    ...
    var
        ...
        RetailContractSetup2: Record "Retail Contract Setup";
        WarrantyLine: Record "Warranty Line";
