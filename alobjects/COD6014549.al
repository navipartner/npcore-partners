codeunit 6014549 "RP Line Print Mgt."
{
    // 
    ...
    begin
        case DecimalRounding of
          DecimalRounding::"2" : UpdateField(Column,Align,0,'',Format(Decimal,0,'<Precision,2:2><Standard Format,2>'));
          DecimalRounding::"3" : UpdateField(Column,Align,0,'',Format(Decimal,0,'<Precision,3:3><Standard Format,2>'));
          DecimalRounding::"4" : UpdateField(Column,Align,0,'',Format(Decimal,0,'<Precision,4:4><Standard Format,2>'));
          DecimalRounding::"5" : UpdateField(Column,Align,0,'',Format(Decimal,0,'<Precision,5:5><Standard Format,2>'));
        end;
    end;
    ...
    begin
        ...
        if TemplateHeader."Print Processing Object ID" = 0 then
          ...
          case TemplateHeader."Print Processing Object Type" of
            TemplateHeader."Print Processing Object Type"::Codeunit : CODEUNIT.Run(TemplateHeader."Print Processing Object ID", Table);
            TemplateHeader."Print Processing Object Type"::Report : REPORT.Run(TemplateHeader."Print Processing Object ID", GuiAllowed, false, Table);
          end;
    ...
    var
        OutputMgt: Codeunit "Object Output Mgt.";
    ...
    local procedure ProcessLayout(DataJoinBuffer: Codeunit "RP Data Join Buffer Mgt.";TemplateCode: Text)
    var
    ...
    local procedure RunPrintEngine(TemplateHeader: Record "RP Template Header";"Table": Variant)
    var
        TemplateLine: Record "RP Template Line";
        RecRef: RecordRef;
    ...
    begin
        ...
        PrintBuffer(TemplateHeader.Code, CODEUNIT::"RP Line Print Mgt.", 0); //Converts generic print buffer to device specific data.
    end;
    ...
    local procedure GetColumnCount(var PrintBufferIn: Record "RP Print Buffer" temporary) Columns: Integer
    begin
    ...
    local procedure MergeBuffer(var TemplateLine: Record "RP Template Line";var DataJoinBuffer: Codeunit "RP Data Join Buffer Mgt.";LowerBoundIn: Integer;UpperBoundIn: Integer)
    var
        TemplateLineChildren: Record "RP Template Line";
    ...
    local procedure EvaluateFields(TemplateLine: Record "RP Template Line";var DataJoinBuffer: Codeunit "RP Data Join Buffer Mgt."): Text[30]
    var
        Field1Val: Text[250];
        Field2Val: Text[250];
        Field1Dec: Decimal;
    ...
    begin
        ...
        case DecimalRounding of
          DecimalRounding::"2" : exit(Format(ReturnResult,0,'<Precision,2:2><Standard Format,2>'));
          DecimalRounding::"3" : exit(Format(ReturnResult,0,'<Precision,3:3><Standard Format,2>'));
          DecimalRounding::"4" : exit(Format(ReturnResult,0,'<Precision,4:4><Standard Format,2>'));
          DecimalRounding::"5" : exit(Format(ReturnResult,0,'<Precision,5:5><Standard Format,2>'));
        end;
    end;

    local procedure PrintLine(TemplateLine: Record "RP Template Line";var DataJoinBuffer: Codeunit "RP Data Join Buffer Mgt.")
    var
        Font: Text[30];
        ...
        case TemplateLine.Type of
          TemplateLine.Type::Data :
            begin
              ...
              else if TemplateLine.Attribute <> '' then begin
          ...
          TemplateLine.Type::FieldCaption :
            begin
              ...
              end else if TemplateLine.Attribute <> '' then begin
                AttributeID.SetRange(AttributeID."Table ID", TemplateLine."Data Item Table");
                AttributeID.SetRange(AttributeID."Attribute Code", TemplateLine.Attribute);
                if AttributeID.FindFirst then begin
    ...
    begin
        ...
        case GetColumnCount(Buffer) of
          1 : FieldWidth := PageWidth;
          2 :
            case Buffer."Column No." of
              1 : FieldWidth := PageWidth * TwoColumnDistribution[1];
              2 : FieldWidth := PageWidth * TwoColumnDistribution[2];
            end;
          3 :
            case Buffer."Column No." of
              1 : FieldWidth := PageWidth * ThreeColumnDistribution[1];
              2 : FieldWidth := PageWidth * ThreeColumnDistribution[2];
              3 : FieldWidth := PageWidth * ThreeColumnDistribution[3];
            end;
          4 :
            case Buffer."Column No." of
              1 : FieldWidth := PageWidth * FourColumnDistribution[1];
              2 : FieldWidth := PageWidth * FourColumnDistribution[2];
              3 : FieldWidth := PageWidth * FourColumnDistribution[3];
              4 : FieldWidth := PageWidth * FourColumnDistribution[4];
            end;
          else exit;
        end;
        ...
        if FieldWidth < StrLen(Buffer.Text) then
          ...
          case Buffer.Align of
            ...
            Buffer.Align::Center : ; //Do nothing, pass align to printer interface instead
    ...
    local procedure ParseColumnDistribution(TemplateHeader: Record "RP Template Header")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnSendPrintJob(TemplateCode: Text;CodeunitId: Integer;ReportId: Integer;var Printer: Codeunit "RP Line Printer Interface";NoOfPrints: Integer)
    begin
    end;
}
