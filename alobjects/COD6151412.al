codeunit 6151412 "Magento Attribute Set Mgt."
{
    ...
    var
        ...
        Item: Record Item;
        MagentoItemAttributes: Page "Magento Item Attributes";
    begin
        Item.Get(ItemNo);
        ...
        MagentoItemAttribute.SetRange("Attribute Set ID",Item."Attribute Set ID");
        //-MAG1.21
    ...
    var
        ...
        MagentoItemAttributeValue: Record "Magento Item Attribute Value";
    begin
        Item.TestField("Attribute Set ID");

        //-MAG1.21
        //WebVariant := Item."WebVariant Main Item No." <> '';
        //+MAG1.21

        MagentoAttributeSetValue.SetRange("Attribute Set ID",Item."Attribute Set ID");
        if MagentoAttributeSetValue.FindSet then
          repeat
            ...
            if not MagentoItemAttribute.Get(MagentoAttributeSetValue."Attribute Set ID",MagentoAttributeSetValue."Attribute ID",Item."No.",VariantCode) then begin
              ...
              MagentoItemAttribute."Attribute Set ID" := Item."Attribute Set ID";
            ...
            if MagentoAttributeLabel.FindSet then
              repeat
                ...
                end else if MagentoItemAttributeValue."Attribute Set ID" <> MagentoAttributeSetValue."Attribute Set ID" then begin
                  MagentoItemAttributeValue."Attribute Set ID" := MagentoAttributeSetValue."Attribute Set ID";
    ...
    begin
        case RecRef.Number of
          DATABASE::"Magento Attribute Set" : begin
            RecRef.SetTable(MagentoAttributeSet);
            MagentoAttributeSet.Find;
            Item.SetRange("Attribute Set ID",MagentoAttributeSet."Attribute Set ID");
            exit(Item.FindFirst);
          end;
        end;
    ...
    local procedure OnInsertCheckAttributeGroupDuplicate(var Rec: Record "Magento Attribute Group";RunTrigger: Boolean)
    var
        MagentoAttributeGroup: Record "Magento Attribute Group";
    begin
        //-MAG2.18 [323934]
