codeunit 6150902 "HC Post Temp Audit Roll"
{
    ...
    var
        Dummy: Record "HC Audit Roll Posting" temporary;
        ...
        RevisionUdbetaling: Record "HC Audit Roll Posting" temporary;
    ...
    procedure PostItemSale(var TempPost: Record "HC Audit Roll Posting" temporary)
    var
    ...
    procedure PostRegisterTransactions(var TempPost: Record "HC Audit Roll Posting" temporary)
    var
    ...
    procedure PostRegisterTransactionsPerEntry(var RevRulle: Record "HC Audit Roll Posting" temporary)
    var
        Betalingsvalg: Record "HC Payment Type POS";
        BankAccount: Record "Bank Account";
    begin
    ...
    procedure PostTransaction(AccNo: Code[20];Amount2: Decimal;CashRegisterNo: Code[10];AccType: Integer;GlobalDimension1: Code[10];ForceDesc: Text[50];PostingDate: Date;var TempPost: Record "HC Audit Roll Posting" temporary)
    var
    ...
    procedure PostTodaysGLEntries(var TempPost: Record "HC Audit Roll Posting" temporary)
    var
    ...
    procedure PosterFremValDifferencer(var Rec: Record "HC Audit Roll Posting" temporary)
    var
        DiffTekst: Label 'Cash register %1, Difference %2 %3';
        AuditRoll: Record "HC Audit Roll";
        Betalingsvalg: Record "HC Payment Type POS";
        HCAuditRoll2: Record "HC Audit Roll";
    ...
    begin
        ...
        if Betalingsvalg.FindSet then repeat
          ...
          if HCAuditRoll2.FindSet then repeat
    ...
    procedure PosterVarekladde(var RevRulle: Record "HC Audit Roll Posting" temporary;Straks: Boolean;Bogfdate: Date): Boolean
    var
    ...
    procedure PosterDebitorIndbetaling(var RevRulle: Record "HC Audit Roll Posting" temporary)
    var
        Kasse: Record "HC Register";
        ...
        TmpJrnlLineDimloc: Record TempBlob;
    ...
    procedure PosterKasseAfslutning(var Rec: Record "HC Audit Roll Posting" temporary)
    var
    ...
    procedure GetDocumentNo(var TempPost: Record "HC Audit Roll Posting" temporary): Code[20]
    var
    ...
    procedure RunPost(var Rec: Record "HC Audit Roll Posting" temporary)
    var
        BetValgRec: Record "HC Payment Type POS";
        XBonNr: Code[20];
        ChangeSum: Decimal;
        ChangeDep: Code[20];
    begin
    ...
    procedure RunPostItemLedger(var Rec: Record "HC Audit Roll Posting" temporary)
    var
        XBonNr: Code[20];
    begin
        //RunPostItemLedger
    ...
    procedure RunTest(var Rec: Record "HC Audit Roll Posting" temporary)
    var
        Vare: Record Item;
    ...
    procedure RunTransfer(var TempPost: Record "HC Audit Roll Posting" temporary;var Revisionsrulle: Record "HC Audit Roll"): Integer
    begin
        //RunTransfer()
    ...
    procedure RunTransferItemLedger(var TempPost: Record "HC Audit Roll Posting" temporary;var Revisionsrulle: Record "HC Audit Roll"): Integer
    begin
    ...
    procedure RemoveSuspendedPayouts(var Rulle: Record "HC Audit Roll Posting" temporary)
    var
        nCount: Integer;
        nTotal: Integer;
    ...
    procedure RunUpdateChanges(var TempPost: Record "HC Audit Roll Posting" temporary)
    begin
        //RunUpdateChanges()
        if WindowIsOpen then
    ...
    procedure PostDayClearing(var TempAuditRoll: Record "HC Audit Roll Posting" temporary;var PaymentType: Record "HC Payment Type POS";Amount: Decimal)
    begin
        //PostDayClearing()
    ...
    procedure CreateRetPurchOrder(AuditRoll: Record "HC Audit Roll Posting"): Boolean
    var
    ...
    procedure CreateRetPurchHeader(var PurchaseHeader: Record "Purchase Header";AuditRoll: Record "HC Audit Roll Posting")
    begin
        PurchaseHeader.Init;
    ...
    procedure CreateRetPurchLines(PurchaseHeader: Record "Purchase Header";AuditRoll: Record "HC Audit Roll Posting")
    var
        PurchaseLine: Record "Purchase Line";
        AuditRollTemp: Record "HC Audit Roll";
    begin
    ...
    local procedure GetPaymentPostingSetup(BCPaymentTypePOS: Record "HC Payment Type POS";BCRegisterCode: Code[10]): Code[20]
    var
        BCRegister: Record "HC Register";
        BCPaymentTypePostingSetup: Record "HC Payment Type Posting Setup";
    begin
