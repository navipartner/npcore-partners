codeunit 6150808 "POS Action - Quantity"
{
    ...
    local procedure SetEanBoxEventInScopeQtyStar(EanBoxSetupEvent: Record "Ean Box Setup Event";EanBoxValue: Text;var InScope: Boolean)
    var
    ...
    begin
        //-NPR5.45 [319706]
        exit(CODEUNIT::"POS Action - Quantity");
        //+NPR5.45 [319706]
    end;
}
