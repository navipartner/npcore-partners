table 6150627 "POS Workshift Checkpoint"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum ("POS Workshift Checkpoint"."Direct Turnover (LCY)" WHERE("POS Unit No." = FIELD("POS Unit No. Filter"),
                                                                                        Type = FIELD("Type Filter"),
                                                                                        "POS Entry No." = FIELD("POS Entry No. Filter"),
                                                                                        Open = FIELD("Open Filter")));
        ...
        {
            CalcFormula = Sum ("POS Workshift Checkpoint"."Rounding (LCY)" WHERE("POS Unit No." = FIELD("POS Unit No. Filter"),
                                                                                 Type = FIELD("Type Filter"),
                                                                                 "POS Entry No." = FIELD("POS Entry No. Filter"),
                                                                                 Open = FIELD("Open Filter")));
