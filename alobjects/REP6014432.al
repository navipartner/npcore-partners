report 6014432 "Customer Analysis"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layouts/Customer Analysis.rdlc';
                ...
                case ShowType of
                  ShowType::Sales :
                    begin
                      ...
                      CustomerAmountTemp2."Amount 3 (LCY)" := Multipl * Customer1."Profit (LCY)";
                    end;
                  ShowType::Balance :
                     begin
                  ...
                  ShowType::Margin :
                    begin
                     ...
                     CustomerAmountTemp2."Amount 2 (LCY)" := Multipl * Customer1."Sales (LCY)";
                     CustomerAmountTemp2."Amount 3 (LCY)" := Multipl * Customer1."Balance (LCY)";
                    end;
                end;
                  ...
                  case ShowType of
                    ShowType::Sales :
                      begin
                        ...
                        CustProfitDKK1  += -CustomerAmountTemp2."Amount 3 (LCY)";
                      end;
                    ShowType::Balance :
                      begin
                    ...
                    ShowType::Margin :
                      begin
                        CustSalesDKK1   += -CustomerAmountTemp2."Amount 2 (LCY)";
                        CustBalanceDKK1  += -CustomerAmountTemp2."Amount 3 (LCY)";
                        CustProfitDKK1  += -CustomerAmountTemp2."Amount (LCY)";
                     end;
                  end;

                CustomerAmountTemp2.Location := Number;
        ...
        dataitem("Integer";"Integer")
        {
            ...
            begin
                ...
                if CustomerAmountTemp2.FindFirst then
                  LastLocation := CustomerAmountTemp2.Location
                else begin
