codeunit 6014629 "Managed Package Builder"
{
    ...
    trigger GlobalJArray::ListChanged(sender: Variant;e: DotNet npNetListChangedEventArgs)
    begin
    end;

    trigger GlobalJArray::AddingNew(sender: Variant;e: DotNet npNetAddingNewEventArgs)
    begin
    end;

    trigger GlobalJArray::CollectionChanged(sender: Variant;e: DotNet npNetNotifyCollectionChangedEventArgs)
    begin
    end;
}
