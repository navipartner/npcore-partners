codeunit 6060138 "MM POS Action - Member Mgmt."
{
    ...
    begin
        ...
        case DialogPrompt of
          ...
          1: DialogMethodType := DialogMethod::FACIAL_RECOGNITION;
          2: DialogMethodType := DialogMethod::NO_PROMPT;
          else
        ...
        if (WorkflowStep = '9') then begin
          case FunctionId of
            0: MemberArrival (POSSession, DialogMethodType, MemberCardNumber);
            1: SelectMembership (POSSession, DialogMethodType, MemberCardNumber);
            2: ViewMembershipEntry (POSSession, DialogMethodType, MemberCardNumber);
            3: RegretMembership (POSSession, DialogMethodType, MemberCardNumber);
            4: RenewMembership (POSSession, DialogMethodType, MemberCardNumber);
            5: ExtendMembership (POSSession, DialogMethodType, MemberCardNumber);
            6: UpgradeMembership (POSSession, DialogMethodType, MemberCardNumber);
    ...
    local procedure UpdateMembershipOnSaleLineInsert(POSSalesWorkflowStep: Record "POS Sales Workflow Step";SaleLinePOS: Record "Sale Line POS")
    var
    ...
    procedure MemberArrival(POSSession: Codeunit "POS Session";InputMethod: Option;ExternalMemberCardNo: Text[100])
    var
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
    ...
    procedure SelectMembership(POSSession: Codeunit "POS Session";InputMethod: Option;var ExternalMemberCardNo: Text[100]) MembershipSelected: Boolean
    var
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
    ...
    local procedure CancelMembership(POSSession: Codeunit "POS Session";InputMethod: Option;ExternalMemberCardNo: Text[100])
    var
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
        MembershipManagement: Codeunit "MM Membership Management";
    ...
    local procedure RenewMembership(POSSession: Codeunit "POS Session";InputMethod: Option;ExternalMemberCardNo: Text[100])
    var
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
        MembershipManagement: Codeunit "MM Membership Management";
        MembershipAlterationSetup: Record "MM Membership Alteration Setup";
    ...
    local procedure UpgradeMembership(POSSession: Codeunit "POS Session";InputMethod: Option;ExternalMemberCardNo: Text[100])
    var
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
        MembershipManagement: Codeunit "MM Membership Management";
        MembershipAlterationSetup: Record "MM Membership Alteration Setup";
    ...
    local procedure ExtendMembership(POSSession: Codeunit "POS Session";InputMethod: Option;ExternalMemberCardNo: Text[100])
    var
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
        MembershipManagement: Codeunit "MM Membership Management";
        MembershipAlterationSetup: Record "MM Membership Alteration Setup";
    ...
    local procedure RegretMembership(POSSession: Codeunit "POS Session";InputMethod: Option;ExternalMemberCardNo: Text[100])
    var
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
        MembershipManagement: Codeunit "MM Membership Management";
        MembershipAlterationSetup: Record "MM Membership Alteration Setup";
    ...
    local procedure ViewMembershipEntry(POSSession: Codeunit "POS Session";InputMethod: Option;ExternalMemberCardNo: Text[100])
    var
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
        MembershipManagement: Codeunit "MM Membership Management";
    ...
    local procedure EditMembership(POSSession: Codeunit "POS Session";InputMethod: Option;ExternalMemberCardNo: Text[100])
    var
        POSSaleLine: Codeunit "POS Sale Line";
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
        MembershipManagement: Codeunit "MM Membership Management";
    ...
    local procedure AddItemToPOS(POSSession: Codeunit "POS Session";MemberInfoEntryNo: Integer;ExternalItemNo: Code[20];Description: Text[80];Description2: Text[80];Quantity: Decimal;UnitPrice: Decimal;var SaleLinePOS: Record "Sale Line POS")
    var
    ...
    local procedure DeleteMemberInfoCapture(SaleLinePOS: Record "Sale Line POS")
    var
        MemberInfoCapture: Record "MM Member Info Capture";
        MemberRetailIntegration: Codeunit "MM Member Retail Integration";
    begin
    ...
    procedure OnAssociateSaleWithMember(POSSession: Codeunit "POS Session";ExternalMembershipNo: Code[20];ExternalMemberNo: Code[20])
    begin
    end;

    [IntegrationEvent(false, false)]
    procedure OnBeforePOSMemberArrival(SaleLinePOS: Record "Sale Line POS";CommunityCode: Code[20];MembershipCode: Code[20];MembershipEntryNo: Integer;MemberEntryNo: Integer;MemberCardEntryNo: Integer;ScannedCardNumber: Text[100])
    begin
    end;
