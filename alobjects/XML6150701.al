xmlport 6150701 "POS Menu Export/Import"
{
    ...
    schema
    {
        ...
        {
            tableelement("POS Menu";"POS Menu")
            {
                AutoReplace = true;
                XmlName = 'POSMenu';
                ...
                tableelement("POS Menu Button";"POS Menu Button")
                {
                    AutoReplace = true;
                    ...
                    tableelement("POS Parameter Value";"POS Parameter Value")
                    {
