report 6060108 "Balancing Ticket IV"
{
    // 001 Af MG 7/12-01
    ...
    dataset
    {
        dataitem("Audit Roll";"Audit Roll")
        {
            ...
            begin
                ...
                if RevRulleTilgodebevis.FindFirst then repeat
        ...
        dataitem("Payment Type POS";"Payment Type POS")
        {
        ...
        dataitem(Gavekort;"Payment Type POS")
        {
            DataItemTableView = SORTING("No.","Register No.");
        ...
        dataitem("Fremmed Gavekort";"Payment Type POS")
        {
            DataItemTableView = SORTING("No.","Register No.");
        ...
        dataitem(Tilgodebevis;"Payment Type POS")
        {
            DataItemTableView = SORTING("No.","Register No.");
        ...
        dataitem("Fremmed Tilgodebevis";"Payment Type POS")
        {
            DataItemTableView = SORTING("No.","Register No.");
        ...
        dataitem(TerminalCard;"Payment Type POS")
        {
            DataItemTableView = SORTING("No.","Register No.");
        ...
        dataitem(OtherCreditCards;"Payment Type POS")
        {
            DataItemTableView = SORTING("No.","Register No.");
        ...
        dataitem(ManualCards;"Payment Type POS")
        {
            DataItemTableView = SORTING("No.","Register No.");
        ...
        dataitem(Terminal;"Payment Type POS")
        {
            DataItemTableView = SORTING("No.","Register No.");
        ...
        dataitem(ForeignCurrency;"Payment Type POS")
        {
        ...
        dataitem(Gavekortrabatkonto;"G/L Account")
        {
            ...
            column(GLEntryInAuditRoll_Gavekortrabatkonto;"G/L Entry in Audit Roll")
            {
            }
            ...
            begin
                ...
                Gavekortrabatkonto.SetRange("Register Filter", GlobalPeriod."Register No.");
                Gavekortrabatkonto.SetFilter("Sales Ticket No. Filter",'%1..%2',
                                             GlobalPeriod."Opening Sales Ticket No.",
                                             GlobalPeriod."Sales Ticket No.");
                Gavekortrabatkonto.CalcFields("G/L Entry in Audit Roll");
            end;
        ...
        {
            DataItemTableView = SORTING("No.") WHERE("Retail Payment"=CONST(true));
            column(NameNo_GLAccount;Name+'  '+Format("No."))
            {
            }
            column(GLEntryInAuditRoll_GLAccount;"G/L Entry in Audit Roll")
            {
            }
            ...
            begin
                ...
                "G/L Account".SetRange("Register Filter", GlobalPeriod."Register No.");
                "G/L Account".SetFilter("Sales Ticket No. Filter",'%1..%2',GlobalPeriod."Opening Sales Ticket No.",GlobalPeriod."Sales Ticket No.");
                "G/L Account".CalcFields("G/L Entry in Audit Roll");
            end;
        }
        dataitem(PaymentTypeCounting;"Payment Type POS")
        {
            ...
            dataitem("Period Line";"Period Line")
            {
    ...
    var
        ...
        Revisionsrulle2: Record "Audit Roll";
        Opsaetning: Record "Retail Setup";
        Primo: Decimal;
        ...
        Linierabat: Decimal;
        Linierabpct: Decimal;
        Kasserec: Record Register;
        TitelTXT: Text[50];
        Sidstebon: Code[30];
        Ekspeditionstaeller: Integer;
        OpenTime: Time;
        CloseTime: Time;
        RevRulleTilgodebevis: Record "Audit Roll";
        TilgodeInd: Decimal;
        TilgodeUd: Decimal;
        Kasserecsidste: Record Register;
