table 6014507 "Accessory Unfold Worksheet"
{
    ...
    local procedure CalcAmountPct(AccessorySparePart: Record "Accessory/Spare Part"): Decimal
    var
        AccessorySparePart2: Record "Accessory/Spare Part";
        SalesAmount: Decimal;
