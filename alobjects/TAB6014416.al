table 6014416 "Alternative No."
{
    ...
    LookupPageID = "Alternative Number";
    ...
    fields
    {
        field(1;"Code";Code[20])
        {
            ...
            TableRelation = IF (Type=CONST(Item)) Item."No."
                            ...
                            ELSE IF (Type=CONST(SalesPerson)) "Salesperson/Purchaser".Code;
        ...
        field(2;"Alt. No.";Code[20])
        {
            ...
            TableRelation = IF (Type=CONST(Item)) Item
                            ...
                            ELSE IF (Type=CONST(Register)) Register
                            ELSE IF (Type=CONST(SalesPerson)) "Salesperson/Purchaser"
                            ELSE IF (Type=CONST("CRM Customer")) Contact;
