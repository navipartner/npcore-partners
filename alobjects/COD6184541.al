codeunit 6184541 "EFT NETS BAXI Protocol"
{
    ...
    begin
        case EftTransactionRequest."Processing Type" of
          ...
          EftTransactionRequest."Processing Type"::GIFTCARD_LOAD : DepositTransaction(EftTransactionRequest);
          ...
          EftTransactionRequest."Processing Type"::AUXILIARY :
            case EftTransactionRequest."Auxiliary Operation ID" of
              ...
              2 : DownloadDataset(EftTransactionRequest);
              3 : DownloadSoftware(EftTransactionRequest);
              4 : Reconciliation(EftTransactionRequest);
            end;
        end;
    end;
    ...
    var
        TransactionRequest: DotNet npNetTransactionRequest3;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTNETSBAXIIntegration: Codeunit "EFT NETS BAXI Integration";
        EFTNETSBAXIPaymentSetup: Record "EFT NETS BAXI Payment Setup";
        OpenParameters: DotNet npNetOpenParameters;
    begin
    ...
    local procedure DepositTransaction(EftTransactionRequest: Record "EFT Transaction Request")
    var
        TransactionRequest: DotNet npNetTransactionRequest3;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
    ...
    local procedure BuildOpenParameterObject(var OpenParameters: DotNet npNetOpenParameters;EFTTransactionRequest: Record "EFT Transaction Request")
    var
        EFTSetup: Record "EFT Setup";
        EFTNETSBAXIIntegration: Codeunit "EFT NETS BAXI Integration";
        EFTNETSBAXIPaymentSetup: Record "EFT NETS BAXI Payment Setup";
    ...
    var
        OpenRequest: DotNet npNetOpenRequest0;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTNETSBAXIIntegration: Codeunit "EFT NETS BAXI Integration";
    ...
    var
        CloseRequest: DotNet npNetCloseRequest0;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTNETSBAXIIntegration: Codeunit "EFT NETS BAXI Integration";
    ...
    var
        AdminRequest: DotNet npNetAdministrationRequest;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTNETSBAXIIntegration: Codeunit "EFT NETS BAXI Integration";
    ...
    local procedure DownloadSoftware(EftTransactionRequest: Record "EFT Transaction Request")
    var
        AdminRequest: DotNet npNetAdministrationRequest;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
    ...
    local procedure DownloadDataset(EftTransactionRequest: Record "EFT Transaction Request")
    var
        AdminRequest: DotNet npNetAdministrationRequest;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
    ...
    var
        GetLastRequest: DotNet npNetGetLastRequest;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTNETSBAXIIntegration: Codeunit "EFT NETS BAXI Integration";
    ...
    local procedure GetOptionalDataTrx(EFTTransactionRequest: Record "EFT Transaction Request";EFTNETSBAXIPaymentSetup: Record "EFT NETS BAXI Payment Setup"): Text
    var
        OptionalData: Text;
    ...
    begin
        ...
        if EFTNETSBAXIPaymentSetup.DCC then begin
          case EFTTransactionRequest."Processing Type" of
            EFTTransactionRequest."Processing Type"::PAYMENT : OptionalData += ',"autodcc": 0';
    ...
    var
        EFTNETSBAXIRespParser: Codeunit "EFT NETS BAXI Resp. Parser";
        EntryNo: Integer;
    ...
    local procedure HandleParseError(var EFTNETSBAXIRespParser: Codeunit "EFT NETS BAXI Resp. Parser")
    var
        EftEntryNo: Integer;
        EFTTransactionRequest: Record "EFT Transaction Request";
        EFTNETSBAXIIntegration: Codeunit "EFT NETS BAXI Integration";
