codeunit 6014420 "Number Logic"
{
    ...
    procedure FindAlternativeNo(Text: Text[260];var AlternativeNo: Record "Alternative No."): Boolean
    begin
    ...
    procedure ForRetailDocumentLine(Text: Text[260];var RetailDocumentLines: Record "Retail Document Lines"): Boolean
    var
