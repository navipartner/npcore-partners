report 6014401 "Counter Report A4"
{
    ...
    dataset
    {
        dataitem("Audit Roll";"Audit Roll")
        {
            ...
            begin
                ...
                if AuditRoll1.FindSet then repeat
                ...
                if RetailSetup."Balancing Posting Type" = RetailSetup."Balancing Posting Type"::"PER REGISTER" then begin
                  ...
                  if Calc then begin
                    ...
                    if AuditRollCalc2.FindSet then repeat
                      case AuditRollCalc2."Discount Type" of
                        AuditRollCalc2."Discount Type"::Campaign : CampaignDiscount   := CampaignDiscount + AuditRollCalc2."Line Discount Amount";
                        AuditRollCalc2."Discount Type"::Mix :      MixDiscount        := MixDiscount + AuditRollCalc2."Line Discount Amount";
                        AuditRollCalc2."Discount Type"::Quantity : QuantityDiscount   := QuantityDiscount + AuditRollCalc2."Line Discount Amount";
                        AuditRollCalc2."Discount Type"::Manual :   ManualDiscount     := ManualDiscount + AuditRollCalc2."Line Discount Amount";
                      end;
                ...
                if AuditRollCreditVoucher.FindSet then repeat
        ...
        dataitem("G/L Account";"G/L Account")
        {
            ...
            begin
                ...
                "G/L Account".SetRange("G/L Account"."Register Filter",AuditRollCalc2."Register No.");
                end;

                if (RetailSetup."Balancing Posting Type" = RetailSetup."Balancing Posting Type"::"PER REGISTER") then begin
                  "G/L Account".SetRange("Date Filter",AuditRollCalc1."Sale Date");
                  "G/L Account".SetRange("G/L Account"."Register Filter",AuditRollCalc1."Register No.");
                end;

                //SETRANGE("Date Filter",AuditRollCalc2."Sale Date");
                //+NPR5.48 [333898]
                SetRange("Retail Payment",true);
                //-NPR5.48 [333898]
                //SETRANGE("Register Filter",AuditRollCalc2."Register No.");
                //+NPR5.48 [333898]
                CalcFields("G/L Entry in Audit Roll");
            end;
        }
        dataitem(AuditRollReturnSale;"Audit Roll")
        {
        ...
        dataitem(PaymentTypeCounting;"Payment Type POS")
        {
            ...
            dataitem(PeriodLine;"Period Line")
            {
    ...
    var
        ...
        AuditRollCalc1: Record "Audit Roll";
        AuditRollCalc2: Record "Audit Roll";
        ...
        RegisterLast: Record Register;
        AuditRoll1: Record "Audit Roll";
        Sidstebon: Code[30];
        Ekspeditionstaeller: Integer;
        Opentime: Time;
        Closetime: Time;
        AuditRollCreditVoucher: Record "Audit Roll";
