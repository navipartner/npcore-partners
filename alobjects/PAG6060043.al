page 6060043 "Item Worksheet Variety Subpage"
{
    ...
    PageType = List;
    SourceTable = "Item Worksheet Variant Line";
    ...
    procedure SetRecFromIW(ItemWorksheetLineHere: Record "Item Worksheet Line")
    var
        LocRecItemWorksheet: Record "Item Worksheet";
    begin
