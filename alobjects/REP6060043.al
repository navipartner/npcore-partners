report 6060043 "Export Excel Item Worksheet"
{
    ...
    dataset
    {
        dataitem("Item Worksheet Line";"Item Worksheet Line")
        {
            ...
            begin
                ...
                if ItemWorksheetVariantLine.FindSet then begin
                  repeat
                    ...
                    if MappingFound then begin
                      if ItemWorksheetVariantLine."Existing Item No." <> '' then
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Item No."),Format(ItemWorksheetVariantLine."Existing Item No."),false,false,'',ExcelBuf."Cell Type"::Text)
                      else
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Item No."),Format(ItemWorksheetVariantLine."Item No."),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo(Description),Format(ItemWorksheetVariantLine.Description),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Item Category Code"),Format("Item Category Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Product Group Code"),Format("Product Group Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Vendor Item No."),Format("Vendor Item No."),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Tariff No."),Format("Tariff No."),false,false,'',ExcelBuf."Cell Type"::Text);
                      if ItemWorksheetVariantLine."Sales Price" <> 0 then
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Sales Price"),Format(ItemWorksheetVariantLine."Sales Price"),false,false,'',ExcelBuf."Cell Type"::Number)
                      else
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Sales Price"),Format("Sales Price"),false,false,'',ExcelBuf."Cell Type"::Number);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Sales Price Currency Code"),Format("Sales Price Currency Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                      if ItemWorksheetVariantLine."Direct Unit Cost" <> 0 then
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Direct Unit Cost"),Format(ItemWorksheetVariantLine."Direct Unit Cost"),false,false,'',ExcelBuf."Cell Type"::Number)
                      else
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Direct Unit Cost"),Format("Direct Unit Cost"),false,false,'',ExcelBuf."Cell Type"::Number);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Purchase Price Currency Code"),Format("Purchase Price Currency Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Vendor No."),Format("Vendor No."),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Item Group"),Format("Item Group"),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Variety Group"),Format("Variety Group"),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Variant Line",ItemWorksheetVariantLine.FieldNo("Variety 1 Value"),Format(ItemWorksheetVariantLine."Variety 1 Value"),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Variant Line",ItemWorksheetVariantLine.FieldNo("Variety 2 Value"),Format(ItemWorksheetVariantLine."Variety 2 Value"),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Variant Line",ItemWorksheetVariantLine.FieldNo("Variety 3 Value"),Format(ItemWorksheetVariantLine."Variety 3 Value"),false,false,'',ExcelBuf."Cell Type"::Text);
                      MapCell(RowNo,DATABASE::"Item Worksheet Variant Line",ItemWorksheetVariantLine.FieldNo("Variety 4 Value"),Format(ItemWorksheetVariantLine."Variety 4 Value"),false,false,'',ExcelBuf."Cell Type"::Text);
                      if ItemWorksheetVariantLine."Recommended Retail Price" <> 0 then
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Recommended Retail Price"),Format(ItemWorksheetVariantLine."Recommended Retail Price"),false,false,'',ExcelBuf."Cell Type"::Number)
                      else
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Recommended Retail Price"),Format("Recommended Retail Price"),false,false,'',ExcelBuf."Cell Type"::Number);
                      //-NPR5.23 [242329]
                      if ItemWorksheetVariantLine."Internal Bar Code" <> '' then
                        MapCell(RowNo,DATABASE::"Item Worksheet Variant Line",ItemWorksheetVariantLine.FieldNo("Internal Bar Code"),Format(ItemWorksheetVariantLine."Internal Bar Code"),false,false,'',ExcelBuf."Cell Type"::Text)
                      else
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Internal Bar Code"),Format("Internal Bar Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                      if ItemWorksheetVariantLine."Vendors Bar Code" <> '' then
                        MapCell(RowNo,DATABASE::"Item Worksheet Variant Line",ItemWorksheetVariantLine.FieldNo("Vendors Bar Code"),Format(ItemWorksheetVariantLine."Vendors Bar Code"),false,false,'',ExcelBuf."Cell Type"::Text)
                      else
                        MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Vendors Bar Code"),Format("Vendors Bar Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                      //+NPR5.23 [242329]
                      //-NPR5.23 [242498]
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Net Weight"),Format("Net Weight"),false,false,'',ExcelBuf."Cell Type"::Number);
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Gross Weight"),Format("Gross Weight"),false,false,'',ExcelBuf."Cell Type"::Number);
                      //+NPR5.23 [242498]
                      //-NPR5.25 [246088]
                      MapAllColumns(RowNo,DATABASE::"Item Worksheet Line",false,false,'');
                      //+NPR5.25 [246088]
                      MapAttributeCells(RowNo,DATABASE::"Item Worksheet Line",false,false,'',ExcelBuf."Cell Type"::Number);
                    end else begin
                    //+NPR5.22
                      if ItemWorksheetVariantLine."Existing Item No." <> '' then
                  ...
                  if MappingFound then begin
                    if ItemWorksheetVariantLine."Existing Item No." <> '' then
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Item No."),Format("Existing Item No."),false,false,'',ExcelBuf."Cell Type"::Text)
                    else
                      MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Item No."),Format("Item No."),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo(Description),Format(Description),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Item Category Code"),Format("Item Category Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Product Group Code"),Format("Product Group Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Vendor Item No."),Format("Vendor Item No."),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Tariff No."),Format("Tariff No."),false,false,'',ExcelBuf."Cell Type"::Text);
                    ...
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Item Group"),Format("Item Group"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Variety Group"),Format("Variety Group"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Variety 1"),Format("Variety 1"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Variety 2"),Format("Variety 2"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Variety 3"),Format("Variety 3"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Variety 4"),Format("Variety 4"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Recommended Retail Price"),Format("Direct Unit Cost"),false,false,'',ExcelBuf."Cell Type"::Number);
                    //-NPR5.23 [242329]
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Vendors Bar Code"),Format("Vendors Bar Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                    MapCell(RowNo,DATABASE::"Item Worksheet Line",FieldNo("Internal Bar Code"),Format("Internal Bar Code"),false,false,'',ExcelBuf."Cell Type"::Text);
                    //+NPR5.23 [242329]
    ...
    begin
        ...
        if ItemWorksheetExcelColumn.FindFirst then repeat
    ...
    begin
        ...
        ItemWorksheetExcelColumn.SetRange("Map to Table No.",TableNo);
        if ItemWorksheetExcelColumn.FindSet then repeat
          AttributeKey.Reset;
