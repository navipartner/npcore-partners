table 6150732 "POS Sales Workflow Set Entry"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup ("POS Sales Workflow".Description WHERE(Code = FIELD("Workflow Code")));
        ...
        {
            CalcFormula = Count ("POS Sales Workflow Step" WHERE("Set Code" = FIELD("Set Code"),
