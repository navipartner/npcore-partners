report 6014403 "Cashed Gift Vouchers"
{
          ...
          RetailSetup.ChangeCompany(Company.Name);
            if (RetailSetup.Get) and (RetailSetup."Company No." <> '') then begin
              ...
              if TMPBuffer.Insert then begin
                ...
                case Counter of
                  1: CompanyVisible1 := true;
                  2: CompanyVisible2 := true;
                  3: CompanyVisible3 := true;
                  4: CompanyVisible4 := true;
                  5: CompanyVisible5 := true;
                  6: CompanyVisible6 := true;
                  7: CompanyVisible7 := true;
                  8: CompanyVisible8 := true;
                end;
                Counter := Counter + 1;
              end;
            end;
    ...
    begin
        TMPBuffer.Reset;
        if TMPBuffer.FindSet then repeat
