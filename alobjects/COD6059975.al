codeunit 6059975 "Variety ShowTables"
{
    ...
    var
        VRTMatrixBool: Page "Variety Matrix Bool";
    begin
        //-VRT1.11
    ...
    local procedure C6059971_OnDrillDownEvent(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024])
    var
        RecRef: RecordRef;
        FRef: FieldRef;
