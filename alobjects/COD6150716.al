codeunit 6150716 "POS Stargate Management"
{
    ...
    procedure AppGatewayProtocol(ActionName: Text;StepName: Text;EventName: Text;SerializedData: Text;DoCallback: Boolean;FrontEnd: Codeunit "POS Front End Management")
    var
        ResponseData: Text;
        Handled: Boolean;
    begin
    ...
    procedure AppGatewayProtocolClosed(ActionName: Text;StepName: Text;SerializedData: Text;Forced: Boolean;FrontEnd: Codeunit "POS Front End Management")
    var
        ResponseData: Text;
        Handled: Boolean;
    begin
    ...
    local procedure InstallMissingAssemblies(FrontEnd: Codeunit "POS Front End Management";Method: Text;ActionName: Text;Step: Text)
    var
    ...
    local procedure ThrowUnsupportedStargateMethodError(FrontEnd: Codeunit "POS Front End Management";Method: Text;ActionName: Text)
    var
        ErrorMessage: Text;
    begin
        ErrorMessage :=
    ...
    local procedure ThrowTooManyAttemptsError(Method: Text;FrontEnd: Codeunit "POS Front End Management";ActionName: Text)
    begin
        ResetRequestState(ActionName);
        FrontEnd.AbortWorkflows();
        FrontEnd.ReportBug(
    ...
    [BusinessEvent(false)]
    local procedure OnDeviceDoesNotSupportStargate(ActionName: Text;Response: Text;POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnAppGatewayProtocol(FrontEnd: Codeunit "POS Front End Management";ActionName: Text;Step: Text;EventName: Text;Data: Text;ResponseRequired: Boolean;var ReturnData: Text;var Handled: Boolean)
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnAppGatewayProtocolClosed(FrontEnd: Codeunit "POS Front End Management";ActionName: Text;Step: Text;Data: Text;Forced: Boolean;var Handled: Boolean)
    begin
    end;
}
