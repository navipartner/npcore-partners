codeunit 6059977 "Variety Setup Wizard"
{
    ...
    begin
        ...
        if TMPBusinessChoiceSelectionBuffer.FindSet then repeat
    ...
    begin
        ...
        if TMPProductChoiceSelectionBuffer.FindSet then repeat
          case TMPProductChoiceSelectionBuffer.Code of
            //Shoes
            'FR_MEN': InsertShoe_FRMen;
            'US_MEN': InsertShoe_USMen;
            'UK_MEN': InsertShoe_UKMen;
            'IT_MEN': InsertShoe_ITMen;
            'FR_WOMEN': InsertShoe_FRWomen;
            'US_WOMEN': InsertShoe_USWomen;
            'UK_WOMEN': InsertShoe_UKWomen;
            'IT_WOMEN': InsertShoe_ITWomen;

            //Clothes
            'SHIRT' : InsertShirts;
            'PANTS2' : InsertPants2;
            'PANTS3' : InsertPants3;
            'T-SHIRT' : InsertTShirts;
