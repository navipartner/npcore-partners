table 6014433 "Posted Document Buffer"
{
    ...
    begin
        ...
        PAGE.Run(PAGE::"Posted Documents",Rec);
    end;
        ...
        case RecID.TableNo of
          DATABASE::"Sales Header":
            case "Document Type" of
              "Document Type"::"Prepayment Invoice": begin
                SalesInvoiceHeader.Get("Document No.");
                PAGE.Run(PAGE::"Posted Sales Invoice",SalesInvoiceHeader);
              end;
              "Document Type"::"Prepayment Credit Memo": begin
