codeunit 6151205 "NpCs POS Session Mgt."
{
    ...
    local procedure UpdateCollectDocumentDelivery(NpCsSaleLinePOSReference: Record "NpCs Sale Line POS Reference")
    var
    ...
    local procedure DeliverCollectDocument(POSSalesWorkflowStep: Record "POS Sales Workflow Step";SalePOS: Record "Sale POS")
    var
        NpCsDocument: Record "NpCs Document";
        NpCsCollectMgt: Codeunit "NpCs Collect Mgt.";
    begin
    ...
    begin
        exit(CODEUNIT::"NpCs POS Session Mgt.");
    end;
}
