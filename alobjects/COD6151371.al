codeunit 6151371 "CS Communication"
{
    ...
    local procedure GetNextRecord(MiniFormLine: Record "CS UI Line"): Integer
    begin
        exit(RecRef.Next);
    end;
    ...
    local procedure GetFieldValue(MiniFormLine: Record "CS UI Line") ReturnValue: Text
    var
        "Field": Record "Field";
        FldRef: FieldRef;
    ...
    procedure GetNextUI(ActualMiniFormHeader: Record "CS UI Header";var MiniformHeader2: Record "CS UI Header")
    begin
        if not MiniformHeader2.Get(ActualMiniFormHeader."Next UI") then
          Error(Text005,ActualMiniFormHeader.Code);
    end;

    procedure GetCallUI(MiniFormCode: Code[20];var MiniformHeader2: Record "CS UI Header";ReturnTextValue: Text[250])
    var
        MiniformLine: Record "CS UI Line";
    begin
        MiniformLine.Reset;
    ...
    var
        MiniformFunction: Record "CS UI Function";
        MiniformFunctionGroup: Record "CS UI Function Group";
    begin
    ...
    trigger XMLDOM::NodeInserting(sender: Variant;e: DotNet npNetXmlNodeChangedEventArgs)
    begin
    end;

    trigger XMLDOM::NodeInserted(sender: Variant;e: DotNet npNetXmlNodeChangedEventArgs)
    begin
    end;

    trigger XMLDOM::NodeRemoving(sender: Variant;e: DotNet npNetXmlNodeChangedEventArgs)
    begin
    end;

    trigger XMLDOM::NodeRemoved(sender: Variant;e: DotNet npNetXmlNodeChangedEventArgs)
    begin
    end;

    trigger XMLDOM::NodeChanging(sender: Variant;e: DotNet npNetXmlNodeChangedEventArgs)
    begin
    end;

    trigger XMLDOM::NodeChanged(sender: Variant;e: DotNet npNetXmlNodeChangedEventArgs)
    begin
    end;
}
