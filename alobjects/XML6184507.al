xmlport 6184507 "M2 Shopper Recognition"
{
    ...
    schema
    {
        ...
        {
            tableelement(tmpshopperrecognitionrequest;"EFT Shopper Recognition")
            {
                XmlName = 'Request';
                UseTemporary = true;
                textelement(Account)
            ...
            textelement(Response)
            {
                ...
                tableelement(tmpshopperrecognitionresponse;"EFT Shopper Recognition")
                {
                    MaxOccurs = Once;
                        ...
                        textattribute(Type)
                        {
                            ...
                            begin
                                ...
                                case TmpShopperRecognitionResponse."Entity Type" of
                                  TmpShopperRecognitionResponse."Entity Type"::Contact  : Type := 'Contact';
                                  TmpShopperRecognitionResponse."Entity Type"::Customer : Type := 'Customer';
                                end;
                            end;
                        }
    ...
    procedure GetRequest(var EFTShopperRecognition: Record "EFT Shopper Recognition" temporary)
    begin
    ...
    procedure SetResponse(var EFTShopperRecognition: Record "EFT Shopper Recognition" temporary)
    begin
