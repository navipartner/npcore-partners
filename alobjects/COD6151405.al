codeunit 6151405 "Magento Order Status Mgt."
{
    ...
    var
        ...
        MagentoPmtMgt: Codeunit "Magento Nc Task Card Mgt.";
    ...
    begin
        ...
        if not MagentoOrderStatus.Get(SalesInvHeader."Order No.") then
          exit;
        if MagentoOrderStatus."External Order No." <> SalesInvHeader."External Order No." then
          exit;
    ...
    begin
        ...
        MagentoOrderStatus."External Order No." := Rec."External Order No.";
    ...
    begin
        ...
        if not MagentoOrderStatus.Get(Rec."No.") then
          exit;
        if MagentoOrderStatus."External Order No." <> Rec."External Order No." then
          exit;
