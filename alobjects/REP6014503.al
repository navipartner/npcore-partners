report 6014503 "Repair Guarantee"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './layouts/Repair Guarantee.rdlc';
    ...
    dataset
    {
        dataitem("Customer Repair";"Customer Repair")
        {
            ...
            dataitem(ErrorCustomerRepairJournal;"Customer Repair Journal")
            {
            ...
            dataitem(RepairCustomerRepairJournal;"Customer Repair Journal")
            {
                DataItemLink = "Customer Repair No."=FIELD("No.");
