tableextension 70000007 tableextension70000007 extends "Sales Cr.Memo Header" 
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("Magento Payment Line".Amount WHERE ("Document Table No."=CONST(114),
