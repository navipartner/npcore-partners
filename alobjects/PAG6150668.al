page 6150668 "NPRE Select Print Categories"
{
    ...
    procedure SetDataset(var PrintCategory: Record "NPRE Print/Prod. Category")
    begin
        //-NPR5.55 [360258]
        Copy(PrintCategory);
        //+NPR5.55 [360258]
    ...
    procedure GetDataset(var PrintCategory: Record "NPRE Print/Prod. Category")
    var
        RecRef: RecordRef;
        FldRef: FieldRef;
        i: Integer;
    ...
    procedure SetAssignedFlowStatusRecordset(var AssignedFlowStatusIn: Record "NPRE Assigned Flow Status")
    begin
        //-NPR5.55 [382428]
    ...
    procedure GetAssignedFlowStatusRecordset(var AssignedFlowStatusOut: Record "NPRE Assigned Flow Status")
    begin
        //-NPR5.55 [382428]
