codeunit 6060062 "Process Catalog File"
{
    ...
    begin
        case GetExtension("Document Name") of
          'CSV'    : ProcessCSVFile(Rec);
          'ZIP','' : ProcessZipFile(Rec);
        end;
    end;
    ...
    begin
        ...
        FileManagement.ExtractZipFile(TemporaryPath + GetZipFilename,ServerTempPath);
        FileManagement.GetServerDirectoryFilesList(TempNameValueBuffer,ServerTempPath);

        //Process fields
        if TempNameValueBuffer.FindFirst then repeat
