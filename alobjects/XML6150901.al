xmlport 6150901 "HC POS Entry"
{
    ...
    schema
    {
        textelement(postransaction)
        {
            ...
            {
                MaxOccurs = Once;
                tableelement(posentry;"POS Entry")
                {
                    XmlName = 'posentry';
                    UseTemporary = true;
                    ...
                    tableelement(posledgerregister;"POS Period Register")
                    {
                        LinkTable = POSEntry;
                        MaxOccurs = Once;
                        MinOccurs = Zero;
                    ...
                    tableelement(possalesline;"POS Sales Line")
                    {
                        LinkTable = POSEntry;
                        MinOccurs = Zero;
                    ...
                    tableelement(pospaymentline;"POS Payment Line")
                    {
                        LinkTable = POSEntry;
                        MinOccurs = Zero;
                    ...
                    tableelement(postaxamountline;"POS Tax Amount Line")
                    {
                        LinkTable = POSEntry;
                        MinOccurs = Zero;
                    ...
                    tableelement(posbalancingline;"POS Balancing Line")
                    {
                        LinkTable = POSEntry;
                        MinOccurs = Zero;
