table 6059937 "RSS Feed Channel Subscription"
{
    // NPR5.22/TJ/20160407 CASE 233762 Added new fields Url, Show As New Within and Default

    Caption = 'RSS Feed Channel Subscription';
    DrillDownPageID = "RSS Feed Channel Subscriptions";
    LookupPageID = "RSS Feed Channel Subscriptions";
    ...
    var
        RssFeedChSub: Record "RSS Feed Channel Subscription";
