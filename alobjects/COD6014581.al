codeunit 6014581 "Retail Report Selection Mgt."
{
    ...
    local procedure RunOptionalSelection(var ReportSelection: Record "Report Selection Retail";var RecRefIn: RecordRef)
    var
        OptionString: Text;
        Itt: Integer;
        Option: Integer;
    begin
        ...
        if ReportSelection.FindSet then repeat
          case true of
            ReportSelection."Print Template" <> ''     : OptionString += DelChr(ReportSelection."Print Template", '=', ',') + ',';
            ReportSelection."Report Name" <> ''    : OptionString += DelChr(ReportSelection."Report Name", '=', ',') + ',';
            ReportSelection."Codeunit Name" <> ''  : OptionString += DelChr(ReportSelection."Codeunit Name", '=', ',') + ',';
            ReportSelection."XML Port Name" <> '' : OptionString += DelChr(ReportSelection."XML Port Name", '=', ',') + ',';
          end;
    ...
    local procedure RunSelection(var ReportSelection: Record "Report Selection Retail";var RecRefIn: RecordRef)
    var
        Variant: Variant;
        ...
        RecRef: RecordRef;
        RecordView: Text;
        TaskLine: Record "Task Line" temporary;
                  ...
                  case RecRef.Number of
                    ...
                    DATABASE::"Retail Journal Line" :
                      begin
                        ...
                        if RetailJournalLine.FindSet then repeat
    ...
    local procedure OnAfterRunReportSelectionRecord(ReportSelectionRetail: Record "Report Selection Retail";RecRef: RecordRef)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterRunReportSelectionType(ReportSelectionRetail: Record "Report Selection Retail";RecRef: RecordRef)
    begin
    end;
}
