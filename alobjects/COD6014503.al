codeunit 6014503 "I-Comm"
{
    ...
    procedure CreateGiftVoucherSQL(var GiftVoucher: Record "Gift Voucher")
    var
        RecRef: RecordRef;
    begin
        //OpretGavekort
        RecRef.Open(DATABASE::"Gift Voucher");
    ...
    procedure DBGiftVoucher(var GiftVoucher: Record "Gift Voucher";IsLocal: Boolean;Status: Boolean;Update: Boolean;var GiftVoucherAmount: Decimal): Integer
    var
        RecRef: RecordRef;
        "Field": FieldRef;
        StatusInt: Integer;
    ...
    procedure DBCreditVoucher(var CreditVoucher: Record "Credit Voucher";IsLocal: Boolean;Status: Boolean;Update: Boolean;var CreditVoucherAmount: Decimal): Integer
    var
        RecRef: RecordRef;
        "Field": FieldRef;
        StatusInt: Integer;
    begin
        //DBTilgodebevis()
        RecRef.Open(DATABASE::"Credit Voucher");
    ...
    var
        TestGiftVoucher: Record "Gift Voucher";
    begin
        //TestFremmedGavekort()
    ...
    var
        TestCreditVoucher: Record "Credit Voucher";
    begin
