codeunit 6150818 "POS Action - Set Tax Area Code"
{
    ...
    local procedure SetTaxAreaCode(Context: DotNet JObject;POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
        JSON: Codeunit "POS JSON Management";
