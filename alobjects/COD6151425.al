codeunit 6151425 "Magento Proj. Avail. Balance"
{
    ...
    local procedure CalcProjectedAvailableInventory(MagentoSetup: Record "Magento Setup";ItemNo: Code[20];VariantFilter: Text;LocationFilter: Text;var StockQty: Decimal;var Handled: Boolean)
    var
        Item: Record Item;
    ...
    procedure UpsertStockTriggers(MagentoSetup: Record "Magento Setup";NpXmlTemplate: Record "NpXml Template";var Handled: Boolean)
    var
        Item: Record Item;
    ...
    local procedure TriggerToItem(MagentoSetup: Record "Magento Setup";RecRef: RecordRef;var TempItem: Record Item temporary;var Handled: Boolean)
    var
        Item: Record Item;
        ItemLedgerEntry: Record "Item Ledger Entry";
    ...
    begin
        exit(CODEUNIT::"Magento Proj. Avail. Balance");
    end;
    ...
    local procedure IsSubscriber(MagentoSetup: Record "Magento Setup"): Boolean
    begin
