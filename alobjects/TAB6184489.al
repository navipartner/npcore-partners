table 6184489 "Pepper EFT Result Code"
{
    ...
    DrillDownPageID = "Pepper EFT Result Codes";
    LookupPageID = "Pepper EFT Result Codes";
    ...
    fields
    {
        ...
        field(15;"Transaction Subtype Code";Code[10])
        {
            ...
            TableRelation = "Pepper EFT Transaction Subtype".Code WHERE ("Integration Type Code"=FIELD("Integration Type"),
