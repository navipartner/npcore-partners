table 6014426 "Retail Document Lines"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Document No.';
            TableRelation = "Retail Document Header"."No." WHERE ("Document Type"=FIELD("Document Type"));
        }
        ...
        field(5;"No.";Code[20])
        {
            ...
            TableRelation = IF (Type=CONST(" ")) "Standard Text"
                            ...
                            ELSE IF (Type=CONST("Catalouge items")) "Nonstock Item";
            ...
            trigger OnValidate()
            var
                NumberLogic: Codeunit "Number Logic";
            begin
                case Type of
                  Type::Item :
                    begin
    ...
    procedure TransferFromSaleLinePOS(var SaleLinePOS: Record "Sale Line POS")
    begin
    ...
    begin
        ...
        Field.Get(DATABASE::"Retail Document Lines",FieldNumber);
