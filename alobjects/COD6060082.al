codeunit 6060082 "MCS Recommendations Handler"
{
    ...
    begin
        ...
        if TempMCSRecommendationsLine.FindSet then repeat
    ...
    begin
        ...
        if MCSRecommendationsLine.FindSet then begin
          ...
          if SaleLinePOS.FindSet then repeat
            ...
            if MCSRecommendationsLine.FindSet then repeat
    ...
    begin
        ...
        until TempMCSRecommendationsLine.Next = 0;
        if TempMCSRecommendationsLine2.FindSet then repeat
        ...
        if TempMCSRecommendationsLine.FindLast then repeat
    ...
    begin
        //-NPR5.34 [275206]
        exit(TypeHelper.IsMatch(InputText,'^[a-zA-Z0-9-_]*$'));
        //+NPR5.34 [275206]
    end;
}
