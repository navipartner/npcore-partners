page 6060035 "GIM - Document Template"
{
    Caption = 'GIM - Document Template';
    Editable = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part(SubPage;"GIM - Subpage Template")
            {
            }
        }
    }
    ...
    begin
        ...
        case "Table ID" of
          DATABASE::"Sales Header": CurrPage.SubPage.PAGE.SetEntity(ImpDoc,DATABASE::"Sales Line");
          DATABASE::"Purchase Header": CurrPage.SubPage.PAGE.SetEntity(ImpDoc,DATABASE::"Purchase Line");
        end;
    end;
