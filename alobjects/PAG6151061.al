page 6151061 "Distribution Matrix"
{
    ...
    var
        MatrixDistributionLines: array[12] of Record "Distribution Lines";
        Item: Record Item;
    ...
    var
        ...
        DistributionGroupMembersGV: Record "Distribution Group Members";
        DistributionLinesGV: Record "Distribution Lines";
        DistributionHeadersGV: Record "Distribution Headers";
    ...
    var
        ...
        DistributionLinesPage: Page "Distribution Lines";
    begin
    ...
    procedure Load(var DistributionHeaders: Record "Distribution Headers")
    var
