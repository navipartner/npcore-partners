table 6060051 "Item Worksheet Excel Column"
{
        ...
        field(60; "Process as"; Option)
        {
            ...
            begin
                case "Process as" of
                    ...
                    "Process as"::Item:
                        begin
                            Validate("Map to Table No.", DATABASE::"Item Worksheet Line");
                            Validate("Map to Attribute Code", '');
                        end;
                    "Process as"::"Item Variant":
                        begin
                            Validate("Map to Table No.", DATABASE::"Item Worksheet Variant Line");
                            Validate("Map to Attribute Code", '');
                        end;
