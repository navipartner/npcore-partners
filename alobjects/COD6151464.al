codeunit 6151464 "M2 Category Mgt."
{
    ...
    var
        ...
        TempMagentoCategory: Record "Magento Category" temporary;
    ...
    local procedure RemoveCategory(var MagentoCategory: Record "Magento Category")
    var
