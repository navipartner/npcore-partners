codeunit 6014546 "RP Matrix Printer Interface"
{
    ...
    var
        Bound: Boolean;
        BlasterCLPCommandLibrary: Codeunit "RP Blaster CPL Device Library";
        CitizenCLPCommandLibrary: Codeunit "RP Citizen CLP Device Library";
        ZebraZPLCommandLibrary: Codeunit "RP Zebra ZPL Device Library";
        EpsonLabelCommandLibrary: Codeunit "RP Epson Label Device Library";
    ...
    begin
        ...
        case true of
          BlasterCLPCommandLibrary.IsThisDevice(PrinterDevice) : BlasterBound := BindSubscription(BlasterCLPCommandLibrary);
          CitizenCLPCommandLibrary.IsThisDevice(PrinterDevice) : CitizenBound := BindSubscription(CitizenCLPCommandLibrary);
          ZebraZPLCommandLibrary.IsThisDevice(PrinterDevice) : ZebraBound := BindSubscription(ZebraZPLCommandLibrary);
          EpsonLabelCommandLibrary.IsThisDevice(PrinterDevice) : EpsonBound := BindSubscription(EpsonLabelCommandLibrary);
          else
