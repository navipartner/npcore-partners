page 6014432 "Audit Roll"
{
        ...
        area(processing)
        {
            ...
            group("Credit Card")
            {
                ...
                action("Credit Transaction List")
                {
                    ...
                    Image = "Action";
                    RunObject = Page "Credit card transaction list";
                }
                action("EFT Receipt")
                {
                    Caption = 'EFT Receipt';
                ...
                action("Show credit Card Transaction")
                {
                    ...
                    begin
                        ...
                        if CreditCardTransaction.Find('-') then
                          ...
                          PAGE.RunModal(PAGE::"Credit card transaction ticket",CreditCardTransaction)
                        else
                          Message(Text10600006,"Sales Ticket No.","Register No.");
                    end;
                }
            ...
            group(Functions)
            {
                        ...
                        case "Document Type" of
                          ...
                          "Document Type"::Order:
                            begin
                              ...
                              SalesShipmentHeader.SetRange("Sales Ticket No.",SalesTicketNo);
                ...
                action(Comment)
                {
                    ...
                    begin
                        RetailComment.SetRange("Table ID",DATABASE::"Audit Roll");
                ...
                action("Sales Ticket Statistics")
                {
                    ...
                    begin
                        ...
                        PAGE.RunModal(PAGE::"Audit Roll Statistics",AuditRollGlobal);
                    end;
                }
    ...
    var
        AuditRollGlobal: Record "Audit Roll";
