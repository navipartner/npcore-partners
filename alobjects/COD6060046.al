codeunit 6060046 "Item Wsht.-Register Line"
{
    ...
    Permissions = TableData "Registered Item Worksheet"=imd,
                  ...
                  TableData "Reg. Item Wsht Variant Line"=imd;
    ...
    var
        ...
        RegisteredWorksheet: Record "Registered Item Worksheet";
        RegisteredWorksheetLine: Record "Registered Item Worksheet Line";
        RegisteredWorksheetVariantLine: Record "Reg. Item Wsht Variant Line";
        RegisteredWorksheetVarietyValue: Record "Reg. Item Wsht Variety Value";
        ...
        ItemWorksheetItemManagement: Codeunit "Item Worksheet Item Management";
              ...
              case ItemWkshVariantLine.Action of
                ...
                ItemWkshVariantLine.Action :: Update :
                  begin
                    ...
                    ItemVariant.Blocked := ItemWkshVariantLine.Blocked;
    ...
    begin
        ...
        with Item do begin
          ...
          //+NPR5.26 [250745]
            Validate("Item Group",ItemWkshLine."Item Group");
          ...
          "Variety 1 Table" := ItemWkshLine."Variety 1 Table (New)";
          "Variety 2" := ItemWkshLine."Variety 2";
          "Variety 2 Table" := ItemWkshLine."Variety 2 Table (New)";
          "Variety 3" := ItemWkshLine."Variety 3";
          "Variety 3 Table" := ItemWkshLine."Variety 3 Table (New)";
          "Variety 4" := ItemWkshLine."Variety 4";
          "Variety 4 Table" := ItemWkshLine."Variety 4 Table (New)";
    ...
    local procedure UpdateAndCopyVarieties(var ItemworkshLine: Record "Item Worksheet Line";VarietyNo: Integer;Variety: Code[20];VarietyTableFrom: Code[20];VarietyTableTo: Code[20];CreateCopy: Boolean;CopyValues: Boolean)
    var
        VarietyTableOld: Record "Variety Table";
        PrefixCode: Code[20];
        SuffixCode: Code[20];
        NewTableCode: Code[20];
        VarietyGroup: Record "Variety Group";
        VarietyValue: Record "Variety Value";
        NewVarietyTable: Record "Variety Table";
    ...
    begin
        if CreateCopy then begin
          ...
          if (VarietyTableTo = '') or (VarietyTableFrom = VarietyTableTo) then begin
            ...
            case VarietyNo of
              1:  if (VarietyGroup."Copy Naming Variety 1" = VarietyGroup."Copy Naming Variety 1"::TableCodeAndNoSeries) and
                    (VarietyGroup."No. Series" <> '') then
                    NoSeriesMgt.InitSeries(VarietyGroup."No. Series",'',WorkDate,SuffixCode,VarietyGroup."No. Series");
              2:  if (VarietyGroup."Copy Naming Variety 2" = VarietyGroup."Copy Naming Variety 2"::TableCodeAndNoSeries) and
                    (VarietyGroup."No. Series" <> '') then
                    NoSeriesMgt.InitSeries(VarietyGroup."No. Series",'',WorkDate,SuffixCode,VarietyGroup."No. Series");
              3:  if (VarietyGroup."Copy Naming Variety 3" = VarietyGroup."Copy Naming Variety 3"::TableCodeAndNoSeries) and
                    (VarietyGroup."No. Series" <> '') then
                    NoSeriesMgt.InitSeries(VarietyGroup."No. Series",'',WorkDate,SuffixCode,VarietyGroup."No. Series");
              4:  if (VarietyGroup."Copy Naming Variety 4" = VarietyGroup."Copy Naming Variety 4"::TableCodeAndNoSeries) and
                    (VarietyGroup."No. Series" <> '') then
                    NoSeriesMgt.InitSeries(VarietyGroup."No. Series",'',WorkDate,SuffixCode,VarietyGroup."No. Series");
            end;
            ...
            //-NPR4.19
            case VarietyNo of
              1: ItemworkshLine."Variety 1 Table (New)" := NewTableCode;
              2: ItemworkshLine."Variety 2 Table (New)" := NewTableCode;
              3: ItemworkshLine."Variety 3 Table (New)" := NewTableCode;
              4: ItemworkshLine."Variety 4 Table (New)" := NewTableCode;
            end;
            //+NPR4.19
          end else begin
    ...
    local procedure FindNewVarietyNames(ItemWkshLine: Record "Item Worksheet Line";VarietyNo: Integer;Variety: Code[20];VarietyTableFrom: Code[20];VarietyTableTo: Code[20];CreateCopy: Boolean): Code[50]
    var
        VarietyTableOld: Record "Variety Table";
        PrefixCode: Code[20];
        SuffixCode: Code[20];
    ...
    var
        ExistingVarityValue: Record "Variety Value";
        VarietyTable: Record "Variety Table";
        NewVarietyValue: Record "Variety Value";
    begin
        //-NPR4.19
    ...
    local procedure CreateVariant(var ItemWkshVariantLine: Record "Item Worksheet Variant Line")
    begin
        //-NPR5.29 [263917]
        ...
        //+NPR5.22
        ItemVariant."Variety 1" := ItemWkshVariantLine."Variety 1";
        ItemVariant."Variety 1 Table" := ItemWkshVariantLine."Variety 1 Table";
        ItemVariant."Variety 1 Value" := ItemWkshVariantLine."Variety 1 Value";
        ItemVariant."Variety 2" := ItemWkshVariantLine."Variety 2";
        ItemVariant."Variety 2 Table" := ItemWkshVariantLine."Variety 2 Table";
        ItemVariant."Variety 2 Value" := ItemWkshVariantLine."Variety 2 Value";
        ItemVariant."Variety 3" := ItemWkshVariantLine."Variety 3";
        ItemVariant."Variety 3 Table" := ItemWkshVariantLine."Variety 3 Table";
        ItemVariant."Variety 3 Value" := ItemWkshVariantLine."Variety 3 Value";
        ItemVariant."Variety 4" := ItemWkshVariantLine."Variety 4";
        ItemVariant."Variety 4 Table" := ItemWkshVariantLine."Variety 4 Table";
        ItemVariant."Variety 4 Value" := ItemWkshVariantLine."Variety 4 Value";
        ItemVariant.Blocked := ItemWkshVariantLine.Blocked;
    ...
    begin
        ...
        AttributeKey.SetFilter ("Table ID", '=%1', DATABASE::"Item Worksheet Line");
    ...
    var
        RegisteredItemWorksheet: Record "Registered Item Worksheet";
    begin
    ...
    var
        ...
        ItemWorksheeVarieties: Record "Item Worksheet Variety Value";
    ...
    begin
        ...
        if SalesPrice.FindFirst then begin
          ...
          if not SalesPrice."Is Master" then begin
            SalesPrice.Validate("Master Record Reference",Format(SalesPrice.RecordId));
        ...
        if SalesPrice.FindFirst then begin
          ...
          if SalesPriceMaster.FindFirst then begin
            ...
            if (SalesPriceMaster."Unit Price" <> VariantSalesPrice) and (not OnlyCloseExistingPrices) then begin
              SalesPrice.Validate("Variant Code");
              SalesPrice.Validate("Unit Price",VariantSalesPrice);
              SalesPrice.Validate("Is Master",false);
              SalesPrice.Validate("Ending Date",SalesPriceEndDate);
              SalesPrice.Insert(true);
            end;
          end else begin
    ...
    [BusinessEvent(false)]
    local procedure OnBeforeRegisterLine(var ItemWorksheetLine: Record "Item Worksheet Line")
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnBeforeRegisterVariantLine(var ItemWorksheetVariantLine: Record "Item Worksheet Variant Line")
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnAfterRegisterLine(var ItemWorksheetLine: Record "Item Worksheet Line")
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnAfterRegisterVariantLine(var ItemWorksheetVariantLine: Record "Item Worksheet Variant Line")
    begin
    end;
    ...
    local procedure ValidateFields(var VarItem: Record Item;var VarItemWkshLine: Record "Item Worksheet Line";DoValidateFields: Boolean;DoInsertChangeRecords: Boolean)
    var
    ...
    local procedure MapField(ItemWorksheetFieldSetup: Record "Item Worksheet Field Setup";SourceFldRef: FieldRef;var TargetFldRef: FieldRef): Boolean
    var
    ...
    local procedure InsertChangeRecord(ParItemWorksheetLine: Record "Item Worksheet Line";ParItemWorksheetFieldSetup: Record "Item Worksheet Field Setup";SourceFldRef: FieldRef;TargetFldRef: FieldRef)
    var
        ItemWorksheetFieldChange: Record "Item Worksheet Field Change";
    begin
        with ItemWorksheetFieldChange do begin
          ...
          Validate("Table No.",DATABASE::"Item Worksheet Line");
