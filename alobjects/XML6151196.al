xmlport 6151196 "NpCs Collect Documents"
{
        ...
        textelement(collect_documents)
        {
            tableelement(tempnpcsdocument;"NpCs Document")
            {
                ...
                textelement(log_entries)
                {
                    MaxOccurs = Once;
                    MinOccurs = Zero;
                    tableelement(tempnpcsdocumentlogentry;"NpCs Document Log Entry")
                    {
    ...
    local procedure FindNpCsDocument(var NpCsDocument: Record "NpCs Document"): Boolean
    begin
    ...
    local procedure FindNpCsArchDocument(var NpCsArchDocument: Record "NpCs Arch. Document"): Boolean
    begin
    ...
    procedure GetSourceTable(var TempNpCsDocumentTo: Record "NpCs Document" temporary)
    begin
    ...
    local procedure ArchDocLog2DocLog(NpCsArchDocumentLogEntry: Record "NpCs Arch. Document Log Entry";var NpCsDocumentLogEntry: Record "NpCs Document Log Entry")
    begin
