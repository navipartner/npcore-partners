codeunit 6151512 "NpXml Batch Processing"
{
    ...
    local procedure ProcessNpXmlBatch(var NpXmlTemplate: Record "NpXml Template")
    var
    ...
    local procedure FindNpXmlTemplate(JobQueueEntry: Record "Job Queue Entry";var NpXmlTemplate: Record "NpXml Template"): Boolean
    var
        TemplateCode: Text;
    begin
        Clear(NpXmlTemplate);
    ...
    begin
        exit(CODEUNIT::"NpXml Batch Processing");
    end;
    ...
    procedure ScheduleBatchTask(NpXmlTemplate: Record "NpXml Template";var JobQueueEntry: Record "Job Queue Entry")
    begin
        JobQueueEntry.Init;
