    ...
    fields
    {
        ...
        field(31;"Dependency Code";Code[10])
        {
            ...
            TableRelation = IF ("Dependency Type"=FILTER(Logo|Background)) "Web Client Dependency".Code WHERE (Type=CONST(DataUri))
                            ELSE IF ("Dependency Type"=CONST(Stylesheet)) "Web Client Dependency".Code WHERE (Type=CONST(CSS))
                            ELSE IF ("Dependency Type"=CONST(JavaScript)) "Web Client Dependency".Code WHERE (Type=CONST(JavaScript));
