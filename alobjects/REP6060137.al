report 6060137 "MM Membership Batch Renew"
{
    ...
    dataset
    {
        dataitem(ReportMembership;"MM Membership")
        {
            ...
            var
                ...
                MembershipAlterationJnlPage: Page "MM Membership Alteration Jnl";
                LogMessage: Text;
            ...
            area(content)
            {
                field(MembershipCode;MembershipCode)
                {
                    ...
                    var
                        ...
                        PageAction: Action;
                        MembershipSetupPage: Page "MM Membership Setup";
                    begin
    ...
    local procedure DoRenew(Membership: Record "MM Membership";RenewUsingItem: Code[20];var ReasonText: Text): Boolean
    var
    ...
    local procedure AddToJournal(Membership: Record "MM Membership")
    var
        MemberInfoCapture: Record "MM Member Info Capture";
        MembershipManagement: Codeunit "MM Membership Management";
        FromDate: Date;
    ...
    local procedure LogToJournal(Membership: Record "MM Membership";Reason: Text)
    var
        MemberInfoCapture: Record "MM Member Info Capture";
    begin
