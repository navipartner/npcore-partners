report 6014447 "Sales Invoice A4 (Retail)"
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header";"Sales Invoice Header")
        {
            ...
            dataitem(KopiLoekke;"Integer")
            {
                ...
                dataitem(SideLoekke;"Integer")
                {
                    ...
                    dataitem("Sales Invoice Line";"Sales Invoice Line")
                    {
                        ...
                        column(SerialNotCreated;'Serienr: '+Format("Serial No. not Created"))
                        {
                        }
                        ...
                        column(SerialNonotCreated_SalesInvoiceLine;"Sales Invoice Line"."Serial No. not Created")
                        {
                        }
            ...
            var
                ...
                Bestilling: Record "Retail Document Header";
            begin
                if "Order No." = '' then
                  OrdreNrTekst := ''
                else
                ...
                case NPRopsaetning."Base for FIK-71" of
                  NPRopsaetning."Base for FIK-71"::Invoice : "Betalings-ID" := PadStr('',13 - StrLen("No."),'0') + "No." + '0';
    ...
    var
        ...
        NPRopsaetning: Record "Retail Setup";
        ...
        Dow: Text[10];
        TxtWoy: Text[30];
        Retaildoc: Record "Retail Document Header";
