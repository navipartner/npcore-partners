codeunit 6150861 "POS Action - Doc. Import"
{
    ...
    local procedure SetPosSaleCustomer(POSSale: Codeunit "POS Sale";CustomerNo: Code[20])
    var
        SalePOS: Record "Sale POS";
    begin
        //-NPR5.54 [387428]
    ...
    local procedure SelectDocument(POSSession: Codeunit "POS Session";var SalesHeader: Record "Sales Header";DocumentType: Integer;SalesDocViewString: Text;LocationSource: Option "POS Store","Location Filter Parameter";LocationFilter: Text): Boolean
    var
    ...
    begin
        ...
        case LocationSource of
          LocationSource::"POS Store": begin
    ...
    local procedure ImportFromDocument(Context: JsonObject; POSSession: Codeunit "POS Session"; FrontEnd: Codeunit "POS Front End Management"; var SalesHeader: Record "Sales Header")
    var
        JSON: Codeunit "POS JSON Management";
        RetailSalesDocImpMgt: Codeunit "Retail Sales Doc. Imp. Mgt.";
        SalePOS: Record "Sale POS";
    ...
    begin
        ...
        case POSParameterValue.Name of
          ...
          'SalesDocViewString' : Caption := CaptionSalesView;  //NPR5.54 [387130]
          //-NPR5.54 [387428]
          'LocationFrom' : Caption := CaptionLocationFrom;
          'LocationFilter' : Caption := CaptionLocationFilter;
          //+NPR5.54 [387428]
        end;
    end;
    ...
    begin
        ...
        case POSParameterValue.Name of
          ...
          'SalesDocViewString' : Caption := DescSalesView;  //NPR5.54 [387130]
          //-NPR5.54 [387428]
          'LocationFrom' : Caption := DescLocationFrom;
          'LocationFilter' : Caption := DescLocationFilter;
          //+NPR5.54 [387428]
        end;
    end;
    ...
    begin
        ...
        case POSParameterValue.Name of
          ...
          'LocationFrom' : Caption := OptionLocationFrom;  //NPR5.54 [387428]
        end;
    end;
    ...
    local procedure GetPOSMenuButtonLocationFilter(POSSession: Codeunit "POS Session"): Text
    var
    ...
    begin
        ...
        if not POSParameterValue.Get(DATABASE::"POS Menu Button",POSMenuButton."Menu Code",POSMenuButton.ID,POSMenuButton.RecordId,'LocationFrom') then
          exit('');
        ...
        case POSParameterValue.Value of
          ...
          'Location Filter Parameter':
            begin
              if not POSParameterValue.Get(DATABASE::"POS Menu Button",POSMenuButton."Menu Code",POSMenuButton.ID,POSMenuButton.RecordId,'LocationFilter') then
