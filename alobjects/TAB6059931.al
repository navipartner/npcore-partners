table 6059931 "Doc. Exch. Setup"
{
    // NPR5.25/TJ/20160629 CASE 242206 New field added: 110 File Export Enabled
    // NPR5.25/BR/20160725 CASE 246088 Added new fields for unmatched items
    // NPR5.29/BR/20170117 CASE 263705 New Fields added for FTP Import
    ...
    fields
    {
        ...
        field(151;"Unmatched Items Wsht. Name";Code[10])
        {
            ...
            Description = 'NPR5.25';
            TableRelation = "Item Worksheet".Name WHERE ("Item Template Name"=FIELD("Unmatched Items Wsht. Template"));
        }
