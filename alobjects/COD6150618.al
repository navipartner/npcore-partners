codeunit 6150618 "POS Entry Output Log Mgt."
{
    ...
    local procedure CreatePOSEntryOutputLog(RecRef: RecordRef;ReportSelectionRetail: Record "Report Selection Retail")
    var
    ...
    local procedure OnAfterRunReportSelectionTypeCreatePOSEntryOutputLog(ReportSelectionRetail: Record "Report Selection Retail";RecRef: RecordRef)
    begin
