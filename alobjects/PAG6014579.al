page 6014579 "Retail List"
{
    ...
    procedure GetSelectionFilter(var lines: Record "Retail List")
    var
        t001: Label 'No lines chosen';
        t002: Label 'Only one line chosen. Continue?';
        lines2: Record "Retail List";
    begin
        // GetSelectionFilter
    ...
    procedure SetRec(var TempRetailList: Record "Retail List" temporary)
    begin
        //-NPR5.26 [241549]
    ...
    procedure GetRec(var TempRetailListOut: Record "Retail List" temporary)
    begin
        //-NPR5.26 [241549]
