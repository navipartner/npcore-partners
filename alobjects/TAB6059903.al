table 6059903 "Task Queue"
{
    ...
    DrillDownPageID = "Task Queue";
    LookupPageID = "Task Queue";
    ...
    fields
    {
        ...
        field(3;"Task Batch";Code[10])
        {
            Caption = 'Task Batch';
            NotBlank = true;
            TableRelation = "Task Batch".Name WHERE ("Journal Template Name"=FIELD("Task Template"));
        }
        field(4;"Task Line No.";Integer)
        {
            Caption = 'Task Line No.';
            NotBlank = true;
            TableRelation = "Task Line"."Line No." WHERE ("Journal Template Name"=FIELD("Task Template"),
        ...
        {
            CalcFormula = Max("Task Log (Task)"."Ending Time" WHERE ("Journal Template Name"=FIELD("Task Template"),
                                                                     "Journal Batch Name"=FIELD("Task Batch"),
    ...
    procedure SetupNewLine(TaskLine: Record "Task Line";UseCurrentDateTime: Boolean)
    var
