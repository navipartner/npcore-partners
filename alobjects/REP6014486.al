report 6014486 "Retail Document A4"
{
    ...
    dataset
    {
        dataitem("Retail Document Header";"Retail Document Header")
        {
            ...
            var
                ...
                Retailcomments: Record "Retail Comment";
                i: Integer;
                t001: Label 'Week';
            ...
            begin
                  ...
                  Delivery::Collected :
                    begin
                      ...
                      case "Shipping Type" of
                        "Shipping Type"::"External carrier" : TxtDeliveryType += ' ' + Format("Shipping Type");
                      end;
                    end;
                  Delivery::Shipped :
                ...
                if Retailcomments.FindFirst then repeat
