table 6059908 "Session Log"
{
    ...
    DrillDownPageID = "Session Log";
    LookupPageID = "Session Log";
    ...
    procedure AddLogin(TaskWorker: Record "Task Worker") AddedEntryNo: Integer
    var
    ...
    procedure AddLogout(TaskWorker: Record "Task Worker") AddedEntryNo: Integer
    var
        TaskLog: Record "Task Log (Task)";
    begin
        //-TQ1.29
    ...
    local procedure InitLine(TaskWorker: Record "Task Worker")
    begin
        Init;
        "Entry No." := 0;
    ...
    procedure LogStartSession(MasterTaskWorker: Record "Task Worker";TaskQueue: Record "Task Queue") AddedEntryNo: Integer
    var
        TaskLog: Record "Task Log (Task)";
    begin
        //-TQ1.29
