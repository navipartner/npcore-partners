codeunit 6150697 "Retail Data Model AR Upgrade"
{
    ...
    var
        TmpAuditRollBuffer: Record "Audit Roll" temporary;
    ...
    var
        ...
        xAuditRoll: Record "Audit Roll";
        LastAuditRoll: Record "Audit Roll";
    ...
    local procedure InsertPOSSaleLine(var AuditRoll: Record "Audit Roll";var POSEntry: Record "POS Entry";var POSSalesLine: Record "POS Sales Line")
    var
        AuditRolltoPOSEntryLink: Record "Audit Roll to POS Entry Link";
            ...
            AuditRoll.Type::"Debit Sale":
              begin
                ...
                case AuditRoll."Customer Type" of
                  AuditRoll."Customer Type"::"Ord." : POSEntry."Customer No." := AuditRoll."Customer No.";
                  AuditRoll."Customer Type"::Cash : POSEntry."Contact No." := AuditRoll."Customer No.";
                end;
              end;
            else
    ...
    local procedure InsertPOSPaymentLine(var AuditRoll: Record "Audit Roll";var POSEntry: Record "POS Entry";var POSPaymentLine: Record "POS Payment Line")
    var
        AuditRolltoPOSEntryLink: Record "Audit Roll to POS Entry Link";
    begin
    ...
    local procedure InsertPOSBalancingLine(var AuditRoll: Record "Audit Roll";var POSEntry: Record "POS Entry";var POSLedgerRegister: Record "POS Period Register";var POSBalancingLine: Record "POS Balancing Line")
    var
        AuditRolltoPOSEntryLink: Record "Audit Roll to POS Entry Link";
        CashRegister: Record Register;
        CashRegPeriod: Record Period;
    ...
    procedure BufferAuditRollLink(var AuditRoll: Record "Audit Roll")
    begin
    ...
    local procedure UpdatePOSEntry(var POSEntry: Record "POS Entry";var AuditRoll: Record "Audit Roll")
    begin
    ...
    local procedure FinalizePOSEntry(var POSEntry: Record "POS Entry";var AuditRoll: Record "Audit Roll")
    begin
    ...
    local procedure RecalulatePOSEntry(var POSEntry: Record "POS Entry")
    var
