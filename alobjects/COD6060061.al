codeunit 6060061 "Import Vendor Catalog File"
{
    ...
    var
        ...
        CatalogNonstockManagement: Codeunit "Catalog Nonstock Management";
    begin
        with NonstockItem do begin
          ...
          */
          ...
          if NPRAttribute.FindSet then repeat
    ...
    begin
        with Item do begin
          ...
          if "Item Group" = '' then
            ...
            //+NPR5.45
              Validate("Item Group",ItemCategoryMapping."Item Group");
          //+NPR5.45
          Modify;
        end;
    end;
    ...
    var
        ItemCrossReference: Record "Item Cross Reference";
        CatalogSupplier: Record "Catalog Supplier";
    begin
