codeunit 6184497 "Pepper Protocol"
{
    ...
    var
        ...
        EFTRecoveryTransactionRequest: Record "EFT Transaction Request";
    ...
    procedure Init(pAmount: Decimal;pCashbackAmount: Decimal;var pSaleLinePOS: Record "Sale Line POS";pcvm: Integer;pOnOffline: Integer;BarcodeTransfer: Boolean): Boolean
    var
    ...
    begin
        with ParCreditCardTransaction do begin
          ...
          //-NPR5.35 [285804]
          case ReceiptType of
            ReceiptType::MERCHANT: Validate("Receipt No.",1);
            ReceiptType::CUSTOMER: Validate("Receipt No.",2);
          end;
          //+NPR5.35 [285804]
          Validate(Type,0);
    ...
    local procedure FindTerminalSetupFromRegister(RegisterNo: Code[10];var VarPepperTerminal: Record "Pepper Terminal";var VarPepperInstance: Record "Pepper Instance";var VarPepperConfiguration: Record "Pepper Configuration";var VarPepperVersion: Record "Pepper Version"): Boolean
    var
    ...
    var
        ...
        PepperTerminalList: Page "Pepper Terminal List";
        PepperVersionList: Page "Pepper Version List";
        PepperConfigurationList: Page "Pepper Configuration List";
        PepperInstances: Page "Pepper Instances";
        PepperTerminalCard: Page "Pepper Terminal Card";
        PepperTerminalTypes: Page "Pepper Terminal Types";
    ...
    procedure FindTerminalCode(Register: Record Register): Code[10]
    begin
        //-NPR5.27 [255131]
    ...
    var
        LocSaleLinePOS: Record "Sale Line POS";
        SalesAmount: Decimal;
    ...
    begin
        ...
        if LocSaleLinePOS.FindSet then repeat
