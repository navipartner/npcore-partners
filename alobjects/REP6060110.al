report 6060110 "Add EAN barcode to all items"
{
    ...
    dataset
    {
        dataitem(Item;Item)
        {
            ...
            begin
                ...
                if not (CheckBarcodeValid(Item."Label Barcode")) then begin
                  ...
                  FoundValid := false;
                  if AltNo.FindSet then repeat
                    if CheckBarcodeValid(AltNo."Alt. No.") then begin
                      Item."Label Barcode" := AltNo."Alt. No.";
                      Item.Modify;
                      FoundValid := true;
                    end;
    ...
    var
        ...
        Vare: Record Item;
        "alt.varenummer": Record "Alternative No.";
    begin
        //EAN13 check
    ...
    begin
        ...
        TableExportLibrary.AddTableForExport(DATABASE::"Alternative No.");
        AltNo.SetRange(Type,AltNo.Type::Item);
        TableExportLibrary.SetTableView(DATABASE::"Alternative No.", AltNo.GetView(false));
