codeunit 6059969 "Description Control"
{
    ...
    var
        ...
        DescriptionControl: Record "Description Control";
    begin
    ...
    begin
        ...
        case Desc1Setup of
          Desc1Setup::ItemDescription1:    Description1 := Item.Description;
          Desc1Setup::ItemDescription2:    Description1 := Item."Description 2";
          Desc1Setup::VariantDescription1: Description1 := ItemVariant.Description;
          Desc1Setup::VariantDescription2: Description1 := ItemVariant."Description 2";
          Desc1Setup::VendorItemNo:        Description1 := Item."Vendor Item No.";
        end;

        case Desc2Setup of
          Desc2Setup::ItemDescription1:    Description2 := Item.Description;
          Desc2Setup::ItemDescription2:    Description2 := Item."Description 2";
          Desc2Setup::VariantDescription1: Description2 := ItemVariant.Description;
          Desc2Setup::VariantDescription2: Description2 := ItemVariant."Description 2";
    ...
    begin
        ...
        if VariantCode = '' then begin
          case VRTSetup."Item Cross Ref. Description(I)" of
            VRTSetup."Item Cross Ref. Description(I)"::ItemDescription1: exit(Item.Description);
            VRTSetup."Item Cross Ref. Description(I)"::ItemDescription2: exit(Item."Description 2");
          end;
        end else begin
          ItemVariant.Get(ItemNo, VariantCode);
          case VRTSetup."Item Cross Ref. Description(V)" of
            VRTSetup."Item Cross Ref. Description(V)"::ItemDescription1: exit(Item.Description);
            VRTSetup."Item Cross Ref. Description(V)"::ItemDescription2: exit(Item."Description 2");
            VRTSetup."Item Cross Ref. Description(V)"::VariantDescription1: exit(ItemVariant.Description);
            VRTSetup."Item Cross Ref. Description(V)"::VariantDescription2: exit(ItemVariant."Description 2");
          end;
        end;
        //+NPR5.48 [338542]
    end;

    local procedure GetDescriptionPOS_OLD(var Rec: Record "Sale Line POS";XRec: Record "Sale Line POS";Item: Record Item)
    var
        RetailSetup: Record "Retail Setup";
          ...
          if (( XRec."No." <> "No." ) or ( Description = '' )) and not "Custom Descr" then begin
            case RetailSetup."Description control" of
              ...
              RetailSetup."Description control"::"<Vendor Name><Item Group><Vendor Item No.>" :
                begin
                  if ItemGroup.Get( Item."Item Group" ) then begin
              ...
              RetailSetup."Description control"::"<Description 2><Item group name>" :
                begin
                  if ItemGroup.Get( Item."Item Group" ) and (Item."Description 2" <> '') then
        ...
        with SalesLine do begin
          ...
          case RetailSetup."Description control" of
            ...
            RetailSetup."Description control"::"<Description 2><Item group name>" :
              begin
                GetItemTranslation_OLD("No.",'',SalesHeader."Language Code",Desc,Desc2);
                if ItemGroup.Get( Item."Item Group" ) and (Desc2 <> '') then
    ...
    [EventSubscriber(ObjectType::Table, 5741, 'OnAfterValidateEvent', 'Cross-Reference No.', true, true)]
