codeunit 6184520 "EFT Adyen Cloud Sign Dialog"
{
    ...
    procedure SetSignatureData(EFTTransactionRequest: Record "EFT Transaction Request";SignatureDataIn: Text)
    begin
        TransactionEntryNo := EFTTransactionRequest."Entry No.";
        SignatureData := SignatureDataIn;
    end;

    procedure ApproveSignature(EFTTransactionRequest: Record "EFT Transaction Request")
    var
    ...
    local procedure CreateSignatureApprovalDialog(EFTTransactionRequest: Record "EFT Transaction Request")
    begin
        Model := Model.Model();
        Model.AddHtml(HTML());
        Model.AddStyle(CSS());
    ...
    local procedure OnSignatureDialogResponse(POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management";ModelID: Guid;Sender: Text;EventName: Text;var Handled: Boolean)
    var
        Confirmed: Boolean;
        EFTAdyenCloudIntegration: Codeunit "EFT Adyen Cloud Integration";
