report 6014411 "Sale Time Report"
{
        ...
        for I := 1 to ArrayLen(DayArray) do begin
          if not DayArray[I] then
            DayFilter := true
                 ...
                 1: WeekDay += Text10600001;
                 2: WeekDay += Text10600002;
                 3: WeekDay += Text10600003;
                 4: WeekDay += Text10600004;
                 5: WeekDay += Text10600005;
                 6: WeekDay += Text10600006;
                 7: WeekDay += Text10600007;
               end;
        end;
