report 6014611 "Sales Statistics w/ Variants"
{
    ...
    dataset
    {
        dataitem(Item;Item)
        {
            RequestFilterFields = "No.","Search Description","Inventory Posting Group","Statistics Group","Base Unit of Measure","Date Filter","Group sale";
