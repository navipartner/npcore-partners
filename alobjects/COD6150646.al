codeunit 6150646 "POS Payment Bin Eject - Templ."
{
    ...
    local procedure OnGetParameterNameCaption(PaymentBinInvokeParameter: Record "POS Payment Bin Eject Param.";var Caption: Text)
    var
        PaymentBin: Record "POS Payment Bin";
    begin
        ...
        case PaymentBinInvokeParameter.Name of
          'print_template' : Caption := CaptionTemplate;
        end;
    end;

    [EventSubscriber(ObjectType::Table, 6150633, 'OnGetParameterDescriptionCaption', '', false, false)]
    local procedure OnGetParameterDescriptionCaption(PaymentBinInvokeParameter: Record "POS Payment Bin Eject Param.";var Caption: Text)
    var
        PaymentBin: Record "POS Payment Bin";
    begin
        if not PaymentBin.Get(PaymentBinInvokeParameter."Bin No.") then
        ...
        case PaymentBinInvokeParameter.Name of
          'print_template' : Caption := DescriptionTemplate;
        end;
    end;

    [EventSubscriber(ObjectType::Table, 6150633, 'OnAfterValidateEvent', 'Value', false, false)]
    local procedure OnValidateParameter(var Rec: Record "POS Payment Bin Eject Param.";var xRec: Record "POS Payment Bin Eject Param.";CurrFieldNo: Integer)
    var
        PaymentBin: Record "POS Payment Bin";
    ...
    begin
        ...
        case POSPaymentBinEjectParam.Name of
          'print_template' :
            begin
              RPTemplateHeader.SetRange("Table ID", DATABASE::"POS Payment Bin");
