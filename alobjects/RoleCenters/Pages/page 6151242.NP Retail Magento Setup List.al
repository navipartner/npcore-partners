page 6151242 "NP Retail Magento Setup List"
//page 6014673 "NP Retail Magento Setup List"
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Generic Setup"; "Generic Setup")
                {
                    ApplicationArea = All;
                }
                ...
                field("Exchange Web Code Pattern"; "Exchange Web Code Pattern")
                {
                    ApplicationArea = All;
                }
