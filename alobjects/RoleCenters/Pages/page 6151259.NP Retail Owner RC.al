page 6151259 "NP Retail Owner RC"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(Control16; "Retail 10 Items by Qty.")
            {
            }
            ...
            part(Control17; "Retail Top 10 Salesperson")
            {
            }
            part(Control72; "Retail Top 10 Customers")
            {
            }
