page 6151333 "O365 Activities Ext"
{
    Caption = 'Activities';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            cuegroup(Control54)
            {
                CueGroupLayout = Wide;
                ShowCaption = false;
                field("Sales This Month"; "NP Sales This Month ILE")
                {
            ...
            cuegroup("SalesThisMonthLastYear")
            {
                CuegroupLayout = wide;
                ShowCaption = false;
                field("Sales This Month Last Year"; "NP Sales This Month Last Year")
                {
                    ApplicationArea = Basic, Suite;
    ...
    var
        ...
        NewRecord: Boolean;
        ActivitiesMgt: Codeunit "NP Retail Activities Mgt.";
        HeadlineMan: Codeunit "NP Retail Headline Management";
    begin
        Reset;
        ...
        CODEUNIT.Run(CODEUNIT::"NP Retail Activities Mgt.");
