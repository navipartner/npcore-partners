page 6151244 "NP Retail Magento Manag. RC"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(NPRETAILACTIVITIES; "NP Retail Activities")
            {
            }
        ...
        area(reporting)
        {
            ...
            group("Setup Group")
            {
                ...
                action("Websites")
                {
                    Caption = 'Websites';
                    Image = Setup;
                    RunObject = Page "Magento Website List";
                }
                action("Pictures")
                {
                    Caption = 'Pictures';
                ...
                action("Payment Gateways")
                {
                    ...
                    Image = Setup;
                    RunObject = page "Magento Payment Gateways";
                }
                ...
                action("Tax Classes")
                {
                    Caption = 'Tax Classes';
                    Image = Setup;
                    RunObject = page "Magento Tax Classes";
                }
                ...
                action("Customer Mapping")
                {
                    ...
                    Image = List;
                    RunObject = page "Magento Customer Mapping";
                }
            }
