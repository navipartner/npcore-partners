page 6151340 "NP Retail SO Processor Act"
{
    Caption = 'Activities';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            cuegroup("For Release")
            {
                Caption = 'For Release';
                CueGroupLayout = Wide;
                field("NPRC Sales This Month"; "NPRC Sales This Month")
                {
                ...
                field("NPRC Sales This Month Lst Year"; "NPRC Sales This Month Lst Year")
                {
                    ApplicationArea = Basic, Suite;
    ...
    begin
        ...
        SetFilter("NPRC Date Filter Lst Year", '%1..%2', CalcDate('<-CM-1Y>', Today), CalcDate('<CM-1Y>', Today));
        SetFilter("NPRC Date Filter", '%1..%2', CalcDate('<-CM>', Today), Today);
