codeunit 6151242 "NP Retail Activities Mgt."
{
    ...
    begin
        ...
        ActivitiesCue.Get;
        ActivitiesCue."NP Sales This Month Last Year" := NPCalcSalesThisMonthAmountLastYear(false);
        ActivitiesCue."NP Sales This Month ILE" := NPCalcSalesThisMonthAmount(false);
