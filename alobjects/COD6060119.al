    ...
    begin
        ...
        if (ExternalAdmissionScheduleEntryNo = 0) then begin
          case Admission."Default Schedule" of
            ...
            Admission."Default Schedule"::NEXT_AVAILABLE : begin
    ...
    begin
        ...
        repeat
          ...
          case TicketReservationRequest."Notification Method" of
            TicketReservationRequest."Notification Method"::SMS   : TicketNotificationEntry."Notification Method" := TicketNotificationEntry."Notification Method"::SMS;
            TicketReservationRequest."Notification Method"::EMAIL : TicketNotificationEntry."Notification Method" := TicketNotificationEntry."Notification Method"::EMAIL;
          end;
    ...
    begin
        ...
        while (StrPos (NewLine, StartSeparator) > 0) do begin
          ...
          if (RecRef.FieldExist(FieldNo)) then begin
            ...
            end else if (UpperCase (Format(Format(FieldRef.Type)))) = 'DATETIME' then begin
              NewLine := InsStr (NewLine, Format(FieldRef.Value,0,9), StartPos);
            end else if (UpperCase (Format(Format(FieldRef.Type)))) = 'BOOLEAN' then begin
