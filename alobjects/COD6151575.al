codeunit 6151575 "AF Event Subscriber"
{
    ...
    local procedure T6151574OnAfterInsert(var Rec: Record "AF Notification Hub";RunTrigger: Boolean)
    var
        AFArgumentsNotificationHub: Record "AF Arguments - NotificationHub" temporary;
