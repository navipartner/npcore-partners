codeunit 6014428 "Std. Codeunit Code"
{
    ...
    procedure PrintReceipt(var Rec: Record "Audit Roll";Force: Boolean)
    var
    ...
    procedure PrintCreditGiftVoucher(var AuditRollIn: Record "Audit Roll")
    var
        AuditRoll: Record "Audit Roll";
    ...
    begin
        ...
        if AuditRoll.FindSet() then
          repeat
            ...
            end else if CreditVoucher.Get(AuditRoll."Credit voucher ref.") then begin
    ...
    procedure PrintRegisterReceipt(var AuditRollIn: Record "Audit Roll")
    var
        ...
        //+NPR5.27 [254376]
          case PrintType of
            ...
            PrintType::"To Screen":
              begin
                //-NPR5.34
                MPOSReporthandler.ExecutionHandlerWithVars(REPORT::"Balancing Ticket IV",AuditRoll,true,false);
