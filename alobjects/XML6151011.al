xmlport 6151011 "NpRv Ext. Vouchers"
{
    ...
    schema
    {
        ...
        {
            MaxOccurs = Once;
            tableelement(nprvextvoucherbuffer;"NpRv Ext. Voucher Buffer")
            {
                MinOccurs = Zero;
                XmlName = 'voucher';
                UseTemporary = true;
    ...
    procedure GetSourceTable(var NpRvExtVoucherBuffer2: Record "NpRv Ext. Voucher Buffer" temporary)
    begin
        NpRvExtVoucherBuffer2.Copy(NpRvExtVoucherBuffer,true);
    end;

    procedure SetSourceTable(var NpRvExtVoucherBuffer2: Record "NpRv Ext. Voucher Buffer" temporary)
    begin
