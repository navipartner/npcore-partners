codeunit 6151599 "NpDc Module Validate - Time"
{
    ...
    var
        NpDcValidTimeInterval: Record "NpDc Valid Time Interval";
    ...
    local procedure IsValidTimeInterval(NpDcValidTimeInterval: Record "NpDc Valid Time Interval";CheckTime: Time;CheckDate: Date): Boolean
    begin
    ...
    local procedure IsValidDay(NpDcValidTimeInterval: Record "NpDc Valid Time Interval";CheckDate: Date): Boolean
    begin
        //-NPR5.37 [292171]
    ...
    begin
        ...
        PAGE.Run(PAGE::"NpDc Valid Time Intervals",NpDcValidTimeInterval);
    end;
    ...
    begin
        exit(CODEUNIT::"NpDc Module Validate - Time");
    end;
