codeunit 6060161 "POS Action - Chg. Active Event"
{
    ...
    local procedure UpdateCurrentEvent(Context: DotNet npNetJObject;POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management";EventNo: Code[20])
    var
