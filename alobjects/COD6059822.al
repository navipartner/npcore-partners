codeunit 6059822 "Mandrill Trans. Email Mgt"
{
    ...
    var
        ...
        BodyJObject: DotNet npNetJObject;
    ...
    local procedure TryGetMessageDetails(EmailLog: Record "Transactional Email Log")
    var
        JObject: DotNet npNetJObject;
        MessageId: Text;
    begin
    ...
    procedure SendSmartEmail(SmartEmail: Record "Smart Email"; Recipient: Text; Cc: Text; Bcc: Text; RecRef: RecordRef; Silent: Boolean) ErrorMessage: Text
    var
    ...
    procedure SendSmartEmailWAttachment(SmartEmail: Record "Smart Email"; Recipient: Text; Cc: Text; Bcc: Text; RecRef: RecordRef; var Attachment: Record "E-mail Attachment"; Silent: Boolean) ErrorMessage: Text
    var
        MessageJObject: DotNet npNetJObject;
        JObject: DotNet npNetJObject;
        JArray: DotNet npNetJArray;
    ...
    procedure SendClassicMail(Recipient: Text; Cc: Text; Bcc: Text; Subject: Text; BodyHtml: Text; BodyText: Text; FromEmail: Text; FromName: Text; ReplyTo: Text; TrackOpen: Boolean; TrackClick: Boolean; Tags: Text; AddRecipientsToListID: Text; var Attachment: Record "E-mail Attachment"; Silent: Boolean): Text
    var
        MessageJObject: DotNet npNetJObject;
        JObject: DotNet npNetJObject;
        JArray: DotNet npNetJArray;
    ...
    local procedure AddVariablesToJArray(var JArray: DotNet npNetJArray; SmartEmail: Record "Smart Email"; RecRef: RecordRef)
    var
        JObject: DotNet npNetJObject;
        JTokenType: DotNet npNetJTokenType;
    ...
    local procedure WriteVariables(var JArray: DotNet npNetJArray; var SmartEmailVariable: Record "Smart Email Variable"; RecRef: RecordRef)
    var
        JObject: DotNet npNetJObject;
        FldRef: FieldRef;
    begin
    ...
    local procedure AddRecepient(var JArray: DotNet npNetJArray; Recipients: Text; Type: Text)
    var
        JObject: DotNet npNetJObject;
        email: Text;
        Pos: Integer;
    ...
    local procedure AddTags(var MessageJObject: DotNet npNetJObject; TagString: Text)
    var
        JArray: DotNet npNetJArray;
        Tag: Text;
        Pos: Integer;
    ...
    local procedure AddAttachmentsToJArray(var JArray: DotNet npNetJArray; var Attachment: Record "E-mail Attachment")
    var
        JObject: DotNet npNetJObject;
    ...
    local procedure AddPropertyToJObject(var JObject: DotNet npNetJObject; PropertyName: Text; Value: Variant)
    var
    ...
    local procedure FindVariables(var TempVariable: Record "Smart Email Variable" temporary; CodeString: Text)
    var
