        ...
        area(reporting)
        {
            group(Reports)
            {
                action("Advanced Sales Statistics")
                {
                    ...
                    trigger OnAction()
                    var
                        SalesStatisticsReport: Report "Advanced Sales Statistics";
                    begin
                        //-NPR4.13
        ...
        area(navigation)
        {
            group(RelatedInformation)
            {
                action("Salesperson Stats")
                {
                    ...
                    trigger OnAction()
                    var
                        SalespersonStatistics: Page "Salesperson Statistics Retail";
                    begin
                        //-NPR4.21
                ...
                action("Item Group")
                {
                    ...
                    trigger OnAction()
                    var
                        ItemGroupStatistic: Page "Item Group Statistics Subpage";
                    begin
                        //-NPR4.21
                ...
                action("Item Statistics")
                {
                    ...
                    trigger OnAction()
                    var
                        ItemStatistics: Page "Item Statistics Subpage";
                    begin
                        //-NPR4.21
                ...
                action("Customer Statistics")
                {
                    ...
                    trigger OnAction()
                    var
                        CustomerStatistics: Page "Customer Statistics Subpage";
                    begin
                        //-NPR4.21
                ...
                action("Vendor Statistics")
                {
                    ...
                    trigger OnAction()
                    var
                        VendorStatistics: Page "Vendor Statistics Subpage";
                    begin
                        //-NPR4.21
                ...
                action("Item Category Code Statistics")
                {
                    ...
                    trigger OnAction()
                    var
                        ItemCategoryStatsSubpage: Page "Item Category Code Statistics";
                    begin
                ...
                action("Product Group Code Statistics")
                {
                    ...
                    trigger OnAction()
                    var
                        ProdGroupCodeStatsSubpage: Page "Product Group Code Statistics";
                    begin
