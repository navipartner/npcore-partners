codeunit 6151109 "NpRi Collect G/L Entries"
{
    ...
    local procedure DiscoverGLEntries(var NpRiModule: Record "NpRi Reimbursement Module")
    begin
    ...
    local procedure CollectGLEntries(var NpRiDataCollectionMgt: Codeunit "NpRi Data Collection Mgt.";var NpRiReimbursement: Record "NpRi Reimbursement")
    var
    ...
    local procedure FindGLEntries(NpRiReimbursement: Record "NpRi Reimbursement";var GLEntry: Record "G/L Entry"): Boolean
    var
    ...
    local procedure UpdateEntry(GLEntry: Record "G/L Entry";var NpRiReimbursementEntry: Record "NpRi Reimbursement Entry")
    begin
    ...
    begin
        exit(CODEUNIT::"NpRi Collect G/L Entries");
    end;
}
