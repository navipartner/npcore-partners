codeunit 6059777 CompanySyncManagement
{
    ...
    var
        ...
        CompanySyncProfiles: Record "Company Sync Profiles";
    ...
    var
        ...
        FieldRef: FieldRef;
        SyncType: Option;
        CompaniesInProfile2: Record "Companies in Profile";
        CompaniesInProfile: Record "Companies in Profile";
        RetailSetup: Record "Retail Setup";
        PartialSyncFieldsProfile: Record "Partial Sync Fields Profile";
        SyncProfileSetup: Record "Sync Profile Setup";
        CompanyName: Text[30];
    ...
    procedure ProcessRemoteRecordRef(CommandCode: Text[30];FromRecRef: RecordRef;CompanyName: Text[30];FieldSyncType: Text[30];var PartialSyncFieldsProfile: Record "Partial Sync Fields Profile";IsModifyAfterInsert: Boolean)
    var
        FoundRec: Boolean;
        MatchFound: Boolean;
        FromField: FieldRef;
    ...
    procedure SetSyncSetup(CurrentSynchronisationProfile: Code[20];var SyncProfileSetup: Record "Sync Profile Setup")
    begin
