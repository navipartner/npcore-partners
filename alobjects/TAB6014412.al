table 6014412 "Mixed Discount Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Code';
            TableRelation = "Mixed Discount".Code;
        }
        field(2;"No.";Code[20])
        {
            Caption = 'No.';
            ...
            TableRelation = IF ("Disc. Grouping Type"=CONST(Item)) Item
                            ELSE IF ("Disc. Grouping Type"=CONST("Item Group")) "Item Group"
                            ELSE IF ("Disc. Grouping Type"=CONST("Item Disc. Group")) "Item Discount Group"
                            ELSE IF ("Disc. Grouping Type"=CONST("Mix Discount")) "Mixed Discount" WHERE ("Mix Type"=CONST("Combination Part"));
