codeunit 6184490 "Pepper Config. Management"
{
    ...
    procedure GetConfigurationText(PepperConfiguration: Record "Pepper Configuration";TextType: Option License,Configuration,AdditionalParameters): Text
    var
    ...
    procedure GetTerminalText(PepperTerminal: Record "Pepper Terminal";TextType: Option License,AdditionalParameters): Text
    var
    ...
    procedure GetZipFileAsText(PepperVersion: Record "Pepper Version"): Text
    var
        StreamIn: InStream;
        TextWhole: Text;
        TextLine: Text[1024];
    ...
    procedure GetHeaderFooterText(Register: Record Register;PrintType: Option Transaction,"Transaction CC",Administration;TextType: Option Header,Footer): Text
    var
        Utility: Codeunit Utility;
        RetailComment: Record "Retail Comment" temporary;
        TextToPrint: Text;
        Separator: Char;
    begin
        TextToPrint := '';
    ...
    procedure GetReceiptText(PepperTransactionRequest: Record "EFT Transaction Request";ReceiptNo: Integer;AddBackSlash: Boolean): Text
    var
    ...
    procedure GetCustomerID(PepperTerminal: Record "Pepper Terminal"): Text[8]
    var
        PepperInstance: Record "Pepper Instance";
        PepperConfiguration: Record "Pepper Configuration";
    begin
    ...
    procedure GetLicenseID(PepperTerminal: Record "Pepper Terminal"): Text[8]
    var
        PepperInstance: Record "Pepper Instance";
        PepperConfiguration: Record "Pepper Configuration";
    begin
