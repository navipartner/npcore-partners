report 6059900 "Analyse Task Queue Usage"
{
    ...
    dataset
    {
        dataitem("Task Log (Task)";"Task Log (Task)")
        {
    ...
    var
        TMPTaskQueue: Record "Task Queue" temporary;
        TaskLog: Record "Task Log (Task)";
        TMPDateTimeGroup: Record "Task Log (Task)" temporary;
    ...
    begin
        case GroupBy of
          GroupBy::Quarter: Dur := 1000*60*15;
          GroupBy::Hour: Dur := 1000*60*60;
          GroupBy::Day: Dur := 1000*60*60*24;
        end;
    ...
    procedure InsertTmpTQ(Group: Integer;StartTime: DateTime;EndTime: DateTime;TaskLog: Record "Task Log (Task)")
    begin
        TMPTaskQueue.Company := Company.Name;
    ...
    procedure CalcUtilization(TaskLog: Record "Task Log (Task)"): Decimal
    var
        Int: Integer;
        DivBy: Integer;
    begin
        ...
        case GroupBy of
          GroupBy::Quarter: DivBy :=1000*60*15;
          GroupBy::Hour: DivBy := 1000*60*60;
          GroupBy::Day: DivBy := 1000*60*60*24;
        end;
