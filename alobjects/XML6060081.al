xmlport 6060081 "MCS Recommendations History"
{
            ...
            tableelement("Item Ledger Entry";"Item Ledger Entry")
            {
                ...
                begin
                    ...
                    if MCSRecommendationsModel."Item View" <> '' then begin
                      ...
                      if ItemWithinSelection.FindSet(false,false) then repeat
    ...
    procedure SetModel(ParMCSRecommendationsModel: Record "MCS Recommendations Model")
    begin
