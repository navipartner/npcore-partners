codeunit 6060110 "TM Statistics WebService"
{
    ...
    var
        ...
        TmpLineFacts: Record "TM Ticket Access Fact" temporary;
        TmpColumnFacts: Record "TM Ticket Access Fact" temporary;
    begin
    ...
    var
        ...
        TmpTicketAccessStatistics: Record "TM Ticket Access Statistics" temporary;
        TicketAccessStatistics: Codeunit "TM Ticket Access Statistics";
        Tmp2DimStatisics: Record "TM Ticket Access Statistics";
        TmpLineFacts: Record "TM Ticket Access Fact" temporary;
        TmpColumnFacts: Record "TM Ticket Access Fact" temporary;
        Columns: Record "TM Ticket Access Fact" temporary;
        Lines: Record "TM Ticket Access Fact" temporary;
    ...
    begin
        ...
        case UpperCase (DimensionText) of
          '0', 'ITEM','TICKET'                                  : FactCode := TicketAccessFact."Fact Name"::ITEM;
          '1', 'TICKETTYPE', 'TICKET TYPE'                      : FactCode := TicketAccessFact."Fact Name"::TICKET_TYPE;
          '2', 'ADMISSIONDATE', 'ADMISSION DATE'                : FactCode := TicketAccessFact."Fact Name"::ADMISSION_DATE;
          '3', 'ADMISSIONHOUR', 'ADMISSION HOUR'                : FactCode := TicketAccessFact."Fact Name"::ADMISSION_HOUR;
          '4', 'ADMISSIONCODE', 'ADMISSION CODE'                : FactCode := TicketAccessFact."Fact Name"::ADMISSION_CODE;
          '5', 'VARIANTCODE', 'TICKETVARIANT', 'TICKET VARIANT' : FactCode := TicketAccessFact."Fact Name"::VARIANT_CODE;
          else begin
        ...
        repeat
          ...
          repeat
            ...
            with TmpLineFacts do
              case "Fact Name" of
                "Fact Name"::ADMISSION_CODE : TmpTicketAccessStatistics.SetFilter ("Admission Code", '=%1', "Fact Code");
                ...
                "Fact Name"::ITEM           : TmpTicketAccessStatistics.SetFilter ("Item No.", '=%1', "Fact Code");
                "Fact Name"::TICKET_TYPE    : TmpTicketAccessStatistics.SetFilter ("Ticket Type", '=%1', "Fact Code");
                "Fact Name"::VARIANT_CODE   : TmpTicketAccessStatistics.SetFilter ("Variant Code", '=%1', "Fact Code");
            ...
            with TmpColumnFacts do
              case "Fact Name" of
                "Fact Name"::ADMISSION_CODE : TmpTicketAccessStatistics.SetFilter ("Admission Code", '=%1', "Fact Code");
                "Fact Name"::ADMISSION_HOUR : begin
                    Evaluate (AdmissionHour, "Fact Code");
                    TmpTicketAccessStatistics.SetFilter ("Admission Hour", '=%1', AdmissionHour);
                  end;
                "Fact Name"::ITEM           : TmpTicketAccessStatistics.SetFilter ("Item No.", '=%1', "Fact Code");
    ...
    local procedure BuildFactTable(var TmpTicketAccessStatistics: Record "TM Ticket Access Statistics" temporary;var TmpTicketAccessFact: Record "TM Ticket Access Fact" temporary)
    var
