codeunit 6059979 "Variety Calculations"
{
    ...
    local procedure LookupInventoryPerLocation(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];CalledFrom: Option OnDrillDown,OnLookup;var ItemFilters: Record Item)
    var
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'OnDrillDownVarietyMatrix', '', true, false)]
    local procedure LookupLocation(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];CalledFrom: Option OnDrillDown,OnLookup;var ItemFilters: Record Item)
    var
        Location: Record Location;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'OnDrillDownVarietyMatrix', '', true, false)]
    local procedure LookupItemCrossReference(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];CalledFrom: Option OnDrillDown,OnLookup;var ItemFilters: Record Item)
    var
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'OnDrillDownVarietyMatrix', '', true, false)]
    local procedure LookupAvailabilityByEvent(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];CalledFrom: Option OnDrillDown,OnLookup;var ItemFilters: Record Item)
    var
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'OnDrillDownVarietyMatrix', '', true, false)]
    local procedure LookupAvailabilityByVariant(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];CalledFrom: Option OnDrillDown,OnLookup;var ItemFilters: Record Item)
    var
        ItemAvailFormsMgt: Codeunit "Item Availability Forms Mgt";
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'OnDrillDownVarietyMatrix', '', true, false)]
    local procedure LookupAvailabilityByLocation(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];CalledFrom: Option OnDrillDown,OnLookup;var ItemFilters: Record Item)
    var
        ItemAvailFormsMgt: Codeunit "Item Availability Forms Mgt";
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'OnDrillDownVarietyMatrix', '', true, false)]
    local procedure LookupAvailabilityByPeriod(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];CalledFrom: Option OnDrillDown,OnLookup;var ItemFilters: Record Item)
    var
        ItemAvailFormsMgt: Codeunit "Item Availability Forms Mgt";
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'OnDrillDownVarietyMatrix', '', true, false)]
    local procedure LookupAvailabilityByTimeLine(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];CalledFrom: Option OnDrillDown,OnLookup;var ItemFilters: Record Item)
    var
        ItemAvailFormsMgt: Codeunit "Item Availability Forms Mgt";
        Item: Record Item;
    ...
    local procedure GetItemCrossReference(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetAlternativeNo(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetQuantityAvailable(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetExpectedInventory(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetProjAvailableBalance(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetPlannedOrderReleases(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetScheduledRcpt(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetPlannedOrderRcpt(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetGrossRequirement(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
        Item: Record Item;
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetQuantityAvailableToPromise(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    var
    ...
    [EventSubscriber(ObjectType::Codeunit, 6059971, 'GetVarietyMatrixFieldValue', '', true, false)]
    local procedure GetQuantityAvailableToPromise2(TMPVrtBuffer: Record "Variety Buffer" temporary;VrtFieldSetup: Record "Variety Field Setup";var FieldValue: Text[1024];SubscriberName: Text;var ItemFilters: Record Item;CalledFrom: Option PrimaryField,SecondaryField)
    begin
    ...
    procedure UseReturnValue(CalledFrom: Option OnDrillDown,OnLookup;VrtFieldSetup: Record "Variety Field Setup"): Boolean
    begin
    ...
    procedure CheckIsMe(CalledFrom: Option OnDrillDown,OnLookup;VrtFieldSetup: Record "Variety Field Setup";CurrFunctionName: Text): Boolean
    begin
    ...
    procedure CheckIsMe2(CalledFrom: Option PrimaryField,SecondaryField;VrtFieldSetup: Record "Variety Field Setup";CurrFunctionName: Text): Boolean
    begin
