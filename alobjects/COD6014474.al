codeunit 6014474 "E-mail Retail Management"
{
    ...
    var
        RetailReportSelection: Record "Report Selection Retail";
    begin
    ...
    procedure SendReportAuditRoll(var AuditRoll: Record "Audit Roll";Silent: Boolean)
    var
    ...
    procedure SendReportCreditVoucher(var CreditVoucher: Record "Credit Voucher";Silent: Boolean)
    var
        Customer: Record Customer;
        EmailMgt: Codeunit "E-mail Management";
        RecRef: RecordRef;
    ...
    procedure SendReportGiftVoucher(var GiftVoucher: Record "Gift Voucher";Silent: Boolean)
    var
        Customer: Record Customer;
        EmailMgt: Codeunit "E-mail Management";
        RecRef: RecordRef;
    ...
    local procedure SendReportPOSEntry(var PosEntry: Record "POS Entry";Silent: Boolean)
    var
        Customer: Record Customer;
        RecRef: RecordRef;
        EmailMgt: Codeunit "E-mail Management";
