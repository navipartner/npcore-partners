codeunit 6060107 "Ean Box Event Handler"
{
    ...
    procedure InvokeEanBox(EanBoxValue: Text;Context: JsonObject;POSSession: Codeunit "POS Session";var FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    local procedure FindEanBoxSetup(POSSession: Codeunit "POS Session";var EanBoxSetup: Record "Ean Box Setup"): Boolean
    var
    ...
    local procedure FindEnabledEanBoxEvents(EanBoxSetup: Record "Ean Box Setup";EanBoxValue: Text;var TempEanBoxSetupEvent: Record "Ean Box Setup Event" temporary): Boolean
    var
    ...
    local procedure SelectEanBoxEvent(var TempEanBoxSetupEvent: Record "Ean Box Setup Event" temporary): Boolean
    var
    ...
    local procedure UpdatePriority(var TempEanBoxSetupEvent: Record "Ean Box Setup Event" temporary)
    var
        EanBoxSetupEvent: Record "Ean Box Setup Event";
    begin
        //-NPR5.47 [333512]
    ...
    procedure InvokePOSAction(EanBoxValue: Text;EanBoxSetupEvent: Record "Ean Box Setup Event";POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management"): Boolean
    var
    ...
    local procedure SetPOSActionParameters(EanBoxValue: Text;EanBoxSetupEvent: Record "Ean Box Setup Event";var POSAction: Record "POS Action";FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    local procedure SetPOSActionParameter(EanBoxValue: Text;EanBoxParameter: Record "Ean Box Parameter";var POSAction: Record "POS Action";FrontEnd: Codeunit "POS Front End Management")
    var
        IntBuffer: Integer;
        DecBuffer: Decimal;
    begin
