codeunit 6184527 "EFT Verifone Vim Protocol"
{
    ...
    begin
        case EftTransactionRequest."Processing Type" of
          ...
          EftTransactionRequest."Processing Type"::GIFTCARD_LOAD : RefundTransaction(EftTransactionRequest);
          EftTransactionRequest."Processing Type"::REFUND : RefundTransaction(EftTransactionRequest);
          ...
          EftTransactionRequest."Processing Type"::AUXILIARY :
            case EftTransactionRequest."Auxiliary Operation ID" of
              ...
              2 : Reconciliation(EftTransactionRequest);
            end;
        end;
    end;
    ...
    var
        TransactionRequest: DotNet npNetTransactionRequest2;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTVerifoneVimIntegration: Codeunit "EFT Verifone Vim Integration";
    begin
    ...
    local procedure RefundTransaction(EftTransactionRequest: Record "EFT Transaction Request")
    var
        TransactionRequest: DotNet npNetTransactionRequest2;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
    ...
    local procedure VoidTransaction(EftTransactionRequest: Record "EFT Transaction Request")
    var
        TransactionRequest: DotNet npNetTransactionRequest2;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
    ...
    local procedure PrepareGenericTransaction(EftTransactionRequest: Record "EFT Transaction Request";EFTSetup: Record "EFT Setup";var TransactionRequest: DotNet npNetTransactionRequest2;POSSession: Codeunit "POS Session")
    var
        EFTVerifoneVimIntegration: Codeunit "EFT Verifone Vim Integration";
    ...
    begin
        ...
        if EFTVerifoneVimIntegration.GetAutoOpenOnTransaction(EFTSetup) then begin
          ...
          case EFTVerifoneVimIntegration.GetLogLevel(EFTSetup) of
            EFTVerifoneUnitParameter."Terminal Log Level"::ALL : TransactionRequest.LogLevel := 'ALL';
            EFTVerifoneUnitParameter."Terminal Log Level"::DEBUG : TransactionRequest.LogLevel := 'DEBUG';
            EFTVerifoneUnitParameter."Terminal Log Level"::ERROR : TransactionRequest.LogLevel := 'ERROR';
            EFTVerifoneUnitParameter."Terminal Log Level"::INFO : TransactionRequest.LogLevel := 'INFO';
            EFTVerifoneUnitParameter."Terminal Log Level"::WARN : TransactionRequest.LogLevel := 'WARN';
          end;

          case EFTVerifoneVimIntegration.GetDefautlLanguage(EFTSetup) of
            EFTVerifoneUnitParameter."Terminal Default Language"::ENGLISH : TransactionRequest.DefaultLanguage := 'ENGLISH';
            EFTVerifoneUnitParameter."Terminal Default Language"::NORWEGIAN : TransactionRequest.DefaultLanguage := 'NORWEGIAN';
            EFTVerifoneUnitParameter."Terminal Default Language"::SWEDISH : TransactionRequest.DefaultLanguage := 'SWEDISH';
            EFTVerifoneUnitParameter."Terminal Default Language"::FINNISH : TransactionRequest.DefaultLanguage := 'FINNISH';
            EFTVerifoneUnitParameter."Terminal Default Language"::DANISH : TransactionRequest.DefaultLanguage := 'DANISH';
          end;

          case EFTVerifoneVimIntegration.GetConnectionMode(EFTSetup) of
            EFTVerifoneUnitParameter."Terminal Connection Mode"::TERMINAL_CONNECT : TransactionRequest.ConnectionMode := 'TERMINALCONNECTMODE';
            EFTVerifoneUnitParameter."Terminal Connection Mode"::ECR_CONNECT : TransactionRequest.ConnectionMode := 'ECRCONNECTMODE';
          end;
        end;
    end;

    local procedure OpenTerminal(EftTransactionRequest: Record "EFT Transaction Request")
    var
        LoginRequest: DotNet npNetLoginRequest;
        EFTSetup: Record "EFT Setup";
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        HardwareId: Text;
    ...
    begin
        ...
        case EFTVerifoneVimIntegration.GetLogLevel(EFTSetup) of
          EFTVerifoneUnitParameter."Terminal Log Level"::ALL : LoginRequest.LogLevel := 'ALL';
          EFTVerifoneUnitParameter."Terminal Log Level"::DEBUG : LoginRequest.LogLevel := 'DEBUG';
          EFTVerifoneUnitParameter."Terminal Log Level"::ERROR : LoginRequest.LogLevel := 'ERROR';
          EFTVerifoneUnitParameter."Terminal Log Level"::INFO : LoginRequest.LogLevel := 'INFO';
          EFTVerifoneUnitParameter."Terminal Log Level"::WARN : LoginRequest.LogLevel := 'WARN';
        end;

        case EFTVerifoneVimIntegration.GetDefautlLanguage(EFTSetup) of
          EFTVerifoneUnitParameter."Terminal Default Language"::ENGLISH : LoginRequest.DefaultLanguage := 'ENGLISH';
          EFTVerifoneUnitParameter."Terminal Default Language"::NORWEGIAN : LoginRequest.DefaultLanguage := 'NORWEGIAN';
          EFTVerifoneUnitParameter."Terminal Default Language"::SWEDISH : LoginRequest.DefaultLanguage := 'SWEDISH';
          EFTVerifoneUnitParameter."Terminal Default Language"::FINNISH : LoginRequest.DefaultLanguage := 'FINNISH';
          EFTVerifoneUnitParameter."Terminal Default Language"::DANISH : LoginRequest.DefaultLanguage := 'DANISH';
        end;

        case EFTVerifoneVimIntegration.GetConnectionMode(EFTSetup) of
          EFTVerifoneUnitParameter."Terminal Connection Mode"::TERMINAL_CONNECT : LoginRequest.ConnectionMode := 'TERMINALCONNECTMODE';
          EFTVerifoneUnitParameter."Terminal Connection Mode"::ECR_CONNECT : LoginRequest.ConnectionMode := 'ECRCONNECTMODE';
        end;

        POSFrontEnd.InvokeDevice(LoginRequest, ActionCode(), 'Login');
    end;

    local procedure CloseTerminal(EftTransactionRequest: Record "EFT Transaction Request")
    var
        LogoutRequest: DotNet npNetLogoutRequest;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTVerifoneVimIntegration: Codeunit "EFT Verifone Vim Integration";
    ...
    local procedure BalanceEnquiry(EftTransactionRequest: Record "EFT Transaction Request")
    var
        BalanceEnquiryRequest: DotNet npNetBalanceEnquiryRequest0;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTVerifoneVimIntegration: Codeunit "EFT Verifone Vim Integration";
    ...
    local procedure Reconciliation(EftTransactionRequest: Record "EFT Transaction Request")
    var
        ReconciliationRequest: DotNet npNetReconciliationRequest;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        EFTSetup: Record "EFT Setup";
        EFTVerifoneVimIntegration: Codeunit "EFT Verifone Vim Integration";
    ...
    var
        TransactionStatusRequest: DotNet npNetTransactionStatusRequest;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
        OriginalEftTrxRequest: Record "EFT Transaction Request";
        EFTSetup: Record "EFT Setup";
    ...
    begin
        ...
        case OriginalEftTrxRequest."Processing Type" of
          OriginalEftTrxRequest."Processing Type"::PAYMENT : TransactionStatusRequest.TransactionType := 'PURCHASE';
          OriginalEftTrxRequest."Processing Type"::REFUND : TransactionStatusRequest.TransactionType := 'REFUND';
          OriginalEftTrxRequest."Processing Type"::VOID : TransactionStatusRequest.TransactionType := 'REVERSAL';
          else
    ...
    local procedure VerifySetup(EftTransactionRequest: Record "EFT Transaction Request")
    var
        TransactionRequest: DotNet npNetTransactionRequest2;
        POSSession: Codeunit "POS Session";
        POSFrontEnd: Codeunit "POS Front End Management";
    ...
    local procedure Device_Response(ActionName: Text;Step: Text;Envelope: DotNet npNetResponseEnvelope0;POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
        EFTVerifoneVimResponseParser: Codeunit "EFT Verifone Vim Resp. Parser";
        EntryNo: Integer;
        ...
        if (EFTVerifoneVimResponseParser.Run() and EFTVerifoneVimResponseParser.TryGetEftTransactionEntryNo(EntryNo))  then begin
          case EventName of
            ...
            'PrintSignatureReceipt':
              begin
                EFTTransactionRequest.Get(EntryNo);
                if CODEUNIT.Run(CODEUNIT::"EFT Try Print Receipt", EFTTransactionRequest) then begin
                  ReturnData := 'true';
                end else begin
    ...
    local procedure HandleParseError(var EFTVerifoneVimResponseParser: Codeunit "EFT Verifone Vim Resp. Parser")
    var
        EftEntryNo: Integer;
        EFTTransactionRequest: Record "EFT Transaction Request";
    begin
