codeunit 6060063 "Catalog Nonstock Management"
{
    ...
    begin
        ...
        if NPRAttributeKey.FindSet then repeat
          NPRAttributeValueSet.SetRange("Attribute Set ID",NPRAttributeKey."Attribute Set ID");
          if NPRAttributeValueSet.FindFirst then repeat
    ...
    begin
        if AttributeValue = '' then
          exit;
        case Type of
          Type::Item: NPRAttributeKey.SetRange("Table ID",DATABASE::Item);
          Type::Nonstocktem: NPRAttributeKey.SetRange("Table ID",DATABASE::"Nonstock Item");
        end;
        ...
        if not NPRAttributeKey.FindLast then begin
          ...
          case Type of
            Type::Item: NPRAttributeKey."Table ID" := DATABASE::Item;
            Type::Nonstocktem: NPRAttributeKey."Table ID" := DATABASE::"Nonstock Item";
          end;
    ...
    var
        ...
        ItemCategoryMapping: Record "Item Category Mapping";
    begin
    end;
    ...
    var
        ItemGroup: Record "Item Group";
        ItemCategoryMapping: Record "Item Category Mapping";
        NonstockItemMaterial: Record "Nonstock Item Material";
        NonstockItem: Record "Nonstock Item";
    begin
        if not Rec."Created From Nonstock Item" then
          exit;
        if Rec."Item Group" <> '' then
          exit;
        ...
        if Rec."Created From Nonstock Item" then begin
          ...
          if NonstockItem.FindFirst then begin
            ...
            //+NPR5.45
              Rec.Validate("Item Group",ItemCategoryMapping."Item Group");
          //-NPR5.45
          end;
          //+NPR5.45
          Rec.Modify;
