xmlport 6150905 "HC Generic Request"
{
    ...
    schema
    {
        textelement(generichqrequest)
        {
            ...
            {
                MaxOccurs = Once;
                tableelement(tmpgenericwebrequest;"HC Generic Web Request")
                {
                    MaxOccurs = Once;
                    XmlName = 'requestline';
                    UseTemporary = true;
            ...
            textelement(requestresponse)
            {
                ...
                tableelement(tmpresponse;"HC Generic Web Request")
                {
                    MaxOccurs = Once;
                    MinOccurs = Zero;
    ...
    procedure GetRequest(var TmpHCGenericWebRequest: Record "HC Generic Web Request" temporary)
    begin
    ...
    procedure SetResponse(var TmpHCGenericWebRequest: Record "HC Generic Web Request" temporary)
    begin
