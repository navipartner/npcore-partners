codeunit 6184601 "Np Consignor Mgt."
{
    ...
    local procedure OnAfterInsertConsignorEntry(var Rec: Record "Consignor Entry";RunTrigger: Boolean)
    begin
    ...
    begin
        ...
        NpXmlTemplate.SetRange("Table No.",DATABASE::"Consignor Entry");
        ...
        JobQueueEntry.SetRange("Object ID to Run",CODEUNIT::"Nc Task List Processing");
