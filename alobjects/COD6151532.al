codeunit 6151532 "Nc Coll.  Request WebService"
{
    ...
    begin
        ...
        ImportEntry."Import Type" := GetImportTypeCode(CODEUNIT::"Nc Coll.  Request WebService", WebserviceFunction);
    ...
    begin
        ...
        ImportType.SetFilter ("Webservice Codeunit ID", '=%1', CODEUNIT::"Nc Coll.  Request WebService");
    ...
    begin
        ...
        ImportType."Import Codeunit ID" :=  CODEUNIT::"Nc Coll. Req. WebService Mgr";
        ImportType."Webservice Codeunit ID" :=  CODEUNIT::"Nc Coll.  Request WebService";
