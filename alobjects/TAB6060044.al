table 6060044 "Item Worksheet Variety Value"
{
    ...
    DrillDownPageID = "Item Worksheet Variety Values";
    LookupPageID = "Item Worksheet Variety Values";
    ...
    var
        VRTValue: Record "Item Worksheet Variety Value";
        Dec: Decimal;
