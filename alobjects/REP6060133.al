report 6060133 "MM Visiting Report"
{
            ...
            dataitem("MM Membership Role";"MM Membership Role")
            {
                ...
                dataitem("MM Member";"MM Member")
                {
                    ...
                    dataitem("TM Ticket";"TM Ticket")
                    {
                        ...
                        dataitem("TM Ticket Access Entry";"TM Ticket Access Entry")
                        {
    ...
    var
        ...
        TickResReq: Record "TM Ticket Reservation Request";
        Qty: Integer;
        Temp: Code[100];
        AdmSet: Record "MM Membership Admission Setup";
