table 6060119 "TM Admission Schedule Lines"
{
    ...
    fields
    {
        ...
        field(2;"Schedule Code";Code[20])
        {
            ...
            TableRelation = "TM Admission Schedule";
        }
        ...
        {
            CalcFormula = Lookup("TM Admission Schedule"."Start Time" WHERE ("Schedule Code"=FIELD("Schedule Code")));
        ...
        {
            CalcFormula = Lookup("TM Admission Schedule"."Stop Time" WHERE ("Schedule Code"=FIELD("Schedule Code")));
    ...
    trigger OnDelete()
    var
        TMAdmissionScheduleEntry: Record "TM Admission Schedule Entry";
    begin
        //-TM1.24 [289293]
    ...
    trigger OnInsert()
    var
        TicketAdmissionSchedules: Record "TM Admission Schedule Lines";
    ...
    procedure SyncAdmissionSettings(Admission: Record "TM Admission")
    var
        AdmissionSchedule: Record "TM Admission Schedule";
    begin
    ...
    procedure SyncScheduleSettings(AdmissionSchedule: Record "TM Admission Schedule")
    var
        Admission: Record "TM Admission";
    begin
