report 6014456 "Sales per week year/Last year"
{
        ...
        dataitem("Integer";"Integer")
        {
            ...
            begin
                ...
                if SalesPersonPurchaser.Find('-') then
                  begin
                    SalesAllPersons := 0;
                    repeat
                      SalesPersonPurchaser.CalcFields("Sales (LCY)");
                      SalesAllPersons := SalesAllPersons + SalesPersonPurchaser."Sales (LCY)";
                ...
                if SalesPersonPurchaser.Find('-') then
                  begin
                    ...
                    repeat
                      SalesPersonPurchaser.CalcFields("Sales (LCY)");
                      SalesAllPersonsLastYear := SalesAllPersonsLastYear + SalesPersonPurchaser."Sales (LCY)";
                    until SalesPersonPurchaser.Next = 0;
                  end;
            ...
            begin
                if "Dimension Value".Code<>'' then
                  SalesPersonPurchaser.SetRange("Global Dimension 1 Filter", "Dimension Value".Code);
            end;
        }
