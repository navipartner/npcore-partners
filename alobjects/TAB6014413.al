table 6014413 "Period Discount"
{
    ...
    LookupPageID = "Campaign Discount List";
    ...
    fields
    {
        ...
        {
            CalcFormula = Exist("Retail Comment" WHERE ("Table ID"=CONST(6014413),
                                                        "No."=FIELD(Code)));
            Caption = 'Comment';
            Editable = false;
        ...
        {
            CalcFormula = -Sum("Item Ledger Entry".Quantity WHERE ("Discount Type"=CONST(Period),
        ...
        {
            CalcFormula = Sum("Value Entry"."Sales Amount (Actual)" WHERE ("Discount Type"=CONST(Period),
                                                                           "Discount Code"=FIELD(Code),
                                                                           "Global Dimension 1 Code"=FIELD("Global Dimension 1 Code"),
                                                                           "Global Dimension 2 Code"=FIELD("Global Dimension 2 Code")));
            Caption = 'Sold Amount';
    ...
    begin
        ...
        DimMgt.DeleteDefaultDim(DATABASE::"Period Discount",Code);
    ...
    procedure AssistEdit(PeriodDisc: Record "Period Discount"): Boolean
    begin
    ...
    begin
        ...
        DimMgt.SaveDefaultDim(DATABASE::"Period Discount",Code,FieldNumber,ShortcutDimCode);
        //+NPR5.29 [261710]
        Modify;
    end;
    ...
    var
        PeriodDiscountLines: Record "Period Discount Line";
    begin
        //-NPR5.40 [294655]
        if IsTemporary then
          exit;
        ...
        if PeriodDiscountLines.FindSet then repeat
