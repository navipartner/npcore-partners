                    ...
                    case LinesType of
                        ...
                        LinesType::Variants:
                            begin
                                ...
                                case ShortcutValue of
                                    1:
                                        ItemVariant.SetRange("Variety 1 Value", ItemWorksheetVarietyValue.Value);
                                    2:
                                        ItemVariant.SetRange("Variety 2 Value", ItemWorksheetVarietyValue.Value);
                                    3:
                                        ItemVariant.SetRange("Variety 3 Value", ItemWorksheetVarietyValue.Value);
                                    4:
                                        ItemVariant.SetRange("Variety 4 Value", ItemWorksheetVarietyValue.Value);
                                end;
