table 6060042 "Item Worksheet Line"
{
    ...
    LookupPageID = "Item Worksheet Page";
    ...
    fields
    {
        ...
        field(5;"Existing Item No.";Code[20])
        {
            ...
            begin
                ...
                "Variety 1" := Item."Variety 1";
                //-NPR4.19
                if VRTTable.Get("Variety 1",Item."Variety 1 Table") then
                ...
                //+NPR4.19
                    Validate("Variety 1 Table (Base)", Item."Variety 1 Table");
                    "Create Copy of Variety 1 Table" := false;
                //-NPR4.19
                  end;
                //+NPR4.19

                "Variety 2" := Item."Variety 2";
                //-NPR4.19
                if VRTTable.Get("Variety 2",Item."Variety 2 Table") then
                  if VRTTable."Is Copy" and (Action = Action ::CreateNew) then begin
                    Validate("Variety 2 Table (Base)", VRTTable."Copy from");
                    "Create Copy of Variety 2 Table" := true;
                  end else begin
                //+NPR4.19
                  Validate("Variety 2 Table (Base)", Item."Variety 2 Table");
                  "Create Copy of Variety 2 Table" := false;
                //-NPR4.19
                  end;
                //+NPR4.19

                "Variety 3" := Item."Variety 3";
                //-NPR4.19
                if VRTTable.Get("Variety 3",Item."Variety 3 Table") then
                  if VRTTable."Is Copy" and (Action = Action ::CreateNew)   then begin
                    Validate("Variety 3 Table (Base)", VRTTable."Copy from");
                    "Create Copy of Variety 3 Table" := true;
                  end else begin
                //+NPR4.19
                    Validate("Variety 3 Table (Base)", Item."Variety 3 Table");
                    "Create Copy of Variety 3 Table" := false;
                //-NPR4.19
                  end;
                //+NPR4.19

                "Variety 4" := Item."Variety 4";
                //-NPR4.19
                if VRTTable.Get("Variety 4",Item."Variety 4 Table") then
                  if VRTTable."Is Copy"  and (Action = Action ::CreateNew)  then begin
                    Validate("Variety 4 Table (Base)", VRTTable."Copy from");
                    "Create Copy of Variety 4 Table" := true;
                  end else begin
                //+NPR4.19
                    Validate("Variety 4 Table (Base)", Item."Variety 4 Table");
        ...
        {
            CalcFormula = Count("Item Worksheet Variant Line" WHERE ("Worksheet Template Name"=FIELD("Worksheet Template Name"),
        ...
        {
            CalcFormula = Count("Item Worksheet Field Change" WHERE ("Worksheet Template Name"=FIELD("Worksheet Template Name"),
                                                                     "Worksheet Name"=FIELD("Worksheet Name"),
                                                                     "Worksheet Line No."=FIELD("Line No."),
                                                                     Process=CONST(true)));
    ...
    var
        ...
        ItemWorksheetItemMgt: Codeunit "Item Worksheet Item Management";
    ...
    var
        ItemWizBatch: Record "Item Worksheet";
    begin
    ...
    var
        "Field": Record "Field";
    begin
        Field.Get(DATABASE::"Item Worksheet Line",FieldNumber);
        exit(Field."Field Caption");
    end;

    procedure SetUpNewLine(LastItemWorksheetLine: Record "Item Worksheet Line")
    begin
    ...
    begin
        ...
        if ItemVar.FindSet then repeat
          ...
          ItemWorksheetVar."Variety 1 Value" := ItemVar."Variety 1 Value";
          ItemWorksheetVar."Variety 2 Value" := ItemVar."Variety 2 Value";
          ItemWorksheetVar."Variety 3 Value" := ItemVar."Variety 3 Value";
          ItemWorksheetVar."Variety 4 Value" := ItemVar."Variety 4 Value";
          case Action of
            Action :: Skip :
    ...
    var
        ItemWorksheetVarietyValue1: Record "Item Worksheet Variety Value";
        ItemWorksheetVarietyValue2: Record "Item Worksheet Variety Value";
        ItemWorksheetVarietyValue3: Record "Item Worksheet Variety Value";
        ItemWorksheetVarietyValue4: Record "Item Worksheet Variety Value";
        TempItemWorksheetVarietyValue1: Record "Item Worksheet Variety Value" temporary;
        TempItemWorksheetVarietyValue2: Record "Item Worksheet Variety Value" temporary;
        TempItemWorksheetVarietyValue3: Record "Item Worksheet Variety Value" temporary;
        TempItemWorksheetVarietyValue4: Record "Item Worksheet Variety Value" temporary;
        ItemWorksheetVariantLine: Record "Item Worksheet Variant Line";
        VRT1Desc: Text[50];
        VRT2Desc: Text[50];
        VRT3Desc: Text[50];
    ...
    begin
        ...
        if TempItemWorksheetVarietyValue1.FindFirst then repeat
        //+NPR5.38 [268786]
          ...
          if TempItemWorksheetVarietyValue2.FindFirst then repeat
          //+NPR5.38 [268786]
            ...
            if TempItemWorksheetVarietyValue3.FindFirst then repeat
            //+NPR5.38 [268786]
              if ("Variety 4 Table (New)" <> '') and IncludeHeaders then begin
                ...
                if TempItemWorksheetVarietyValue4.FindFirst then repeat
    ...
    begin
        ...
        if (AttributeKey.FindFirst ()) then begin
          ...
          if AttributeValueSet.FindSet then repeat
            AttributeID.Reset;
            ...
            if AttributeID.FindFirst then begin
              AttributeID."Table ID" := DATABASE::"Item Worksheet Line";
              if AttributeID.Insert then;
            end;
            AttributeManagement.SetWorksheetLineAttributeValue(DATABASE::"Item Worksheet Line",AttributeID."Shortcut Attribute ID",
    ...
    local procedure InitItemWorksheetVarietyValue(var ItemWorksheetVarietyValue: Record "Item Worksheet Variety Value";LineType: Code[20];LineTable: Code[20])
    begin
    ...
    local procedure VariantExists(ItemWorksheetVariantLine: Record "Item Worksheet Variant Line"): Boolean
    var
    ...
    begin
        ...
        ItemWorksheetVariantLine.SetRange("Worksheet Line No.", "Line No.");
        ItemWorksheetVariantLine.SetCurrentKey("Worksheet Template Name","Worksheet Name","Worksheet Line No.","Variety 1 Value","Variety 2 Value","Variety 3 Value","Variety 4 Value");
        if ItemWorksheetVariantLine.FindLast then repeat
    ...
    begin
        case VrtValue of
          1 : exit("Create Copy of Variety 1 Table");
          2 : exit("Create Copy of Variety 2 Table");
          3 : exit("Create Copy of Variety 3 Table");
          4 : exit("Create Copy of Variety 4 Table");
        end;
        exit(false);
    end;
    ...
    begin
        VarietyTable.Init;
        case VrtValue of
          1 : VarietyTable.Get("Variety 1","Variety 1 Table (New)");
          2 : VarietyTable.Get("Variety 2","Variety 2 Table (New)");
          3 : VarietyTable.Get("Variety 3","Variety 3 Table (New)");
          4 : VarietyTable.Get("Variety 4","Variety 4 Table (New)");
        end;
    ...
    var
        ...
        WorksheetVarietyValue: Record "Item Worksheet Variety Value";
    begin
        VarietyTable.Init;
        case VrtValue of
          1 : VarietyTable.Get("Variety 1","Variety 1 Table (New)");
        ...
        if WorksheetVarietyValue.FindSet then repeat
    ...
    begin
        ...
        ItemWorksheetVar.SetRange("Worksheet Name", "Worksheet Name");
        ItemWorksheetVar.SetRange("Worksheet Line No.", "Line No.");
        if ItemWorksheetVar.FindFirst then repeat
    ...
    var
        DuplicateItemWorksheetLine: Record "Item Worksheet Line";
    begin
        //-NPR5.25 [246088]
    ...
    var
        ...
        LocRecItemWorksheetLine: Record "Item Worksheet Line";
    begin
        //-NPR5.25 [246088]
        if "Existing Item No."  = '' then
          exit;
    ...
    local procedure ValidateFields(var VarItem: Record Item;var VarItemWorksheetLine: Record "Item Worksheet Line")
    var
    ...
    var
        ObsoleteWorksheetLine: Record "Item Worksheet Line";
    begin
        //-NPR5.27 [253672]
        if "Item No." = '' then
          exit;
        ...
        if ObsoleteWorksheetLine.FindSet then repeat
          //-NPR5.39 [304421]
    ...
    local procedure GetTempVarietyLines(var ItemWorksheetVarietyValue: Record "Item Worksheet Variety Value";var tempItemWorksheetVarietyValue: Record "Item Worksheet Variety Value" temporary;ShortcutValue: Integer;LinesType: Option "None",Variants,"Varieties Without Variants",All)
    var
        ItemWorksheetVariantLine: Record "Item Worksheet Variant Line";
        VarFound: Boolean;
            ...
            case LinesType of
              LinesType::None:
                begin
                  ...
                  case ShortcutValue of
                    1: ItemWorksheetVariantLine.SetFilter("Variety 1 Value",ItemWorksheetVarietyValue.Value);
                    2: ItemWorksheetVariantLine.SetFilter("Variety 2 Value",ItemWorksheetVarietyValue.Value);
                    3: ItemWorksheetVariantLine.SetFilter("Variety 3 Value",ItemWorksheetVarietyValue.Value);
                    4: ItemWorksheetVariantLine.SetFilter("Variety 4 Value",ItemWorksheetVarietyValue.Value);
                  end;
              ...
              LinesType::Variants:
                begin
                  ...
                  case ShortcutValue of
                    1: ItemVariant.SetRange("Variety 1 Value",ItemWorksheetVarietyValue.Value);
                    2: ItemVariant.SetRange("Variety 2 Value",ItemWorksheetVarietyValue.Value);
                    3: ItemVariant.SetRange("Variety 3 Value",ItemWorksheetVarietyValue.Value);
                    4: ItemVariant.SetRange("Variety 4 Value",ItemWorksheetVarietyValue.Value);
                  end;
    ...
    local procedure OldLineContainsSameVarieties(WorksheetLineToCompare: Record "Item Worksheet Line"): Boolean
    var
        ItemWorksheetVariantLineToCompare: Record "Item Worksheet Variant Line";
        ItemWorksheetVariantLine: Record "Item Worksheet Variant Line";
    begin
        //-NPR5.39 [304421]
        ...
        if ItemWorksheetVariantLineToCompare.FindSet then  repeat
          ItemWorksheetVariantLine.SetRange("Worksheet Template Name","Worksheet Template Name");
          ItemWorksheetVariantLine.SetRange("Worksheet Name","Worksheet Name");
          ItemWorksheetVariantLine.SetRange("Worksheet Line No.","Line No.");
