codeunit 6060057 "Item Worksheet Purch. Integr."
{
    ...
    local procedure SelectItemtoCreate(ItemWorksheet: Record "Item Worksheet";VendorNo: Code[20];VendorItemNo: Text[50];var ItemNo: Code[20];var VariantCode: Code[10]): Boolean
    var
        TempItemWorksheetLine: Record "Item Worksheet Line" temporary;
        TempItemWorksheetVariantLine: Record "Item Worksheet Variant Line" temporary;
        ItemWorksheetPage: Page "Item Worksheet Page";
        LineNoFilter: Text;
    begin
        ...
        if TempItemWorksheetLine.FindSet then repeat
    ...
    local procedure CreateItem(TempItemWorksheetLine: Record "Item Worksheet Line" temporary;var ItemNo: Code[20];var VariantCode: Code[10]): Boolean
    var
        ItemWorksheetLine: Record "Item Worksheet Line";
    ...
    begin
        ...
        if not CODEUNIT.Run(CODEUNIT::"Item Wsht.-Register Batch",ItemWorksheetLine) then
          exit(false);
    ...
    local procedure SelectItemWorksheet(var ItemWorksheet: Record "Item Worksheet";VendorItemNo: Text[50]): Boolean
    var
        TempItemWorksheetWithPossibleMatch: Record "Item Worksheet" temporary;
        TempItemWorksheetLine: Record "Item Worksheet Line" temporary;
        TempItemWorksheetVariantLine: Record "Item Worksheet Variant Line" temporary;
            ...
            case TempItemWorksheetWithPossibleMatch.Count of
              ...
              1  :
                ...
                begin
                  ...
                  if not GuiAllowed then
                    exit(false);
                  if TempItemWorksheetWithPossibleMatch.FindSet then repeat
    ...
    local procedure MatchToItemWorksheetLine(ItemWorksheet: Record "Item Worksheet";VendorItemNo: Text[50];var TempItemWorksheetLine: Record "Item Worksheet Line" temporary;var TempItemWorksheetVariantLine: Record "Item Worksheet Variant Line" temporary): Boolean
    var
        ItemWorksheetLine: Record "Item Worksheet Line";
        ItemWorksheetVariantLine: Record "Item Worksheet Variant Line";
    begin
    ...
    local procedure AddItemWorksheetLinesToTemp(var ItemWorksheetLine: Record "Item Worksheet Line";var TempItemWorksheetLine: Record "Item Worksheet Line" temporary)
    begin
    ...
    local procedure AddItemWorksheetVariantLinesToTemp(var TempItemWorksheetLine: Record "Item Worksheet Line" temporary;var ItemWorksheetVariantLine: Record "Item Worksheet Variant Line";var TempItemWorksheetVariantLine: Record "Item Worksheet Variant Line" temporary)
    var
        ItemWorksheetLine: Record "Item Worksheet Line";
    begin
