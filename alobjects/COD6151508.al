codeunit 6151508 "Nc Task List Processing"
{
    ...
    local procedure FindTaskProcessorCode(var JobQueueEntry: Record "Job Queue Entry";var NcTaskProcessor: Record "Nc Task Processor")
    var
    ...
    begin
        exit(CODEUNIT::"Nc Task List Processing");
    end;
