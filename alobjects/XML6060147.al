xmlport 6060147 "MM Loyalty Coupon Eligibility"
{
            ...
            textelement(getcouponeligibility)
            {
                ...
                tableelement(tmpmembershipresponse;"MM Membership")
                {
                    ...
                    textelement(coupons)
                    {
                        MaxOccurs = Once;
                        MinOccurs = Zero;
                        tableelement(tmployaltypointssetupresponse;"MM Loyalty Points Setup")
                        {
                            MinOccurs = Zero;
                            XmlName = 'coupon';
                            UseTemporary = true;
    ...
    procedure GetRequest(var TmpMemberInfoCaptureOut: Record "MM Member Info Capture" temporary)
    begin
    ...
    procedure AddResponse(MembershipEntryNo: Integer;var TmpLoyaltyPointsSetup: Record "MM Loyalty Points Setup" temporary;ResponseMessageIn: Text)
    var
