codeunit 6014434 "NF Retail Code"
{
    // //001 - Ohm
    ...
    procedure TR406CheckSerialNoApplication(var SaleLinePOS: Record "Sale Line POS";var TotalItemLedgerEntryQuantity: Decimal;ItemNo: Code[20];SerialNo: Code[20])
    var
    ...
    procedure TR406SerialNoOnValidate(var SaleLinePOS: Record "Sale Line POS";var TotalNonAppliedQuantity: Decimal;var TotalAuditRollQuantity: Decimal;var TotalItemLedgerEntryQuantity: Decimal)
    var
    ...
    procedure TR406SerialNoOnLookup(var SaleLinePOS: Record "Sale Line POS"): Boolean
    var
    ...
    begin
        ...
        //+NPR5.27 [253261]
          ...
          ActionTaken := PAGE.RunModal(PAGE::"Item - Series Number",TempItemLedgerEntry);
    ...
    procedure TR406FindItemCostPrice(var SaleLinePOS: Record "Sale Line POS";var Item2: Record Item;Color: Code[20];Size: Code[20]): Decimal
    var
        ItemLedgerEntry: Record "Item Ledger Entry";
    ...
    procedure TS37SerieNoCopy(var SalesLine: Record "Sales Line";var SaleLinePOS: Record "Sale Line POS")
    begin
        //TS37SerieNrCopy()
        //Do nothing
    end;
    ...
    begin
        //CS22InitValueEntry2()
        ValueEntry."Item Group No." := ItemJnlLine."Item Group No.";
        ValueEntry."Vendor No." := ItemJnlLine."Vendor No.";
        ValueEntry."Discount Type" := ItemJnlLine."Discount Type";
        ValueEntry."Discount Code" := ItemJnlLine."Discount Code";
        //-NPR5.30 [266866]
        ...
        //+NPR4.04
        ValueEntry."Register No." := ItemJnlLine."Register Number";
        ValueEntry."Group Sale" := ItemJnlLine."Group Sale";
        ValueEntry."Salesperson Code" := ItemJnlLine."Salespers./Purch. Code";
    ...
    procedure TR406FindSerialNo(var SaleLinePOS: Record "Sale Line POS")
    var
        Item: Record Item;
        ItemLedgerEntry: Record "Item Ledger Entry";
    begin
    ...
    procedure TR408CreateInvFromCreditVoucher(var CreditVoucher: Record "Credit Voucher")
    var
    ...
    procedure TR409CreateInvFromGiftVoucher(var GiftVoucher: Record "Gift Voucher")
    var
        Register: Record Register;
