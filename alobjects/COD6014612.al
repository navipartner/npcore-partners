codeunit 6014612 "Tax Free PTF Offline"
{
    ...
    local procedure VoucherPrint(var AuditRoll: Record "Audit Roll")
    var
        LinePrintMgt: Codeunit "RP Line Print Mgt.";
    begin
        LinePrintMgt.ProcessCodeunit(CODEUNIT::"Report - Tax Free Receipt", AuditRoll);
    end;
