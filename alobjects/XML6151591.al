xmlport 6151591 "NpDc Ext. Coupon"
{
    ...
    procedure GetCoupons(var TempNpDcExtCouponBuffer2: Record "NpDc Ext. Coupon Buffer" temporary)
    begin
        TempNpDcExtCouponBuffer2.Copy(TempNpDcExtCouponBuffer,true);
    end;

    procedure SetCoupons(var TempNpDcExtCouponBuffer2: Record "NpDc Ext. Coupon Buffer" temporary)
    begin
