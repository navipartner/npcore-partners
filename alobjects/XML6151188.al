xmlport 6151188 "MM Member Communication"
{
            ...
            textelement(getsetcomoptions)
            {
                ...
                textelement(request)
                {
                    ...
                    textelement(communicationoptions)
                    {
                        MaxOccurs = Once;
                        MinOccurs = Zero;
                        tableelement(tmpmembercommunicationrequest;"MM Member Communication")
                        {
                            MinOccurs = Zero;
                            XmlName = 'option';
                            UseTemporary = true;
                ...
                textelement(response)
                {
                    ...
                    textelement(membershipresponse)
                    {
                        ...
                        textelement(communicationoptionsresponse)
                        {
                            ...
                            tableelement(tmpmembercommunicationresponse;"MM Member Communication")
                            {
                                MinOccurs = Zero;
                                XmlName = 'option';
                                UseTemporary = true;
    ...
    procedure GetRequest(var MemberNumberOut: Code[20];var MembershipNumberOut: Code[20];var TmpMemberCommunication: Record "MM Member Communication" temporary)
    begin
    ...
    procedure SetResponse(MemberNumberIn: Code[20];MembershipNumberIn: Code[20];var TmpMemberCommunication: Record "MM Member Communication" temporary)
    begin
    ...
    begin
        ...
        with MemberCommunication do
          case MessageType of
            "Message Type"::WELCOME     : Name := 'Welcome';
            "Message Type"::RENEW       : Name := 'Renew';
            "Message Type"::TICKETS     : Name := 'Tickets';
            "Message Type"::NEWSLETTER  : Name := 'Newsletter';
            "Message Type"::MEMBERCARD  : Name := 'MemberCard';
          end;
    end;
    ...
    begin
        ...
        with MemberCommunication do
          case Method of
            "Preferred Method"::EMAIL         : Name := 'E-Mail';
            "Preferred Method"::SMS           : Name := 'SMS';
            "Preferred Method"::MANUAL        : Name := 'Manual';
            "Preferred Method"::WALLET_EMAIL  : Name := 'Wallet (E-Mail)';
            "Preferred Method"::WALLET_SMS    : Name := 'Wallet (SMS)';
          end;
    end;
    ...
    begin
        ...
        with MemberCommunication do
          case Accepted of
            "Accepted Communication"::PENDING   : Name := 'Pending';
            "Accepted Communication"::"OPT-IN"  : Name := 'OptIn';
            "Accepted Communication"::"OPT-OUT" : Name := 'OptOut';
          end;
    end;
    ...
    begin
        ...
        case UpperCase (Name) of
          '0', 'WELCOME'    : OptionValue := MemberCommunication."Message Type"::WELCOME;
          '1', 'RENEW'      : OptionValue := MemberCommunication."Message Type"::RENEW;
          '2', 'NEWSLETTER' : OptionValue := MemberCommunication."Message Type"::NEWSLETTER;
          '3', 'MEMBERCARD' : OptionValue := MemberCommunication."Message Type"::MEMBERCARD;
          '4', 'TICKETS'    : OptionValue := MemberCommunication."Message Type"::TICKETS;
          else begin
    ...
    begin
        ...
        case UpperCase (Name) of
          '0', 'MANUAL'                     : OptionValue := MemberCommunication."Preferred Method"::MANUAL;
          '1', 'SMS'                        : OptionValue := MemberCommunication."Preferred Method"::SMS;
          '2', 'EMAIL', 'E-MAIL'            : OptionValue := MemberCommunication."Preferred Method"::EMAIL;
          '3', 'WALLET_SMS', 'WALLET (SMS)' : OptionValue := MemberCommunication."Preferred Method"::WALLET_SMS;
          '4', 'WALLET_EMAIL', 'WALLET (E-MAIL)', 'WALLET (EMAIL)' : OptionValue := MemberCommunication."Preferred Method"::WALLET_EMAIL;
          else
    ...
    begin
        ...
        case UpperCase (Name) of
          '0', 'PENDING'            : OptionValue := MemberCommunication."Accepted Communication"::PENDING;
          '1', 'OPTIN', 'OPT-IN'    : OptionValue := MemberCommunication."Accepted Communication"::"OPT-IN";
          '2', 'OPTOUT', 'OPT-OUT'  : OptionValue := MemberCommunication."Accepted Communication"::"OPT-OUT";
          else
