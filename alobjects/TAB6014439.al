table 6014439 "Quantity Discount Header"
{
    ...
    LookupPageID = "Quantity Discount List";
    ...
    fields
    {
        ...
        {
            CalcFormula = Exist("Retail Comment" WHERE ("Table ID"=CONST(6014439),
                                                        "No."=FIELD("Item No."),
                                                        "No. 2"=FIELD("Main No.")));
            Caption = 'Comment';
            Editable = false;
    ...
    begin
        ...
        RetailComment.SetRange("Table ID", DATABASE::"Quantity Discount Header" );
        ...
        DimMgt.DeleteDefaultDim(DATABASE::"Quantity Discount Header", "Main No." );
    end;
    ...
    begin
        ...
        DimMgt.UpdateDefaultDim(
          DATABASE::"Quantity Discount Header", "Main No.",
    ...
    begin
        ...
        DimMgt.SaveDefaultDim(DATABASE::"Quantity Discount Header","Main No.",FieldNumber,ShortcutDimCode);
        //+NPR4.01
        Modify;
    end;

    procedure AssistEdit(QtyDiscHeader: Record "Quantity Discount Header"): Boolean
    var
        QtyDiscHeader2: Record "Quantity Discount Header";
    begin
