codeunit 6184473 "EFT Payment"
{
    ...
    begin
        ...
        case EftTransactionRequest."Processing Type" of
          ...
          EftTransactionRequest."Processing Type"::Lookup : EftLookupResponseReceived(EftTransactionRequest, POSFrontEnd, POSSession);
        end;
    end;
    ...
    begin
        ...
        if EftTransactionRequest."Processing Type" = EftTransactionRequest."Processing Type"::Lookup then begin
          OriginalEftTransactionRequest.Get(EftTransactionRequest."Processed Entry No.");
