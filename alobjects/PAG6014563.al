page 6014563 "Touch Screen - Ticket Reserv."
{
    ...
    var
        TicketAccessCapacity: Record "Ticket Access Capacity Slots";
    ...
    procedure Init(SalePOSIn: Record "Sale POS";TicketTypeIn: Code[10])
    begin
        SalePOS      := SalePOSIn;
    ...
    procedure GetReservations(var TempCapacitySlots: Record "Ticket Access Capacity Slots" temporary)
    begin
    ...
    procedure SetSalePOS(var SalePOSIn: Record "Sale POS")
    begin
        SalePOS := SalePOSIn;
    end;
