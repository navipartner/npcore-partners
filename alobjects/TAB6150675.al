table 6150675 "NPRE Kitchen Req. Source Link"
{
    ...
    DrillDownPageID = "NPRE Kitchen Req. Source Links";
    LookupPageID = "NPRE Kitchen Req. Source Links";
