codeunit 6151592 "NpDc Module Issue - Default"
{
    ...
    local procedure IssueCoupon(CouponType: Record "NpDc Coupon Type";var TempCoupon: Record "NpDc Coupon" temporary)
    var
    ...
    begin
        exit(CODEUNIT::"NpDc Module Issue - Default");
    end;
