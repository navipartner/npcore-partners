codeunit 6151105 "NpRi Reimburse Provision"
{
    ...
    local procedure DiscoverProvision(var NpRiModule: Record "NpRi Reimbursement Module")
    begin
    ...
    var
        NpRiProvisionSetup: Record "NpRi Provision Setup";
    begin
    ...
    begin
        ...
        PAGE.RunModal(PAGE::"NpRi Provision Setup",NpRiProvisionSetup);
    ...
    local procedure RunProvisionReimbursement(var NpRiReimbursement: Record "NpRi Reimbursement";var NpRiReimbursementEntryApply: Record "NpRi Reimbursement Entry")
    var
    ...
    local procedure CreateGenJnl(NpRiReimbursement: Record "NpRi Reimbursement";var NpRiReimbursementEntryApply: Record "NpRi Reimbursement Entry";var TempGenJnlLine: Record "Gen. Journal Line" temporary) ReimbursementAmount: Decimal
    var
    ...
    local procedure PostProvision(ReimbursementAmount: Decimal;var NpRiReimbursementEntryApply: Record "NpRi Reimbursement Entry";var TempGenJnlLine: Record "Gen. Journal Line" temporary)
    var
    ...
    begin
        exit(CODEUNIT::"NpRi Reimburse Provision");
    end;
}
