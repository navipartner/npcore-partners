codeunit 6151103 "NpRi Collect Vendor Ledgers"
{
    ...
    local procedure DiscoverVendorLedgers(var NpRiModule: Record "NpRi Reimbursement Module")
    begin
    ...
    local procedure CollectVendLedgEntries(var NpRiDataCollectionMgt: Codeunit "NpRi Data Collection Mgt.";var NpRiReimbursement: Record "NpRi Reimbursement")
    var
    ...
    local procedure FindVendLedgEntries(NpRiReimbursement: Record "NpRi Reimbursement";var VendLedgEntry: Record "Vendor Ledger Entry"): Boolean
    var
    ...
    local procedure UpdateEntry(VendLedgEntry: Record "Vendor Ledger Entry";var NpRiReimbursementEntry: Record "NpRi Reimbursement Entry")
    begin
    ...
    begin
        exit(CODEUNIT::"NpRi Collect Vendor Ledgers");
    end;
}
