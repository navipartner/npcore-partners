table 6060122 "TM Admission Schedule Entry"
{
    ...
    LookupPageID = "TM Admission Schedule Entry";
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("TM Det. Ticket Access Entry".Quantity WHERE ("External Adm. Sch. Entry No."=FIELD("External Schedule Entry No."),
