codeunit 6151504 "Nc Import Mgt."
{
    ...
    [TryFunction]
    procedure CleanupImportType(ImportType: Record "Nc Import Type")
    var
        ImportEntry: Record "Nc Import Entry";
    ...
    local procedure GetErrorMailBody(var NcImportEntry: Record "Nc Import Entry") Body: Text
    var
    ...
    local procedure GetErrorMailSenderAddress(NcImportEntry: Record "Nc Import Entry") SenderAddress: Text
    begin
        //-NC2.02 [262318]
    ...
    local procedure GetErrorMailSubject(NcImportEntry: Record "Nc Import Entry") Subject: Text
    var
        ErrorMessage: Text;
    begin
        //-NC2.02 [262318]
    ...
    procedure SendTestErrorMail(NcImportType: Record "Nc Import Type")
    var
        NcImportEntry: Record "Nc Import Entry";
        TempNcImportEntry: Record "Nc Import Entry";
        OutStream: OutStream;
    begin
        //-NC2.02 [262318]
