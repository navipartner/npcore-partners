table 6059907 "Task Worker"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Task Queue".Company WHERE ("Assigned to Service Inst.ID"=FIELD("Server Instance ID"),
        ...
        {
            CalcFormula = Lookup("Task Queue"."Task Template" WHERE ("Assigned to Service Inst.ID"=FIELD("Server Instance ID"),
                                                                     "Assigned to Session ID"=FIELD("Session ID")));
        ...
        {
            CalcFormula = Lookup("Task Queue"."Task Batch" WHERE ("Assigned to Service Inst.ID"=FIELD("Server Instance ID"),
                                                                  "Assigned to Session ID"=FIELD("Session ID")));
        ...
        {
            CalcFormula = Lookup("Task Queue"."Task Line No." WHERE ("Assigned to Service Inst.ID"=FIELD("Server Instance ID"),
                                                                     "Assigned to Session ID"=FIELD("Session ID")));
