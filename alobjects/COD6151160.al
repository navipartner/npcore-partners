codeunit 6151160 "MM Loyalty Points Mgr (Client)"
{
    ...
    procedure PrepareServiceRequest(var EFTTransactionRequest: Record "EFT Transaction Request")
    var
        LoyaltyStoreSetup: Record "MM Loyalty Store Setup";
        LoyaltyEndpointClient: Record "MM NPR Remote Endpoint Setup";
        SoapAction: Text;
    ...
    procedure MakeServiceRequest(var EFTTransactionRequest: Record "EFT Transaction Request")
    var
        LoyaltyStoreSetup: Record "MM Loyalty Store Setup";
        LoyaltyEndpointClient: Record "MM NPR Remote Endpoint Setup";
        EFTInterface: Codeunit "EFT Interface";
        LoyaltyPointsWSClient: Codeunit "MM Loyalty Points WS (Client)";
        SoapAction: Text;
        ResponseMessage: Text;
        XmlRequest: Text;
    ...
    local procedure TransformToSoapAction(var EFTTransactionRequest: Record "EFT Transaction Request";var SoapAction: Text;var XmlText: Text;var ResponseText: Text) TransformOk: Boolean
    var
        IStream: InStream;
        OStream: OutStream;
    begin
    ...
    procedure ValidateServiceRequest(EFTTransactionRequest: Record "EFT Transaction Request"): Boolean
    var
        ResponseMessage: Text;
        LoyaltyStoreSetup: Record "MM Loyalty Store Setup";
        PaymentMethod: Record "POS Payment Method";
    begin
    ...
    local procedure GetAuthorization(var EFTTransactionRequest: Record "EFT Transaction Request";LoyaltyStoreSetup: Record "MM Loyalty Store Setup";var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary)
    begin
    ...
    local procedure TransformToRegisterReceipt(EFTTransactionRequest: Record "EFT Transaction Request";var SoapAction: Text;var XmlText: Text;var ResponseText: Text): Boolean
    var
        TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;
        TmpRegisterPaymentLines: Record "MM Register Sales Buffer" temporary;
        TmpRegisterSalesLines: Record "MM Register Sales Buffer" temporary;
        LoyaltyStoreSetup: Record "MM Loyalty Store Setup";
        SaleLinePOS: Record "Sale Line POS";
        GeneralLedgerSetup: Record "General Ledger Setup";
        EFTTransactionRequest2: Record "EFT Transaction Request";
          ...
          if (SaleLinePOS.FindFirst ()) then begin
            repeat
              ...
              case (SaleLinePOS."Amount Including VAT" >= 0) of
                true: Type := Type::SALES;
                false: Type := Type::RETURN;
              end;
    ...
    local procedure TransformToReservePoints(EFTTransactionRequest: Record "EFT Transaction Request";var SoapAction: Text;var XmlText: Text;var ResponseText: Text): Boolean
    var
        TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;
        TmpRegisterPaymentLines: Record "MM Register Sales Buffer" temporary;
        LoyaltyStoreSetup: Record "MM Loyalty Store Setup";
    ...
    local procedure FinalizeTransactionRequest(var EFTTransactionRequest: Record "EFT Transaction Request";MessageCode: Text;ResponseMessage: Text;AuthorizationCode: Text;ReferenceNumber: Text)
    var
        OStream: OutStream;
        LoyaltyStoreSetup: Record "MM Loyalty Store Setup";
        POSPaymentMethod: Record "POS Payment Method";
    ...
    local procedure EarnAmountToPoints(LoyaltyStoreSetup: Record "MM Loyalty Store Setup";CurrencyCode: Code[10];Amount: Decimal) Points: Integer
    var
    ...
    local procedure BurnPointsToAmount(LoyaltyStoreSetup: Record "MM Loyalty Store Setup";CurrencyCode: Code[10];Points: Decimal) Amount: Decimal
    var
        PaymentMethod: Record "POS Payment Method";
        PaymentTypePOS: Record "Payment Type POS";
    begin
    ...
    procedure AssignLoyaltyInformation(var EFTTransactionRequest: Record "EFT Transaction Request") CardInfo: Boolean
    var
    ...
    procedure GetStoreSetup(PosUnitNo: Code[10];var ResponseText: Text;var LoyaltyStoreSetup: Record "MM Loyalty Store Setup"): Boolean
    var
        POSUnit: Record "POS Unit";
    begin
    ...
    local procedure CreateAuthorizationSection(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary) XmlText: Text
    begin
    ...
    procedure CreateRegisterSalesEftTransaction(IntegrationName: Code[20];SalePOS: Record "Sale POS";var EFTTransactionRequest: Record "EFT Transaction Request"): Boolean
    begin
    ...
    procedure CreateRegisterSaleTestXml(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;var TmpRegisterSaleLines: Record "MM Register Sales Buffer" temporary;var TmpRegisterPaymentLines: Record "MM Register Sales Buffer" temporary) XmlText: Text
    var
        XmlSalesLines: Text;
    ...
    procedure CreateRegisterSaleSoapXml(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;var TmpRegisterSaleLines: Record "MM Register Sales Buffer" temporary;var TmpRegisterPaymentLines: Record "MM Register Sales Buffer" temporary) XmlText: Text
    var
        XmlSalesLines: Text;
        XmlPaymentLines: Text;
    begin
    ...
    local procedure CreateRegisterSaleXml(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;var TmpRegisterSaleLines: Record "MM Register Sales Buffer" temporary;var TmpRegisterPaymentLines: Record "MM Register Sales Buffer" temporary) XmlText: Text
    var
        XmlSalesLines: Text;
        XmlPaymentLines: Text;
    begin
    ...
    procedure CreateReservePointsTestXml(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;var TmpRegisterPaymentLines: Record "MM Register Sales Buffer" temporary) XmlText: Text
    var
    ...
    procedure CreateReservePointsSoapXml(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;var TmpRegisterPaymentLines: Record "MM Register Sales Buffer" temporary) XmlText: Text
    var
        XmlReservationLines: Text;
    begin
    ...
    local procedure CreateReservePointsXml(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary;var TmpRegisterPaymentLines: Record "MM Register Sales Buffer" temporary) XmlText: Text
    var
        XmlReservationLines: Text;
    begin
    ...
    procedure CreateGetLoyaltyConfigurationSoapXml(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary) XmlText: Text
    begin
    ...
    local procedure CreateGetLoyaltyConfigurationXml(var TmpTransactionAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary) XmlText: Text
    begin
