codeunit 6150846 "POS Action - EFT Operation"
{
    ...
    begin
        ...
        //-NPR5.54 [364340]
          OperationType::OpenConn : EFTTransactionMgt.StartBeginWorkshift(EFTSetup, SalePOS);
          OperationType::CloseConn : EFTTransactionMgt.StartEndWorkshift(EFTSetup, SalePOS);
          OperationType::VerifySetup : EFTTransactionMgt.StartVerifySetup(EFTSetup, SalePOS);
        //+NPR5.54 [364340]
    ...
    local procedure GetLastFinancialTransaction(var EFTTransactionRequest: Record "EFT Transaction Request";EFTSetup: Record "EFT Setup";SalePOS: Record "Sale POS";IncludeVoidRequests: Boolean)
    begin
        EFTTransactionRequest.SetRange("Register No.", SalePOS."Register No.");
        EFTTransactionRequest.SetRange("Integration Type", EFTSetup."EFT Integration Type");
        //-NPR5.54 [364340]
