codeunit 6150792 "POS Action - Discount"
{
    ...
    begin
        ...
        */
        ...
        case DiscountType of
          ...
          DiscountType::LineDiscountAmount: begin
    ...
    local procedure OnActionSalespersonPassword(JSON: Codeunit "POS JSON Management";POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    local procedure OnActionCurrentSalespersonPassword(JSON: Codeunit "POS JSON Management";POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
        Salesperson: Record "Salesperson/Purchaser";
        SalePOS: Record "Sale POS";
        POSSale: Codeunit "POS Sale";
    ...
    local procedure OnActionSupervisorPassword(JSON: Codeunit "POS JSON Management";POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
        Salesperson: Record "Salesperson/Purchaser";
    ...
    local procedure OnActionFixedReasonCode(JSON: Codeunit "POS JSON Management";POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
        ReasonCode: Code[10];
    begin
        //-NPR5.38 [302220]
    ...
    local procedure OnActionLookupReasonCode(JSON: Codeunit "POS JSON Management";POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    local procedure OnActionAddDimensionValue(JSON: Codeunit "POS JSON Management";POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    begin
        ...
        case POSParameterValue.Name of
          'TotalDiscTargetLines' : Caption := CaptionTotalDiscTargetLines;
        end;
        //+NPR5.55 [406357]
    end;
    ...
    begin
        ...
        case POSParameterValue.Name of
          'TotalDiscTargetLines' : Caption := DescTotalDiscTargetLines;
        end;
        //+NPR5.55 [406357]
    end;

    [EventSubscriber(ObjectType::Table, 6150705, 'OnGetParameterOptionStringCaption', '', true, false)]
    local procedure OnGetParameterOptionStringCaption(POSParameterValue: Record "POS Parameter Value";var Caption: Text)
    var
    ...
    begin
        ...
        case POSParameterValue.Name of
          'TotalDiscTargetLines' : Caption := OptionTotalDiscTargetLines;
        end;
        //+NPR5.55 [406357]
    end;
    ...
    local procedure GetSingleLineTotalDiscountableValue(SaleLinePOS: Record "Sale Line POS";IncludeDiscount: Boolean) LineValue: Decimal
    begin
        //-NPR5.55 [406357]
    ...
    local procedure AddDimensionToDimensionSet(var SaleLinePOS: Record "Sale Line POS";DimensionCode: Code[20];DimensionValueCode: Code[20])
    var
    ...
    local procedure GetMultiLineDiscountTarget(SalePOS: Record "Sale POS";SaleLinePOS: Record "Sale Line POS";PresetMultiLineDiscTarget: Option Auto,"Positive Only","Negative Only",All,Ask;AllowAllLines: Boolean)
    var
    ...
    local procedure GetSignFactor(SaleLinePOS: Record "Sale Line POS"): Integer
    begin
        //-NPR5.55 [406357]
        if SaleLinePOS.Quantity < 0 then
          exit(-1);
    ...
    local procedure GetAdditionalParams(JSON: Codeunit "POS JSON Management")
    begin
        //-NPR5.55 [418824]
        JSON.SetScope('/',true);
    ...
    local procedure ApplyAdditionalParams(var SaleLinePOS: Record "Sale Line POS")
    begin
        //-NPR5.55 [418824]
