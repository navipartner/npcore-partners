codeunit 6184543 "EFT Test Mock Integration"
{
    ...
    local procedure HandleSendEftDeviceRequest(EFTTransactionRequest: Record "EFT Transaction Request")
    var
          ...
          DeviceResponseMode::SUCCESS :
            begin
              ...
              case EFTTransactionRequest."Processing Type" of
                EFTTransactionRequest."Processing Type"::PAYMENT : EFTTransactionRequest."Result Amount" += TipAmount + SurchargeAmount; //Tip & Surcharge was unknown on payments.
                ...
                EFTTransactionRequest."Processing Type"::LOOK_UP : EFTTransactionRequest."Result Amount" := LookupAmount;
              end;
            end;
    ...
    local procedure HandleCreateRequestRecord(var EFTTransactionRequest: Record "EFT Transaction Request")
    begin
    ...
    local procedure HandlePaymentConfirmation(EftTransactionRequest: Record "EFT Transaction Request";var DoNotResume: Boolean)
    var
