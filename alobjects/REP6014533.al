    ...
    dataset
    {
        dataitem(Vendor;Vendor)
        {
            ...
            dataitem(Item;Item)
            {
                ...
                RequestFilterFields = "No.","Statistics Group","Item Group","Location Filter";
                ...
                column(ItemGroup_Item;Item."Item Group")
                {
                }
                ...
                {
                    DataItemLink = "No."=FIELD("Item Group"),"Vendor Filter"=FIELD("Vendor No.");
                    ...
                    var
                        ...
                        ItemL2: Record Item;
                    begin
                        Item2.SetRange("Item Group", "Item Group"."No.");
                        ...
                        ItemL3.SetRange("Item Group", "Item Group"."No.");
                        if Item.GetFilter("Statistics Group") <> '' then
                          ItemL3.SetRange("Statistics Group", Item."Statistics Group");

                        if ItemL3.FindFirst then repeat
                          if ItemL3."No." = ItemNo then begin
                            if ItemL3.Next = 0 then begin
                              NewGroup := true;
                              Done := true;
                            end;
                            if ItemL3."Item Group" <> "Item Group"."No." then begin
                              NewGroup := true;
                              Done := true;
                            end;
                          end;
                        ...
                        if NewGroup then begin
                          if Item2.FindFirst then repeat
                            ShowTotalGroup := true;
                ...
                begin
                    ...
                    if SkipWithoutPortfolio then begin
                      ...
                      if ItemL.FindFirst then repeat
                    ...
                    if ItemGroupPrevious = Item."Item Group" then begin
                      if SkipNoSales then
                        if "Sales (LCY)" = 0 then
                    ...
                    ItemGroupPrevious := Item."Item Group";
