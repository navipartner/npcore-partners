xmlport 6060145 "MM Get Loyalty Statement"
{
            ...
            textelement(getloyaltystatement)
            {
                ...
                tableelement(tmpmembershipresponse;"MM Membership")
                {
                    ...
                    textelement(transactions)
                    {
                        MaxOccurs = Once;
                        MinOccurs = Zero;
                        tableelement(membershippointsentry;"MM Membership Points Entry")
                        {
                            ...
                            textelement(type)
                            {
                                ...
                                begin
                                    ...
                                    with MembershipPointsEntry do
                                      case "Entry Type" of
                                        "Entry Type"::CAPTURE         : type := 'capture';
                                        "Entry Type"::EXPIRED         : type := 'expired';
                                        "Entry Type"::POINT_DEPOSIT   : type := 'deposit';
                                        "Entry Type"::POINT_WITHDRAW  : type := 'withdrawl';
                                        "Entry Type"::REFUND          : type := 'refund';
                                        "Entry Type"::RESERVE         : type := 'reserve';
                                        "Entry Type"::SYNCHRONIZATION : type := 'synchronization';
                                        "Entry Type"::SALE            : type := 'sale';
                                      end;
                                end;
                            }
