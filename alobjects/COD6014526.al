codeunit 6014526 "RP Aux - Sales Receipt Calc."
{
    ...
    local procedure AuditRollUnitPriceInclVATExclDiscount(AuditRoll: Record "Audit Roll"): Decimal
    begin
    ...
    local procedure POSSalesLineUnitPriceInclVATExclDiscount(POSSalesLine: Record "POS Sales Line"): Decimal
    begin
    ...
    begin
        AllObj.Get(AllObj."Object Type"::Codeunit, CODEUNIT::"RP Aux - Sales Receipt Calc.");
        tmpAllObj.Init;
        tmpAllObj := AllObj;
        tmpAllObj.Insert;
    end;
    ...
    begin
        if CodeunitID <> CODEUNIT::"RP Aux - Sales Receipt Calc." then
          exit;
    ...
    begin
        ...
        case FunctionTxt of
          'UNITPRICEINCLVATEXCLDISC' :
            case RecID.TableNo of
              DATABASE::"Audit Roll" : Result := AuditRollUnitPriceInclVATExclDiscount(AuditRoll);
              DATABASE::"POS Sales Line" : Result := POSSalesLineUnitPriceInclVATExclDiscount(POSSalesLine);
            end;
          else
            exit;
        end;
