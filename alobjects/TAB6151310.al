    ...
    fields
    {
        ...
        field(40;"Document No.";Code[20])
        {
            ...
            TableRelation = IF ("Document Type"=CONST("Sales Quote")) "Sales Header"."No." WHERE ("Document Type"=CONST(Quote))
                            ...
                            ELSE IF ("Document Type"=CONST("Sales Blanket Order")) "Sales Header"."No." WHERE ("Document Type"=CONST("Blanket Order"))
                            ELSE IF ("Document Type"=CONST("Sales Return Order")) "Sales Header"."No." WHERE ("Document Type"=CONST("Return Order"))
                            ELSE IF ("Document Type"=CONST("Posted Sales Invoice")) "Sales Invoice Header"."No."
                            ELSE IF ("Document Type"=CONST("Posted Sales Credit Memo")) "Sales Cr.Memo Header"."No."
                            ELSE IF ("Document Type"=CONST("Posted Sales Shipment")) "Sales Shipment Header"."No."
                            ELSE IF ("Document Type"=CONST("Posted Sales Return Receipt")) "Return Receipt Header"."No."
                            ...
                            ELSE IF ("Document Type"=CONST("Purchase Invoice")) "Purchase Header"."No." WHERE ("Document Type"=CONST(Invoice))
                            ELSE IF ("Document Type"=CONST("Purchase Credit Memo")) "Purchase Header"."No." WHERE ("Document Type"=CONST("Credit Memo"))
                            ELSE IF ("Document Type"=CONST("Purchase Blanket Order")) "Purchase Header"."No." WHERE ("Document Type"=CONST("Blanket Order"))
                            ELSE IF ("Document Type"=CONST("Purchase Return Order")) "Purchase Header"."No." WHERE ("Document Type"=CONST("Return Order"))
                            ELSE IF ("Document Type"=CONST("Posted Purchase Invoice")) "Purch. Inv. Header"."No."
                            ELSE IF ("Document Type"=CONST("Posted Purchase Credit Memo")) "Purch. Cr. Memo Hdr."."No."
                            ELSE IF ("Document Type"=CONST("Posted Purchase Receipt")) "Purch. Rcpt. Header"."No."
                            ELSE IF ("Document Type"=CONST("Posted Purchase Return Shipment")) "Return Shipment Header"."No.";
        }
