report 6060065 "Sales Statistic"
{
    ...
    dataset
    {
        dataitem("Catalog Supplier";"Catalog Supplier")
        {
    ...
    local procedure FillArray(var FieldArray: array [200] of Text;AuditRoll: Record "Audit Roll";CatalogSupplier: Record "Catalog Supplier")
    var
        Day: Text[2];
        Month: Text[2];
        Year: Text[4];
    ...
    var
        ...
        EANPrefixByCountry: Record "EAN Prefix per Country";
