table 6014411 "Mixed Discount"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Retail Setup"."Prices Include VAT");
        ...
        {
            CalcFormula = -Sum("Item Ledger Entry".Quantity WHERE ("Discount Type"=CONST(Mixed),
        ...
        {
            CalcFormula = Sum("Value Entry"."Sales Amount (Actual)" WHERE ("Discount Type"=CONST(Mixed),
                                                                           "Discount Code"=FIELD(Code)));
            Caption = 'Turnover';
            Editable = false;
            FieldClass = FlowField;
    ...
    begin
        ...
        MixedDiscountLine.DeleteAll(true);
        //+NPR5.31 [262904]
        DimMgt.DeleteDefaultDim(DATABASE::"Mixed Discount",Code);
    end;
    ...
    procedure Assistedit(MixedDiscount: Record "Mixed Discount"): Boolean
    var
    ...
    begin
        ...
        DimMgt.SaveDefaultDim(DATABASE::"Mixed Discount",Code,FieldNumber,ShortcutDimCode);
        Modify;
        //+NPR5.31 [263093]
    end;
    ...
    begin
        ...
        MixedDiscountLine.SetRange(Code, Code);
        if MixedDiscountLine.FindSet then repeat
