codeunit 6014529 "Remote Configuration Mgt."
{
    ...
    procedure SetupUserForClickOnce(UserID: Code[30])
    var
    ...
    begin
        if not UserSetup.Get(UserID) then begin
          ...
          UserSetup."Backoffice Register No."            := '1';
          UserSetup."Connection Profile Code" := 'LOCAL';
          UserSetup.Insert;
        end;
    end;
