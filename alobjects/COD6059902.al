codeunit 6059902 "Task Queue Processor"
{
    ...
    procedure "Code"(TaskQueue: Record "Task Queue")
    var
    ...
    procedure StartTask(var TaskQueue: Record "Task Queue";TaskLine: Record "Task Line")
    var
        TaskLog: Record "Task Log (Task)";
    ...
    procedure EndTask(TaskLine: Record "Task Line";TaskQueue: Record "Task Queue";Success: Boolean;CurrExecRunTime: DateTime)
    var
        TaskLog: Record "Task Log (Task)";
        TaskQueueAdd2Log: Codeunit "Task Queue - Single Instance";
    begin
    ...
    procedure CheckValid2RunNow(TaskLine: Record "Task Line";TaskQueue: Record "Task Queue"): Boolean
    var
        ProposedTime: Time;
    begin
    ...
    procedure CalculateNextRunTime(TaskLine: Record "Task Line";Succesfull: Boolean;var NewEnabled: Boolean): DateTime
    var
        TaskQueue: Record "Task Queue";
        CurrDate: Date;
        CurrTime: Time;
    ...
    procedure IsValidDate(TaskLine: Record "Task Line";ProposedDateTime: DateTime;CheckTime: Boolean): Boolean
    var
        WeekdayNo: Integer;
        MonthNo: Integer;
        ProposedTime: Time;
    ...
    procedure InsertChildrensInTaskQueue(TaskLine: Record "Task Line";Success: Boolean)
    var
