xmlport 6014484 "Pacsoft Shipment Document"
{
    ...
    schema
    {
        tableelement(shipmentdocument;"Pacsoft Shipment Document")
        {
            XmlName = 'data';
            textelement(sender)
            {
            ...
            textelement(shipment)
            {
                ...
                textelement(service)
                {
                    ...
                    textelement(return)
                    {
                        ...
                        begin
                            if ShipmentDocument."Return Label Both" then
                              return := 'both'
                            else if ShipmentDocument."Return Label" then
                              return := 'yes'
                            else
                              return := 'no';
                        end;
                    ...
                    tableelement(shipmentdocumentservice;"Pacsoft Shipment Doc. Services")
                    {
                ...
                textelement(container)
                {
                    textattribute(type)
                    {
                        ...
                        trigger OnBeforePassVariable()
                        var
                            PacsoftPackage: Record "Pacsoft Package Code";
                        begin
                ...
                textelement(customsdeclaration)
                {
                    textattribute(documents)
                    {
                        ...
                        begin
                            case ShipmentDocument."Customs Document" of
                              ShipmentDocument."Customs Document"::" " : documents := '';
                              ShipmentDocument."Customs Document"::CN23 : documents := 'CN23';
                              ShipmentDocument."Customs Document"::"Trade Invoice",
                              ShipmentDocument."Customs Document"::"Pro Forma Invoice" : documents := 'PROFORMA';
                            end;
                        end;
                    }
                    textelement(invoicetype)
                    {
                        ...
                        begin
                            case ShipmentDocument."Customs Document" of
                              ...
                              ShipmentDocument."Customs Document"::CN23 : invoicetype := '';
                              ShipmentDocument."Customs Document"::"Trade Invoice" : invoicetype := 'STANDARD';
                              ShipmentDocument."Customs Document"::"Pro Forma Invoice" : invoicetype := 'PROFORMA';
                            end;
                        end;
                    }
                    ...
                    tableelement(customsitemrows;"Pacsoft Customs Item Rows")
                    {
                        ...
                        textattribute(lineattr)
                        {
                            ...
                            begin
                                case CustomsItemRows."Line Information" of
                                  CustomsItemRows."Line Information"::"Specified Per Row" : lineattr := 'total';
                                  CustomsItemRows."Line Information"::"Specified Per Piece" : lineattr := 'unit';
                                end;
                            end;
                        }
                        textelement(statno)
                ...
                textelement(ufonline2)
                {
                    ...
                    textelement(option2)
                    {
                        ...
                        textattribute(optid2)
                        {
                            ...
                            trigger OnBeforePassVariable()
                            var
                                PacsoftShipmentDocServices: Record "Pacsoft Shipment Doc. Services";
                            begin
