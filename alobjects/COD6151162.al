codeunit 6151162 "MM Loyalty Points PSP (Client)"
{
    ...
    begin
        ...
        tmpEFTIntegrationType."Codeunit ID" := CODEUNIT::"MM Loyalty Points PSP (Client)";
    ...
    var
        LoyaltyPointsMgrClient: Codeunit "MM Loyalty Points Mgr (Client)";
    begin
    ...
    var
        ...
        LoyaltyPointsUIClient: Codeunit "MM Loyalty Points UI (Client)";
        LoyaltyPointsMgrClient: Codeunit "MM Loyalty Points Mgr (Client)";
    begin
    ...
    procedure OnServiceRequestResponse(var EFTTransactionRequest: Record "EFT Transaction Request")
    var
    ...
    local procedure OnBeforeEndSale(var Sender: Codeunit "POS Sale";SaleHeader: Record "Sale POS")
    var
        LoyaltyPointsMgrClient: Codeunit "MM Loyalty Points Mgr (Client)";
