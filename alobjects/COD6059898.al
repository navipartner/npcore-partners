codeunit 6059898 "Data Log Subscriber Mgt."
{
    ...
    var
        ...
        TempDataLogSubscriber: Record "Data Log Subscriber" temporary;
        RecRef: RecordRef;
    ...
    local procedure InsertNewTempRecords(SubscriberCompanyName: Text[30];TableID: Integer;var LastLogEntryNo: BigInteger;MaxRecords: Integer;var TempDataLogRecord: Record "Data Log Record" temporary)
    var
        DataLogRecord: Record "Data Log Record";
        DataLogSubscriber: Record "Data Log Subscriber";
        RecRef: RecordRef;
