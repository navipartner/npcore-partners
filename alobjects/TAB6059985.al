table 6059985 "Retail Document Cue"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Count("Retail Document Header" WHERE ("Document Type"=CONST("Selection Contract"),
                                                                Cashed=CONST(false)));
        ...
        {
            CalcFormula = Count("Retail Document Header" WHERE ("Document Type"=CONST("Retail Order"),
                                                                Cashed=CONST(false)));
        ...
        {
            CalcFormula = Count("Retail Document Header" WHERE ("Document Type"=CONST(Wish),
                                                                Cashed=CONST(false)));
        ...
        {
            CalcFormula = Count("Retail Document Header" WHERE ("Document Type"=CONST(Customization),
                                                                Cashed=CONST(true)));
        ...
        {
            CalcFormula = Count("Retail Document Header" WHERE ("Document Type"=CONST("Rental contract"),
                                                                Cashed=CONST(false)));
        ...
        {
            CalcFormula = Count("Retail Document Header" WHERE ("Document Type"=CONST("Purchase contract"),
                                                                Cashed=CONST(false)));
        ...
        {
            CalcFormula = Count("Retail Document Header" WHERE ("Document Type"=CONST(Quote),
                                                                Cashed=CONST(false)));
            Caption = 'Quotes Open';
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Count("Sales Invoice Header" WHERE ("Order Type"=CONST(Order)));
