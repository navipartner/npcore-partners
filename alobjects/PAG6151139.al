page 6151139 "TM Admission Forecast Lines"
{
    ...
    var
        MatrixRecords: array[12] of Record "TM Admission Schedule Entry";
        MATRIX_ColumnTempRec: Record "TM Admission Schedule Entry";
    ...
    var
        ...
        AdmissionScheduleEntryPage: Page "TM Admission Schedule Entry";
    begin
    ...
    procedure Load(MatrixColumns1: array[32] of Text[80]; var MatrixRecords1: array[12] of Record "TM Admission Schedule Entry"; CurrentNoOfMatrixColumns: Integer; pStatisticsOption: Option; pPeriodType: Option Day,Week,Month,Quarter,Year,"Accounting Period")
    var
