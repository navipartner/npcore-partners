codeunit 6150744 "POS Keyboard Binding Mgt."
{
    ...
    procedure CheckNoMultipleKeyCodes(var POSKeyboardBindingSetup: Record "POS Keyboard Binding Setup")
    var
        OnDiscoveryCheck: Boolean;
        POSKeyboardBindingSetup2: Record "POS Keyboard Binding Setup";
        POSKeyboardBindingSetupTemp: Record "POS Keyboard Binding Setup" temporary;
        POSKeyboardBindingSetupTemp2: Record "POS Keyboard Binding Setup" temporary;
    begin
    ...
    local procedure CreateSetup(var POSKeyboardBindingSetup: Record "POS Keyboard Binding Setup")
    var
        POSKeyboardBindingSetup2: Record "POS Keyboard Binding Setup";
    begin
        if POSKeyboardBindingSetup.FindSet then
    ...
    procedure RestoreDefaultKeyBind(var Rec: Record "POS Keyboard Binding Setup")
    var
        POSKeyboardBindingSetup: Record "POS Keyboard Binding Setup";
    begin
    ...
    local procedure AddKey(var AvailablePOSKeybind: Record "Available POS Keybind"; var EntryNo: Integer; KeyName: Text[30]; ModifierKeyPriority: Integer; Supported: Boolean)
    begin
        EntryNo += 1;
        AvailablePOSKeybind.Init;
        AvailablePOSKeybind."Entry No." := EntryNo;
    ...
    procedure CheckKeyBind(var Rec: Record "POS Keyboard Binding Setup"; OnDiscoveryCheck: Boolean)
    var
        ...
        IncomingFilters: Record "POS Keyboard Binding Setup";
    begin
    ...
    local procedure GetSupportedKeyBind(KeyBind: Text; var AvailablePOSKeybind: Record "Available POS Keybind"; var ErrMessage: Text): Boolean
    begin
        ErrMessage := '';
    ...
    local procedure InvokeKeyPressMethod(Method: Text; Context: JsonObject; POSSession: Codeunit "POS Session"; FrontEnd: Codeunit "POS Front End Management"; var Handled: Boolean)
    var
        POSKeyboardBindingSetup: Record "POS Keyboard Binding Setup";
    ...
    local procedure OnDiscoverKeyboardBindings(var POSKeyboardBindingSetup: Record "POS Keyboard Binding Setup")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnInvokeKeyPress(KeyPress: Text; POSSession: Codeunit "POS Session"; FrontEnd: Codeunit "POS Front End Management"; var Handled: Boolean)
    begin
    end;
}
