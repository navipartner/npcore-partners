xmlport 6060120 "TM Ticket Details"
{
            ...
            textelement(ticket_results)
            {
                ...
                tableelement(tmpticketreservationresponse;"TM Ticket Reservation Response")
                {
                    ...
                    tableelement(tmpticket;"TM Ticket")
                    {
                        ...
                        tableelement("ticket access entry";"TM Ticket Access Entry")
                        {
                            ...
                            tableelement(detticketaccessentry;"TM Det. Ticket Access Entry")
                            {
                            ...
                            tableelement(arrivalentry;"TM Det. Ticket Access Entry")
                            {
                                LinkTable = "Ticket Access Entry";
                                MaxOccurs = Once;
                                MinOccurs = Zero;
