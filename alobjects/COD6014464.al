codeunit 6014464 "E-mail Document Management"
{
    ...
    begin
        ...
        //-NPR5.43 [316218]
        REPORT.RunModal(REPORT::"Statement E-Mail",false,false,Customer2);
        //+NPR5.43 [316218]
        //+PN1.10
    end;
    ...
    begin
        ...
        if PAGE.RunModal(PAGE::"E-mail Template Choice List",TempField) <> ACTION::LookupOK then
          exit(0);
    ...
    var
        ...
        EmailTemplate: Record "E-mail Template Header";
    ...
    begin
        //-NPR5.39 [302779]
        exit(CODEUNIT::"E-mail Document Management");
        //+NPR5.39 [302779]
    end;

    [EventSubscriber(ObjectType::Codeunit, 6150705, 'OnFinishSale', '', true, true)]
    local procedure EmailReceiptOnSale(POSSalesWorkflowStep: Record "POS Sales Workflow Step";SalePOS: Record "Sale POS")
    var
