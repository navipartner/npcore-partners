codeunit 6151177 "POS Action - Print Posted Exch"
{
    ...
    local procedure RunModalPage(var POSEntry: Record "POS Entry";var POSSalesLine: Record "POS Sales Line";SingleLine: Boolean)
    var
        POSEntries: Page "POS Entries";
