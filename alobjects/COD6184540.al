codeunit 6184540 "EFT NETS BAXI Integration"
{
    ...
    begin
        ...
        tmpEFTIntegrationType."Codeunit ID" := CODEUNIT::"EFT NETS BAXI Integration";
    ...
    var
        ...
        EFTNETSBAXIPaymentSetupPage: Page "EFT NETS BAXI Payment Setup";
    begin
        ...
        Commit;
        PAGE.RunModal(PAGE::"EFT NETS BAXI Payment Setup", EFTNETSBAXIPaymentSetup);
    end;
    ...
    var
        EFTNETSBAXIProtocol: Codeunit "EFT NETS BAXI Protocol";
    begin
        if not EftTransactionRequest.IsType(IntegrationType()) then
          exit;
        Handled := true;
        ...
        case EftTransactionRequest."Processing Type" of
          ...
          EftTransactionRequest."Processing Type"::AUXILIARY :
            case EftTransactionRequest."Auxiliary Operation ID" of
              1 : HandleBalanceEnquiryResponse(EftTransactionRequest);
              2 : HandleDownloadDatasetResponse(EftTransactionRequest);
              3 : HandleDownloadSoftwareResponse(EftTransactionRequest);
              4 : HandleReconciliation(EftTransactionRequest);
            end;
        end;
    ...
    local procedure HandleOpenCloseResponse(EFTTransactionRequest: Record "EFT Transaction Request")
    begin
        if EFTTransactionRequest.Successful then
    ...
    procedure GetPaymentTypeParameters(EFTSetup: Record "EFT Setup";var EFTNETSBAXIPaymentSetup: Record "EFT NETS BAXI Payment Setup")
    begin
