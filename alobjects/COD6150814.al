codeunit 6150814 "POS Action - Cust.Sal.Doc.Exp."
{
    ...
    local procedure OnSetCustomer(Context: DotNet npNetJObject;POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
        POSActionReceivables: Codeunit "POS Action - Receivables";
    begin
    ...
    begin
        ...
        case SetDocumentType of
          ...
          else Error(ERRDOCTYPE, Format(SetDocumentType), Format(SetDocumentType::Order), Format(SetDocumentType::Invoice), Format(SetDocumentType::CreditMemo), Format(SetDocumentType::ReturnOrder), Format(SetDocumentType::Quote) );
          //+NPR5.45 [325216]
        end;
    ...
    local procedure SetReference(var SalePOS: Record "Sale POS";ExtDocNo: Text;Attention: Text)
    var
        CustomerNo: Code[20];
    begin
        //-NPR5.45 [313966]
