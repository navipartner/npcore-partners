codeunit 6150814 "POS Action - Cust.Sal.Doc.Exp."
{
    ...
    local procedure OnSetCustomer(Context: JsonObject; POSSession: Codeunit "POS Session"; FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    local procedure OnStartDocumentManager(Context: JsonObject; POSSession: Codeunit "POS Session"; FrontEnd: Codeunit "POS Front End Management")
    var
        JSON: Codeunit "POS JSON Management";
