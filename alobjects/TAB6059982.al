table 6059982 "Item Repair"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Count("Item Repair Action" WHERE ("Item No."=FIELD("Item No."),
                                                            "Variant Code"=FIELD("Variant Code")));
        ...
        {
            CalcFormula = Lookup("Item Repair Action"."Variant Action" WHERE ("Item No."=FIELD("Item No."),
                                                                              "Variant Code"=FIELD("Variant Code")));
        ...
        {
            CalcFormula = Lookup("Item Repair Action"."Variety 1 Action" WHERE ("Item No."=FIELD("Item No.")));
        ...
        {
            CalcFormula = Lookup("Item Repair Action"."Variety 2 Action" WHERE ("Item No."=FIELD("Item No.")));
        ...
        {
            CalcFormula = Lookup("Item Repair Action"."Variety 3 Action" WHERE ("Item No."=FIELD("Item No.")));
        ...
        {
            CalcFormula = Lookup("Item Repair Action"."Variety 4 Action" WHERE ("Item No."=FIELD("Item No.")));
        ...
        field(6059971;"Variety 1 Table (Item)";Code[40])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Table".Code WHERE (Type=FIELD("Variety 1 (Item)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(6059972;"Variety 1 Value (Var) (NEW)";Code[20])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = IF ("Variety 1 (Var)"=FILTER(<>'')) "Variety Value".Value WHERE (Type=FIELD("Variety 1 (Var)"),
                                                                                             Table=FIELD("Variety 1 Table (Var)"))
                                                                                             ELSE IF ("Variety 1 (Item)"=FILTER(<>'')) "Variety Value".Value WHERE (Type=FIELD("Variety 1 (Item)"),
        ...
        field(6059974;"Variety 2 Table (Item)";Code[40])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Table".Code WHERE (Type=FIELD("Variety 2 (Item)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(6059975;"Variety 2 Value (Var) (NEW)";Code[20])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = IF ("Variety 2 (Var)"=FILTER(<>'')) "Variety Value".Value WHERE (Type=FIELD("Variety 2 (Var)"),
                                                                                             Table=FIELD("Variety 2 Table (Var)"))
                                                                                             ELSE IF ("Variety 2 (Item)"=FILTER(<>'')) "Variety Value".Value WHERE (Type=FIELD("Variety 2 (Item)"),
        ...
        field(6059977;"Variety 3 Table (Item)";Code[40])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Table".Code WHERE (Type=FIELD("Variety 3 (Item)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(6059978;"Variety 3 Value (Var) (NEW)";Code[20])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = IF ("Variety 3 (Var)"=FILTER(<>'')) "Variety Value".Value WHERE (Type=FIELD("Variety 3 (Var)"),
                                                                                             Table=FIELD("Variety 3 Table (Var)"))
                                                                                             ELSE IF ("Variety 3 (Item)"=FILTER(<>'')) "Variety Value".Value WHERE (Type=FIELD("Variety 3 (Item)"),
        ...
        field(6059980;"Variety 4 Table (Item)";Code[40])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Table".Code WHERE (Type=FIELD("Variety 4 (Item)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        ...
        field(6059983;"Variety 4 Value (Var) (NEW)";Code[20])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = IF ("Variety 4 (Var)"=FILTER(<>'')) "Variety Value".Value WHERE (Type=FIELD("Variety 4 (Var)"),
                                                                                             Table=FIELD("Variety 4 Table (Var)"))
                                                                                             ELSE IF ("Variety 4 (Item)"=FILTER(<>'')) "Variety Value".Value WHERE (Type=FIELD("Variety 4 (Item)"),
        ...
        field(6059991;"Variety 1 Table (Var)";Code[40])
        {
            ...
            TableRelation = "Variety Table".Code WHERE (Type=FIELD("Variety 1 (Var)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(6059992;"Variety 1 Value (Var)";Code[20])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Value".Value WHERE (Type=FIELD("Variety 1 (Var)"),
                                                         Table=FIELD("Variety 1 Table (Var)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        ...
        field(6059994;"Variety 2 Table (Var)";Code[40])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Table".Code WHERE (Type=FIELD("Variety 2 (Var)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(6059995;"Variety 2 Value (Var)";Code[20])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Value".Value WHERE (Type=FIELD("Variety 2 (Var)"),
                                                         Table=FIELD("Variety 2 Table (Var)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        ...
        field(6059997;"Variety 3 Table (Var)";Code[40])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Table".Code WHERE (Type=FIELD("Variety 3 (Var)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(6059998;"Variety 3 Value (Var)";Code[20])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Value".Value WHERE (Type=FIELD("Variety 3 (Var)"),
                                                         Table=FIELD("Variety 3 Table (Var)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        ...
        field(6060000;"Variety 4 Table (Var)";Code[40])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Table".Code WHERE (Type=FIELD("Variety 4 (Var)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(6060001;"Variety 4 Value (Var)";Code[20])
        {
            ...
            Description = 'VRT1.00';
            TableRelation = "Variety Value".Value WHERE (Type=FIELD("Variety 4 (Var)"),
                                                         Table=FIELD("Variety 4 Table (Var)"));
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
