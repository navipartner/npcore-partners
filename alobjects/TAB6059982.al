table 6059982 "Item Repair"
{
    ...
    fields
    {
        ...
        field(6059972; "Variety 1 Value (Var) (NEW)"; Code[20])
        {
            ...
            ELSE
            IF ("Variety 1 (Item)" = FILTER(<> '')) "Variety Value".Value WHERE(Type = FIELD("Variety 1 (Item)"),
        ...
        field(6059975; "Variety 2 Value (Var) (NEW)"; Code[20])
        {
            ...
            ELSE
            IF ("Variety 2 (Item)" = FILTER(<> '')) "Variety Value".Value WHERE(Type = FIELD("Variety 2 (Item)"),
        ...
        field(6059978; "Variety 3 Value (Var) (NEW)"; Code[20])
        {
            ...
            ELSE
            IF ("Variety 3 (Item)" = FILTER(<> '')) "Variety Value".Value WHERE(Type = FIELD("Variety 3 (Item)"),
        ...
        field(6059983; "Variety 4 Value (Var) (NEW)"; Code[20])
        {
            ...
            ELSE
            IF ("Variety 4 (Item)" = FILTER(<> '')) "Variety Value".Value WHERE(Type = FIELD("Variety 4 (Item)"),
