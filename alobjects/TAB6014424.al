table 6014424 "Audit Roll Posting"
{
    ...
    fields
    {
        field(1;"Register No.";Code[10])
        {
            ...
            trigger OnValidate()
            var
                Rapportvalg: Record "Report Selection Retail";
            begin
            end;
        }
    ...
    procedure TransferFromRev(var Revisionsrulle: Record "Audit Roll";var RevPost: Record "Audit Roll Posting" temporary;var Dlg: Dialog): Integer
    var
        Total: Integer;
        nCount: Integer;
    begin
    ...
    procedure TransferFromRevItemLedger(var Revisionsrulle: Record "Audit Roll";var RevPost: Record "Audit Roll Posting" temporary;var Dlg: Dialog): Integer
    var
        Total: Integer;
        nCount: Integer;
    begin
    ...
    procedure TransferFromTemp(var Target: Record "Audit Roll Posting" temporary;var Source: Record "Audit Roll Posting" temporary)
    begin
        //TransferFromTemp()
    ...
    procedure CopyAllFilters(var RevRulle: Record "Audit Roll")
    begin
        //CopyAllFilters
    ...
    procedure TransferFromRevSilent(var Revisionsrulle: Record "Audit Roll";var RevPost: Record "Audit Roll Posting" temporary): Integer
    var
        Dlg: Dialog;
    begin
    ...
    procedure TransferFromRevSilentItemLedg(var Revisionsrulle: Record "Audit Roll";var RevPost: Record "Audit Roll Posting" temporary): Integer
    var
        Dlg: Dialog;
    begin
        //TransferFromRevSilent()
    ...
    procedure DoTransferFromRev(var Revisionsrulle: Record "Audit Roll";var RevPost: Record "Audit Roll Posting" temporary;var Dlg: Dialog;UpdateDialog: Boolean): Integer
    var
        Total: Integer;
        nCount: Integer;
    begin
    ...
    procedure DoTransferFromRevItemLedger(var Revisionsrulle: Record "Audit Roll";var RevPost: Record "Audit Roll Posting" temporary;var Dlg: Dialog;UpdateDialog: Boolean): Integer
    var
        Total: Integer;
        nCount: Integer;
    begin
