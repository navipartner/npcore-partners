codeunit 6184496 "Pepper Event Subscribers"
{
    ...
    */
    ...
    local procedure CheckRunEndOfDay(var SalePOS: Record "Sale POS"; var Register: Record Register)
    var
    ...
    local procedure RunEndOfDay(var SalePOS: Record "Sale POS"; var Register: Record Register)
    var
