page 6060033 "GIM - List Template"
{
    Caption = 'GIM - List Template';
    Editable = false;
    PageType = List;
    ...
    actions
    {
        area(processing)
        {
            action(Card)
            {
                ...
                trigger OnAction()
                begin
                    PAGE.RunModal(PAGE::"GIM - Card Template",Rec);
                end;
            }
            action(Document)
            {
                ...
                trigger OnAction()
                begin
                    PAGE.RunModal(PAGE::"GIM - Document Template",Rec);
                end;
            }
        }
    }
    ...
    begin
        ...
        MaxPKFieldCount := PKRef.FieldCount;
        RecRef.Close;
        ...
        for RowCount := 1 to LastRow do begin
          ...
          ImpEntity.SetRange("Column ID");
          ImpEntity.SetRange("Part of Primary Key",true);
          for KeyFieldCount := 1 to MaxPKFieldCount do begin
            ...
            if ImpEntity.FindFirst then begin
              ...
              AssignValue(KeyFieldCount);
              Modify;
            end;
          end;
          if MaxPKFieldCount < 10 then begin
            ImpEntity.SetRange("Field ID");
