page 6014573 "Tax Free GB I2 Info Capture"
{
    ...
    InsertAllowed = false;
    LinksAllowed = false;
    SourceTable = "Tax Free GB I2 Info Capture";
    ...
    procedure SetModes(var GlobalBlueParameters: Record "Tax Free GB I2 Parameter")
    begin
