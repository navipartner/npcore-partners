codeunit 6150857 "POS Action - Item Unit Price"
{
    ...
    local procedure OnActionInsertItemUnitPrice(JSON: Codeunit "POS JSON Management";POSSession: Codeunit "POS Session";FrontEnd: Codeunit "POS Front End Management")
    var
        Item: Record Item;
    ...
    local procedure FindUnitPrice(JSON: Codeunit "POS JSON Management";var UnitPrice: Decimal): Boolean
    var
    ...
    local procedure SetEanBoxEventInScopeItemUnitPrice(EanBoxSetupEvent: Record "Ean Box Setup Event";EanBoxValue: Text;var InScope: Boolean)
    var
        Item: Record Item;
        JSON: Codeunit "POS JSON Management";
