codeunit 6059904 "Task Queue NAS Login"
{
    ...
    var
        ...
        TaskWorker2: Record "Task Worker";
    ...
    var
        TaskWorkerGroup: Record "Task Worker Group";
        TempTaskQueue: Record "Task Queue" temporary;
        taskQueueMgt: Codeunit "Task Queue Manager";
    ...
    local procedure StartTaskWorkers(var AvailableWorkers: Integer;var TempTaskQueue: Record "Task Queue" temporary)
    var
        RecRef: RecordRef;
    begin
        if AvailableWorkers < 0 then
    ...
    var
        ...
        TaskLogMaster: Record "Session Log";
    ...
    [TryFunction]
    local procedure TryStartSession(TaskQueue: Record "Task Queue")
    var
        NewSessionId: Integer;
    begin
        //-TQ1.32 [310092]
        if not StartSession(NewSessionId,CODEUNIT::"Task Queue Manager",TaskQueue.Company,TaskQueue) then
          Error('TryStartSession() failed in Codeunit 6059904');
        //+TQ1.32 [310092]
    end;

    local procedure FindPendingTasks(TaskWorkerGroupCode: Code[10];var TempTaskQueue: Record "Task Queue" temporary) PendingTasksExist: Boolean
    var
    ...
    begin
        ...
        if TaskQueue.FindSet then repeat
          TempTaskQueue.Init;
    ...
    begin
        ...
        if TaskWorker.FindSet then repeat
