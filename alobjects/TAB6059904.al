table 6059904 "Task Log (Task)"
{
    ...
    Caption = 'Task Log';
    DrillDownPageID = "Task Log (Task)";
    LookupPageID = "Task Log (Task)";
    ...
    fields
    {
        ...
        {
            CalcFormula = Count("Task Output Log" WHERE ("Task Log Entry No."=FIELD("Entry No.")));
    ...
    procedure AddLogInit(TaskQueue: Record "Task Queue";TaskLine: Record "Task Line") AddedEntryNo: Integer
    begin
        //-TQ1.28
        //TaskLog.LOCKTABLE;
    ...
    procedure AddLogFinal(TaskQueue: Record "Task Queue";WithSucces: Boolean;OrgEntryNo: Integer)
    var
    ...
    procedure AddLogOtherFailure(TaskQueue: Record "Task Queue";TaskLine: Record "Task Line") AddedEntryNo: Integer
    var
        TaskLog: Record "Task Log (Task)";
        TMPText: Text[1024];
        OutStream: OutStream;
    ...
    procedure AddMovedTask(TaskQueue: Record "Task Queue";TaskLine: Record "Task Line")
    var
        TaskLog: Record "Task Log (Task)";
    begin
        //-TQ1.28
    ...
    procedure AddMessage(TaskLine: Record "Task Line";MessageText: Text[1024])
    var
        TaskLog: Record "Task Log (Task)";
        TMPText: Text[1024];
        OutStream: OutStream;
