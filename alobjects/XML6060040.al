xmlport 6060040 "Item Worksheet Import/Export"
{
    ...
    schema
    {
        textelement(Root)
        {
            tableelement("Item Worksheet";"Item Worksheet")
            {
                ...
                tableelement("Item Worksheet Line";"Item Worksheet Line")
                {
                    ...
                    tableelement("Item Worksheet Variant Line";"Item Worksheet Variant Line")
                    {
