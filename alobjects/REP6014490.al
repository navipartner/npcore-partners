report 6014490 "Advanced Sales Statistics"
{
    ...
    var
        ...
        Buffer: Record "Advanced Sales Statistics" temporary;
    ...
    begin
        ...
        case Type of
          Type::Item        : ItemLedgerEntry.SetRange( "Item No.", Code );
          Type::ItemGroup   : ItemLedgerEntry.SetRange( "Item Group No.", Code );
          Type::Salesperson : ItemLedgerEntry.SetRange( "Salesperson Code", Code );
          Type::Customer    : ItemLedgerEntry.SetRange( "Source No.", Code );
          Type::Vendor      : ItemLedgerEntry.SetRange( "Vendor No.", Code );
          Type::Projectcode : begin
    ...
    begin
        ...
        case Type of
          Type::Item        : ValueEntry.SetRange( "Item No.", Code );
          Type::ItemGroup   : ValueEntry.SetRange( "Item Group No.", Code );
          Type::Salesperson : ValueEntry.SetRange( "Salespers./Purch. Code", Code );
          Type::Customer    : ValueEntry.SetRange( "Source No.", Code );
          Type::Vendor      : ValueEntry.SetRange( "Vendor No.", Code );
          Type::Projectcode : begin
                                if (ProjektKodeStart <> '') and (ProjektKodeStart <> '') then
    ...
    begin
        // UpdateSortKey
        case SortBy of
          SortBy::Description            : Buffer.SetCurrentKey( Description );
          SortBy::"Period Start"         : Buffer.SetCurrentKey( "Period Start" );
          SortBy::"Sales qty."           : Buffer.SetCurrentKey( "Sales qty." );
          SortBy::"Sales qty. last year" : Buffer.SetCurrentKey( "Sales qty. last year" );
          SortBy::"Sales LCY"            : Buffer.SetCurrentKey( "Sales LCY" );
          SortBy::"Sales LCY last year"  : Buffer.SetCurrentKey( "Sales LCY last year" );
          SortBy::"Profit LCY"           : Buffer.SetCurrentKey( "Profit LCY" );
          SortBy::"Profit LCY last year" : Buffer.SetCurrentKey( "Profit LCY last year" );
          SortBy::"Profit %"             : Buffer.SetCurrentKey( "Profit %" );
          SortBy::"Profit % last year"   : Buffer.SetCurrentKey( "Profit % last year" );
          else begin
