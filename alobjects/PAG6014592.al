page 6014592 "Item Replen. by Stores Matrix"
{
        ...
        case PrepareRows of
          PrepareRows::"Fixed Columns",PrepareRows::"Dynamic Columns":
            if Item.FindSet then
              ...
              until Item.Next = 0;
          PrepareRows::"Single Row Dyn. Col.": FetchItemOrItemVariant("Item No.","Variant Code",PrepareRows);
        end;
    end;
    ...
    begin
        ...
        case PrepareRows of
          PrepareRows::"Fixed Columns": Insert;
          PrepareRows::"Dynamic Columns",PrepareRows::"Single Row Dyn. Col.": UpdateMatrixData();
        end;
    end;
          ...
          1:
            begin
              case PropertyType of
                PropertyType::Visible: Field1Visible := true;
                PropertyType::Editable: Field1Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize1 := MatrixData[ColumnNo] <> '';
              end;
            end;
          2:
            begin
              case PropertyType of
                PropertyType::Visible: Field2Visible := true;
                PropertyType::Editable: Field2Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize2 := MatrixData[ColumnNo] <> '';
              end;
            end;
          3:
            begin
              case PropertyType of
                PropertyType::Visible: Field3Visible := true;
                PropertyType::Editable: Field3Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize3 := MatrixData[ColumnNo] <> '';
              end;
            end;
          4:
            begin
              case PropertyType of
                PropertyType::Visible: Field4Visible := true;
                PropertyType::Editable: Field4Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize4 := MatrixData[ColumnNo] <> '';
              end;
            end;
          5:
            begin
              case PropertyType of
                PropertyType::Visible: Field5Visible := true;
                PropertyType::Editable: Field5Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize5 := MatrixData[ColumnNo] <> '';
              end;
            end;
          6:
            begin
              case PropertyType of
                PropertyType::Visible: Field6Visible := true;
                PropertyType::Editable: Field6Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize6 := MatrixData[ColumnNo] <> '';
              end;
            end;
          7:
            begin
              case PropertyType of
                PropertyType::Visible: Field7Visible := true;
                PropertyType::Editable: Field7Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize7 := MatrixData[ColumnNo] <> '';
              end;
            end;
          8:
            begin
              case PropertyType of
                PropertyType::Visible: Field8Visible := true;
                PropertyType::Editable: Field8Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize8 := MatrixData[ColumnNo] <> '';
              end;
            end;
          9:
            begin
              case PropertyType of
                PropertyType::Visible: Field9Visible := true;
                PropertyType::Editable: Field9Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize9 := MatrixData[ColumnNo] <> '';
              end;
            end;
          10:
            begin
              case PropertyType of
                PropertyType::Visible: Field10Visible := true;
                PropertyType::Editable: Field10Editable := "Variant Code" = '';
                PropertyType::Emphasize: Emphasize10 := MatrixData[ColumnNo] <> '';
              end;
            end;
        end;
    end;
