codeunit 6184535 "EFT NETSCloud Trx Dialog"
{
    ...
    begin
        ...
        case Sender of
          'nets-timer' : CheckResponse(POSSession, FrontEnd);
          'nets-abort' : RequestAbort(FrontEnd);
          'nets-force-abort' : ForceAbort(FrontEnd);
        end;
    end;
    ...
    var
        ...
        EFTNETSCloudBgResp: Codeunit "EFT NETSCloud Bg. Resp.";
