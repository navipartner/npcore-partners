codeunit 6059942 "VAN Document Endpoint Delivery"
{
    ...
    var
        ...
        TempNcTaskOutput: Record "Nc Task Output" temporary;
    ...
    begin
        ...
        NcEndpoint.Get(ElectronicDocumentFormat."Delivery Endpoint");
