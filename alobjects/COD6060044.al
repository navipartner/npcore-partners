codeunit 6060044 "Item Wsht.-Register Batch"
{
    ...
    var
        ...
        ItemWkshtVariantLine2: Record "Item Worksheet Variant Line";
        ItemWkshtVarietyValueLine2: Record "Item Worksheet Variety Value";
    begin
        ItemWkshLine2.Copy(ItemWkshLine);
        if ItemWkshLine2.FindSet then repeat
