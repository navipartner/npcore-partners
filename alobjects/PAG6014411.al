page 6014411 "Turnover Statistics"
{
    ...
    begin
        ValueEntry.SetCurrentKey("Salespers./Purch. Code","Item Group No.","Item Ledger Entry Type","Posting Date","Global Dimension 1 Code");
