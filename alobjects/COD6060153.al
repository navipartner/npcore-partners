codeunit 6060153 "Event Email Management"
{
    ...
    begin
        ...
        if Rec."Bill-to Customer No." <> '' then begin
          ...
          Rec."Bill-to E-Mail" := Cust."E-Mail";
        end else
          Rec."Bill-to E-Mail" := '';
    end;
    ...
    begin
        ...
        */
        ...
        //+NPR5.32 [275946]
          Job."Mail Item Status" := Job."Mail Item Status"::Sent
        else
          Job."Mail Item Status" := Job."Mail Item Status"::Error;
    ...
    begin
        ...
        */
        ...
        //+NPR5.32 [275946]
          JobPlanningLine."Mail Item Status" := JobPlanningLine."Mail Item Status"::Sent
        else
          JobPlanningLine."Mail Item Status" := JobPlanningLine."Mail Item Status"::Error;
    ...
    begin
        ...
        */
        ...
        case MailFor of
          MailFor::Customer:
            AddEMailRecipient(EmailMessage,0,Job."Bill-to E-Mail");
          MailFor::Team:
            if JobPlanningLine.FindSet then
              repeat
                AddEMailRecipient(EmailMessage,0,JobPlanningLine."Resource E-Mail");
                if JobPlanningLine."Resource Group No." <> '' then begin
                  ResourceGroup.Get(JobPlanningLine."Resource Group No.");
                  if ResourceGroup."E-Mail" <> '' then
                    AddEMailRecipient(EmailMessage,1,ResourceGroup."E-Mail");
                end;
        ...
        //+NPR5.34 [277938]
          ...
          //+NPR5.32 [274405]
            repeat
              ...
              JobPlanningLineTickets.SetRange("Ticket Collect Status",JobPlanningLineTickets."Ticket Collect Status"::Collected);
