                                        ...
                                        begin
                                            ...
                                            with TmpSalesLine do
                                              case TmpSalesLine."Document Type" of
                                                "Document Type"::Quote            : NotShippedDocyType := 'quote';
                                                "Document Type"::Order            : NotShippedDocyType := 'order';
                                                "Document Type"::"Return Order"   : NotShippedDocyType := 'returnorder';
                                                "Document Type"::Invoice          : NotShippedDocyType := 'invoice';
                                                "Document Type"::"Credit Memo"    : NotShippedDocyType := 'creditmemo';
                                                "Document Type"::"Blanket Order"  : NotShippedDocyType := 'blanketorder';
                                              else
                                        ...
                                        begin
                                            ...
                                            with TmpItemLedgerEntry do
                                              case "Document Type" of
                                                "Document Type"::"Sales Shipment"       : ShippedDocType := 'shipment';
                                                "Document Type"::"Sales Return Receipt" : ShippedDocType := 'return';
                                                "Document Type"::"Sales Invoice"        : ShippedDocType := 'invoice';
                                                "Document Type"::"Sales Credit Memo"    : ShippedDocType := 'creditmemo';
                                              else
                                    ...
                                    textattribute(invoiceddoctype)
                                    {
                                        ...
                                        begin
                                            ...
                                            with TmpValueEntry do
                                              case "Document Type" of
                                                "Document Type"::"Sales Invoice" : InvoicedDocType := 'invoice';
                                                "Document Type"::"Sales Credit Memo" : InvoicedDocType := 'creditmemo';
                                              else
