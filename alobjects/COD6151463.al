codeunit 6151463 "M2 Account Lookup Mgt."
{
    ...
    var
        Result: DotNet JToken;
        MagentoWebsites: DotNet IList;
        MagentoWebsite: DotNet JToken;
        MagentoStores: DotNet IList;
