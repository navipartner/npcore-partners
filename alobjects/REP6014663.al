report 6014663 "Retail Calculate Inventory"
{
    ...
    dataset
    {
        dataitem(Item;Item)
        {
            ...
            begin
                ...
                if not SkipDim then
                  SelectedDim.GetSelectedDim(UserId,3,REPORT::"Retail Calculate Inventory",'',TempSelectedDim);
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ByDimensions;ColumnDim)
                    {
                        ...
                        begin
                            DimSelectionBuf.SetDimSelectionMultiple(3,REPORT::"Retail Calculate Inventory",ColumnDim);
                        end;
                    }
                }
            }
    ...
    begin
        if SkipDim then
          ...
          DimSelectionBuf.CompareDimText(3,REPORT::"Retail Calculate Inventory",'',ColumnDim,Text003);
        ZeroQtySave := ZeroQty;
    end;
        ...
        if DimSetEntry.Find('-') then begin
          repeat
            if TempSelectedDim.Get(
                 UserId,3,REPORT::"Retail Calculate Inventory",'',DimSetEntry."Dimension Code")
            then
