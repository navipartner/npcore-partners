table 6059905 "Task Output Log"
{
    ...
    DrillDownPageID = "Task Output Log";
    LookupPageID = "Task Output Log";
    ...
    procedure AddFile(TaskLine: Record "Task Line";FileName: Text[250])
    var
    ...
    procedure InitRecord(TaskLine: Record "Task Line")
    var
        TaskQueueAdd2Log: Codeunit "Task Queue - Single Instance";
        IStream: InStream;
    begin
    ...
    procedure AddDescription(TaskLine: Record "Task Line";MessageText: Text[1024])
    var
        TaskQueueAdd2Log: Codeunit "Task Queue - Single Instance";
        TMPText: Text[1024];
        OutStream: OutStream;
