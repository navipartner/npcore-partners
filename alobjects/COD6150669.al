codeunit 6150669 "NPRE POS Action - Show Wa."
{
    ...
    var
        Text000: Label 'This is a built in function for handling move between pos and waiter pad.';
    ...
    begin
        with Sender do begin
          ...
          then begin
            ...
            RegisterWorkflowStep('showWaiterPad',
    ...
    local procedure OnActionShowWaiterPad(JSON: Codeunit "POS JSON Management")
    var
        NPRESeating: Record "NPRE Seating";
        NPREWaiterPad: Record "NPRE Waiter Pad";
        NPREWaiterPadPOSMgt: Codeunit "NPRE Waiter Pad POS Management";
