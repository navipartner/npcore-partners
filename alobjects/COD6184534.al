codeunit 6184534 "EFT NETSCloud Protocol"
{
    ...
    var
        ...
        SessionId: Integer;
        EFTNETSCloudTrxDialog: Codeunit "EFT NETSCloud Trx Dialog";
    ...
    begin
        ...
        StartSession(SessionId, CODEUNIT::"EFT NETSCloud Bg. Trx. Req.", CompanyName, EFTTransactionAsyncRequest);
    ...
    local procedure LookupLastTransaction(EftTransactionRequest: Record "EFT Transaction Request")
    var
        Response: Text;
    ...
    procedure CancelAction(EFTTransactionRequest: Record "EFT Transaction Request")
    var
        EFTSetup: Record "EFT Setup";
        OriginalEFTTransactionRequest: Record "EFT Transaction Request";
        Response: Text;
    ...
    procedure TerminalList(EFTSetup: Record "EFT Setup"): Text
    var
    ...
    procedure TerminalSettings(EFTSetup: Record "EFT Setup"): Text
    var
        EFTTransactionRequest: Record "EFT Transaction Request";
        EFTNETSCloudIntegration: Codeunit "EFT NETSCloud Integration";
        Response: Text;
    ...
    local procedure LoginAndGetToken(EFTSetup: Record "EFT Setup"): Text
    var
        EFTTransactionRequest: Record "EFT Transaction Request";
        EFTNETSCloudIntegration: Codeunit "EFT NETSCloud Integration";
        Response: Text;
    ...
    procedure GetToken(EFTSetup: Record "EFT Setup"): Text
    var
    ...
    local procedure GetTokenFromRequestRecord(EFTTransactionRequest: Record "EFT Transaction Request"): Text
    var
        InStream: InStream;
        TextBuffer: Text;
        Token: Text;
