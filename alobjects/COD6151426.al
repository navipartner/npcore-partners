codeunit 6151426 "Magento Retail Campaign Mgt."
{
    ...
    local procedure OnInsertRetailCampaignLine(var Rec: Record "Retail Campaign Line";RunTrigger: Boolean)
    begin
    ...
    local procedure OnModifyRetailCampaignLine(var Rec: Record "Retail Campaign Line";var xRec: Record "Retail Campaign Line";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnDeleteRetailCampaignLine(var Rec: Record "Retail Campaign Line";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure RetailCampaignLine2MagentoCategory(RetailCampaignLine: Record "Retail Campaign Line";var MagentoCategory: Record "Magento Category"): Boolean
    var
    ...
    local procedure OnInsertPeriodDiscountLine(var Rec: Record "Period Discount Line";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnDeletePeriodDiscountLine(var Rec: Record "Period Discount Line";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnRenamePeriodDiscountLine(var Rec: Record "Period Discount Line";var xRec: Record "Period Discount Line";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnInsertMixedDiscountLine(var Rec: Record "Mixed Discount Line";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnDeleteMixedDiscountLine(var Rec: Record "Mixed Discount Line";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnRenameMixedDiscountLine(var Rec: Record "Mixed Discount Line";var xRec: Record "Mixed Discount Line";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnInsertRetailCampaignHeader(var Rec: Record "Retail Campaign Header";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnModifyRetailCampaignHeader(var Rec: Record "Retail Campaign Header";var xRec: Record "Retail Campaign Header";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure OnDeleteRetailCampaignHeader(var Rec: Record "Retail Campaign Header";RunTrigger: Boolean)
    begin
        if Rec.IsTemporary then
          exit;
    ...
    local procedure InitMagentoCategoryLinks(RetailCampaignLine: Record "Retail Campaign Line")
    var
    ...
    local procedure InitMagentoCategoryLinks2(PeriodDiscountLine: Record "Period Discount Line")
    var
        Item: Record Item;
        MagentoCategory: Record "Magento Category";
        MagentoCategoryLink: Record "Magento Category Link";
    ...
    local procedure InitMagentoCategoryLinks3(MixedDiscountLine: Record "Mixed Discount Line")
    var
        TempItem: Record Item temporary;
        MagentoCategory: Record "Magento Category";
        MagentoCategoryLink: Record "Magento Category Link";
    ...
    local procedure InitMagentoCategoryLinks4(RetailCampaignHeader: Record "Retail Campaign Header")
    var
        MagentoCategory: Record "Magento Category";
        MagentoCategoryLink: Record "Magento Category Link";
        RetailCampaignLine: Record "Retail Campaign Line";
    ...
    local procedure RemoveMagentoCategoryLinks(RetailCampaignLine: Record "Retail Campaign Line")
    var
        MagentoCategory: Record "Magento Category";
        MagentoCategoryLink: Record "Magento Category Link";
        TempItem: Record Item temporary;
    ...
    local procedure RemoveMagentoCategoryLinks2(PeriodDiscountLine: Record "Period Discount Line")
    var
        MagentoCategory: Record "Magento Category";
        MagentoCategoryLink: Record "Magento Category Link";
        RetailCampaignLine: Record "Retail Campaign Line";
    ...
    local procedure RemoveMagentoCategoryLinks3(MixedDiscountLine: Record "Mixed Discount Line")
    var
        TempItem: Record Item temporary;
        TempItem2: Record Item temporary;
        MagentoCategory: Record "Magento Category";
    ...
    local procedure RemoveMagentoCategoryLinks4(RetailCampaignHeader: Record "Retail Campaign Header")
    var
        MagentoCategory: Record "Magento Category";
        MagentoCategoryLink: Record "Magento Category Link";
        RetailCampaignLine: Record "Retail Campaign Line";
    ...
    var
        RetailCampaignItemsPeriod: Query "Retail Campaign Items (Period)";
        RetailCampaignItemsMix0: Query "Retail Campaign Items (Mix 0)";
        RetailCampaignItemsMix1: Query "Retail Campaign Items (Mix 1)";
        RetailCampaignItemsMix2: Query "Retail Campaign Items (Mix 2)";
    begin
    ...
    var
        PeriodDiscountItems: Query "Period Discount Items";
    begin
    ...
    var
        MixedDiscountItemsMix0: Query "Mixed Discount Items (Mix 0)";
    begin
    ...
    var
        MixedDiscountItemsMix1: Query "Mixed Discount Items (Mix 1)";
    begin
    ...
    var
        MixedDiscountItemsMix2: Query "Mixed Discount Items (Mix 2)";
    begin
    ...
    local procedure FindMixedItems(MixedDiscountLine: Record "Mixed Discount Line";var TempItem: Record Item temporary)
    var
        Item: Record Item;
    begin
        if not TempItem.IsTemporary then
        ...
        case MixedDiscountLine."Disc. Grouping Type" of
          ...
          MixedDiscountLine."Disc. Grouping Type"::"Item Group":
            begin
              Item.SetRange("Item Group",MixedDiscountLine."No.");
            end;
