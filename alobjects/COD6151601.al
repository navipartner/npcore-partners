codeunit 6151601 "NpDc Apply - Extra Item. Qty."
{
    ...
    procedure CalcDiscountAmount(SaleLinePOS: Record "Sale Line POS";SaleLinePOSCoupon: Record "NpDc Sale Line POS Coupon";ExtraItemQty: Decimal) DiscountAmount: Decimal
    var
    ...
    local procedure CalcExtraItemQty(SaleLinePOSCoupon: Record "NpDc Sale Line POS Coupon") ExtraItemQty: Decimal
    var
    ...
    local procedure CalcExtraItemQtyLot(SaleLinePOSCoupon: Record "NpDc Sale Line POS Coupon") MaxLotQty: Decimal
    var
        NpDcCouponListItem: Record "NpDc Coupon List Item";
        LotQty: Decimal;
    begin
    ...
    local procedure CalcPOSSalesQty(SaleLinePOSCoupon: Record "NpDc Sale Line POS Coupon";NpDcCouponListItem: Record "NpDc Coupon List Item"): Decimal
    var
        SaleLinePOS: Record "Sale Line POS";
    begin
    ...
    local procedure CalcPOSSalesQtyLot(SaleLinePOSCoupon: Record "NpDc Sale Line POS Coupon";NpDcCouponListItem: Record "NpDc Coupon List Item"): Decimal
    var
        SaleLinePOS: Record "Sale Line POS";
    begin
    ...
    begin
        ...
        Commit;
        PAGE.RunModal(PAGE::"NpDc Extra Item Qty.",ExtraCouponItem);
        Commit;
