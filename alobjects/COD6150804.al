codeunit 6150804 "POS Action - Switch Register"
{
    ...
    local procedure OnActionList(Context: JsonObject; POSSession: Codeunit "POS Session"; FrontEnd: Codeunit "POS Front End Management")
    var
    ...
    local procedure SwitchRegister(Context: JsonObject; POSSession: Codeunit "POS Session"; FrontEnd: Codeunit "POS Front End Management"; NewRegisterNo: Code[10])
    var
