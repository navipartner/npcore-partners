    ...
    begin
        ...
        with SalesInvHeader do begin
          ...
          case PaymentLine."Account Type" of
            PaymentLine."Account Type"::"G/L Account": GenJnlLine."Bal. Account Type" := GenJnlLine."Bal. Account Type"::"G/L Account";
            PaymentLine."Account Type"::"Bank Account": GenJnlLine."Bal. Account Type" := GenJnlLine."Bal. Account Type"::"Bank Account";
          end;
