codeunit 6014484 "Pacsoft Management"
{
    ...
    begin
        ...
        XMLPORT.Export(XMLPORT::"Pacsoft Shipment Document", oStream, pShipmentDocument);
        pShipmentDocument.Modify;
    ...
    var
        ...
        iStream2: InStream;
        oStream: OutStream;
        XMLResponce: XMLport "Pacsoft Response";
        URI: Text[250];
    begin
        pShipmentDocument.CalcFields("Request XML");
    ...
    procedure CheckDocument(pShipmentDocument: Record "Pacsoft Shipment Document") OK: Boolean
    var
        ShippingAgent: Record "Shipping Agent";
        ShippingAgentService: Record "Shipping Agent Services";
        ShipDocService: Record "Pacsoft Shipment Doc. Services";
