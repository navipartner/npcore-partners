table 6014428 "Payment Type - Prefix"
{
    ...
    LookupPageID = "Credit Card Prefix";
    ...
    fields
    {
        ...
        field(2;"Register No.";Code[10])
        {
            ...
            TableRelation = IF ("Payment Type"=CONST('<>''')) Register."Register No.";
        }
        ...
        {
            CalcFormula = Lookup("Payment Type POS".Status WHERE ("No."=FIELD("Payment Type")));
            Caption = 'Status';
