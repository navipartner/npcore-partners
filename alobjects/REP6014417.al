report 6014417 "Inventory per Date"
{
    ...
    dataset
    {
        dataitem(Item;Item)
        {
            ...
            DataItemTableView = SORTING("Primary Key Length");
            RequestFilterFields = "No.","Vendor No.","Item Group","Group sale";
            ...
            begin
                ...
                else if NegativVolumeShow and not ShowItemNegativeInventory then begin
                  if ("Net Change" >= 0) then
                    CurrReport.Skip;
                end
                else if ShowZeroInventory then begin
                //-NPR4.10
                //  IF "Net Change" = 0 THEN
                  if "Net Change" <> 0 then
                //+NPR4.10
                ...
                else if ShowItemNegativeInventory and NegativVolumeShow then begin
                   Error('Choose either');
                end;
