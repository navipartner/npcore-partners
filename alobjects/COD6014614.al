codeunit 6014614 "Retail Campaign Calc. Mgt."
{
    ...
    var
        RetailCampaignItemTotals: Query "Retail Campaign Item Totals";
    begin
    ...
    var
        ...
        RetailCampaignItemEntries: Query "Retail Campaign Item Entries";
    begin
        if CampaignCode = '' then
          exit;
