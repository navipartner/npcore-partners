codeunit 6151527 "Nc Collector Data Log Proc."
{
    ...
    local procedure CheckCollectors(Datalogrecord: Record "Data Log Record")
    var
    ...
    begin
        ...
        if NcCollector.FindSet then repeat
    ...
    local procedure ProcessChange(DataLogRecord: Record "Data Log Record";NcCollectorCode: Code[20])
    var
    ...
    local procedure CheckFilter(DataLogRecord: Record "Data Log Record";NcCollectorCode: Code[20]): Boolean
    var
    ...
    local procedure CheckModifyTriggers(DataLogRecord: Record "Data Log Record";NcCollectorCode: Code[20]): Boolean
    var
        NcCollectorFilter: Record "Nc Collector Filter";
        DataLogField: Record "Data Log Field";
