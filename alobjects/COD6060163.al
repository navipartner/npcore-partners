codeunit 6060163 "Event Transfer Ext. Text Mgt."
{
    ...
    begin
        ...
        JobPlanningLine.SetRange("Att. to Line No.",Rec."Line No.");
    ...
    begin
        ...
        if IsDeleteAttachedLines(JobPlanningLine."Line No.",JobPlanningLine."No.",JobPlanningLine."Att. to Line No.") then
        ...
        if AutoText then begin
          ...
          ExtTextHeader.SetRange("Event",true);
    ...
    begin
        ...
        JobPlanningLine2.SetRange("Att. to Line No.",JobPlanningLine."Line No.");
    ...
    begin
        ...
        if TmpExtTextLine.Find('-') then begin
          repeat
            ...
            ToJobPlanningLine."Att. to Line No." := JobPlanningLine."Line No.";
