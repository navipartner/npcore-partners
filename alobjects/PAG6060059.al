page 6060059 "POS Inventory Overview"
{
    ...
    ModifyAllowed = false;
    PageType = List;
    SourceTable = "Inventory Overview Line";
    ...
    begin
        ...
        Item.Get(ItemCode);
        Variety1ValueVisible := Item."Variety 1" <> '';
        Variety2ValueVisible := Item."Variety 2" <> '';
        Variety3ValueVisible := Item."Variety 3" <> '';
    ...
    var
        ...
        VarietyValuePage: Page "Variety Value";
