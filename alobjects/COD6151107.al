codeunit 6151107 "NpRi Reim. Purch. Doc. Disc."
{
    ...
    local procedure DiscoverPurchDocDiscCode(var NpRiModule: Record "NpRi Reimbursement Module")
    begin
    ...
    begin
        ...
        PAGE.RunModal(PAGE::"NpRi Purch. Doc. Disc. Setup",NpRiPurchDocDiscSetup);
    ...
    local procedure RunPurchDocDiscReimbursement(var NpRiReimbursement: Record "NpRi Reimbursement";var NpRiReimbursementEntryApply: Record "NpRi Reimbursement Entry")
    var
    ...
    local procedure GetVendor(NpRiReimbursement: Record "NpRi Reimbursement";var Vendor: Record Vendor)
    var
