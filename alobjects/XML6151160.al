xmlport 6151160 "MM Get Loyalty Configuration"
{
        ...
        textelement(GetLoyaltyConfiguration)
        {
            ...
            textelement(Response)
            {
                ...
                textelement(Configurations)
                {
                    MaxOccurs = Once;
                    MinOccurs = Zero;
                    tableelement(tmployaltysetupresponse;"MM Loyalty Setup")
                    {
                        MinOccurs = Zero;
    ...
    procedure GetRequest(var TmpAuthorization: Record "MM Loyalty Ledger Entry (Srvr)" temporary)
    begin
    ...
    procedure GetResponse(var ResponseCodeOut: Code[10];var ResponseMessageOut: Text;var DocumentIdOut: Text;var TmpLoyaltySetup: Record "MM Loyalty Setup" temporary)
    begin
    ...
    procedure SetResponse(var TmpLoyaltySetup: Record "MM Loyalty Setup" temporary)
    begin
