codeunit 6014625 "POS Device Proxy Manager"
{
    ...
    begin
        ...
        case ToInt(Manager.State) of
          ToInt(ProtocolState.Securing):              ProtocolSecureResponse(Manager,Envelope);
          ToInt(ProtocolState.CheckingAssemblies):    ProtocolGetAssembliesResponse(Manager,Envelope);
          ToInt(ProtocolState.InstallingAssemblies):  ProtocolInstallAssemblyResponse(Manager,Envelope);
          ToInt(ProtocolState.Messaging):             ProtocolMessagingResponse(Manager,Envelope);
        end;
    end;
    ...
    begin
        case ToInt(NewState) of
          ...
          ToInt(ProtocolState.Secured):             ProtocolStateEnteredSecured(Manager,PreviousState);
          ToInt(ProtocolState.CheckedAssemblies):   ProtocolStateEnteredCheckedAssemblies(Manager,PreviousState);
          ToInt(ProtocolState.InstalledAssemblies): ProtocolStateEnteredInstalledAssemblies(Manager,PreviousState);
          ToInt(ProtocolState.Open):                ProtocolStateEnteredOpen(Manager,PreviousState);
        end;
    end;
