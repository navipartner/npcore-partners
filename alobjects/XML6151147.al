xmlport 6151147 "M2 Item Availability By Period"
{
                                ...
                                tableelement(itemavailabilitybyperiodstart;Date)
                                {
                                    ...
                                    begin
                                        ...
                                        case ViewAsOption of
                                          ViewAsOption::BALANCEATDATE : ItemByPeriod.SetFilter ("Date Filter", '%1..%2', 0D, ItemAvailabilityByPeriodStart."Period Start");
                                          ViewAsOption::NETCHANGE     : ItemByPeriod.SetFilter ("Date Filter", '%1..%2', ItemAvailabilityByPeriodStart."Period Start", ItemAvailabilityByPeriodStart."Period Start");
                                        end;
    ...
    var
        ...
        M2ServiceLibrary: Codeunit "M2 Service Library";
