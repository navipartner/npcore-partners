xmlport 6151121 "MM GDPR Get Set Approval State"
{
        ...
        textelement(members)
        {
            textelement(getsegdprtapproval)
            {
                ...
                textelement(response)
                {
                    ...
                    tableelement(tmpmember;"MM Membership Role")
                    {
                        MaxOccurs = Unbounded;
                        MinOccurs = Zero;
                        XmlName = 'member';
                        ...
                        textelement(guardians)
                        {
                            MaxOccurs = Once;
                            MinOccurs = Zero;
                            tableelement(tmpguardians;"MM Membership Role")
                            {
                                MinOccurs = Zero;
                                XmlName = 'guardian';
                                UseTemporary = true;
                        ...
                        textelement(dependents)
                        {
                            MaxOccurs = Once;
                            MinOccurs = Zero;
                            tableelement(tmpdependents;"MM Membership Role")
                            {
                                MinOccurs = Zero;
                                XmlName = 'dependent';
                                UseTemporary = true;
