table 6059906 "Task Worker Group"
{
    ...
    DrillDownPageID = "Task Worker Group";
    LookupPageID = "Task Worker Group";
    ...
    fields
    {
        ...
        {
            CalcFormula = Count("Task Worker" WHERE ("Task Worker Group"=FIELD(Code)));
            Caption = 'No. of Active Threads';
            FieldClass = FlowField;
            TableRelation = "Task Worker" WHERE ("Task Worker Group"=FIELD(Code));
        }
    }
