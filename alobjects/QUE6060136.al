query 6060136 "MM Member Card Notification"
{
    ...
    elements
    {
        dataitem(MemberCard;"MM Member Card")
        {
            ...
            dataitem(MembershipRoles;"MM Membership Role")
            {
                ...
                dataitem(Membership;"MM Membership")
                {
