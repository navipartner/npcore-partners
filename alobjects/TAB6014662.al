table 6014662 "Stock-Take Worksheet"
{
    ...
    LookupPageID = "Stock-Take Worksheets";
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Stock-Take Configuration"."Inventory Calc. Date" WHERE (Code=FIELD("Stock-Take Config Code")));
        ...
        {
            CalcFormula = Lookup("Stock-Take Configuration"."Location Code" WHERE (Code=FIELD("Stock-Take Config Code")));
        ...
        {
            CalcFormula = Lookup("Stock-Take Configuration"."Item Group Filter" WHERE (Code=FIELD("Stock-Take Config Code")));
            Caption = 'Item Group Filter';
            Editable = false;
            FieldClass = FlowField;
            TableRelation = "Item Group"."No.";
        ...
        {
            CalcFormula = Lookup("Stock-Take Configuration"."Vendor Code Filter" WHERE (Code=FIELD("Stock-Take Config Code")));
            Caption = 'Vendor Code Filter';
            Editable = false;
            FieldClass = FlowField;
            TableRelation = Vendor;
        ...
        {
            CalcFormula = Lookup("Stock-Take Configuration"."Global Dimension 1 Code" WHERE (Code=FIELD("Stock-Take Config Code")));
            CaptionClass = '1,1,1';
            Caption = 'Global Dimension 1 Code Filter';
            Editable = false;
            FieldClass = FlowField;
        ...
        {
            CalcFormula = Lookup("Stock-Take Configuration"."Global Dimension 2 Code" WHERE (Code=FIELD("Stock-Take Config Code")));
            CaptionClass = '1,1,2';
            Caption = 'Global Dimension 2 Code Filter';
            Editable = false;
            FieldClass = FlowField;
        ...
        {
            CalcFormula = Lookup("Stock-Take Configuration"."Stock Take Method" WHERE (Code=FIELD("Stock-Take Config Code")));
        ...
        {
            CalcFormula = Lookup("Stock-Take Configuration"."Adjustment Method" WHERE (Code=FIELD("Stock-Take Config Code")));
