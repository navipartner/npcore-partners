codeunit 6014637 "Generic Filter Page Mgt."
{
    ...
    var
        ...
        FilterViewName: Text;
        GenericFilterPage: Page "Generic Filter Page";
    ...
    local procedure AuditRollAdvancedFilter(var Rec: Record "Audit Roll")
    var
    ...
    local procedure POSMenuFilterGenericFilter(var Rec: Record "POS Menu Filter")
    var
        RecRef: RecordRef;
        FilterStringText: Text;
        INS: InStream;
    ...
    local procedure DisplayFilter(var Rec: Record "POS Menu Filter")
    var
        FilterStringText: Text;
        INS: InStream;
