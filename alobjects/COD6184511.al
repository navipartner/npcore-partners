codeunit 6184511 "EFT Mock Client Integration"
{
    ...
    begin
        ...
        tmpEFTIntegrationType."Codeunit ID" := CODEUNIT::"EFT Mock Client Integration";
    ...
    local procedure OnLookupPaymentBlobParameterValue(var Parameter: Record "EFT Type Payment BLOB Param.")
    begin
    end;

    [EventSubscriber(ObjectType::Table, 6184481, 'OnValidateParameterValue', '', false, false)]
    local procedure OnValidatePaymentBlobParameterValue(var Parameter: Record "EFT Type Payment BLOB Param.")
    begin
    end;
    ...
    local procedure OnValidatePaymentGenParameterValue(var Parameter: Record "EFT Type Payment Gen. Param.")
    begin
    end;
    ...
    local procedure OnLookupUnitBlobParameterValue(var Parameter: Record "EFT Type POS Unit BLOB Param.")
    begin
    end;

    [EventSubscriber(ObjectType::Table, 6184482, 'OnValidateParameterValue', '', false, false)]
    local procedure OnValidateUnitBlobParameterValue(var Parameter: Record "EFT Type POS Unit BLOB Param.")
    begin
    end;
    ...
    procedure GetConnectionMethod(EFTSetup: Record "EFT Setup"): Integer
    var
        EFTTypePOSUnitGenParam: Record "EFT Type POS Unit Gen. Param.";
    begin
    ...
    procedure GetIPAddr(EFTSetup: Record "EFT Setup"): Text
    var
        EFTTypePOSUnitGenParam: Record "EFT Type POS Unit Gen. Param.";
    begin
    ...
    procedure GetVirtualCOM(EFTSetup: Record "EFT Setup"): Integer
    var
        EFTTypePOSUnitGenParam: Record "EFT Type POS Unit Gen. Param.";
    begin
    ...
    local procedure GetPaymentParam1(EFTSetup: Record "EFT Setup"): Text
    var
        EFTTypePaymentGenParam: Record "EFT Type Payment Gen. Param.";
    begin
    ...
    local procedure GetPaymentParam2(EFTSetup: Record "EFT Setup"): Text
    var
        EFTTypePaymentGenParam: Record "EFT Type Payment Gen. Param.";
    begin
