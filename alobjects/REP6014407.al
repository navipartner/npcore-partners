report 6014407 "Sales Ticket Statistics A4"
{
    ...
    dataset
    {
        dataitem(PaymentTypePeriod;"Payment Type POS")
        {
        ...
        dataitem(GiftVoucher;"Payment Type POS")
        {
            CalcFields = "Amount in Audit Roll";
            DataItemTableView = SORTING("No.","Register No.") ORDER(Ascending);
        ...
        dataitem(CreditVoucher;"Payment Type POS")
        {
            CalcFields = "Amount in Audit Roll";
            DataItemTableView = SORTING("No.","Register No.") ORDER(Ascending);
        ...
        dataitem(PaymentTypePOS4;"Payment Type POS")
        {
            CalcFields = "Amount in Audit Roll";
            DataItemTableView = SORTING("No.","Register No.") ORDER(Ascending);
        ...
        dataitem(PaymentTypePOS5;"Payment Type POS")
        {
            CalcFields = "Amount in Audit Roll";
            DataItemTableView = SORTING("No.","Register No.") ORDER(Ascending);
        ...
        dataitem(PaymentTypePOS6;"Payment Type POS")
        {
            CalcFields = "Amount in Audit Roll";
            DataItemTableView = SORTING("No.","Register No.") ORDER(Ascending);
    ...
    var
        ...
        Sale3: Decimal;
        Credit3: Decimal;
        PaymentTypePOSTotal: Record "Payment Type POS";
