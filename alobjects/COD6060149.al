codeunit 6060149 "RC MM Membership Burndown Mgt."
{
    ...
    procedure OnPageOpen(var vMembershipBurndownSetup: Record "RC Membership Burndown Setup")
    begin
          ...
          for MembershipEntryContext := 1 to ArrayLen(ChartToStatusMap) do begin
            ...
            for ColumnNo := 1 to ArrayLen (ToDate) do begin
              ...
              case MembershipBurndownSetup."Show Change As" of
                MembershipBurndownSetup."Show Change As"::ACK : if ColumnNo = 1 then TotalValue := Value else TotalValue += Value;
                MembershipBurndownSetup."Show Change As"::NET : TotalValue := Value;
              end;
