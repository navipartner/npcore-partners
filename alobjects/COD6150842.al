codeunit 6150842 "POS Action - Set Sale VAT"
{
    ...
    local procedure CheckLimits(POSSession: Codeunit "POS Session";MinSaleAmount: Decimal;MinSaleAmountLimit: Boolean;MaxSaleAmount: Decimal;MaxSaleAmountLimit: Boolean)
    var
    ...
    local procedure InsertComment(POSSaleLine: Codeunit "POS Sale Line";VATAmountDifference: Decimal)
    var
    ...
    begin
        ...
        if VATAmountDifference = 0 then
          exit
        else if VATAmountDifference > 0 then
    ...
    local procedure ChangeSaleVATBusPostingGroup(POSSession: Codeunit "POS Session";NewGenBusPostingGroup: Text;NewVATBusPostingGroup: Text;AddCommentLine: Boolean)
    var
