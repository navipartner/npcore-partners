report 6014473 "Common balancing A4"
{
    ...
    begin
        ...
        if ar.Find('-') then repeat
          ...
          case ar."Discount Type" of
            ar."Discount Type"::Campaign      : perioderabat   := perioderabat + ar."Line Discount Amount";
            ar."Discount Type"::Mix         : mixprisrabat   := mixprisrabat + ar."Line Discount Amount";
            ar."Discount Type"::Quantity     : flerstyksrabat := flerstyksrabat + ar."Line Discount Amount";
            ar."Discount Type"::Manual : brugerrabat    := brugerrabat + ar."Line Discount Amount";
            5                                : linierabat     := linierabat + ar."Line Discount Amount";
            0                                : linierabat     := linierabat + ar."Line Discount Amount";
          end;
        until ar.Next = 0;
