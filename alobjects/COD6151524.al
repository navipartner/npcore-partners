codeunit 6151524 "Nc Endpoint FTP Mgt."
{
    ...
    local procedure ProcessNcEndpoints(NcTriggerCode: Code[20];Output: Text;Filename: Text;var NcTask: Record "Nc Task")
    var
    ...
    local procedure ProcessNcEndpointTrigger(NcTriggerCode: Code[20];Output: Text;Filename: Text;var NcTask: Record "Nc Task";NcEndpointFTP: Record "Nc Endpoint FTP")
    var
        NcTrigger: Record "Nc Trigger";
    begin
    ...
    local procedure InsertEndpointTask(var NcEndpointFTP: Record "Nc Endpoint FTP";var NcTask: Record "Nc Task";Filename: Text)
    var
        NcTriggerSyncMgt: Codeunit "Nc Trigger Sync. Mgt.";
        NewTask: Record "Nc Task";
        TempNcEndPointFTP: Record "Nc Endpoint FTP" temporary;
        RecRef: RecordRef;
    ...
    local procedure ProcessEndPointTask(var NcEndpointFTP: Record "Nc Endpoint FTP";var NcTask: Record "Nc Task";Output: Text;Filename: Text)
    var
    ...
    local procedure FtpProcess(var NcTask: Record "Nc Task";NcEndpointFTP: Record "Nc Endpoint FTP";OutputText: Text;Filename: Text)
    var
    ...
    begin
        ...
        case NcEndpointFTP."File Encoding" of
          NcEndpointFTP."File Encoding"::ANSI: Encoding := Encoding.GetEncoding('windows-1252');
          NcEndpointFTP."File Encoding"::Unicode: Encoding := Encoding.Unicode;
          NcEndpointFTP."File Encoding"::UTF8: Encoding := Encoding.UTF8;
        end;
    ...
    local procedure SendFtpOutput(NcTaskOutput: Record "Nc Task Output";NcEndpointFTP: Record "Nc Endpoint FTP")
    begin
        //-308107 [308107]
        if not NcEndpointFTP.Enabled then
          exit;
    ...
    local procedure OnHasInitEndpoint(NcEndpoint: Record "Nc Endpoint";var EndpointHasInit: Boolean)
    var
        NcEndpointFTP: Record "Nc Endpoint FTP";
    begin
        //-NC2.13 [318934]
    ...
    local procedure OnInitEndpoint(NcEndpoint: Record "Nc Endpoint")
    var
        NcEndpointFTP: Record "Nc Endpoint FTP";
    begin
        //-NC2.13 [318934]
    ...
    begin
        ...
        PAGE.Run(PAGE::"Nc Endpoint FTP Card", NcEndpointFTP);
        Handled := true;
    end;
