xmlport 6060110 "TM Ticket Statistics N-Dim"
{
        ...
        textelement(TicketStatistics)
        {
            ...
            textelement(Response)
            {
                ...
                textelement(Statistics)
                {
                    MaxOccurs = Once;
                    MinOccurs = Zero;
                    tableelement(ticketstatisticsresponse;"TM Ticket Access Statistics")
                    {
                        XmlName = 'Fact';
                        UseTemporary = true;
    ...
    procedure SetResponse(var TmpTicketAccessStatistics: Record "TM Ticket Access Statistics" temporary)
    begin
