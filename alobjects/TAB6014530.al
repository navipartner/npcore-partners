table 6014530 "POS Customer Location"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Exist("Sale POS" WHERE ("Saved Sale"=CONST(true),
        ...
        {
            CalcFormula = Sum("Sale Line POS"."Amount Including VAT" WHERE ("Customer Location No."=FIELD("No.")));
