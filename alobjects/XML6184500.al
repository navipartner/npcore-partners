xmlport 6184500 "EFT BIN Import"
{
    ...
    schema
    {
        ...
        {
            XmlName = 'BINRange';
            tableelement("EFT BIN Range";"EFT BIN Range")
            {
                XmlName = 'EFTBINRange';
                UseTemporary = true;
    ...
    begin
        if "EFT BIN Range".FindSet then repeat
    ...
    begin
        ...
        if EFTBINGroup.FindSet then repeat
    ...
    var
        tmpEFTBINGroup: Record "EFT BIN Group" temporary;
