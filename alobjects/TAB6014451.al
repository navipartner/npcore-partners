table 6014451 "Retail Journal Header"
{
    ...
    LookupPageID = "Retail Journal List";
    ...
    procedure AssistEdit(old: Record "Retail Journal Header"): Boolean
    var
        this: Record "Retail Journal Header";
    begin
        with this do begin
          this := Rec;
          RetailSetup.Get;
    ...
    var
        RetailJournalLine1: Record "Retail Journal Line";
    begin
        //-NPR5.49 [344000]
        if ("Shortcut Dimension 1 Code" <> xRec."Shortcut Dimension 1 Code") or
          ...
          ("Location Code" <> xRec."Location Code") then begin
            ...
            if RetailJournalLine1.FindSet then repeat
