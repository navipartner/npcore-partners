xmlport 6151590 "NpDc Ext. Coupon Application"
{
    ...
    schema
    {
        ...
        {
            tableelement(tempsaleposreq;"Sale POS")
            {
                MaxOccurs = Once;
                MinOccurs = Zero;
                XmlName = 'request';
                ...
                textelement(possaleslinesreq)
                {
                    ...
                    tableelement(tempsalelineposreq;"Sale Line POS")
                    {
                ...
                {
                    MaxOccurs = Once;
                    tableelement(tempnpdcextcouponbuffer;"NpDc Ext. Coupon Buffer")
                    {
            ...
            tableelement(tempsaleposres;"Sale POS")
            {
                MaxOccurs = Once;
                MinOccurs = Zero;
                XmlName = 'response';
                ...
                textelement(possaleslinesres)
                {
                    MaxOccurs = Once;
                    XmlName = 'pos_sales_lines';
                    tableelement(tempsalelineposres;"Sale Line POS")
                    {
                        MaxOccurs = Unbounded;
                        MinOccurs = Zero;
                        XmlName = 'pos_sales_line';
    ...
    procedure GetRequest(var TempSalePOSReq2: Record "Sale POS" temporary;var TempSaleLinePOSReq2: Record "Sale Line POS" temporary;var TempNpDcExtCouponBuffer2: Record "NpDc Ext. Coupon Buffer" temporary)
    begin
    ...
    procedure SetResponse(var TempSalePOSRes2: Record "Sale POS" temporary;var TempSaleLinePOSRes2: Record "Sale Line POS" temporary)
    begin
