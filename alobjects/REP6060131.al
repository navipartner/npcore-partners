report 6060131 "MM Membership Points Detail"
{
    // MM1.17/JLK /20170123  CASE 243075 Object created
    DefaultLayout = RDLC;
    RDLCLayout = './layouts/MM Membership Points Detail.rdlc';
    ...
    dataset
    {
        dataitem("MM Membership";"MM Membership")
        {
            ...
            dataitem("MM Membership Points Entry";"MM Membership Points Entry")
            {
