codeunit 6060145 "MM Foreign Membership Mgr."
{
    ...
    var
        ForeignValidationSetup: Record "MM Foreign Membership Setup";
        IsHandled: Boolean;
    ...
    procedure ShowSetup(ForeignMembershipSetup: Record "MM Foreign Membership Setup")
    begin

        OnShowSetup (ForeignMembershipSetup."Community Code", ForeignMembershipSetup."Manager Code");
    end;

    procedure ShowDashboard(ForeignMembershipSetup: Record "MM Foreign Membership Setup")
    begin
    ...
    local procedure OnDiscoverExternalMembershipMgr(var Sender: Record "MM Foreign Membership Setup")
    begin
    end;
