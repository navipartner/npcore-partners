/**
 * Returns Transcendence script code that's intended to be instantiated as a Function and invoked with two parameters: dragonglass and window
 */
export const TRANSCENDENCE_SCRIPT: string = `
console.log(
